...
final class Class_f
{
        ...
        for (int i = 0; i < 5; ++i) {
            ...
            for (Class_f class_f = Class_f.var_157d[i]; class_f != null; class_f = var_17ad) {
                ...
                if ((class_f2 = class_f).var_189d != null) {
                    class_f2.var_189d.sub_1ca1(GLLib.var_1e1f);
                }
                switch (class_f2.var_17c5) {
                            ...
                            if ((class_f5.var_1835 == 12 || class_f5.var_1835 == 11) && cGame.var_807c == 0 && class_f5.sub_a2a0(512)) {
                                ...
                                if (cGame.sub_2a397()) {
                                    if (class_f5.var_15d5 >= 0) {
                                        ...
                                        class_f6.var_15d5 -= GLLib.var_1e1f;
                                        if (class_f5.var_15d5 < 0) {
                                        ...
                                        class_f5.var_189d.sub_1ca1(GLLib.var_1e1f);
                                        if (class_f5.var_189d.sub_1b34()) {
                                            class_f5.var_189d = null;
                                            class_f5.var_15d5 = GLLib.sub_2b97(1000, 4000);
                                        }
                                    }
                                }
                                else if (class_f5.var_189d != null) {
                                ...
                                if (cGame.var_807c == 0 && cGame.sub_2b680()) {
                                    ...
                                    if (class_f5.var_15d5 >= 0) {
                                        ...
                                        class_f7.var_15d5 -= GLLib.var_1e1f;
                                        if (class_f5.var_15d5 < 0) {
                                            (class_f5.var_189d = new GLLibPlayer(cGame.var_7ff4[class_f5.var_1865], class_f5.var_17ed, class_f5.var_17f5)).SetAnim(0, 1);
                                        }
                                    }
                                        ...
                                        class_f5.var_189d.sub_1ca1(GLLib.var_1e1f);
                                        if (class_f5.var_189d.sub_1b34()) {
                                            class_f5.var_15d5 = GLLib.sub_2b97(10000, 30000);
                                            class_f5.var_189d = null;
                                        }
                                    }
                                }
                                ...
                                if (cGame.sub_35bc4()) {
                                    ...
                                    if (class_f5.var_15d5 >= 0) {
                                        ...
                                        class_f8.var_15d5 -= GLLib.var_1e1f;
                                        if (class_f5.var_15d5 < 0) {
                                            class_f5.var_18b5.SetAnim(0, 1);
                                        }
                                    }
                                    else {
                                        class_f5.var_18b5.sub_1ca1(GLLib.var_1e1f);
                                        if (class_f5.var_18b5.sub_1b34()) {
                                            class_f5.var_15d5 = GLLib.sub_2b97(3000, 4000);
                                        }
                                    }
                                }
                                ...
                                if (class_f5.var_15d5 >= 0) {
                                    ...
                                    class_f9.var_15d5 -= GLLib.var_1e1f;
                                    if (class_f5.var_15d5 < 0) {
                                        (class_f5.var_189d = new GLLibPlayer(cGame.var_7ff4[class_f5.var_1865], class_f5.var_17ed, class_f5.var_17f5)).SetAnim(0, 1);
                        ...
                        if ((class_f11 = class_f2).var_189d != null) {
                            if (class_f11.var_18b5 != null) {
                                ...
                                if (class_f11.var_18b5.sub_1b34()) {
                                    ...
                                    class_f11.var_18b5.sub_1ca1(GLLib.var_1e1f);
                                }
                            }
                            ...
                            if (!class_f11.sub_a2a0(512)) {
                                ...
                                switch (class_f11.var_185d) {
                                    case 0: {
                                        ...
                                        if (cGame.var_6aa4 == 0 || cGame.var_6aa4 == 1 || cGame.var_6aa4 == 3 || (cGame.sub_1146d() && cGame.var_8034 == class_f11) || !class_f11.sub_b03e() || cGame.var_813c || GLLib.sub_2b97(0, 100) < 50) {
                                            class_f11.sub_8365(0);
                                            break;
                                        }
                                        final Class_f class_f12 = class_f11;
                                        cGame.var_813c = true;
                                        final int sub_2b97 = GLLib.sub_2b97(-4, 4);
                                        final int sub_2b98 = GLLib.sub_2b97(-4, 4);
                                        ...
                                        final int n7 = 1;
                                        array5[n7] += sub_2b98;
                                        if (cGame.var_7fd4 == -1 && !cGame.sub_2cce3(array3[0], array3[1], class_f12.var_1815 << 1, class_f12.var_181d << 1)) {
                                    ...
                                    case 5: {
                                        ...
                                        if (cGame.var_807c == 0 || (cGame.sub_2dcf3(5) < cGame.sub_2df26() && GLLib.sub_2b97(0, 100) < cGame.var_8064[20])) {
                                            final int sub_2b99 = GLLib.sub_2b97(0, 100);
                                            int n13 = 0;
                                            if (sub_2b99 < n9) {
                                ...
                                if (class_f11.sub_a2a0(32)) {
                                    ...
                                    if (!class_f11.sub_a2a0(256) && (cGame.sub_4ac19(20) || cGame.sub_4abbb(cGame.var_80f4[20]))) {
                                        if (n15 > class_f11.var_1625 * 3 / 4 && class_f11.var_161d > 0L && !class_f11.var_165d) {
                                            ...
                                            if (!class_f11.var_1655 && GLLib.sub_2b97(0, 100) < 35) {
                                                class_f11.sub_85b3(256);
                                                class_f11.var_1655 = true;
                                            }
                                        }
                                    ...
                                    if (n15 >= class_f11.var_1625 && class_f11.var_161d != 0L) {
                                        if (cGame.var_7fd4 == 35) {
                                            cGame.var_6c94 = true;
                                        }
                                        if (cGame.var_7fd4 != 34) {
                                ...
                                if (class_f11.sub_a2a0(4) && (class_f11.var_1895 == null || class_f11.var_1895.var_17c5 == -1)) {
                                    ...
                                    if ((cGame.var_6aac == null || cGame.var_6aac != class_f11) && class_f11.sub_b03e() && GLLib.sub_2b97(0, 100) < 10) {
                    ...
                    case 49: {
                        ...
                        if ((class_f14 = class_f2).var_18b5 != null) {
                            class_f14.var_18b5.sub_1ca1(GLLib.var_1e1f);
                        }
                        if (class_f14.var_185d == 3) {
                            final long n16;
                            if ((n16 = (System.currentTimeMillis() - class_f14.var_15e5) / 1000L) >= class_f14.var_15ed / 2 && cGame.var_7fd4 != 8 && cGame.var_7fd4 != 45) {
                            ...
                            final long n17;
                            if ((n17 = (System.currentTimeMillis() - class_f14.var_15e5) / 1000L) >= class_f14.var_15ed && (cGame.var_7fd4 < 46 || cGame.var_7fd4 > 57) && cGame.var_7fd4 != 8 && cGame.var_7fd4 != 45) {
                        ...
                        if (class_f14.var_18b5 != null && class_f14.var_185d == 5) {
                            ...
                            if (class_f14.var_18b5.GetSprite().sub_6475() != n18) {
                                class_f14.var_18b5.GetSprite().sub_6434(n18);
                            }
                        }
                        break;
                    }
                    ...
                    case 23: {
                        ...
                        if ((class_f17 = class_f2).var_189d != null && class_f17.var_189d.sub_1b34() && (Class_f.var_1785 == -1 || Class_f.var_1785 < Class_f.var_178d)) {
                            ...
                            class_f17.var_17cd = Class_f.var_1795 + GLLib.sub_2b97(-sub_312c, sub_312c);
                            class_f17.var_17d5 = Class_f.var_179d + GLLib.sub_2b97(-sub_1924, sub_1924);
        ...
        for (int i = 0; i < 5; ++i) {
                ...
                if ((class_f2 = var_17ad2).var_17c5 == 10) {
                    if (cGame.var_800c.var_17d5 < 576) {
                        ...
                        if (cGame.var_7fc4 != 100) {
                            GLLib.sub_5b71();
                            GLLib.sub_5c41(cGame.var_7fc4);
                            n2 = 138 * cGame.var_7fc4 / 100;
                        }
                        ...
                        int n4 = 321;
                        if (cGame.var_7fc4 != 100) {
                            n3 = 800 * cGame.var_7fc4 / 100;
                            n4 = 321 * cGame.var_7fc4 / 100;
                        }
                        for (int j = 0; j < sub_5cb3; j += n3) {
                            if (cGame.var_7fc4 < 100 && cGame.sub_438b0(79)) {
                                ...
                                GLLibPlayer.sub_6133(0, cGame.var_7ff4[79], 0, j, n4, cGame.var_8074, null);
                            }
                        }
                        int n5 = 240;
                        int n6 = 536;
                        if (cGame.var_7fc4 != 100) {
                            n5 = 240 * cGame.var_7fc4 / 100;
                            n6 = 536 * cGame.var_7fc4 / 100;
                        }
                        for (int k = 0; k < sub_5cb3; k += n5) {
                            if (cGame.var_7fc4 < 100 && cGame.sub_438b0(78)) {
                                ...
                                GLLibPlayer.sub_6133(0, cGame.var_7ff4[78], 0, k, n6, cGame.var_8074, null);
                            }
                        }
                        int n7 = 400;
                        int n8 = 576;
                        if (cGame.var_7fc4 != 100) {
                            n7 = 400 * cGame.var_7fc4 / 100;
                            n8 = 576 * cGame.var_7fc4 / 100;
                        }
                        for (int l = 0; l < sub_5cb3; l += n7) {
                            if (cGame.var_7fc4 < 100 && cGame.sub_438b0(77)) {
                                ...
                                GLLibPlayer.sub_6133(0, cGame.var_7ff4[77], 0, l, n8, cGame.var_8074, null);
                            }
                        }
                        if (cGame.var_7fc4 != 100) {
                            GLLib.sub_5b96();
            ...
            for (Class_f var_17ad3 = Class_f.var_157d[n]; var_17ad3 != null; var_17ad3 = var_17ad3.var_17ad) {
                ...
                if ((class_f3 = var_17ad3).var_17c5 == 10) {
                    GLLibPlayer.sub_3b5c(GLLib.var_1daf, 0, 0, 0);
                }
                    ...
                    if (!class_f3.sub_a2a0(16777216) || class_f3.var_189d != null) {
                        ...
                        if (class_f3.var_189d != null) {
                            ...
                            if (cGame.var_7fc4 < 100 && cGame.sub_438b0(class_f3.var_1865)) {
                                ...
                                sub_17f3.sub_700c(GLLib.var_1daf, sub_17f3.sub_36dd() / 2 + class_f3.var_189d.sub_1922(), class_f3.var_189d.sub_196d(), class_f3.var_17ed, class_f3.var_17f5, 0);
                            }
                            else {
                        ...
                        for (int n10 = 0; n10 < Class_f.var_1915; ++n10) {
                            if (Class_f.var_1905[2] >= Class_f.var_190d[n10][0] && Class_f.var_1905[0] <= Class_f.var_190d[n10][2] && Class_f.var_1905[3] >= Class_f.var_190d[n10][1] && Class_f.var_1905[1] <= Class_f.var_190d[n10][3]) {
                                ...
                                GLLib.sub_36f4(GLLib.var_1daf, array[0], array[1], array2[0] - array[0], array2[1] - array[1], true);
                                if (cGame.var_7fc4 == 100) {
                                    class_e2.sub_71ae(GLLib.var_1daf, class_f5.var_186d, class_f5.var_17ed, class_f5.var_17f5, 0);
                                }
                                else if (cGame.sub_438b0(class_f5.var_1865)) {
                                    class_e2.sub_71ae(GLLib.var_1daf, class_e2.sub_3717() / 2 + class_f5.var_186d, class_f5.var_17ed, class_f5.var_17f5, 0);
                                }
                                else {
                                    class_e2.sub_7d2b(GLLib.var_1daf, class_f5.var_186d, class_f5.var_17ed, class_f5.var_17f5, cGame.var_7fc4);
                                }
                ...
                switch (class_f3.var_17c5) {
                    case 54: {
                        ...
                        if (((sub_1922 = class_f6.var_189d.sub_1922()) == 1 || sub_1922 == 6 || sub_1922 == 2 || sub_1922 == 7) && cGame.var_68d4[1] != null) {
                            ...
                            if (cGame.var_7fc4 == 100) {
                                cGame.var_68d4[1].sub_71ae(GLLib.var_1daf, 34, n11, n12, 0);
                            }
                            else {
                                n11 += 10;
                                cGame.var_68d4[1].sub_7d2b(GLLib.var_1daf, 34, n11, n12, cGame.var_7fc4);
                            }
                        }
                        ...
                        if (cGame.var_7fc4 == 100) {
                            cGame.var_68d4[1].sub_71ae(GLLib.var_1daf, 64, n13, n14, 0);
                            break;
                        }
                        n14 += 40;
                        cGame.var_68d4[1].sub_7d2b(GLLib.var_1daf, 64, n13, n14, cGame.var_7fc4);
                        break;
                    }
                }
                if (class_f3.var_18bd && cGame.var_6aac == class_f3) {
                    ...
                    if (class_e4 != null && n15 > -1) {
                        ...
                        final int n18 = n16 + class_e4.sub_312c(n15);
                        final int n19 = n17 + class_e4.sub_3189(n15);
                        final int n20 = 0 + GLLib.var_1ddf;
                        final int n21 = 0 + GLLib.var_1de7;
                    ...
                    if (b && cGame.sub_2cad2(class_f3)) {
                        if (cGame.var_7fc4 == 100) {
                            cGame.var_7ff4[14].sub_71ae(GLLib.var_1daf, class_f3.var_1825, class_f3.var_17ed, class_f3.var_17f5, 0);
                        }
                        else {
                            cGame.var_7ff4[14].sub_7d2b(GLLib.var_1daf, class_f3.var_1825, class_f3.var_17ed, class_f3.var_17f5, cGame.var_7fc4);
                        }
                    }
                }
            }
            for (Class_f var_17ad4 = Class_f.var_157d[n]; var_17ad4 != null; var_17ad4 = var_17ad4.var_17ad) {
                ...
                if ((class_f9 = var_17ad4).var_18b5 != null) {
                    ...
                    class_f9.var_18b5.sub_1d9e(cGame.var_7fc4);
    ...
    private void sub_5bd2(int n, final int n2) {
        ...
        final ASprite class_e;
        if ((class_e = (((n & 0x8000) != 0x0) ? cGame.var_68d4[n3] : cGame.var_7ff4[n3])) == null || n2 < 0) {
            return;
        }
        ...
        if (cGame.var_7fc4 != 100) {
            GLLib.sub_5b71();
            GLLib.sub_5c41(cGame.var_7fc4);
            var_17cd = var_17cd * cGame.var_7fc4 / 100;
            var_17d5 = var_17d5 * cGame.var_7fc4 / 100;
        }
        int var_1875 = this.var_1875;
        if (this.sub_a2a0(65536)) {
            var_1875 += class_e.var_107f >> 1;
        }
        class_e.sub_6434(var_1875);
        ...
        if (n2 > -1) {
            ...
            final ASprite class_e2;
            (class_e2 = (((n & 0x8000) != 0x0) ? cGame.var_68d4[n4] : cGame.var_7ff4[n4])).sub_3524(Class_f.var_1905, n2, this.var_17cd, this.var_17d5);
            if (cGame.var_7fc4 != 100) {
                Class_f.var_1905[0] = Class_f.var_1905[0] * cGame.var_7fc4 / 100;
                Class_f.var_1905[1] = Class_f.var_1905[1] * cGame.var_7fc4 / 100;
                Class_f.var_1905[2] = Class_f.var_1905[2] * cGame.var_7fc4 / 100;
            ...
            for (int i = 0; i < Class_f.var_1915; ++i) {
                if (Class_f.var_1905[2] >= Class_f.var_190d[i][0] && Class_f.var_1905[0] <= Class_f.var_190d[i][2] && Class_f.var_1905[3] >= Class_f.var_190d[i][1] && Class_f.var_1905[1] <= Class_f.var_190d[i][3]) {
                    ...
                    if (cGame.var_7fc4 != 100) {
                        var_17cd2 = var_17cd2 * cGame.var_7fc4 / 100;
                        var_17d6 = var_17d6 * cGame.var_7fc4 / 100;
                    }
                    int var_1876 = this.var_1875;
                    if (this.sub_a2a0(65536)) {
                        var_1876 += class_e2.var_107f >> 1;
                    }
                    class_e2.sub_6434(var_1876);
                    if (cGame.var_7fc4 < 100 && cGame.sub_438b0(n)) {
                        GLLib.sub_5b96();
    ...
    private void sub_5f3b(int n, final int n2) {
        final int n3 = n & 0x7FFF;
        final ASprite class_e = ((n & 0x8000) != 0x0) ? cGame.var_68d4[n3] : cGame.var_7ff4[n3];
        int var_1875 = this.var_1875;
        if (class_e == null || n2 < 0) {
            return;
        }
        if (this.sub_a2a0(65536)) {
            var_1875 += class_e.var_107f >> 1;
        ...
        class_e.sub_6434(var_1875);
        if (cGame.var_7fc4 == 100) {
            class_e.sub_71ae(GLLib.var_1daf, n2, this.var_17ed, this.var_17f5, 0);
            return;
        }
        if (cGame.var_7fc4 < 100 && cGame.sub_438b0(n)) {
            n = class_e.sub_3717() / 2 + n2;
            class_e.sub_71ae(GLLib.var_1daf, n, this.var_17ed, this.var_17f5, 0);
            return;
        }
        class_e.sub_7d2b(GLLib.var_1daf, n2, this.var_17ed, this.var_17f5, cGame.var_7fc4);
    }
    
    final void sub_605f() {
        this.var_17ed = (this.var_17cd + this.var_1805) * cGame.var_7fc4 / 100 - cGame.var_800c.var_17cd;
        this.var_17f5 = (this.var_17d5 + this.var_180d) * cGame.var_7fc4 / 100 - cGame.var_800c.var_17d5;
    }
        ...
        if (cGame.var_70d4 == 0 && cGame.sub_2c4ff() < 50) {
            ...
            if (GLLib.sub_762d() && cGame.var_6aa4 == -1) {
                if (cGame.sub_2ceb1(array2[0], array2[1])) {
                    ...
                    final int sub_2d213;
                    if ((sub_2d213 = cGame.sub_2d213(array2[0], array2[1])) >= 1 && !cGame.var_6d5c[sub_2d213] && cGame.var_7fd4 == -1 && cGame.sub_4abbb(cGame.var_80f4[0]) && cGame.sub_4abbb(cGame.var_80f4[1])) {
                ...
                if (cGame.sub_2d213(array2[0], array2[1]) > 0 && cGame.var_7fd4 == -1) {
    ...
    final void sub_6872() {
        if (this.var_185d == 0 && GLLib.sub_7693()) {
            if (GLLib.var_2037 < 40) {
                this.var_17cd -= 1 * GLLib.var_1e1f;
            }
            else if (GLLib.var_2037 > GLLib.var_1ddf - 40) {
                this.var_17cd += 1 * GLLib.var_1e1f;
            }
            if (GLLib.var_203f < 40) {
                this.var_17d5 -= 1 * GLLib.var_1e1f;
                return;
            }
            if (GLLib.var_203f > GLLib.var_1de7 - 40) {
                this.var_17d5 += 1 * GLLib.var_1e1f;
            }
        }
    }
    ...
    final void sub_692a() {
        ...
        if (this.var_185d == 0) {
            final int var_17cd = 0 * cGame.var_7fc4 / 100;
            final int var_17d5 = 0 * cGame.var_7fc4 / 100;
            final int var_17cd2 = this.var_15ad * cGame.var_7fc4 / 100 - GLLib.var_1ddf;
            final int var_17d6 = this.var_15b5 * cGame.var_7fc4 / 100 - GLLib.var_1de7;
            ...
            int n3;
            if (this.var_15bd > 0) {
                if ((n3 = GLLib.var_1e1f * 100 / this.var_15bd) > 100) {
                    n3 = 100;
                }
            }
            else {
    ...
    static void sub_6b3b(final int var_7fc4) {
        if (cGame.var_7fc4 != var_7fc4) {
            final int n = GLLib.var_1ddf >> 1;
            final int n2 = GLLib.var_1de7 >> 1;
            final int n3 = (cGame.var_800c.var_17cd - n * cGame.var_7fc4 / 100 + n) * 100 / cGame.var_7fc4;
            final int n4 = (cGame.var_800c.var_17d5 - n2 * cGame.var_7fc4 / 100 + n2) * 100 / cGame.var_7fc4;
            cGame.var_7fc4 = var_7fc4;
            cGame.sub_cc72();
            cGame.var_800c.var_17cd = (n3 + n) * cGame.var_7fc4 / 100 - n;
            cGame.var_800c.var_17d5 = (n4 + n2) * cGame.var_7fc4 / 100 - n2;
        }
    }
    ...
    static void sub_6bd7() {
        ...
        if (sub_4c91(0, 23) > 0) {
            ...
            (array2[0].var_189d = new GLLibPlayer(cGame.var_7ff4[13], array2[0].var_17cd, array2[0].var_17d5)).SetAnim(1, 1);
            return;
        }
        final Class_f sub_92ea = sub_92ea(23, 0, new int[] { Class_f.var_1795 * 100 / cGame.var_7fc4, Class_f.var_179d * 100 / cGame.var_7fc4, 255 });
        (sub_92ea.var_189d = new GLLibPlayer(cGame.var_7ff4[13], sub_92ea.var_17cd, sub_92ea.var_17d5)).SetAnim(1, 1);
    }
    ...
    final boolean sub_6f71() {
        if (cGame.var_7fd4 == 1 || cGame.var_7fd4 == 2 || cGame.var_7fd4 == 3 || (cGame.var_7fd4 >= 32 && cGame.var_7fd4 <= 36)) {
            return false;
        }
        if (this.var_185d == 5) {
            cGame.sub_251a0(1);
    ...
    final boolean sub_6fe6() {
        if (cGame.var_7fd4 == 4 || cGame.var_7fd4 == 7 || cGame.var_7fd4 == 44) {
            cGame.var_6c94 = true;
        }
        if (this.var_185d == 1 && cGame.var_6af4 == 0) {
            if (cGame.var_6b44 <= cGame.getLevel()) {
                ...
                if ((cGame.var_6b24 > 0 && cGame.sub_2e3a5(cGame.var_6b24)) || (cGame.var_6b2c > 0 && cGame.sub_2e3d9(cGame.var_6b2c))) {
                    ...
                    if (cGame.var_7fd4 == 5 || cGame.var_7fd4 == 8) {
                    ...
                    if (cGame.var_6b24 > 0) {
                        ...
                        cGame.var_7ab4 = GLLib.sub_547c(((sub_4e1f = GLLib.sub_4e1f(379)) == null) ? "" : sub_4e1f, "%d", GLLib.sub_4fa1(cGame.var_6b24 - cGame.sub_2e0da(), cGame.var_7fe4, " "));
                        cGame.var_7aac = 18;
                        cGame.var_7d24 = false;
                    }
                    else if (cGame.var_6b2c > 0) {
                        final String sub_4e1f2;
                        cGame.var_7ab4 = GLLib.sub_547c(((sub_4e1f2 = GLLib.sub_4e1f(381)) == null) ? "" : sub_4e1f2, "%d", GLLib.sub_4fa1(cGame.var_6b2c - cGame.getCash(), cGame.var_7fe4, " "));
                        cGame.var_7aac = 19;
                        cGame.var_7d24 = true;
                    }
                    if (cGame.var_7aac != -1) {
    ...
    final boolean sub_7296() {
        ...
        if (cGame.var_7fd4 >= 14 && cGame.var_7fd4 <= 35) {
            return false;
        }
    ...
    final void sub_73e7() {
        if ((this.var_15f5 > 0 && cGame.sub_2e369(this.var_15f5)) || (this.var_15fd > 0 && cGame.sub_2e449(this.var_15fd))) {
            ...
            if (this.var_15f5 > 0) {
                final String sub_4e1f;
                cGame.var_7ab4 = GLLib.sub_547c(((sub_4e1f = GLLib.sub_4e1f(379)) == null) ? "" : sub_4e1f, "%d", GLLib.sub_4fa1(this.var_15f5 - cGame.sub_2e0da(), cGame.var_7fe4, " "));
                cGame.var_7aac = 18;
                cGame.var_7d24 = false;
            }
            else if (this.var_15fd > 0) {
                final String sub_4e1f2;
                cGame.var_7ab4 = GLLib.sub_547c(((sub_4e1f2 = GLLib.sub_4e1f(381)) == null) ? "" : sub_4e1f2, "%d", GLLib.sub_4fa1(this.var_15fd - cGame.getCash(), cGame.var_7fe4, " "));
                cGame.var_7aac = 19;
                cGame.var_7d24 = true;
            }
            if (cGame.var_7aac != -1) {
    ...
    private void sub_75fa(final boolean b) {
        ...
        if (cGame.getLevel() >= cGame.var_7a04[0] && GLLib.sub_2b97(0, 100) < cGame.var_8064[10]) {
    ...
    final boolean sub_7946() {
        ...
        if ((cGame.var_807c == 0 && cGame.sub_2dcf3(5) + sub_59d2(2) + 3 > cGame.sub_2df26()) || (cGame.var_807c == 0 && cGame.sub_2dcf3(5) + cGame.var_6fd4 + 3 > cGame.sub_2df26())) {
            ...
            if (cGame.sub_2dcf3(5) < cGame.sub_2df26()) {
                final String sub_4e1f;
                final String sub_4e1f2;
                cGame.sub_406d3(((sub_4e1f = GLLib.sub_4e1f(475)) == null) ? "" : sub_4e1f, GLLib.sub_547c(((sub_4e1f2 = GLLib.sub_4e1f(476)) == null) ? "" : sub_4e1f2, "%slots", "3"), 7, 0);
            }
            else {
                cGame.sub_40658(471, 477);
            }
    ...
    final boolean sub_7a79() {
        if (this.var_185d == 2) {
            if (cGame.var_7fd4 != 18 && cGame.var_6af4 == -1) {
                cGame.sub_23a84(47);
                cGame.sub_11320(true, this);
                return true;
            }
    ...
    final void sub_7b94() {
        if (this.var_1865 > -1 && this.var_186d > -1) {
            ...
            final ASprite class_e;
            final int n2 = (class_e = (((var_1865 & 0x8000) != 0x0) ? cGame.var_68d4[n] : cGame.var_7ff4[n])).sub_312c(this.var_186d) >> 1;
            final int n3 = class_e.sub_3189(this.var_186d) >> 1;
        ...
        final int sub_2b97;
        if (n7 > 0 && (sub_2b97 = GLLib.sub_2b97(n6, n7 + 1)) > 0) {
    ...
    final void sub_7f50() {
        if (!this.sub_a2a0(4)) {
            if (this.sub_a2a0(256)) {
                ...
                this.sub_a25c(256);
                this.sub_aa8a();
                (this.var_18b5 = new GLLibPlayer(cGame.var_7ff4[13], this.var_17ed, this.var_17f5)).SetAnim(0, 2);
    ...
    private void sub_80fc() {
        if (this.sub_a2a0(32)) {
            ...
            (this.var_18b5 = new GLLibPlayer(cGame.var_7ff4[13], this.var_17ed, this.var_17f5 - 50)).SetAnim(1, 1);
            if (cGame.var_807c == 0) {
            ...
            final short n2 = class_e.var_faf[this.var_16a5];
    ...
    private void sub_8723() {
        if ((GLLib.sub_2b97(0, 100) & 0x1) == 0x0) {
            this.var_17cd = GLLib.sub_2b97(GLLibPlayer.sub_5cb3() >> 1, GLLibPlayer.sub_5cb3());
            this.var_17d5 = GLLibPlayer.sub_5d2e();
        }
        else {
            this.var_17cd = GLLibPlayer.sub_5cb3();
            this.var_17d5 = GLLib.sub_2b97(GLLibPlayer.sub_5d2e() >> 1, GLLibPlayer.sub_5d2e());
        }
        this.var_1845 = 0;
        this.var_184d = 0;
        this.var_16f5 = false;
    ...
    final void sub_87a1() {
        ...
        if (!this.var_172d) {
            this.var_1755 += GLLib.var_1e1f;
            this.var_175d += GLLib.var_1e1f;
        ...
        this.var_1705 += 4 * GLLib.var_1e1f;
        if (this.var_16fd == 57) {
            this.var_1845 = cGame.var_800c.var_17cd + cGame.var_68bc[1][26][2] + (cGame.var_68d4[1].sub_312c(33) >> 1);
            this.var_184d = cGame.var_800c.var_17d5 + cGame.var_68bc[1][26][3] + (cGame.var_68d4[1].sub_312c(33) >> 1);
        }
            ...
            this.var_1845 = cGame.var_800c.var_17cd + cGame.var_68bc[1][21][2] + (cGame.var_68d4[1].sub_312c(4) >> 1);
            this.var_184d = cGame.var_800c.var_17d5 + cGame.var_68bc[1][21][3] + (cGame.var_68d4[1].sub_312c(4) >> 1);
        }
        else {
    ...
    final void sub_8d93() {
        ...
        if (var_1725 > 0) {
            GLLib.sub_5c77(true);
            cGame.sub_1e07e("+" + GLLib.sub_4fa1(var_1725, cGame.var_7fe4, " "), (this.var_17cd + this.var_1805) * cGame.var_7fc4 / 100 - cGame.var_800c.var_17cd + 10, (this.var_17d5 + this.var_180d) * cGame.var_7fc4 / 100 - cGame.var_800c.var_17d5 + 10, 0, 0, 0, 0, 2, 1, false, false);
    ...
    final void sub_8e7d() {
        if (this.var_189d != null) {
            this.var_189d.sub_1d9e(cGame.var_7fc4);
    ...
    final void sub_8ed0() {
        if (this.var_189d != null && this.var_189d.sub_1b34() && (Class_f.var_1775 == -1 || Class_f.var_1775 < Class_f.var_177d)) {
            cGame.sub_23a84(GLLib.sub_2b97(26, 30));
            this.var_189d.SetAnim(0, 1);
            final int sub_312c = this.var_189d.GetSprite().sub_312c(0);
            final int sub_3189 = this.var_189d.GetSprite().sub_3189(0);
            this.var_17cd = (cGame.var_800c.var_17cd + GLLib.sub_2b97(sub_312c, GLLib.var_1ddf - sub_312c)) * 100 / cGame.var_7fc4;
            this.var_17d5 = (cGame.var_800c.var_17d5 + GLLib.sub_2b97(sub_3189, GLLib.var_1de7 - sub_3189)) * 100 / cGame.var_7fc4;
            ...
            this.var_189d.sub_1a6a(GLLib.sub_2b97(0, this.var_189d.GetSprite().var_107f));
    ...
    static Class_f sub_904a(final int var_177d) {
        ...
        if (sub_4c91(0, 21) > 0) {
            ...
            (array[0].var_189d = new GLLibPlayer(cGame.var_7ff4[85], array[0].var_17cd, array[0].var_17d5)).SetAnim(0, 1);
            return array[0];
        }
        final Class_f sub_92ea = sub_92ea(21, 0, new int[] { (cGame.var_800c.var_17cd + (GLLib.var_1ddf >> 1)) * 100 / cGame.var_7fc4, (cGame.var_800c.var_17d5 + (GLLib.var_1de7 >> 1)) * 100 / cGame.var_7fc4, 255 });
        (sub_92ea.var_189d = new GLLibPlayer(cGame.var_7ff4[85], sub_92ea.var_17cd, sub_92ea.var_17d5)).SetAnim(0, 1);
        return sub_92ea;
    }
                ...
                switch (array[3]) {
                    case 0: {
                        ...
                        if ((sub_5439 = sub_5439(0, n2, array2, 100)) > 0) {
                            final int sub_2b97 = GLLib.sub_2b97(0, sub_5439);
    ...
    private boolean sub_a06e() {
        if (this.var_1865 != -1 && this.var_186d != -1 && (this.var_1865 & 0xFFFF0000) == 0x0) {
            ...
            if ((this.var_1865 & 0x8000) != 0x0) {
                n = cGame.var_68d4[this.var_1865 & 0x7FFF].sub_383d(this.var_186d);
            }
            else {
                n = cGame.var_7ff4[this.var_1865].sub_383d(this.var_186d);
            }
            if (n > 0) {
                ...
                if ((this.var_1865 & 0x8000) != 0x0) {
                    ...
                    cGame.var_7ff4[this.var_1865].sub_3882(this.var_186d, 0, array, 0);
                }
    ...
    private void sub_a392() {
        ...
        final int n3 = (this.var_17e5 * GLLib.var_1e1f << 8) / 1000;
    ...
    private boolean sub_b03e() {
        ...
        array[1] = this.var_17d5;
        cGame.sub_264d4(array, array2);
        return array2[0] > -100 && array2[0] < GLLib.var_1ddf + 100 && array2[1] >= -100 && array2[1] < GLLib.var_1de7 + 100;
    }
