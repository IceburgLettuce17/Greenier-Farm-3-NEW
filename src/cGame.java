...
/**
* The main class that controls Green Farm 3.
*/
public final class cGame extends GLLib implements Class_b 
{
	...
	/**
	* The state of the game (GLLib). Decides which slot to use in {@link cGame#s_game_states}
	*/
	static int s_game_state;
	
	/**
	* Prioritized list of game states (cGame). See Define for a list of them
	*/
	static int[] s_game_states;
	...
	/**
	* Used in menus and other areas like cutscenes.
	*/
	...
	private static ImageG[] var_68dc;
	private static byte[] var_68e4;
	private static GLLibPlayer[] var_68ec;
	private static GLLibPlayer[] s_pond_bubblePlayers;
	...
	private static boolean s_displayBasePauseMnu;
	private static boolean s_displayPauseCreds;
	private static boolean s_displayPauseHelp;
	private static boolean s_displayPauseSndOpt;
	private static boolean s_displayPauseOpts;
	private static boolean s_displayDebugInfo;
	private static boolean s_isPaused;
	...
	static int var_6aa4;
	static cActor var_6aac;
	private static cActor var_6ab4;
	...
	/**
	* Has the save finished the tutorial?
	*/
	static boolean s_hasFinishedTut;
	
	static cActor var_6c9c;
	...
	private static cActor[] var_6dec;
	...
	private static int s_game_currentActionID;
	...
	/**
	* The physics map for cActors.
	*/
	static byte[] s_actor_physMap;
	...
	private static int s_deluxifierAmount;
	private static int s_maxDeluxifiers;
	...
	private static int s_kitchen_resultItemName;
	private static int var_73a4;
	private static int var_73ac;
	private static boolean var_73b4;
	private static int var_73bc;
	private static int s_kitchen_firstItemName;
	private static int s_kitchen_secondItemName;
	private static int var_73d4;
	private static int var_73dc;
	private static int s_kitchen_firstItemNeedCnt;
	private static int s_kitchen_secondItemNeedCnt;
	private static int var_73f4;
	private static int var_73fc;
	private static int s_kitchen_firstItemCnt;
	private static int s_kitchen_secondItemCnt;
	...
	private static short[] s_barn_itemNames;
	private static int[] var_76fc;
	private static int[] var_7704;
	private static int[] s_barn_itemIDs;
	private static int[] var_7714;
	private static short[] s_barn_itemCounts;
	...
	private static short s_manor_restoreScrState;
	...
	private static int[] s_reqItem_itemStrs;
	private static int[] s_reqItem_itemIds;
	...
	private static int s_reqItem_itemIndex;
	private static boolean var_7914;
	private static cActor var_791c;
	...
	private static boolean s_hasPushNotifications;
	...
	private static int s_popup_onCloseState;
	private static cActor var_7b14;
	private static String s_popup_subtext;
	private static int s_popup_boxset;
	private static int s_popup_onCloseAct;
	private static cActor var_7b34;
	private static int s_mailbox_scrollLevel;
	private static int[] var_7b44;
	private static int[] s_mailbox_neighborNames;
	private static int[] var_7b54;
	private static int[] s_mailbox_neighborSprs;
	private static int[] s_mailbox_neighborSprIdxs;
	private static int[] var_7b6c;
	private static int s_mailbox_neighborCnt;
	...
	private static String s_iapTermsConditions;
	...
	private static int s_iapCashIndex;
	...
	private static int s_pond_bubbleIndex;
	private static int var_7d74;
	private static int var_7d7c;
	private static int[] s_pond_bubbleXs;
	private static int[] s_pond_bubbleYs;
	...
	private static int s_pond_lowRodCashCost;
	private static int s_pond_highRodCashCost;
	...
	private static String[] s_questDescriptions;
	private static int[] var_7e7c;
	private static int[] var_7e84;
	private static String[] s_questQuests;
	private static int[] s_questValue;
	private static int[] s_questNeededVals;
	...
	private static int[] s_questStates;
	private static int[] var_7f64;
	private static int s_currentQuest;
	...
	*/
	static int s_tutorialState;
	
	private static boolean var_7fdc;
	
	/**
	* The index of the currency formatter.
	*/
	...
	/**
	* The sprites currently loaded by the game.
	*/
	static ASprite[] s_gameSprites;
	private static ASprite[] var_7ffc;
	private static cActor var_8004;
	static cActor var_800c;
	private static cActor var_8014;
	private static cActor var_801c;
	private static cActor var_8024;
	private static cActor var_802c;
	static cActor var_8034;
	private static int var_803c;
	static int var_8044;
	
	/**
	* Prepare time for the current actor.
	*/
	static String s_prepareTime;
	...
	static int s_manor_restoreLevel;
	...
	static int var_8124;
	static int var_812c;
	private static int s_pond_pondState;
	...
	*/
	static void switchToState(final int state) {
		...
		&& state != Define.GS_POPUP 
		&& state != Define.GS_HUD
		&& state != Define.GS_FARM 
		&& state != Define.GS_FARM_TUTORIAL 
		&& state != Define.GS_FARM_NEIGHBOR 
		&& state != Define.GS_ACRE) {
		...
		if (cGame.s_game_state < Define.GS_MAIL_REQUEST) {
			cGame.s_game_stateToSwitch = state;
	...
	private static void sub_82a7(final int var_67c4) {
		...
		&& cGame.s_game_state != Define.GS_EXIT 
		&& n == Define.GS_FARM 
		|| n == Define.GS_FARM_TUTORIAL 
		|| n == Define.GS_FARMDIARY 
		&& var_67c4 != Define.GS_POND
		&& var_67c4 != Define.GS_HUD 
		&& var_67c4 != Define.GS_FARM 
		&& var_67c4 != Define.GS_FARM_TUTORIAL 
		&& var_67c4 != Define.GS_FARM_NEIGHBOR 
		&& var_67c4 != Define.GS_ACRE) {
			cGame.s_isPaused = true;
			cGame.s_clickblocked = true;
			GLLibPlayer.Tileset_Destroy(0);
			GLLibPlayer.Tileset_Destroy(1);
	...
	static int getState() {
		return s_game_state > Define.GS_EXIT ? s_game_states[s_game_state] : Define.GS_EXIT;
	}

	private static int getPreviousState() {
		return s_game_state > 0 ? s_game_states[s_game_state - 1] : Define.GS_EXIT;
	}

	private static int getNextState() {
		return s_game_state > Define.GS_EXIT && s_game_state < Define.GS_PAUSE ? s_game_states[s_game_state + 1] : Define.GS_EXIT;
	}
	...
	final static int SS_GAMELOFT_END = 2;
	...
	// Define.GS_FARM_TUTORIAL
	final static int SS_FARM_TUTORIAL_UNK0 = 0;
	final static int SS_FARM_TUTORIAL_UNK1 = 1;
	final static int SS_FARM_TUTORIAL_UNK2 = 2;
	final static int SS_FARM_TUTORIAL_UNK3 = 3;
	final static int SS_FARM_TUTORIAL_UNK4 = 4;
	final static int SS_FARM_TUTORIAL_UNK8 = 8;

	
	private static boolean dispatchState(int depth, int mode) {
		if (Define.DECOMP_CUSTOM_PRINTS)
		{
			GLLib.Dbg("cGame.dispatchState - Depth: " + depth + "Mode: " + mode);
		}
		...
		if (mode > Define.GS_EXIT) {
			try {
				switch (cGame.s_game_states[mode]) {
				// Game load, at the Gameloft splash
				case Define.GS_GAMELOFT: {
					// SUBSTATES
					// Seems to be checking for IAP, and calling a function that gets the fields from the .jad
					if (depth == SS_GAMELOFT_INITWITHIAP) {
					...
					if (depth == SS_GAMELOFT_END) {
						mode = GLLib.IsAnyKeyDown();
						if (mode == Define.GS_POPUP || mode == Define.GS_KITCHEN) {
							GLLib.s_game_state = Define.GS_EXIT;
						}
						switchToState(Define.GS_INIT);
					}
					b = false;
					break;
				}
				...
				case Define.GS_INIT: {
					...
					// Same with this one
					if (depth == SS_INIT_UNK2) {
						mode = GLLib.IsAnyKeyDown();
						if (mode == Define.GS_POPUP || mode == Define.GS_KITCHEN) {
							GLLib.s_game_state = Define.GS_EXIT;
						}
						if (cGame.var_67f4 > 5000) {
							sub_8281(Define.GS_FARM);
							sub_8281(Define.GS_FARM);
						} else {
							sub_b7c5();
						}
					...
					// WTF is this one?
					if (depth == SS_INIT_UNK3) {
						cGame.var_68d4[19].PaintFrame(GLLib.g, 0, 0, 0, 0);
					}
					if (depth == SS_INIT_CLOSECURRPACK) {
				...
				case Define.GS_LOADING: {
					// SUBSTATES
					if (depth == SS_LOADING_UNK0) {
						sub_1d1a7(0, true);
						...
						if (cGame.var_681c == null) {
							...
							sub_b76e();
						} else if (cGame.s_currentPackFilename != null && cGame.s_currentPackFilename != "") {
							GLLib.Pack_Open(cGame.s_currentPackFilename);
							cGame.s_currentPackFilename = "";
						}
						sub_2000c(0, 4, true);
					}
					...
					if (depth == SS_LOADING_CLOSER) {
						...
						if (mode == Define.GS_POPUP || mode == Define.GS_KITCHEN) {
							if (cGame.var_686c) {
								...
								String sub_4e1f2 = GLLib.Text_GetString(Define.TEXT_CANNOTGOBACK);
								platformRequest("Show_Toast_" + ((sub_4e1f2 == null) ? "" : sub_4e1f2));
							}
						}
						sub_b7c5();
					...
					if (depth == SS_LOADING_UNK3) {
						...
						if (cGame.var_6834 == 0) {
                           ...
                           if ((mode = 416 * (var_682c + 1) / var_6834 + 416 / var_6834 * var_6854 / var_685c) > var89) {
                              mode = var89;
                           }
                        } else {
								mode = 416 * (cGame.var_682c + 1) / cGame.var_6834;
							}
							if (mode > 416) {
								mode = 416;
							}
						...
						mode = cGame.var_68bc[0][3][3];
						GLLib.FillRect(GLLib.g, cGame.var_68bc[0][3][2], mode, mode, 20, true);
					}
					b = false;
					break;
				}
				...
				// Farm from the tutorial: Almost identical to GS_FARM but with a finger graphic
				case Define.GS_FARM_TUTORIAL: {
					if ((depth) == SS_FARM_TUTORIAL_UNK0) {
					...
					if (depth == SS_FARM_TUTORIAL_UNK1) {
						if (cGame.s_isPaused) {
					...
					boolean b2 = false;
					Label_2355: {
						if (depth == SS_FARM_TUTORIAL_UNK8) {
							...
							if (cGame.var_8014 != null) {
								...
								case 50: {
									if (cGame.s_tutorialState == 54 && cGame.var_8024.actorID == Define.ACTOR_SALEDESK) {
									...
									if (cGame.s_tutorialState == 49 && cGame.var_8024.actorID == Define.ACTOR_BARN
									...
									if (cGame.var_8024.actorID == Define.ACTOR_POND) {
										if (cGame.var_8024.sub_a2a0(512)) {
											switchToState(Define.GS_POND);
											b2 = true;
											break Label_2355;
										}
										break;
									} else {
										if (cGame.var_8024.actorID == Define.ACTOR_MILL && cGame.var_8024.sub_a2a0(512)
								...
								case 54: {
									if (cGame.s_tutorialState == 34 && cGame.var_8024.actorID == Define.ACTOR_POND) {
										cGame.s_hasFinishedTut = true;
									} else if (cGame.s_tutorialState == 17 && cGame.var_8024.actorID == Define.ACTOR_UNK16) {
										cGame.s_hasFinishedTut = true;
									} else if (cGame.s_tutorialState == 32 && cGame.var_8024.actorID == Define.ACTOR_POND) {
										cGame.s_hasFinishedTut = true;
									}
							...
							if (GLLib.Pointer_IsReleased() && (cGame.s_tutorialState == 3 || cGame.s_tutorialState == 6
								...
								mode = GLLib.s_pointerX;
								
								final short n7 = cGame.var_68bc[4][2][2];
								final short n8 = cGame.var_68bc[4][2][3];
								if (mode >= n7 - 68 && mode < n7 + 375 && GLLib.s_pointerY > n8 - 20 && GLLib.s_pointerY < n8 + 200) {
									cGame.s_hasFinishedTut = true;
									b2 = true;
									break Label_2355;
								}
						...
						if (depth == SS_FARM_TUTORIAL_UNK2) {
							if ((mode = GLLib.IsAnyKeyDown()) == Define.GS_POPUP || mode == Define.GS_UNREF_24) {
								if (sub_202b7(1, 37) && sub_20167(1, 37)) {
									onPauseButton();
								} else if (mode == Define.GS_POPUP) {
									final String sub_4e1f3;
									platformRequest("Show_Toast_"
											+ (((sub_4e1f3 = GLLib.Text_GetString(Define.TEXT_CANNOTGOBACK)) == null) ? "" : sub_4e1f3));
								} else if (mode == Define.GS_UNREF_24) {
									final String sub_4e1f4;
									platformRequest("Show_Toast_"
											+ (((sub_4e1f4 = GLLib.Text_GetString(Define.TEXT_CANNOTPAUSE)) == null) ? "" : sub_4e1f4));
								}
							}
							sub_253a8();
							...
							if (cGame.var_6ccc) {
								...
								if (cGame.var_6d3c != 0L) {
									...
									if (cGame.var_6d34 == 0) {
										...
										cGame.var_6d1c = ((mode + var_6cfc) / 2 - (var_6cfc - mode) / 2 * sub_2be7 / 256)
												* cGame.s_zoomLevel / 100 - cGame.var_800c.cameraX;
										cGame.var_6d24 = ((var_6cf4 + var_6d04) / 2
												- (var_6d04 - var_6cf4) / 2 * sub_2be7 / 256) * cGame.s_zoomLevel / 100
												- cGame.var_800c.cameraY;
										mode = cGame.var_6d2c;
										if (GLLib.Math_Cos(GLLib.Math_Angle90 - mode) < 0) {
										...
										if (cGame.var_6d2c < 10) {
											cGame.var_6cd4 = true;
											cGame.var_6d1c = (mode + (var_6d0c - mode) * cGame.var_6d2c / 10)
													* cGame.s_zoomLevel / 100 - cGame.var_800c.cameraX;
											cGame.var_6d24 = (var_6cf4 + (var_6d5 - var_6cf4) * cGame.var_6d2c / 10)
													* cGame.s_zoomLevel / 100 - cGame.var_800c.cameraY;
						...
						if (depth == SS_FARM_TUTORIAL_UNK3 && !cGame.s_clickblocked) {
							cActor.sub_3bcd();
							sub_29ee2();
							sub_25129();
							sub_1dcc1(1);
						...
						if (depth == SS_FARM_TUTORIAL_UNK4) {
				...
				// Market menu
				case Define.GS_MARKET: {
					b = drawMarket(depth);
					break;
				}
				// Sales Desk menu
				case Define.GS_SALEDESK: {
					b = drawSaledesk(depth);
					break;
				}
				// Feed Mill's "Feed Producal" menu
				case Define.GS_MILL_PRODUCE: {
					if ((depth) == 1) {
						cGame.var_68ac = 100;
						sub_37750();
						sub_2c69b();
					...
					if (depth == 2) {
						if ((mode = GLLib.IsAnyKeyDown()) == Define.GS_POPUP || mode == Define.GS_KITCHEN) {
							if (cGame.var_6c5c == 160) {
								exitFeedMill();
							} else {
								final String sub_4e1f5;
								platformRequest("Show_Toast_"
										+ (((sub_4e1f5 = GLLib.Text_GetString(Define.TEXT_CANNOTGOBACK)) == null) ? "" : sub_4e1f5));
							}
						}
						sub_d841(1);
						if (cGame.s_tutorialState != -1) {
					...
					if (depth == 3) {
						...
						sub_1df06(((sub_4e1f6 = GLLib.Text_GetString(Define.TEXT_FEEDMILL)) == null) ? "" : sub_4e1f6, 6, 30, 0, 0);
						final String sub_4e1f7;
						drawString(((sub_4e1f7 = GLLib.Text_GetString(cGame.var_7654)) == null) ? "" : sub_4e1f7, 6, 4, 0,
								0);
						sub_1df06(Integer.toString(cGame.var_7694) + " / " + cGame.var_7674, 6, 6, 0, 0);
						sub_1df06("+", 6, 13, 0, 0);
						final String sub_4e1f8;
						drawString(((sub_4e1f8 = GLLib.Text_GetString(cGame.var_765c)) == null) ? "" : sub_4e1f8, 6, 9, 0,
								0);
						...
						drawString(((sub_4e1f9 = GLLib.Text_GetString(cGame.var_762c)) == null) ? "" : sub_4e1f9, 6, 20, 0,
								0);
						sub_1df06("+" + cGame.var_7614, 6, 23, 0, 0);
						sub_1df06(cGame.var_7624, 6, 25, 0, 0);
						final String sub_4e1f10;
						sub_1df06(((sub_4e1f10 = GLLib.Text_GetString(Define.TEXT_MAKE)) == null) ? "" : sub_4e1f10, 6, 27, 0, 0);
						if (cGame.var_76a4) {
							final String sub_4e1f11;
							sub_1df06((((sub_4e1f11 = GLLib.Text_GetString(Define.TEXT_QUEUE)) == null) ? "" : sub_4e1f11) + " "
				...
				case Define.GS_KITCHEN_PRODUCE: {
					if ((depth) == 0) {
						sub_2c69b();
						sub_1fb8e(7);
						cGame.var_68ac = 100;
					...
					if (depth == 3) {
						sub_1dcc1(7);
						// This draws the "Cooking" text up top
						sub_1df06((GLLib.Text_GetString(Define.TEXT_KITCHEN_HOME)) == null ? "" : GLLib.Text_GetString(Define.TEXT_KITCHEN_HOME), 7, 41, 0, 0);
						
						// Draws 1st item count with the plus
						drawString((GLLib.Text_GetString(cGame.s_kitchen_firstItemName)) == null ? "" : GLLib.Text_GetString(cGame.s_kitchen_firstItemName), 7, 4,
								0, 0);
						sub_1df06(Integer.toString(cGame.s_kitchen_firstItemCnt) + " / " + cGame.s_kitchen_firstItemNeedCnt, 7, 6, 0, 0);
						
						sub_1df06("+", 7, 13, 0, 0);
						
						// 2nd item count
						drawString((GLLib.Text_GetString(cGame.s_kitchen_secondItemName)) == null ? "" : GLLib.Text_GetString(cGame.s_kitchen_secondItemName), 7, 9,
								0, 0);
						sub_1df06(Integer.toString(cGame.s_kitchen_secondItemCnt) + " / " + cGame.s_kitchen_secondItemNeedCnt, 7, 11, 0, 0);
						...
						// DELUXIFIER
						drawString((GLLib.Text_GetString(Define.TEXT_DELUXIFIER_NONITEM)) == null ? "" : GLLib.Text_GetString(Define.TEXT_DELUXIFIER_NONITEM), 7, 15, 0, 0);
						
						sub_1df06(Integer.toString(cGame.s_deluxifierAmount), 7, 18, 0, 0);
						sub_1df06("=", 7, 19, 0, 0);
						final String sub_4e1f16;
						drawString(((sub_4e1f16 = GLLib.Text_GetString(cGame.s_kitchen_resultItemName)) == null) ? "" : sub_4e1f16, 7, 27,
								0, 0);
						sub_1df06("+" + GLLib.Text_FormatNumber(cGame.var_737c, cGame.s_currencySeprType, " "), 7, 30, 0, 0);
						sub_1df06("+" + GLLib.Text_FormatNumber(cGame.var_7384, cGame.s_currencySeprType, " "), 7, 32, 0, 0);
						sub_1df06(cGame.var_7394, 7, 34, 0, 0);
						final String sub_4e1f17;
						sub_1df06(((sub_4e1f17 = GLLib.Text_GetString(Define.TEXT_MAKE)) == null) ? "" : sub_4e1f17, 7, 36, 0, 0);
						
						if (cGame.var_743c) {
							final String sub_4e1f18;
							sub_1df06((((sub_4e1f18 = GLLib.Text_GetString(Define.TEXT_QUEUE)) == null) ? "" : sub_4e1f18) + " "
				...
				// Kitchen "homepage"
				case Define.GS_KITCHEN: {
					b = drawKitchen(depth);
					break;
				}
				// Feed Mill "homepage"
				case Define.GS_MILL: {
					b = drawFeedmill(depth);
					break;
				}
				// Barn Inventory page
				case Define.GS_BARN: {
				...
				// Manor homepage
				case Define.GS_MANOR: {
					b = drawManor(depth);
					break;
				}
				// Manor restoration
				case Define.GS_MANOR_RESTORE: {
					if ((depth) == 0) {
					...
					if (depth == 1) {
						if (cGame.s_manor_restoreLevel == 0) {
							final String sub_4e1f19;
							cGame.var_783c = (((sub_4e1f19 = GLLib.Text_GetString(Define.TEXT_MANOR_KITCHENDESC)) == null) ? "" : sub_4e1f19);
						} else if (cGame.s_manor_restoreLevel == 1) {
							final String sub_4e1f20;
							cGame.var_783c = (((sub_4e1f20 = GLLib.Text_GetString(Define.TEXT_MANOR_COLLROOMDESC)) == null) ? "" : sub_4e1f20);
						} else if (cGame.s_manor_restoreLevel == 2) {
							final String sub_4e1f21;
							cGame.var_783c = (((sub_4e1f21 = GLLib.Text_GetString(Define.TEXT_MANOR_TROPHYROOMDESC)) == null) ? "" : sub_4e1f21);
						} else if (cGame.s_manor_restoreLevel == 3) {
							final String sub_4e1f22;
							cGame.var_7834 = (((sub_4e1f22 = GLLib.Text_GetString(Define.TEXT_MANOR_COINS)) == null) ? "" : sub_4e1f22);
						} else if (cGame.s_manor_restoreLevel == 4) {
							final String sub_4e1f23;
							cGame.var_7834 = (((sub_4e1f23 = GLLib.Text_GetString(Define.TEXT_MANOR_FERTILIZER)) == null) ? "" : sub_4e1f23);
						} else if (cGame.s_manor_restoreLevel == 5) {
							final String sub_4e1f24;
							cGame.var_7834 = (((sub_4e1f24 = GLLib.Text_GetString(Define.TEXT_MANOR_CROP)) == null) ? "" : sub_4e1f24);
						} else if (cGame.s_manor_restoreLevel == 6) {
							final String sub_4e1f25;
							cGame.var_7834 = (((sub_4e1f25 = GLLib.Text_GetString(Define.TEXT_MANOR_INGREDIENT)) == null) ? "" : sub_4e1f25);
						} else if (cGame.s_manor_restoreLevel == 7) {
							final String sub_4e1f26;
							cGame.var_7834 = (((sub_4e1f26 = GLLib.Text_GetString(Define.TEXT_MANOR_FEED)) == null) ? "" : sub_4e1f26);
						} else if (cGame.s_manor_restoreLevel == 8) {
							final String sub_4e1f27;
							cGame.var_7834 = (((sub_4e1f27 = GLLib.Text_GetString(Define.TEXT_MANOR_FARMCASH)) == null) ? "" : sub_4e1f27);
						}
						mode = sub_df89(cGame.s_manor_restoreLevel + 1);
						final GameDatas class_h;
						cGame.var_781c = (class_h = GameDatas.s_allDatas[3]).m_dataVars[mode][12];
						cGame.var_7824 = class_h.m_dataVars[mode][22];
						cGame.var_782c = class_h.m_dataVars[mode][21] * 60;
						if (cGame.s_manor_restoreScrState == 0 || cGame.s_manor_restoreScrState == 1) {
							sub_3a73b(cGame.s_manor_restoreScrState = 1);
							sub_3a485();
							if (cGame.s_manor_restoreLevel == 0) {
							...
							mode = (sub_3a230(cGame.var_77ec) ? 1 : 0);
							final boolean sub_3a383 = sub_3a383();
							sub_2000c(14, 7, (boolean) (mode != 0));
							if (cGame.var_77dc = (mode != 0 && sub_3a383)) {
							...
							sub_1f8c5(14);
							sub_3a966(false);
							if (cGame.var_77dc && cGame.s_manor_restoreLevel == 0) {
							...
							sub_2c69b();
							sub_1f8c5(14);
						} else if (cGame.s_manor_restoreScrState == 2 || cGame.s_manor_restoreScrState == 3) {
							sub_3a73b(cGame.s_manor_restoreScrState);
							sub_3a485();
						}
					}
					if (depth == 5) {
					...
					if (depth == 2) {
						if ((mode = GLLib.IsAnyKeyDown()) == Define.GS_POPUP || mode == Define.GS_KITCHEN) {
							if (cGame.var_6c5c == 160) {
								...
								platformRequest("Show_Toast_"
										+ (((sub_4e1f28 = GLLib.Text_GetString(Define.TEXT_CANNOTGOBACK)) == null) ? "" : sub_4e1f28));
							}
						}
						if (cGame.var_6c54) {
							sub_26c8e();
						}
						switch (cGame.s_manor_restoreScrState) {
						case 2: {
							...
							if (n12 > 0L) {
								cGame.var_7804 = getPrepareTime((int) n12);
					...
					if (depth == 3) {
						if (cGame.s_manor_restoreScrState == 1) {
							sub_2000c(14, 4, true);
							sub_2000c(14, 5, true);
						} else {
						...
						case 1: {
							...
							sub_1df06(((sub_4e1f29 = GLLib.Text_GetString(Define.TEXT_MANOR_ROOMRESTORE)) == null) ? "" : sub_4e1f29, 14, 1, 0, 0);
							final String sub_4e1f30;
							sub_1df06(((sub_4e1f30 = GLLib.Text_GetString(cGame.var_77d4)) == null) ? "" : sub_4e1f30, 14,
									2, 0, 0);
							sub_1df06(GLLib.Text_FormatNumber(cGame.var_77e4, cGame.s_currencySeprType, " "), 14, 12, 0, 0);
							final String sub_4e1f31;
							drawString(((sub_4e1f31 = GLLib.Text_GetString(Define.TEXT_MANOR_STARTRESTORING)) == null) ? "" : sub_4e1f31, 14, 11, 0, 0);
							if (!sub_20167(14, 66)) {
								break;
							}
							sub_1df06(GLLib.Text_FormatNumber(cGame.var_781c, cGame.s_currencySeprType, " "), 14, 72, 0, 0);
							if (cGame.s_manor_restoreLevel < 3) {
								drawString(cGame.var_783c, 14, 75, 0, 0);
							} else {
								drawString(cGame.var_7834, 14, 71, 0, 0);
							}
							if (cGame.var_782c > 0) {
								sub_1df06(getPrepareTime(cGame.var_782c), 14, 73, 0, 0);
								break;
							}
							break;
						}
						case 2: {
							...
							sub_1df06(((sub_4e1f32 = GLLib.Text_GetString(Define.TEXT_MANOR_ROOMRESTORE)) == null) ? "" : sub_4e1f32, 14, 1, 0, 0);
							final String sub_4e1f33;
							sub_1df06(((sub_4e1f33 = GLLib.Text_GetString(Define.TEXT_MISC_TIMELEFT)) == null) ? "" : sub_4e1f33, 14, 16, 0, 0);
							...
							if (sub_20167(14, 47)) {
								...
								sub_1df06(((sub_4e1f34 = GLLib.Text_GetString(Define.TEXT_MANOR_FINISH)) == null) ? "" : sub_4e1f34, 14, 48, 0,
										0);
							}
							break;
						}
						case 3: {
							...
							sub_1df06(((sub_4e1f35 = GLLib.Text_GetString(Define.TEXT_MANOR_ROOMRESTORE)) == null) ? "" : sub_4e1f35, 14, 1, 0, 0);
							final String sub_4e1f36;
							sub_1df06(((sub_4e1f36 = GLLib.Text_GetString(Define.TEXT_MISC_TIMELEFT)) == null) ? "" : sub_4e1f36, 14, 16, 0, 0);
							sub_1df06(cGame.var_7804, 14, 17, 0, 0);
							if (sub_20167(14, 47)) {
								final String sub_4e1f37;
								sub_1df06(((sub_4e1f37 = GLLib.Text_GetString(Define.TEXT_MANOR_FINISH)) == null) ? "" : sub_4e1f37, 14, 48, 0,
										0);
								break;
							}
							break;
				...
				case Define.GS_ACRE: {
						...
						if (cGame.var_6d64 == 0) {
							...
							if (!cGame.var_6d6c.IsAnimOver()) {
								if (mode == Define.GS_POPUP) {
									...
									platformRequest("Show_Toast_"
											+ (((sub_4e1f38 = GLLib.Text_GetString(Define.TEXT_CANNOTGOBACK)) == null) ? "" : sub_4e1f38));
								}
								if (cGame.var_800c.var_185d != 0) {
									...
									array3[0] = array[0] * cGame.s_zoomLevel / 100 - GLLibPlayer.Tileset_GetCameraX(0);
									array3[1] = array[1] * cGame.s_zoomLevel / 100 - GLLibPlayer.Tileset_GetCameraY(0);
					...
					if (depth == 3) {
						...
						case 0: {
							...
							sub_1df06(((sub_4e1f39 = GLLib.Text_GetString(Define.TEXT_ACRE_EXPANDTONEWACRE)) == null) ? "" : sub_4e1f39, 11, 3, 0, 0);
							final String sub_4e1f40;
							sub_1df06(((sub_4e1f40 = GLLib.Text_GetString(Define.TEXT_ACRE_PRETTY + (cGame.var_6d54 - 1))) == null) ? ""
									: sub_4e1f40, 11, 4, 0, 0);
							if (!cGame.var_6dfc[cGame.var_6d54]) {
								mode = ((decryptInt(cGame.var_6dac) > decryptInt(cGame.var_6da4))
										? decryptInt(cGame.var_6da4)
										: decryptInt(cGame.var_6dac));
								drawString("" + mode + " / " + decryptInt(cGame.var_6da4), 11, 11, 0, 0);
							}
							if (!cGame.var_6e04[cGame.var_6d54]) {
								mode = ((decryptInt(cGame.var_6dbc) > decryptInt(cGame.var_6db4))
										? decryptInt(cGame.var_6db4)
										: decryptInt(cGame.var_6dbc));
								drawString("" + mode + " / " + decryptInt(cGame.var_6db4), 11, 12, 0, 0);
							}
							final String sub_4e1f41;
							drawString(((sub_4e1f41 = GLLib.Text_GetString(cGame.var_6ddc)) == null) ? "" : sub_4e1f41, 11,
									14, 0, 0);
							final String sub_4e1f42;
							drawString(((sub_4e1f42 = GLLib.Text_GetString(cGame.var_6de4)) == null) ? "" : sub_4e1f42, 11,
									15, 0, 0);
							final String sub_4e1f43;
							drawString(((sub_4e1f43 = GLLib.Text_GetString(Define.TEXT_ACRE_PRETTY + (cGame.var_6d54 - 1) - 1)) == null) ? ""
									: sub_4e1f43, 11, 13, 0, 0);
							sub_1df06(
									GLLib.Text_FormatNumber(decryptLong(cGame.var_6d9c), cGame.s_currencySeprType, " ") + " / "
											+ GLLib.Text_FormatNumber(decryptLong(cGame.var_6d94), cGame.s_currencySeprType, " "),
									11, 32, 0, 0);
							if (!sub_2a117()) {
								final String sub_4e1f44;
								sub_1df06(((sub_4e1f44 = GLLib.Text_GetString(Define.TEXT_ACRE_PRETTYTASK + cGame.var_6d54 - 1)) == null) ? ""
										: sub_4e1f44, 11, 35, 0, 0);
							} else {
								if (!cGame.var_6dfc[cGame.var_6d54]
										&& decryptInt(cGame.var_6dac) < decryptInt(cGame.var_6da4)) {
									drawString("" + decryptInt(cGame.var_6dc4), 11, 25, 0, 0);
								}
								if (!cGame.var_6e04[cGame.var_6d54]
										&& decryptInt(cGame.var_6dbc) < decryptInt(cGame.var_6db4)) {
									drawString("" + decryptInt(cGame.var_6dcc), 11, 26, 0, 0);
								}
							}
							if (cGame.var_6dd4) {
								final String sub_4e1f45;
								sub_1df06(((sub_4e1f45 = GLLib.Text_GetString(Define.TEXT_ACRE_BUY)) == null) ? "" : sub_4e1f45, 11, 7, 0,
										0);
								break;
							}
							break;
				...
				// Leveled up screen
				case Define.GS_LEVELUP: {
					b = drawLevelupScreen(depth);
					break;
				}
				// Neighbor "request item" menu
				case Define.GS_MAIL_REQUEST: {
					b = drawRequestItem(depth);
					break;
				}
				// Neighbor "send item" menu
				case Define.GS_MAIL_SEND: {
					b = drawSendItem(depth);
					break;
				}
				// Pause menu
				case Define.GS_PAUSE: {
					b = drawPauseMenu(depth);
					break;
				}
				
				// IDRK what this one is (it just shows a black screen)
				case Define.GS_UNK_21: {
					if ((depth) == 0) {
						cGame.var_8054 = GLLib.StringFormat(cGame.var_8054,
					...
					if (depth == 2) {
						mode = GLLib.WasAnyKeyPressed();
						int n13 = 2;
						if (mode == Define.GS_POPUP) {
							sub_834e();
						} else if (mode == Define.GS_FARM_TUTORIAL || mode == Define.GS_UNREF_5 || mode == Define.GS_KITCHEN) {
							n13 = 4;
						}
					...
					if (depth == 3) {
						...
						GLLib.DrawAlphaGradientRect(GLLib.s_screenHeight >> 1, GLLib.s_screenWidth, GLLib.s_screenHeight >> 1, -16777216);
					}
					b = false;
					break;
				}
				// Generic popup
				case Define.GS_POPUP: {
					b = drawPopup(depth);
					break;
				}
				// Your neighbor's farm, enables lockdown system and home button
				case Define.GS_FARM_NEIGHBOR: {
					b = drawFarmNeighbor(depth);
					break;
				}
				// Neighbor screen
				case Define.GS_MAIL_NEIGHBOR: {
					b = drawNeighborScreen(depth);
					break;
				}
				...
				// Collections screen
				case Define.GS_MANOR_COLLECTIONS: {
					b = drawCollectionRoom(depth);
					break;
				}
				// Manor's Trophies screen
				case Define.GS_MANOR_TROPHIES: {
					b = drawTrophyRoom(depth);
					break;
				}
				...
				case Define.GS_IGP: {
					if (depth == 0) {
						sub_23d73();
						IGP.enterIGP(((GLLib.Text_GetString(Define.TEXT_LOADING) == null)) ? "" : GLLib.Text_GetString(Define.TEXT_LOADING), 0);
					}
					if (depth == 2) {
						depth = GLLib.IsAnyKeyDown();
						mode = 0;
						switch (depth) {
						case 3:
						case 10: {
				...
				// Generic toast
				case Define.GS_TOAST: {
					b = drawToast(depth);
					break;
				}
				// Don't know
				case Define.GS_UNK_3: {
					if (depth == 2) {
						switchToState(Define.GS_UNREF_5);
					}
					b = false;
					break;
				}
				// IAP "Buy cash/coin" menu
				case Define.GS_BUYSCR: {
					b = drawBuyScreen(depth);
					break;
				}
				// Farm Diary (quest page)
				case Define.GS_FARMDIARY: {
					b = drawFarmDiary(depth);
					break;
				}
				// Pond minigame
				case Define.GS_POND: {
				...
				default: {
					GLLib.Dbg("State [" + cGame.s_game_states[mode] + "] is undefined. Message sent was: " + depth);
					break;
				}
				}
	...
	private static boolean sub_b442() {
		return dispatchState(8, cGame.s_game_state);
	}
		...
		if (cGame.s_switcherState != -1) {
			if (cGame.s_switcherState == 0) {
				...
				if (cGame.s_game_state > Define.GS_EXIT) {
					dispatchState(4, cGame.s_game_state);
				}
				++cGame.s_game_state;
				...
				cGame.s_switcherState = -1;
				dispatchState(4, cGame.s_game_state);
				dispatchState(5, cGame.s_game_state);
			...
			if (cGame.var_682c >= 0 && cGame.var_681c != null && cGame.var_681c.length > 0) {
				...
				case 30: {
					...
					if (cGame.s_currencySeprType != 2 && cGame.s_currencySeprType != 0 && cGame.s_currencySeprType != 1 && cGame.s_currencySeprType != 4
							&& cGame.s_currencySeprType != 3 && cGame.s_currencySeprType != 5 && cGame.s_currencySeprType != 10
							&& cGame.s_currencySeprType != 11 && cGame.s_currencySeprType != 16 && cGame.s_currencySeprType != 15) {
						cGame.s_currencySeprType = 0;
					}
				...
				case 32: {
					if (cGame.s_currencySeprType == 15) {
				...
				case 140: {
					if (!cGame.var_684c) {
						...
						GLLib.Dbg("[0/" + cGame.var_685c + "] - EXECUTE SPRITE REQUESTS");
					}
				...
				case 141: {
					if (!cGame.var_684c) {
						...
						GLLib.Dbg("[0/" + cGame.var_685c + "] - EXECUTE SOUND REQUESTS");
					}
				...
				case 49: {
					if (cGame.var_807c > 0 && cGame.var_807c <= 10) {
						sub_d500(0, GameDatas.s_allDatas[8].m_dataVars[cGame.var_807c - 1][3], 1, 0, 24, 0, -1);
						final int n2;
						if ((n2 = GameDatas.s_allDatas[18].m_dataVars[getLevel() - 1][1 + cGame.var_807c
				...
				case 44: {
					if (cGame.var_807c == 0) {
						cGame.var_7da4 = -1L;
						cGame.s_manor_restoreLevel = 0;
						cGame.s_manor_restoreScrState = 0;
					}
				...
				case 47: {
					...
					cActor.sub_6cdb();
					cActor.newActor(10, 0, new int[] { 0, 0, 0 });
					if (cGame.var_800c != null && cGame.var_8004 != null) {
						cGame.var_800c.cameraX = cGame.var_8004.cameraX - (GLLib.s_screenWidth >> 1);
						cGame.var_800c.cameraY = cGame.var_8004.cameraY - (GLLib.s_screenHeight >> 1);
					}
					break;
				}
				case 23: {
	...
	private static ASprite loadSprite(final int idx, final int n2, boolean isSpecial, final boolean freeSprCache, final int cacheType,
			final int n4) {
		...
		if (getPoolIndex(idx) != -1) {
			spr.SetPool(getPoolIndex(idx));
			isSpecial = false;
		}
		...
		if (isSpecial) {
			buildAllCacheImgs(spr, n2, cacheType, n4);
			if (freeSprCache) {
				spr.FreeCacheData();
			}
		}
	...
	static void loadMap() {
		...
		GLLibPlayer.Tileset_CreateBuffer();
	...
	private static void sub_cd28(final int n) {
		...
		while (n2 < sub_3253.length && !b) {
			...
			if (sub_3e92 == 50) {
				...
				case 13: {
					array[2] = 255;
					class_f = (cGame.var_800c = cActor.newActor(sub_3e93, array));
					break;
				}
				case 48: {
					(class_f = sub_25b35(11, sub_3e94)).cameraX = sub_3eb2;
					class_f.cameraY = sub_3eb3;
					break;
				}
				case 42: {
					if (sub_3e94 == -1) {
						array[2] = 12;
						array[3] = 2;
						class_f = (cGame.var_8004 = cActor.newActor(sub_3e93, array));
						break;
					}
					array[2] = 12;
					array[3] = 2;
					(class_f = sub_25b35(8, sub_3e94)).cameraX = sub_3eb2;
					class_f.cameraY = sub_3eb3;
					break;
				}
				case 49: {
					class_f = cActor.newActor(sub_3e93, array);
					if (sub_3e94 != -1) {
						sub_25213(sub_3e94);
					...
					class_f.actorID = 65535;
					class_f.sub_7795(1);
					break;
				}
				case 52: {
					(class_f = sub_25b35(2, sub_3e94)).sub_7b13(3);
					class_f.cameraX = sub_3eb2;
					class_f.cameraY = sub_3eb3;
					break;
				}
				case 54: {
					(class_f = sub_25b35(0, sub_3e94)).cameraX = sub_3eb2;
					class_f.cameraY = sub_3eb3;
				...
				case 50: {
					(class_f = sub_25b35(3, sub_3e94)).cameraX = sub_3eb2;
					class_f.cameraY = sub_3eb3;
					break;
				}
				case 20: {
					(class_f = sub_25b35(4, sub_3e94)).cameraX = sub_3eb2;
					class_f.cameraY = sub_3eb3;
					break;
				}
				case 51: {
					(class_f = sub_25b35(9, sub_3e94)).cameraX = sub_3eb2;
					class_f.cameraY = sub_3eb3;
					break;
				}
				case 32: {
					(class_f = sub_25b35(15, sub_3e94)).cameraX = sub_3eb2;
					class_f.cameraY = sub_3eb3;
	...
	static void sub_d500(final int n, final int n2, final int n3, final int n4, final int n5, int n6, int n7) {
		if (n4 == 0) {
			...
			cGame.var_689c[n][n2].FreeCachePoolData();
		}
	...
	private static int sub_d6f2(final int n, final int n2) {
		...
		int n3 = 0;
		for (int i = 0; i < 16; ++i) {
			if (cGame.var_689c[n][n2].DoesPaletteHaveImageCache(i)) {
				n3 |= 1 << i;
			}
		}
		return n3;
	...
	private static String getRawPrepareTime(final int time) {
		final int i = time / 86400;
		final int n2;
		final int j = (n2 = time % 86400) / 3600;
		final int n3;
		final int k = (n3 = n2 % 3600) / 60;
		final int seconds = n3 % 60;
		String result = "";
		String s;
		if (time > 0) {
			if (i > 0) {
	...
	private static String getPrepareTime(final int time) {
		final int i = time / 86400;
		final int j = (time % 86400) / 3600;
		final int k = (time % 3600) / 60;
	...
	static void sub_df48(final int n, final int n2) {
		if (n2 != 0) {
			...
			cGame.s_prepareTime = getPrepareTime(n2 - n);
		}
	}
	...
	private static void sub_e055(final boolean b, int i, final int n, final int n2) {
		...
		while (i > 0) {
			...
			cActor.newActor(47, 2, array).sub_8c4c(n + (GLLib.Math_Rand(0, 50) - 25),
	...
	private static void makeRMSHeader() {
		...
		rmsHeader[4] = (byte) cGame.s_currencySeprType;
		rmsHeader[5] = (byte) cGame.s_languageCode;
		rmsHeader[6] = (byte) (cGame.var_69e4 ? 1 : 0);
		rmsHeader[7] = (byte) GLLibPlayer.s_snd_masterVolume;
		rmsHeader[10] = (byte) (cGame.s_unkBoolean ? 1 : 0);
		try {
			GLLib.Rms_Write("RMSHeader", rmsHeader);
		} catch (final Exception ex) {
			sub_4052e(Define.TEXT_POPUP_MEMFULL, Define.TEXT_POPUP_MEMFULLDESC, 7, 0);
		}
	}

	private static boolean readFromRMSHeader() {
		final byte[] rmsHeader = GLLib.Rms_Read("RMSHeader");
		int version = 0;
		if (rmsHeader != null) {
		...
		cGame.s_currencySeprType = rmsHeader[4];
		cGame.s_languageCode = rmsHeader[5];
		if (cGame.s_currencySeprType == -1) {
			cGame.s_currencySeprType = 0;
		}
		cGame.var_69e4 = (rmsHeader[6] == 1);
		cGame.s_unkBoolean = (rmsHeader[10] == 1);
		try {
	...
	private static void doSave(final boolean force) {
		if (cGame.var_807c != 0 || cGame.var_6aa4 != -1) {
			return;
		}
		if (!force && (getLevel() < 3 || cGame.s_tutorialState != -1)) {
			return;
		}
		makeRMSHeader();
		if (cGame.var_6aa4 == -1) {
			byte[] gameplaySave = new byte[51200];
			int n = GLLib.Mem_SetInt(gameplaySave, GLLib.Mem_SetByte(gameplaySave, GLLib.Mem_SetByte(gameplaySave, GLLib.Mem_SetByte(gameplaySave,
					GLLib.Mem_SetByte(gameplaySave, GLLib.Mem_SetByte(gameplaySave, GLLib.Mem_SetByte(gameplaySave, GLLib.Mem_SetByte(gameplaySave,
							GLLib.Mem_SetInt(gameplaySave, GLLib.Mem_SetByte(gameplaySave, GLLib.Mem_SetByte(gameplaySave,
									GLLib.Mem_SetByte(gameplaySave,
											GLLib.Mem_SetByte(gameplaySave, 0, (byte) (cGame.var_7964 ? 1 : 0)),
											(byte) (cGame.var_69ec ? 1 : 0)),
									(byte) (cGame.var_69f4 ? 1 : 0)), (byte) (cGame.var_7974 ? 1 : 0)),
									cGame.s_sndVolume),
							(byte) cGame.s_tutorialState), (byte) (cGame.var_6c14 ? 1 : 0)),
			...
			for (char c = '\0'; c < cGame.var_7f74; ++c) {
				n = GLLib.Mem_SetByte(gameplaySave,
						GLLib.Mem_SetInt(gameplaySave,
								GLLib.Mem_SetByte(gameplaySave,
										GLLib.Mem_SetInt(gameplaySave, GLLib.Mem_SetByte(gameplaySave, GLLib.Mem_SetInt(gameplaySave,
												GLLib.Mem_SetInt(gameplaySave, GLLib.Mem_SetInt(gameplaySave, n, cGame.var_7e54[c]),
														cGame.s_questStates[c]),
												cGame.s_questValue[c]), (byte) (cGame.var_7ebc[c] ? 1 : 0)),
												cGame.var_7ecc[c]),
			...
			for (int i = 0; i < cGame.var_7f7c; ++i) {
				n = GLLib.Mem_SetInt(gameplaySave, n, cGame.var_7f64[i]);
			}
			int n2 = GLLib.Mem_SetInt(gameplaySave,
					GLLib.Mem_SetInt(gameplaySave,
							GLLib.Mem_SetInt(gameplaySave, GLLib.Mem_SetShort(gameplaySave, GLLib.Mem_SetInt(gameplaySave,
									GLLib.Mem_SetShort(gameplaySave, GLLib.Mem_SetInt(gameplaySave, GLLib.Mem_SetLong(gameplaySave,
											GLLib.Mem_SetInt(gameplaySave, GLLib.Mem_SetInt(gameplaySave, n, cGame.s_rmsLevel),
													cGame.s_rmsExp),
											cGame.s_rmsCoin), cGame.s_rmsCash), (short) cGame.var_7024),
									cGame.s_rmsMaxPlots), (short) cGame.s_deluxifierAmount), cGame.idkbro),
							cGame.s_rmsMaxAmountInSilo),
					cGame.var_705c);
			for (int j = 0; j < 6; ++j) {
				n2 = GLLib.Mem_SetInt(gameplaySave, n2, cGame.var_7014[j]);
			}
			for (int k = 0; k < 5; ++k) {
				for (int length = cGame.var_6fcc[k].length, l = 0; l < length; ++l) {
					n2 = GLLib.Mem_SetInt(gameplaySave, n2, cGame.var_6fcc[k][l]);
				}
			}
			for (int n3 = 0; n3 < 10; ++n3) {
				for (int n4 = 0; n4 < 6; ++n4) {
					n2 = GLLib.Mem_SetInt(gameplaySave, n2, cGame.var_6e24[n3][n4]);
				}
			}
			for (int n5 = 0; n5 < 10; ++n5) {
				for (int n6 = 0; n6 < 6; ++n6) {
					n2 = GLLib.Mem_SetLong(gameplaySave, n2, cGame.var_6e34[n5][n6]);
				}
			}
			for (int n7 = 0; n7 < 10; ++n7) {
				for (int n8 = 0; n8 < 6; ++n8) {
					n2 = GLLib.Mem_SetInt(gameplaySave, n2, cGame.var_6e2c[n7][n8]);
				}
			}
			for (int n9 = 0; n9 < 20; ++n9) {
				n2 = GLLib.Mem_SetInt(gameplaySave, GLLib.Mem_SetInt(gameplaySave,
						GLLib.Mem_SetInt(gameplaySave, n2, cGame.var_6e4c[n9][0]), cGame.var_6e4c[n9][1]),
						cGame.var_6e4c[n9][2]);
				for (int n10 = 0; n10 < 3; ++n10) {
					n2 = GLLib.Mem_SetInt(gameplaySave, GLLib.Mem_SetInt(gameplaySave, n2, cGame.var_6e44[n9][n10 << 1]),
							cGame.var_6e44[n9][(n10 << 1) + 1]);
				}
			}
			int n11 = GLLib.Mem_SetShort(gameplaySave, GLLib.Mem_SetInt(gameplaySave, n2, cGame.s_manor_restoreLevel), cGame.s_manor_restoreScrState);
			for (int n12 = 0; n12 < 6; ++n12) {
				n11 = GLLib.Mem_SetLong(gameplaySave, n11, cGame.var_7774[n12]);
			}
			int n13 = GLLib.Mem_SetByte(gameplaySave, n11, (byte) cGame.var_746c);
			for (int n14 = 0; n14 < cGame.var_746c; ++n14) {
				n13 = GLLib.Mem_SetByte(gameplaySave,
						GLLib.Mem_SetInt(gameplaySave,
								GLLib.Mem_SetInt(gameplaySave,
										GLLib.Mem_SetLong(gameplaySave, GLLib.Mem_SetByte(gameplaySave, n13, cGame.var_74bc[n14]),
												cGame.var_74a4[n14]),
										cGame.var_749c[n14]),
								cGame.var_748c[n14]),
						(byte) (cGame.var_74c4[n14] ? 1 : 0));
			}
			int n15 = GLLib.Mem_SetByte(gameplaySave, n13, (byte) cGame.var_7514);
			for (int n16 = 0; n16 < cGame.var_7514; ++n16) {
				n15 = GLLib.Mem_SetInt(gameplaySave,
						GLLib.Mem_SetInt(gameplaySave, GLLib.Mem_SetLong(gameplaySave,
								GLLib.Mem_SetByte(gameplaySave, n15, cGame.var_7564[n16]), cGame.var_7544[n16]),
								cGame.var_753c[n16]),
						cGame.var_752c[n16]);
			}
			for (int n17 = 0; n17 < cGame.s_trophy_numTrophies; ++n17) {
				n15 = GLLib.Mem_SetInt(gameplaySave,
						GLLib.Mem_SetByte(gameplaySave,
								GLLib.Mem_SetInt(gameplaySave,
										GLLib.Mem_SetByte(gameplaySave, GLLib.Mem_SetInt(gameplaySave, n15, cGame.var_6e64[n17]),
												cGame.var_6edc[n17]),
										cGame.var_6e94[n17]),
			...
			for (int n18 = 0; n18 < 15; ++n18) {
				n15 = GLLib.Mem_SetByte(gameplaySave, n15, (byte) (cGame.var_6eec[n18] ? 1 : 0));
			}
			for (int n19 = 0; n19 < 10; ++n19) {
				n15 = GLLib.Mem_SetInt(gameplaySave, n15, cGame.var_6ef4[n19]);
			}
			for (int n20 = 0; n20 < 64; ++n20) {
				n15 = GLLib.Mem_SetShort(gameplaySave, n15, cGame.var_6efc[n20]);
			}
			for (int n21 = 0; n21 < 60; ++n21) {
				n15 = GLLib.Mem_SetInt(gameplaySave, n15, cGame.var_79f4[n21]);
			}
			for (int n22 = 0; n22 < 13; ++n22) {
				n15 = GLLib.Mem_SetByte(gameplaySave, n15, (byte) (cGame.var_6dfc[n22] ? 1 : 0));
			}
			for (int n23 = 0; n23 < 13; ++n23) {
				n15 = GLLib.Mem_SetByte(gameplaySave, n15, (byte) (cGame.var_6e04[n23] ? 1 : 0));
			}
			final int sub_3df9 = GLLib.Mem_SetLong(gameplaySave, GLLib.Mem_SetLong(gameplaySave, n15, cGame.var_7da4),
					cGame.var_814c);
			cGame.var_8144 = System.currentTimeMillis() / 1000L;
			int n24 = GLLib.Mem_SetInt(gameplaySave, GLLib.Mem_SetLong(gameplaySave, sub_3df9, cGame.var_8144), cGame.var_776c);
			for (int n25 = 0; n25 < 100; ++n25) {
				n24 = GLLib.Mem_SetInt(gameplaySave, n24, cGame.var_7764[n25]);
			}
			GLLib.Mem_SetLong(gameplaySave,
					GLLib.Mem_SetInt(gameplaySave,
							GLLib.Mem_SetInt(gameplaySave,
									GLLib.Mem_SetInt(gameplaySave, GLLib.Mem_SetInt(gameplaySave, GLLib.Mem_SetLong(gameplaySave,
											GLLib.Mem_SetLong(gameplaySave, GLLib.Mem_SetInt(gameplaySave, n24, cGame.var_6d4c),
													cGame.var_77bc),
					...
					cGame.var_77b4);
			try {
				GLLib.Rms_Write("save_gameplay", gameplaySave);
			} catch (final Exception ex) {
				sub_4052e(Define.TEXT_POPUP_MEMFULL, Define.TEXT_POPUP_MEMFULLDESC, 7, 0);
			}
		}
		if (cGame.var_6aa4 == -1 && cGame.var_807c == 0) {
			...
			final cActor var_800c = cGame.var_800c;
			final int n29 = n28;
			final byte[] array5 = array2;
			int n30 = GLLib.Mem_SetInt(array5,
					GLLib.Mem_SetShort(array5, GLLib.Mem_SetShort(array5,
							GLLib.Mem_SetByte(array2, n29, (byte) var_800c.var_17c5), (short) var_800c.cameraX),
							(short) var_800c.cameraY),
					var_800c.var_17dd);
			for (cActor var_17ad = cActor.var_157d[0]; var_17ad != null; var_17ad = var_17ad.var_17ad) {
					...
					n30 = GLLib.Mem_SetInt(array7,
							GLLib.Mem_SetShort(array7, GLLib.Mem_SetShort(array7, GLLib.Mem_SetShort(array7,
									GLLib.Mem_SetByte(array7, GLLib.Mem_SetByte(array6, n32, (byte) class_f.var_17c5),
											(byte) class_f.actorID),
									(short) class_f.cameraX), (short) class_f.cameraY), (short) class_f.var_17dd),
							class_f.var_1855);
					break;
				}
				case 20: {
					...
					final int n33 = n30;
					final cActor class_f2 = var_17ad;
					final int n34 = n33;
					...
					n30 = GLLib.Mem_SetByte(array9, GLLib.Mem_SetInt(array9,
							GLLib.Mem_SetShort(array9, GLLib.Mem_SetShort(array9, GLLib.Mem_SetShort(array9,
									GLLib.Mem_SetByte(array9, GLLib.Mem_SetByte(array8, n34, (byte) class_f2.var_17c5),
											(byte) class_f2.actorID),
									(short) class_f2.cameraX), (short) class_f2.cameraY), (short) class_f2.var_17dd),
				...
				case 48: {
					...
					final int n35 = n30;
					final cActor class_f3 = var_17ad;
					final int n36 = n35;
					...
					n30 = GLLib.Mem_SetByte(array11, GLLib.Mem_SetInt(array11,
							GLLib.Mem_SetShort(array11, GLLib.Mem_SetShort(array11, GLLib.Mem_SetShort(array11,
									GLLib.Mem_SetByte(array11, GLLib.Mem_SetByte(array10, n36, (byte) class_f3.var_17c5),
											(byte) class_f3.actorID),
									(short) class_f3.cameraX), (short) class_f3.cameraY), (short) class_f3.var_17dd),
				...
				case 22: {
					...
					final int n37 = n30;
					final cActor class_f4 = var_17ad;
					final int n38 = n37;
					...
					n30 = GLLib.Mem_SetByte(array13, GLLib.Mem_SetInt(array13, GLLib.Mem_SetShort(array13,
							GLLib.Mem_SetShort(array13, GLLib.Mem_SetShort(array13, GLLib.Mem_SetShort(array13,
									GLLib.Mem_SetByte(array13, GLLib.Mem_SetByte(array12, n38, (byte) class_f4.var_17c5),
											(byte) class_f4.actorID),
									(short) class_f4.var_17a5), (short) class_f4.cameraX), (short) class_f4.cameraY),
				...
				case 49: {
					...
					final int n39 = n30;
					final cActor class_f5 = var_17ad;
					final int n40 = n39;
					...
					n30 = GLLib.Mem_SetLong(array15, GLLib.Mem_SetByte(array15, GLLib.Mem_SetInt(array15,
							GLLib.Mem_SetShort(array15, GLLib.Mem_SetShort(array15, GLLib.Mem_SetShort(array15,
									GLLib.Mem_SetByte(array15, GLLib.Mem_SetByte(array14, n40, (byte) class_f5.var_17c5),
											(byte) class_f5.actorID),
									(short) class_f5.cameraX), (short) class_f5.cameraY), (short) class_f5.var_17dd),
				...
				case 52: {
					...
					final int n41 = n30;
					final cActor class_f6 = var_17ad;
					final int n42 = n41;
					...
					n30 = GLLib.Mem_SetLong(array17, GLLib.Mem_SetByte(array17, GLLib.Mem_SetInt(array17,
							GLLib.Mem_SetShort(array17, GLLib.Mem_SetShort(array17, GLLib.Mem_SetShort(array17,
									GLLib.Mem_SetByte(array17, GLLib.Mem_SetByte(array16, n42, (byte) class_f6.var_17c5),
											(byte) class_f6.actorID),
									(short) class_f6.cameraX), (short) class_f6.cameraY), (short) class_f6.var_17dd),
				...
				case 50: {
					...
					final int n43 = n30;
					final cActor class_f7 = var_17ad;
					final int n44 = n43;
					...
					int n45 = GLLib.Mem_SetByte(array19, GLLib.Mem_SetInt(array19,
							GLLib.Mem_SetShort(array19, GLLib.Mem_SetShort(array19, GLLib.Mem_SetShort(array19,
									GLLib.Mem_SetByte(array19, GLLib.Mem_SetByte(array18, n44, (byte) class_f7.var_17c5),
											(byte) class_f7.actorID),
									(short) class_f7.cameraX), (short) class_f7.cameraY), (short) class_f7.var_17dd),
							class_f7.var_1855), (byte) class_f7.var_185d);
					if (class_f7.actorID == Define.ACTOR_STABLES || class_f7.actorID == Define.ACTOR_HENHOUSE) {
				...
				case 54: {
					...
					final int n46 = n30;
					final cActor class_f8 = var_17ad;
					final int n47 = n46;
									...
									GLLib.Mem_SetInt(array21, GLLib.Mem_SetByte(array21, GLLib.Mem_SetInt(array21,
											GLLib.Mem_SetShort(array21, GLLib.Mem_SetShort(array21,
													GLLib.Mem_SetShort(array21, GLLib.Mem_SetByte(array21,
															...
															(byte) class_f8.actorID), (short) class_f8.cameraX),
													(short) class_f8.cameraY), (short) class_f8.var_17dd),
			...
			try {
				GLLib.Rms_Write_Single("save_farm" + cGame.var_807c, array2, 0, n30, null);
			} catch (final Exception ex2) {
				sub_4052e(Define.TEXT_POPUP_MEMFULL, Define.TEXT_POPUP_MEMFULLDESC, 7, 0);
			}
		}
	...
	private static boolean setValuesFromGameplaySave(final boolean b) {
		...
		byte[] rmsGameplay = GLLib.Rms_Read("save_gameplay");
		if (rmsGameplay == null) {
			return false;
		} else {
			int offset = 0;
			...
			offset += 4;
			cGame.s_tutorialState = GLLib.Mem_GetByte(rmsGameplay, 8);
			++offset;
			...
			for (char c = '\0'; c < cGame.var_7f74; ++c) {
				...
				cGame.s_questStates[c] = GLLib.Mem_GetInt(rmsGameplay, offset);
				offset += 4;
				cGame.s_questValue[c] = GLLib.Mem_GetInt(rmsGameplay, offset);
				offset += 4;
			...
			offset += 4;
			cGame.s_deluxifierAmount = GLLib.Mem_GetShort(rmsGameplay, offset);
			offset += 2;
			...
			cGame.s_manor_restoreLevel = GLLib.Mem_GetInt(rmsGameplay, offset);
			offset += 4;
			cGame.s_manor_restoreScrState = GLLib.Mem_GetShort(rmsGameplay, offset);
			offset += 2;
			...
			for (int n11 = 0; n11 < cGame.var_746c; ++n11) {
				...
				GameDatas class_h;
				int n20;
				for (class_h = GameDatas.s_allDatas[7], n20 = 0; n20 < class_h.var_7a
						&& n18 != class_h.m_dataVars[n20][1]; ++n20) {
				}
				if (n20 < class_h.var_7a) {
					cGame.var_748c[n19] = n18;
					cGame.var_74a4[n19] = n17;
					cGame.var_7494[n19] = class_h.m_dataVars[n20][2];
					cGame.var_749c[n19] = n16;
					cGame.var_74ac[n19] = class_h.m_dataVars[n20][15];
					cGame.var_74c4[n19] = b5;
					cGame.var_74b4[n19] = cGame.var_80d4[class_h.m_dataVars[n20][18]];
			...
			for (int n21 = 0; n21 < cGame.var_7514; ++n21) {
				...
				final int n28 = n23;
				final int n29 = n22;
				final GameDatas class_h2 = GameDatas.s_allDatas[22];
				final GameDatas class_h3 = GameDatas.s_allDatas[1];
				int n30;
				for (n30 = 0; n30 < class_h2.var_7a && n28 != class_h2.m_dataVars[n30][1]; ++n30) {
				}
				if (n30 < class_h2.var_7a) {
					cGame.var_752c[n29] = n28;
					cGame.var_7544[n29] = n27;
					cGame.var_7534[n29] = class_h2.m_dataVars[n30][2];
					cGame.var_753c[n29] = n26;
					cGame.var_754c[n29] = class_h2.m_dataVars[n30][12];
					final int n31 = class_h2.m_dataVars[n30][15];
					cGame.var_7554[n29] = (short) class_h3.m_dataVars[n31][3];
					cGame.var_755c[n29] = (short) class_h3.m_dataVars[n31][4];
	...
	private static boolean sub_10216(final boolean b) {
		final byte[] sub_5579;
		if ((sub_5579 = GLLib.Rms_Read("save_farm" + cGame.var_807c)) == null) {
			return false;
		}
	...
	private static int sub_102cc(final byte[] array, int i, final int n) {
		while (i < n) {
			...
			case 13: {
				int n2 = i;
				(cGame.var_800c = cActor.newActor(13, new int[] { 0, 0, 255 })).cameraX = GLLib.Mem_GetShort(array,
						n2);
				n2 += 2;
				cGame.var_800c.cameraY = GLLib.Mem_GetShort(array, n2);
				n2 += 2;
			...
			case 42: {
				...
				cActor sub_25b35;
				if (sub_3e93 == -1) {
					sub_25b35 = (cGame.var_8004 = cActor.newActor(42, new int[] { 0, 0, 12, 2 }));
				} else {
					sub_25b35 = sub_25b35(8, sub_3e93);
				}
				sub_25b35.cameraX = GLLib.Mem_GetShort(array, n3);
				n3 += 2;
				sub_25b35.cameraY = GLLib.Mem_GetShort(array, n3);
				n3 += 2;
			...
			case 20: {
				...
				++n4;
				final cActor sub_25b36;
				(sub_25b36 = sub_25b35(4, sub_3e94)).cameraX = GLLib.Mem_GetShort(array, n4);
				n4 += 2;
				sub_25b36.cameraY = GLLib.Mem_GetShort(array, n4);
				n4 += 2;
			...
			case 48: {
				...
				++n5;
				final cActor sub_25b37;
				(sub_25b37 = sub_25b35(11, sub_3e95)).cameraX = GLLib.Mem_GetShort(array, n5);
				n5 += 2;
				sub_25b37.cameraY = GLLib.Mem_GetShort(array, n5);
				n5 += 2;
			...
			case 22: {
				...
				++n6;
				final cActor sub_25b38;
				(sub_25b38 = sub_25b35(11, sub_3e96)).var_17a5 = GLLib.Mem_GetShort(array, n6);
				n6 += 2;
				sub_25b38.cameraX = GLLib.Mem_GetShort(array, n6);
				n6 += 2;
				sub_25b38.cameraY = GLLib.Mem_GetShort(array, n6);
				n6 += 2;
			...
			case 49: {
				...
				++n7;
				final cActor sub_25a26;
				(sub_25a26 = sub_25a26(49, 0, false)).actorID = sub_3e97;
				sub_25a26.cameraX = GLLib.Mem_GetShort(array, n7);
				n7 += 2;
				sub_25a26.cameraY = GLLib.Mem_GetShort(array, n7);
				n7 += 2;
			...
			case 52: {
				...
				++n8;
				final cActor sub_25b39;
				(sub_25b39 = sub_25b35(2, sub_3e99)).actorID = sub_3e99;
				sub_25b39.cameraX = GLLib.Mem_GetShort(array, n8);
				n8 += 2;
				sub_25b39.cameraY = GLLib.Mem_GetShort(array, n8);
				n8 += 2;
			...
			case 50: {
				...
				++n9;
				final cActor sub_25b40;
				(sub_25b40 = sub_25b35(3, sub_3e101)).cameraX = GLLib.Mem_GetShort(array, n9);
				n9 += 2;
				sub_25b40.cameraY = GLLib.Mem_GetShort(array, n9);
				n9 += 2;
			...
			case 54: {
				...
				++n10;
				final cActor sub_25b41;
				(sub_25b41 = sub_25b35(0, sub_3e102)).actorID = sub_3e102;
				sub_25b41.cameraX = GLLib.Mem_GetShort(array, n10);
				n10 += 2;
				sub_25b41.cameraY = GLLib.Mem_GetShort(array, n10);
				n10 += 2;
	...
	private static void onPauseButton() {
		sub_11320(false, null);
		switchToState(Define.GS_PAUSE);
	}
	...
	private static void sub_10c1f(final boolean b) {
		...
		int n = 0;
		for (char c = '\0'; c < cGame.var_7f74; ++c) {
			if (sub_4aad0(c) && cGame.s_questStates[c] == 1) {
				++n;
			}
		}
		if (n == 0) {
	...
	static void sub_10e3f(final boolean b, int var_6b94, final int var_6b95) {
		...
		if (b) {
			...
			GameDatas class_h = null;
			var_6b94 = 0;
			int j = 0;
			switch (cGame.var_6b94) {
			case 0: {
				var_6b94 = 12;
				class_h = GameDatas.s_allDatas[2];
				j = 1;
				cGame.var_6b8c = 11;
				break;
			}
			case 1: {
				var_6b94 = 8;
				class_h = GameDatas.s_allDatas[21];
				cGame.var_6b8c = 0;
				break;
			}
			}
			...
			while (j < var_6b94) {
				switch (cGame.var_6b94) {
				case 0: {
					n2 = class_h.m_dataVars[j][5] - 1;
					if (class_h.m_dataVars[j][8] <= getLevel()) {
						cGame.var_6b6c[n2] = class_h.m_dataVars[j][3];
						cGame.var_6b74[n2] = class_h.m_dataVars[j][4];
					} else {
						cGame.var_6b6c[n2] = 20;
						cGame.var_6b74[n2] = 136;
					}
					cGame.var_6b7c[n2] = class_h.m_dataVars[j][6];
					cGame.var_6b84[n2] = j;
					break;
				}
				case 1: {
					if (class_h.m_dataVars[j][3] > -1) {
						cGame.var_6b6c[n2] = class_h.m_dataVars[j][3];
						cGame.var_6b74[n2] = class_h.m_dataVars[j][4];
						cGame.var_6b7c[n2] = 0;
			...
			sub_1fb8e(1);
			sub_234cb(3, 6);
			cGame.var_6914[3][4] = ((cGame.var_68d4[20].GetFrameMinY(116) < 0) ? (-cGame.var_68d4[20].GetFrameMinY(116))
					: cGame.var_68d4[20].GetFrameMinY(116));
	...
	static void sub_11320(final boolean b, final cActor var_8034) {
		if (cGame.var_807c != 0) {
			return;
		}
		if (b) {
		...
		if (cGame.var_8034 != null) {
			if (cGame.var_8034.var_17c5 == 54 && cGame.var_8034.sub_a2a0(32)) {
				...
				cGame.var_68cc[1][6] = (((sub_4e1f = GLLib.Text_GetString(Define.TEXT_UNTILADULT)) == null) ? "" : sub_4e1f);
			} else {
				final String sub_4e1f2;
				cGame.var_68cc[1][6] = (((sub_4e1f2 = GLLib.Text_GetString(Define.TEXT_UNTILREADY)) == null) ? "" : sub_4e1f2);
			}
			cGame.var_68cc[1][5] = Integer.toString(cGame.var_8034.prepareTime);
			cGame.var_68cc[1][7] = cGame.s_prepareTime;
		}
	}
	...
	private static void sub_11737() {
		if (cGame.var_6bc4) {
			...
			sub_26a6a(true, cGame.s_currentQuest, cGame.var_6bcc);
		}
	}

	private static int sub_11774(final int n) {
		return GameDatas.s_allDatas[2].m_dataVars[n][5] - 1;
	}
	...
	private static void sub_117fc() {
		if (cGame.var_6aa4 == -1 || cGame.s_tutorialState != -1) {
			return;
		}
		boolean b = false;
		if (cGame.var_6aa4 == 4) {
			final int sub_a9ce;
			sub_2da02(sub_a9ce = cGame.var_6aac.sub_a9ce(), cGame.var_6aac.actorID, cGame.var_6aac);
			if (sub_a9ce == 3) {
		...
		if (cGame.var_6aa4 == 4 || cGame.var_6aa4 == 0 || cGame.var_6aa4 == 1) {
			...
			cGame.var_6aac.cameraX = cGame.var_6adc;
			cGame.var_6aac.cameraY = cGame.var_6ae4;
	...
	private static void sub_11b40() {
		if (cGame.s_tutorialState == 41 || cGame.s_tutorialState == 13 || cGame.s_tutorialState == 14) {
			return;
		}
		playSndNoLoop(61);
		sub_3151e(2, -1);
	...
	private static void openSDCoinTab() {
		if (cGame.s_tutorialState != 56) {
			playSndNoLoop(61);
		}
		...
		GameDatas class_h;
		for (int var_7a = (class_h = GameDatas.s_allDatas[1]).var_7a, k = 0; k < var_7a; ++k) {
			if (sub_2e024(0, k) > 0 && class_h.m_dataVars[k][12] > 0) {
				cGame.var_723c[cGame.var_72a4] = class_h.m_dataVars[k][2];
				cGame.var_7244[cGame.var_72a4] = k;
				cGame.var_724c[cGame.var_72a4] = 0;
				cGame.var_7254[cGame.var_72a4] = class_h.m_dataVars[k][7];
				cGame.var_725c[cGame.var_72a4] = (short) sub_2e024(0, k);
				cGame.var_7264[cGame.var_72a4] = (short) class_h.m_dataVars[k][3];
				cGame.var_726c[cGame.var_72a4] = (short) class_h.m_dataVars[k][4];
				cGame.var_7274[cGame.var_72a4] = 0;
				cGame.var_727c[cGame.var_72a4] = (short) class_h.m_dataVars[k][1];
				cGame.var_7284[cGame.var_72a4] = (byte) class_h.m_dataVars[k][9];
				++cGame.var_72a4;
				if (n < 15) {
					sub_32e1a(n, true);
					++n;
	...
	private static void openSDOrder0() {
		playSndNoLoop(61);
		openSDOrder(0);
	}

	private static void openSDOrder1() {
		playSndNoLoop(61);
		openSDOrder(1);
	}

	private static void openSDOrder2() {
		playSndNoLoop(61);
		openSDOrder(2);
	}

	private static void openSDOrder3() {
		playSndNoLoop(61);
		openSDOrder(3);
	}

	private static void openSDOrder4() {
		playSndNoLoop(61);
		openSDOrder(4);
	}

	private static void openSDOrder5() {
		playSndNoLoop(61);
		openSDOrder(5);
	}

	private static void openSDOrder6() {
		playSndNoLoop(61);
		openSDOrder(6);
	}

	private static void openSDOrder7() {
		playSndNoLoop(61);
		openSDOrder(7);
	}

	private static void openSDOrder8() {
		playSndNoLoop(61);
		openSDOrder(8);
	}

	private static void openSDOrder9() {
		playSndNoLoop(61);
		openSDOrder(9);
	}

	private static void openSDOrder10() {
		playSndNoLoop(61);
		openSDOrder(10);
	}

	private static void openSDOrder11() {
		playSndNoLoop(61);
		openSDOrder(11);
	}

	private static void openSDOrder12() {
		playSndNoLoop(61);
		openSDOrder(12);
	}

	private static void openSDOrder13() {
		playSndNoLoop(61);
		openSDOrder(13);
	}

	private static void openSDOrder14() {
		playSndNoLoop(61);
		openSDOrder(14);
	}

	private static void shiftItemCntUp() {
	...
	private static void shiftItemCntDown() {
	...
	private static void sub_12354() {
		...
		if (sub_2b5c8(cGame.var_72bc[cGame.var_72b4])) {
			final GameDatas class_h = GameDatas.s_allDatas[1];
			playSndNoLoop(49);
			for (int i = 0; i < 3; ++i) {
				final int n;
				if ((n = cGame.var_6e44[cGame.var_72bc[cGame.var_72b4]][i << 1]) > -1) {
					...
					final int n2;
					sub_49db0(n2 = class_h.m_dataVars[n][1], cGame.var_72dc[i], 16, false);
	...
	private static void popupYes() {
		...
		case 3: {
			playSndNoLoop(57);
			cGame.s_popup_onCloseAct = Define.GS_BUYSCR;
			cGame.s_switcherState = 1;
			sub_2c69b();
			break;
		}
		...
		if (cGame.s_popup_boxset != 2 && cGame.s_popup_boxset != 3 && cGame.s_popup_boxset != 4) {
			...
			if (cGame.s_popup_title == (((sub_4e1f = GLLib.Text_GetString(Define.TEXT_POPUP_LETSTELLEVERYONE)) == null) ? "" : sub_4e1f)
				...
				if (cGame.s_popup_title == (((sub_4e1f2 = GLLib.Text_GetString(Define.TEXT_POPUP_WHOOPS)) == null) ? "" : sub_4e1f2)
					...
					sub_8370(Define.GS_POPUP);
					return;
				}
			}
			Label_0360: {
				final String sub_4e1f3;
				if (cGame.s_popup_title == (((sub_4e1f3 = GLLib.Text_GetString(Define.TEXT_POPUP_ROOMRESTORED)) == null) ? "" : sub_4e1f3)) {
					final int n = GameDatas.s_allDatas[3].m_dataVars[sub_df89(cGame.s_manor_restoreLevel)][1];
					if (cGame.s_manor_restoreLevel == 1) {
						sub_2bae9(n, 1, 27);
					} else if (cGame.s_manor_restoreLevel == 9) {
						sub_2bae9(n, 1, 27);
					}
					sub_49db0(n, 1, 27, false);
					if (cGame.s_manor_restoreLevel >= 9) {
						cGame.var_7aac = 7;
					}
					b = true;
				} else {
					final String sub_4e1f4;
					if (cGame.s_popup_title == (((sub_4e1f4 = GLLib.Text_GetString(Define.TEXT_POPUP_CONGRATS)) == null) ? "" : sub_4e1f4)) {
						if (cGame.var_7fa4 != -1) {
			...
			if (cGame.s_popup_onCloseState == Define.GS_FARMDIARY) {
				playSndNoLoop(60);
			} else {
				playSndNoLoop(61);
			}
			if (b) {
				sub_8370(Define.GS_FARM);
			} else {
				cGame.s_switcherState = 1;
				sub_2c69b();
			}
			if (cGame.var_7b34 != null) {
				if (cGame.var_7b34.var_18c5 != -1) {
					...
					if (sub_49db0 == 1) {
						final cActor[] array = new cActor[30];
						for (int sub_5439 = cActor.sub_5439(0, 22, array, 30), j = 0; j < sub_5439; ++j) {
							array[j].sub_9274();
						}
					}
				} else {
	...
	private static void completeTask0() {
		if (spendCash(cGame.var_7eb4[cGame.s_currentQuest])) {
		...
		if (cGame.var_7eb4[cGame.s_currentQuest] > 0) {
			cGame.var_7ab4 = (cGame.s_popup_desc = GLLib.Text_FindReplace(
					(GLLib.Text_GetString(Define.TEXT_NOTENOUGHCASH) == null ? "" : GLLib.Text_GetString(Define.TEXT_NOTENOUGHCASH)), "%d",
					GLLib.Text_FormatNumber(cGame.var_7eb4[cGame.s_currentQuest] - getCash(), cGame.s_currencySeprType, " ")));
			cGame.var_7aac = 19;
			cGame.var_7d24 = true;
			cGame.var_815c = true;
			switchToState(Define.GS_BUYSCR);
		}
	}

	private static void completeTask1() {
		if (spendCash(cGame.var_7eec[cGame.s_currentQuest])) {
			if (cGame.s_questStates[cGame.s_currentQuest] == 2) {
		...
		if (cGame.var_7eec[cGame.s_currentQuest] > 0) {
			final String sub_4e1f;
			cGame.var_7ab4 = (cGame.s_popup_desc = GLLib.Text_FindReplace(
					((sub_4e1f = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCASH)) == null) ? "" : sub_4e1f, "%d",
					GLLib.Text_FormatNumber(cGame.var_7eec[cGame.s_currentQuest] - getCash(), cGame.s_currencySeprType, " ")));
			cGame.var_7aac = 19;
			cGame.var_7d24 = true;
			cGame.var_815c = true;
			switchToState(Define.GS_BUYSCR);
	...
	private static void completeTask2() {
		if (spendCash(cGame.var_7f24[cGame.s_currentQuest])) {
			if (cGame.s_questStates[cGame.s_currentQuest] == 2) {
		...
		if (cGame.var_7f24[cGame.s_currentQuest] > 0) {
			...
			cGame.var_7ab4 = (cGame.s_popup_desc = GLLib.Text_FindReplace(
					((sub_4e1f = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCASH)) == null) ? "" : sub_4e1f, "%d",
					GLLib.Text_FormatNumber(cGame.var_7f24[cGame.s_currentQuest] - getCash(), cGame.s_currencySeprType, " ")));
			cGame.var_7aac = 19;
			cGame.var_7d24 = true;
			cGame.var_815c = true;
			switchToState(Define.GS_BUYSCR);
	...
	private static void sub_12d1e() {
		...
		if (cGame.s_questStates[cGame.s_currentQuest] == 3) {
			int n = cGame.var_800c.cameraX + (GLLib.s_screenWidth >> 1);
			int n2 = cGame.var_800c.cameraY + (GLLib.s_screenHeight >> 1);
			if (cGame.s_zoomLevel < 100) {
				n *= 100 / cGame.s_zoomLevel;
				n2 *= 100 / cGame.s_zoomLevel;
			}
			if (decryptInt(cGame.var_7f44[cGame.s_currentQuest]) > 0) {
				sub_e055(true, decryptInt(cGame.var_7f44[cGame.s_currentQuest]), n, n2);
			}
			if (decryptInt(cGame.var_7f4c[cGame.s_currentQuest]) > 0) {
				sub_e055(false, decryptInt(cGame.var_7f4c[cGame.s_currentQuest]), n, n2);
			}
			if (!cGame.s_iapEnabled && decryptInt(cGame.var_7f54[cGame.s_currentQuest]) > 0) {
				cActor.newActor(47, 2, new int[] { 0, 0, 14 }).sub_8c4c(n + (GLLib.Math_Rand(0, 50) - 25),
						n2 + (GLLib.Math_Rand(0, 50) - 25), 6, 1000, false,
						decryptInt(cGame.var_7f54[cGame.s_currentQuest]));
			}
			if (sub_4ac8d()) {
				cGame.var_7aac = 4;
			} else if (cGame.var_7e54[cGame.s_currentQuest] != 16) {
				if (cGame.var_7e54[cGame.s_currentQuest] == 52) {
					cGame.var_7aac = 14;
				} else if (cGame.var_7e54[cGame.s_currentQuest] == 4) {
					cGame.var_7aac = 15;
				} else if (cGame.var_7e54[cGame.s_currentQuest] == 2) {
					cGame.var_7aac = 16;
				} else if (cGame.var_7eac[cGame.s_currentQuest] == 8) {
					cGame.var_7aac = 17;
				}
			}
		...
		sub_4a6a7(cGame.s_currentQuest);
		if (sub_49794()) {
		...
		if (n != 12) {
			if (n != 14) {
				if (n == 16 || n == 33 || n == 11) {
					...
					cActor.sub_545c(0, 50, 9, array, 1);
					if (array[0] != null) {
						sub_82a7(Define.GS_SALEDESK);
					}
					return;
				}
				if (n == 6) {
					...
					if (var_6d54 == cGame.var_80b4[14]) {
						...
						cActor.sub_545c(0, 50, 14, array2, 1);
						if (array2[0] != null) {
							cGame.var_800c.sub_6b0c(array2[0].cameraX, array2[0].cameraY, 1000);
						}
					}
					return;
				} else if (n == 9) {
					...
					if (n == 25) {
						...
						final cActor[] array4 = { null };
						cActor.sub_545c(0, 50, 14, array4, 1);
						if (array4[0] != null) {
							sub_82a7(Define.GS_MILL);
							return;
						}
						...
						cGame.s_switcherState = 1;
						sub_2c69b();
						if (n <= cGame.s_manor_restoreLevel) {
							sub_4049d(Define.TEXT_POPUP_ROOMRESTORED, Define.TEXT_POPUP_ROOMRESTOREDDESC, 15, 0, 1);
							return;
						}
						final cActor[] array5 = { null };
						cActor.sub_545c(0, 50, 18, array5, 1);
						if (array5[0] != null) {
							cGame.var_800c.sub_6b0c(array5[0].cameraX, array5[0].cameraY, 1000);
						}
						return;
					} else if (n == 10) {
						cGame.s_switcherState = 1;
						...
						int n4 = 0;
						if (class_h != null) {
							n3 = class_h.m_dataVars[0][1];
							n4 = class_h.m_dataVars[1][1];
						}
						if (var_6d54 == n3) {
							final cActor[] array6 = { null };
							cActor.sub_55b2(0, 48, 0, array6);
							if (array6[0] != null) {
								cGame.var_800c.sub_6b0c(array6[0].cameraX, array6[0].cameraY, 1000);
							}
							return;
						}
						if (var_6d54 == n4) {
							final cActor[] array7 = { null };
							cActor.sub_55b2(0, 48, 1, array7);
							if (array7[0] != null) {
								cGame.var_800c.sub_6b0c(array7[0].cameraX, array7[0].cameraY, 1000);
							}
						}
						return;
					} else if (n == 22) {
						...
						if (var_6d54 == cGame.var_80cc[2]) {
							...
							cActor.sub_550f(0, 54, 17, 27, array8, 1);
							if (array8[0] != null) {
								cGame.var_800c.sub_6b0c(array8[0].cameraX, array8[0].cameraY, 1000);
								return;
							}
							cActor.sub_550f(0, 54, 41, 63, array8, 1);
							if (array8[0] != null) {
								cGame.var_800c.sub_6b0c(array8[0].cameraX, array8[0].cameraY, 1000);
							}
							return;
							...
							if (var_6d54 == cGame.var_80cc[1]) {
								...
								cActor.sub_550f(0, 54, 5, 15, array9, 1);
								if (array9[0] != null) {
									cGame.var_800c.sub_6b0c(array9[0].cameraX, array9[0].cameraY, 1000);
								}
							}
							return;
						}
						...
						if (n == 19 || n == 41) {
							...
							if (var_6d54 >= cGame.var_80a4[1] && var_6d54 <= cGame.var_80a4[63]) {
								cActor.sub_577d(0, 54, var_6d54, array10, 1);
							} else if (var_6d54 == 2999) {
								cActor.sub_564e(0, 54, cGame.var_80a4[1], cGame.var_80a4[63], array10);
							} else if (var_6d54 == 2998) {
								cActor.sub_564e(0, 54, cGame.var_80a4[5], cGame.var_80a4[15], array10);
							} else if (var_6d54 == 2997) {
								cActor.sub_564e(0, 54, cGame.var_80a4[17], cGame.var_80a4[27], array10);
							} else if (var_6d54 == 2996) {
								cActor.sub_564e(0, 54, cGame.var_80a4[29], cGame.var_80a4[39], array10);
							} else if (var_6d54 == 2995) {
								cActor.sub_564e(0, 54, cGame.var_80a4[41], cGame.var_80a4[51], array10);
							} else if (var_6d54 == 2994) {
								cActor.sub_564e(0, 54, cGame.var_80a4[53], cGame.var_80a4[63], array10);
							}
							if (array10[0] != null) {
								cGame.var_800c.sub_6b0c(array10[0].cameraX, array10[0].cameraY, 1000);
							}
							return;
						}
						if (n == 39) {
						...
						if (n == 8) {
							...
							if (n == 23 || n == 24 || n == 28 || n == 29 || n == 30 || n == 26) {
								...
								if (array11[0] != null) {
									cGame.var_800c.sub_6b0c(array11[0].cameraX, array11[0].cameraY, 1000);
								}
								return;
							}
							if (n == 7) {
								if (var_6d54 == cGame.var_80b4[12]) {
									...
									if (array12[0] != null) {
										cGame.var_800c.sub_6b0c(array12[0].cameraX, array12[0].cameraY, 1000);
									}
									return;
								}
								if (var_6d54 >= cGame.var_80b4[0] && var_6d54 <= cGame.var_80b4[8]) {
									...
									if (array13[0] != null) {
										cGame.var_800c.sub_6b0c(array13[0].cameraX, array13[0].cameraY, 1000);
									}
								}
								return;
							} else {
								if (n == 3) {
									...
									if (array14[0] != null) {
										cGame.var_800c.sub_6b0c(array14[0].cameraX, array14[0].cameraY, 1000);
									}
									return;
								}
								if (n == 4 || n == 5) {
									sub_82a7(Define.GS_MANOR_COLLECTIONS);
									return;
								}
								if (n == 34 && var_6d54 == cGame.var_80cc[110]) {
									onMarketButton(0, 4, false);
									return;
								}
							}
						}
	...
	private static void sub_1392c() {
		...
		if ((n = cGame.var_7e4c[cGame.s_currentQuest]) == cGame.var_80f4[0] && !cGame.var_6c14) {
			...
			cGame.var_6c3c = true;
			cGame.var_7aac = 12;
		} else if ((cGame.var_7eac[cGame.s_currentQuest] == 38 && cGame.var_7ea4[cGame.s_currentQuest] == 2999)
				|| (cGame.var_7ee4[cGame.s_currentQuest] == 38 && cGame.var_7edc[cGame.s_currentQuest] == 2999)
				|| (cGame.var_7f1c[cGame.s_currentQuest] == 38 && cGame.var_7f14[cGame.s_currentQuest] == 2999)) {
			sub_4ad3f(cGame.var_80a4[0]);
		} else if ((cGame.var_7eac[cGame.s_currentQuest] == 32 && cGame.var_7ea4[cGame.s_currentQuest] == 2999)
				|| (cGame.var_7ee4[cGame.s_currentQuest] == 32 && cGame.var_7edc[cGame.s_currentQuest] == 2999)
				|| (cGame.var_7f1c[cGame.s_currentQuest] == 32 && cGame.var_7f14[cGame.s_currentQuest] == 2999)) {
			sub_4ad3f(0);
		}
		boolean b = false;
		for (int i = 0; i < 22; ++i) {
		...
		if (b) {
			final int getIntValue = decryptInt(cGame.s_questNeededVals[cGame.s_currentQuest]);
			final int getIntValue2 = decryptInt(cGame.var_7ed4[cGame.s_currentQuest]);
			final int getIntValue3 = decryptInt(cGame.var_7f0c[cGame.s_currentQuest]);
			final int n2;
			...
			for (int j = 0; j < getIntValue; ++j) {
				array2[j] = cGame.var_7ea4[cGame.s_currentQuest];
				array[j] = sub_14091(cGame.var_7ea4[cGame.s_currentQuest]);
				for (int k = 0; k < 67; ++k) {
					if (array2[j] == class_h.m_dataVars[k][1]) {
						array3[j] = k;
						break;
					}
				}
			...
			for (int n4 = 0; n4 < getIntValue2; ++n4) {
				array2[n3 + n4] = cGame.var_7edc[cGame.s_currentQuest];
				array[n3 + n4] = sub_14091(cGame.var_7edc[cGame.s_currentQuest]);
				for (int n5 = 0; n5 < 67; ++n5) {
					if (array2[n3 + n4] == class_h.m_dataVars[n5][1]) {
						array3[n3 + n4] = n5;
						break;
					}
				}
			...
			for (int n9 = 0; n9 < getIntValue3; ++n9) {
				array2[n8 + n9] = cGame.var_7f14[cGame.s_currentQuest];
				array[n8 + n9] = sub_14091(cGame.var_7f14[cGame.s_currentQuest]);
				for (int n10 = 0; n10 < 67; ++n10) {
					if (array2[n8 + n9] == class_h.m_dataVars[n10][1]) {
						array3[n8 + n9] = n10;
						break;
					}
				}
	...
	private static int sub_14091(final int n) {
		...
		final GameDatas class_h = GameDatas.s_allDatas[11];
		for (int i = 0; i < 67; ++i) {
			if (n == class_h.m_dataVars[i][1]) {
				n2 = class_h.m_dataVars[i][2];
				break;
			}
		}
		return n2;
	...
	private static void exitFeedMill() {
		playSndNoLoop(57);
		cGame.var_757c = true;
		cGame.s_switcherState = 1;
		sub_2c69b();
	...
	private static void sub_142d1() {
		if (!spendCash(cGame.var_7684)) {
			playSndNoLoop(56);
			if (cGame.var_7684 > 0) {
				final String sub_4e1f;
				cGame.var_7ab4 = GLLib.Text_FindReplace(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCASH)) == null) ? "" : sub_4e1f, "%d",
						GLLib.Text_FormatNumber(cGame.var_7684 - getCash(), cGame.s_currencySeprType, " "));
				cGame.var_7aac = 19;
				cGame.var_7d24 = true;
				cGame.var_815c = true;
				switchToState(Define.GS_BUYSCR);
		...
		if (sub_2dcf3(5) + cActor.sub_59d2(2) + cGame.var_7674 - cGame.var_7694 > sub_2df26()) {
			playSndNoLoop(56);
	...
	private static void sub_143b2() {
		if (!spendCash(cGame.var_768c)) {
			playSndNoLoop(56);
			if (cGame.var_768c > 0) {
				final String sub_4e1f;
				cGame.var_7ab4 = GLLib.Text_FindReplace(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCASH)) == null) ? "" : sub_4e1f, "%d",
						GLLib.Text_FormatNumber(cGame.var_768c - getCash(), cGame.s_currencySeprType, " "));
				cGame.var_7aac = 19;
				cGame.var_7d24 = true;
				cGame.var_815c = true;
				switchToState(Define.GS_BUYSCR);
		...
		if (sub_2dcf3(5) + cActor.sub_59d2(2) + cGame.var_767c - cGame.var_769c > sub_2df26()) {
			playSndNoLoop(56);
	...
	private static void sub_14592() {
		if (cGame.s_kitchen_firstItemNeedCnt <= cGame.s_kitchen_firstItemCnt && cGame.s_kitchen_secondItemNeedCnt <= cGame.s_kitchen_secondItemCnt) {
			if (cGame.var_747c < cGame.var_746c) {
				sub_2da54(0, cGame.var_73d4, -cGame.s_kitchen_firstItemNeedCnt);
				sub_2da54(0, cGame.var_73dc, -cGame.s_kitchen_secondItemNeedCnt);
				if (cGame.var_741c && cGame.var_73b4) {
					if (1 <= cGame.s_deluxifierAmount) {
				...
				final int var_739c = cGame.s_kitchen_resultItemName;
	...
	private static void sub_14750() {
		if (!spendCash(cGame.var_73f4)) {
			playSndNoLoop(56);
			if (cGame.var_73f4 > 0) {
				final String sub_4e1f;
				cGame.var_7ab4 = GLLib.Text_FindReplace(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCASH)) == null) ? "" : sub_4e1f, "%d",
						GLLib.Text_FormatNumber(cGame.var_73f4 - getCash(), cGame.s_currencySeprType, " "));
				cGame.var_7aac = 19;
				cGame.var_815c = true;
				cGame.var_7d24 = true;
				switchToState(Define.GS_BUYSCR);
		...
		if (sub_2dcf3(5) + cActor.sub_59d2(2) + cGame.s_kitchen_firstItemNeedCnt - cGame.s_kitchen_firstItemCnt > sub_2df26()) {
			playSndNoLoop(56);
		...
		sub_2da54(0, cGame.var_73d4, cGame.s_kitchen_firstItemNeedCnt - cGame.s_kitchen_firstItemCnt);
		sub_33e7d();
		playSndNoLoop(49);
	}

	private static void sub_14831() {
		if (!spendCash(cGame.var_73fc)) {
			playSndNoLoop(56);
			if (cGame.var_73fc > 0) {
				final String sub_4e1f;
				cGame.var_7ab4 = GLLib.Text_FindReplace(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCASH)) == null) ? "" : sub_4e1f, "%d",
						GLLib.Text_FormatNumber(cGame.var_73fc - getCash(), cGame.s_currencySeprType, " "));
				cGame.var_7aac = 19;
				cGame.var_815c = true;
				cGame.var_7d24 = true;
				switchToState(Define.GS_BUYSCR);
		...
		if (sub_2dcf3(5) + cActor.sub_59d2(2) + cGame.s_kitchen_secondItemNeedCnt - cGame.s_kitchen_secondItemCnt > sub_2df26()) {
			playSndNoLoop(56);
		...
		sub_2da54(0, cGame.var_73dc, cGame.s_kitchen_secondItemNeedCnt - cGame.s_kitchen_secondItemCnt);
		sub_33e7d();
		playSndNoLoop(49);
	}
	...
	private static void sub_1497a(final int n) {
		...
		boolean b = false;
		final GameDatas class_h = GameDatas.s_allDatas[7];
		for (int i = 0; i < class_h.var_7a; ++i) {
			if (class_h.m_dataVars[i][18] == n && getLevel() >= class_h.m_dataVars[i][5]) {
				b = true;
				cGame.var_730c = cGame.var_7304;
				cGame.var_745c = cGame.var_736c;
				cGame.var_736c = class_h.m_dataVars[i][3];
				cGame.var_7304 = (char) (class_h.m_dataVars[i][4] - 1);
				break;
			}
		}
		if (!b) {
	...
	private static void sub_14a74() {
		if (cGame.var_74e4) {
			final int sub_8396;
			if ((sub_8396 = getState()) == Define.GS_MILL) {
				sub_36ea2(cGame.var_74f4);
			} else if (sub_8396 == Define.GS_KITCHEN) {
		...
		if (cGame.s_tutorialState == 24 || cGame.s_tutorialState == 25) {
			return;
		}
		playSndNoLoop(57);
		cGame.s_switcherState = 1;
	...
	private static void sub_14b26(int n, int n2) {
		if (n2 != 27) {
			if (n2 == 11) {
				...
				if (!cGame.var_74e4) {
					...
					int n4 = 0;
					for (int i = 0; i < 83; ++i) {
						if (cGame.var_748c[n] == class_h.m_dataVars[i][1]) {
							if (cGame.var_74c4[n]) {
								n4 = class_h.m_dataVars[i][13];
							}
							n3 = i;
							break;
						}
					}
					final int n5 = class_h.m_dataVars[n3][18];
					...
					addExperience(n2 = class_h.m_dataVars[n3][16]);
					cGame.var_750c = n2;
		...
		if (!cGame.var_74e4) {
			...
			int n6 = 0;
			for (int j = 0; j < 6; ++j) {
				if (cGame.var_752c[n] == class_h2.m_dataVars[j][1]) {
					n6 = j;
					break;
				}
			}
			if (sub_2e4fa(1, n6)) {
				addExperience(n2 = class_h2.m_dataVars[n6][13]);
				cGame.var_75fc = n2;
	...
	private static void sub_14e7b() {
		final int sub_8396;
		if (((sub_8396 = getState()) == Define.GS_MILL && cGame.var_7564[cGame.var_7524] == 4)
				|| (sub_8396 == Define.GS_KITCHEN && cGame.var_74bc[cGame.var_7484] == 4)) {
	...
	private static void sub_14ede() {
		final int sub_8396;
		if (((sub_8396 = getState()) == Define.GS_MILL && cGame.var_7564[cGame.var_7524 + 1] == 4)
				|| (sub_8396 == Define.GS_KITCHEN && cGame.var_74bc[cGame.var_7484 + 1] == 4)) {
	...
	private static void sub_14f45() {
		final int sub_8396;
		if (((sub_8396 = getState()) == Define.GS_MILL && cGame.var_7564[cGame.var_7524 + 2] == 4)
				|| (sub_8396 == Define.GS_KITCHEN && cGame.var_74bc[cGame.var_7484 + 2] == 4)) {
	...
	private static void sub_14fac() {
		final int sub_8396;
		if (((sub_8396 = getState()) == Define.GS_MILL && cGame.var_7564[cGame.var_7524 + 3] == 4)
				|| (sub_8396 == Define.GS_KITCHEN && cGame.var_74bc[cGame.var_7484 + 3] == 4)) {
	...
	private static void sub_15013() {
		final int sub_8396;
		if (((sub_8396 = getState()) == Define.GS_MILL && cGame.var_7564[cGame.var_7524 + 4] == 4)
				|| (sub_8396 == Define.GS_KITCHEN && cGame.var_74bc[cGame.var_7484 + 4] == 4)) {
	...
	private static void sub_152a6(final int n) {
		...
		if (cGame.var_756c[n] > 0) {
			final String sub_4e1f;
			cGame.var_7ab4 = GLLib.Text_FindReplace(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCASH)) == null) ? "" : sub_4e1f, "%d",
					GLLib.Text_FormatNumber(cGame.var_756c[n] - getCash(), cGame.s_currencySeprType, " "));
			cGame.var_7aac = 19;
			cGame.var_815c = true;
			cGame.var_7d24 = true;
			switchToState(Define.GS_BUYSCR);
	...
	private static void sub_15350(final int n) {
		...
		if (cGame.var_74cc[n] > 0) {
			final String sub_4e1f;
			cGame.var_7ab4 = GLLib.Text_FindReplace(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCASH)) == null) ? "" : sub_4e1f, "%d",
					GLLib.Text_FormatNumber(cGame.var_74cc[n] - getCash(), cGame.s_currencySeprType, " "));
			cGame.var_7aac = 19;
			cGame.var_815c = true;
			cGame.var_7d24 = true;
			switchToState(Define.GS_BUYSCR);
	...
	private static void sub_15738() {
		...
		if (getState() == Define.GS_MILL) {
			if (cGame.var_7514 < cGame.var_7474) {
				final int sub_27050;
				if (spendCash(sub_27050 = sub_27050(cGame.var_7514 + 1))) {
					playSndNoLoop(49);
				...
				final String sub_4e1f;
				cGame.var_7ab4 = GLLib.Text_FindReplace(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCASH)) == null) ? "" : sub_4e1f, "%d",
						GLLib.Text_FormatNumber(sub_27050 - getCash(), cGame.s_currencySeprType, " "));
				cGame.var_7aac = 19;
				cGame.var_815c = true;
				cGame.var_7d24 = true;
				switchToState(Define.GS_BUYSCR);
		...
		if (cGame.var_746c < cGame.var_7474) {
			final int sub_27051;
			if (spendCash(sub_27051 = sub_27050(cGame.var_746c + 1))) {
				playSndNoLoop(49);
				++cGame.var_746c;
			...
			playSndNoLoop(56);
			final String sub_4e1f2;
			cGame.var_7ab4 = GLLib.Text_FindReplace(((sub_4e1f2 = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCASH)) == null) ? "" : sub_4e1f2, "%d",
					GLLib.Text_FormatNumber(sub_27051 - getCash(), cGame.s_currencySeprType, " "));
			cGame.var_7aac = 19;
			cGame.var_815c = true;
			cGame.var_7d24 = true;
			switchToState(Define.GS_BUYSCR);
	...
	private static void sub_158b3() {
		if (getState() == Define.GS_MILL) {
			...
			if (getLevel() >= cGame.var_75cc[cGame.var_7604]) {
				playSndNoLoop(61);
				switchToState(Define.GS_MILL_PRODUCE);
			} else {
				playSndNoLoop(56);
			}
			...
			if (getLevel() >= cGame.var_734c[cGame.var_7304][cGame.var_736c]) {
				playSndNoLoop(61);
				switchToState(Define.GS_KITCHEN_PRODUCE);
				return;
			}
			playSndNoLoop(56);
		}
	...
	private static void sub_15cd3() {
		if (cGame.s_tutorialState == -1 && cGame.var_6c5c == 160) {
			switchToState(Define.GS_BUYSCR);
		}
	}
	...
	private static void sub_15d57(final int n) {
		if (getState() == Define.GS_MILL) {
			if (!cGame.var_75d4) {
				playSndNoLoop(61);
			} else if (cGame.s_tutorialState != 25) {
				playSndNoLoop(57);
			}
			if (cGame.s_tutorialState >= 28 && cGame.s_tutorialState <= 30 && !cGame.var_75d4) {
				return;
			}
			if (cGame.s_tutorialState == 25) {
				if (!cGame.var_75d4) {
	...
	private static void buyCurrentCashItem() {
		cGame.var_697c = 4;
		if (sub_16aba()) {
			cGame.s_toastType = 3 + cGame.s_iapCashIndex;
			switchToState(Define.GS_TOAST);
			return;
		}
		GLLib.PaySMS_SendRequest(cGame.s_iapCashIndices[cGame.s_iapCashIndex], "Cash");
	...
	private static void buyCashItem0() {
		...
		GLLib.PaySMS_SendRequest(cGame.s_iapCashIndices[0], "Cash");
		cGame.var_6944 = false;
		sub_1715b();
	}
	...
	private static void buyCashItem1() {
		...
		GLLib.PaySMS_SendRequest(cGame.s_iapCashIndices[1], "Cash");
		cGame.var_6944 = false;
		sub_1715b();
	}
	...
	private static void buyCashItem2() {
		...
		GLLib.PaySMS_SendRequest(cGame.s_iapCashIndices[2], "Cash");
		cGame.var_6944 = false;
		sub_1715b();
	}
	...
	private static void buyCashItem3() {
		...
		GLLib.PaySMS_SendRequest(cGame.s_iapCashIndices[3], "Cash");
		cGame.var_6944 = false;
		sub_1715b();
	}
	...
	private static void buyCashItem4() {
		...
		GLLib.PaySMS_SendRequest(cGame.s_iapCashIndices[4], "Cash");
		cGame.var_6944 = false;
		sub_1715b();
	}
	...
	private static void buyCashItem5() {
		...
		GLLib.PaySMS_SendRequest(cGame.s_iapCashIndices[5], "Cash");
		cGame.var_6944 = false;
		sub_1715b();
	}

	private static void switchToCoinIAP() {
		playSndNoLoop(61);
		if (!cGame.var_6934) {
			sub_1715b();
			sub_16bcb();
	...
	private static void switchToCashIAP() {
		playSndNoLoop(61);
		sub_17332();
		cGame.var_7d24 = true;
		if (GLLib.PaySMS_CanRedeemCode()) {
			sub_175b0();
			sub_16c4d();
	...
	private static void sub_161fb(final int n) {
		...
		String sub_4e1f2;
		String sub_4e1f3;
		sub_405b1(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_NOTIAP_NOTENOUGHCASH)) == null) ? "" : sub_4e1f,
				GLLib.Text_FindReplace(
						cGame.s_iapEnabled ? (((sub_4e1f2 = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCASH)) == null) ? "" : sub_4e1f2)
								: (((sub_4e1f3 = GLLib.Text_GetString(Define.TEXT_NOTIAP_NOTENOUGHCASHDESC)) == null) ? "" : sub_4e1f3),
						"%d", GLLib.Text_FormatNumber(cGame.var_7c6c[n] - getCash(), cGame.s_currencySeprType, " ")),
				7);
	}

	private static void sub_162f2() {
		if (spendCash(cGame.var_7c6c[0])) {
			addCoins(cGame.var_7cf4[0]);
			cGame.var_68cc[8][7] = GLLib.Text_FormatNumber(getCash(), cGame.s_currencySeprType, " ");
			cGame.var_68cc[8][4] = GLLib.Text_FormatNumber(getCoins(), cGame.s_currencySeprType, " ");
			playSndNoLoop(49);
			return;
		}
		playSndNoLoop(56);
	...
	private static void sub_1638f() {
		if (spendCash(cGame.var_7c6c[1])) {
			addCoins(cGame.var_7cf4[1]);
			cGame.var_68cc[8][7] = GLLib.Text_FormatNumber(getCash(), cGame.s_currencySeprType, " ");
			cGame.var_68cc[8][4] = GLLib.Text_FormatNumber(getCoins(), cGame.s_currencySeprType, " ");
			return;
		}
	...
	private static void sub_16427() {
		if (spendCash(cGame.var_7c6c[2])) {
			addCoins(cGame.var_7cf4[2]);
			cGame.var_68cc[8][7] = GLLib.Text_FormatNumber(getCash(), cGame.s_currencySeprType, " ");
			cGame.var_68cc[8][4] = GLLib.Text_FormatNumber(getCoins(), cGame.s_currencySeprType, " ");
			return;
		}
	...
	private static void sub_164bf() {
		if (spendCash(cGame.var_7c6c[3])) {
			addCoins(cGame.var_7cf4[3]);
			cGame.var_68cc[8][7] = GLLib.Text_FormatNumber(getCash(), cGame.s_currencySeprType, " ");
			cGame.var_68cc[8][4] = GLLib.Text_FormatNumber(getCoins(), cGame.s_currencySeprType, " ");
			return;
		}
	...
	private static void sub_16557() {
		if (spendCash(cGame.var_7c6c[4])) {
			addCoins(cGame.var_7cf4[4]);
			cGame.var_68cc[8][7] = GLLib.Text_FormatNumber(getCash(), cGame.s_currencySeprType, " ");
			cGame.var_68cc[8][4] = GLLib.Text_FormatNumber(getCoins(), cGame.s_currencySeprType, " ");
			return;
		}
	...
	private static void sub_165ef() {
		if (spendCash(cGame.var_7c6c[5])) {
			addCoins(cGame.var_7cf4[5]);
			cGame.var_68cc[8][7] = GLLib.Text_FormatNumber(getCash(), cGame.s_currencySeprType, " ");
			cGame.var_68cc[8][4] = GLLib.Text_FormatNumber(getCoins(), cGame.s_currencySeprType, " ");
			return;
		}
	...
	private static void sub_16834() {
		...
		if (GLLib.PaySMS_VerifyRequest(n)) {
			GLLib.PaySMS_GetPackageID();
			addCash((int) GLLib.PaySMS_GetVirtualCurrency(200L));
	...
	private static void sub_16b22() {
		if (cGame.s_iapTermsConditions == null || cGame.s_iapTermsConditions.equals("")) {
			sub_16aec();
			return;
		}
		...
		final String sub_4e1f;
		cGame.var_68cc[8][205] = (((sub_4e1f = GLLib.Text_GetString(cGame.var_6924 ? Define.TEXT_OK : Define.TEXT_IAP_TERMSCONDS)) == null) ? ""
				: sub_4e1f);
	}
	...
	private static void sub_16bcb() {
		if (cGame.var_6924) {
			sub_16b22();
			final String sub_4e1f;
			cGame.var_68cc[8][205] = (((sub_4e1f = GLLib.Text_GetString(Define.TEXT_IAP_TERMSCONDS)) == null) ? "" : sub_4e1f);
		...
		if (!cGame.var_692c) {
			...
			if (cGame.var_7cd4) {
				...
				if (n == 0 && (cGame.var_7cac == 10 || cGame.var_7cac == 6)) {
					...
					int n2 = 0;
					for (int sub_7988 = GLLib.PaySMS_GetCurrencyAmount("Cash"), j = 0; j < sub_7988; ++j) {
						final int sub_79a7;
						if ((sub_79a7 = GLLib.PaySMS_GetPricePoint(j, "Cash")) != -1) {
	...
	private static void sub_17b24() {
		...
		if (cGame.s_iapTermsConditions != null && !cGame.s_iapTermsConditions.equals("")) {
			...
			if (!cGame.var_6924) {
				sub_16b22();
				final String sub_4e1f;
				cGame.var_68cc[8][205] = (((sub_4e1f = GLLib.Text_GetString(Define.TEXT_OK)) == null) ? "" : sub_4e1f);
	...
	private static void sub_17c09() {
		...
		if (cGame.var_6e24[0 + cGame.s_mailbox_scrollLevel][4] != -1) {
			sub_41a13(0);
		}
	}
	...
	private static void sub_17c52() {
		...
		if (cGame.var_6e24[1 + cGame.s_mailbox_scrollLevel][4] != -1) {
			sub_41a13(1);
		}
	}
	...
	private static void sub_17c9b() {
		...
		if (cGame.var_6e24[2 + cGame.s_mailbox_scrollLevel][4] != -1) {
			sub_41a13(2);
		}
	}
	...
	private static void sub_17ce4() {
		...
		if (cGame.var_6e24[3 + cGame.s_mailbox_scrollLevel][4] != -1) {
			sub_41a13(3);
		}
	}
	...
	private static void sub_17d2d() {
		...
		if (cGame.var_6e24[4 + cGame.s_mailbox_scrollLevel][4] != -1) {
			sub_41a13(4);
		}
	}
	...
	private static void sub_17d76() {
		...
		if (cGame.var_6e24[0 + cGame.s_mailbox_scrollLevel][3] != -1) {
			sub_41938(0);
		}
	}
	...
	private static void sub_17dbf() {
		...
		if (cGame.var_6e24[1 + cGame.s_mailbox_scrollLevel][3] != -1) {
			sub_41938(1);
		}
	}
	...
	private static void sub_17e08() {
		...
		if (cGame.var_6e24[2 + cGame.s_mailbox_scrollLevel][3] != -1) {
			sub_41938(2);
		}
	}
	...
	private static void sub_17e51() {
		...
		if (cGame.var_6e24[3 + cGame.s_mailbox_scrollLevel][3] != -1) {
			sub_41938(3);
		}
	}
	...
	private static void sub_17e9a() {
		...
		if (cGame.var_6e24[4 + cGame.s_mailbox_scrollLevel][3] != -1) {
			sub_41938(4);
		}
	}
	...
	private static void sub_17fc1(final boolean b) {
		if (!cGame.var_698c || b) {
			...
			cGame.var_698c = true;
			int n = 0;
			for (int i = 0; i < cGame.s_mailbox_neighborCnt; ++i) {
				if (n < 5) {
	...
	private static void sub_182ed() {
		if (System.currentTimeMillis() / 1000L - cGame.var_6e34[cGame.var_7bb4][4] >= 86400L) {
			playSndNoLoop(61);
			switchToState(Define.GS_MAIL_SEND);
			return;
		}
		playSndNoLoop(56);
	}
	...
	private static void sub_1833e() {
		...
		cActor.setZoomLevel(100);
		cGame.var_705c = sub_2df26();
		cGame.var_8084 = cGame.var_7bb4 + 1;
		sub_49db0(GameDatas.s_allDatas[8].m_dataVars[cGame.var_7bb4][1], 1, 23, false);
		sub_3e7c1();
		sub_3d6da(false, -1);
		playSndNoLoop(61);
		doSave(false);
		sub_8281(Define.GS_FARM_NEIGHBOR);
	}

	private static void sub_183b6() {
		if (System.currentTimeMillis() / 1000L - cGame.var_6e34[cGame.var_7bb4][1] >= 86400L) {
			playSndNoLoop(61);
			switchToState(Define.GS_MAIL_REQUEST);
			return;
		}
		playSndNoLoop(56);
	}
	...
	private static void sub_18407() {
		...
		if (cGame.var_7be4 > 0) {
			final String sub_4e1f;
			cGame.var_7ab4 = GLLib.Text_FindReplace(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCASH)) == null) ? "" : sub_4e1f, "%d",
					GLLib.Text_FormatNumber(cGame.var_7be4 - getCash(), cGame.s_currencySeprType, " "));
			cGame.var_7aac = 19;
			cGame.var_815c = true;
			cGame.var_7d24 = true;
			switchToState(Define.GS_BUYSCR);
	...
	private static void sub_184a9() {
		...
		if (cGame.var_7bfc > 0) {
			final String sub_4e1f;
			cGame.var_7ab4 = GLLib.Text_FindReplace(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCASH)) == null) ? "" : sub_4e1f, "%d",
					GLLib.Text_FormatNumber(cGame.var_7bfc - getCash(), cGame.s_currencySeprType, " "));
			cGame.var_7aac = 19;
			cGame.var_815c = true;
			cGame.var_7d24 = true;
			switchToState(Define.GS_BUYSCR);
	...
	private static void sub_18574() {
		...
		if (cGame.var_7bdc >= cGame.var_6e2c[cGame.var_7bb4][2]
			...
			final GameDatas class_h = GameDatas.s_allDatas[24];
			final GameDatas class_h2 = GameDatas.s_allDatas[1];
			...
			sub_2b10b(cGame.var_7bb4,
					(class_h2.m_dataVars[cGame.var_6e2c[cGame.var_7bb4][2] + cGame.var_6e2c[cGame.var_7bb4][1]][11]
							* n2
							+ class_h2.m_dataVars[cGame.var_6e2c[cGame.var_7bb4][5]
									+ cGame.var_6e2c[cGame.var_7bb4][4]][11] * n3)
							/ (n2 + n3) * class_h.m_dataVars[n][6] / getLevel());
			sub_42685(0);
			sub_42685(1);
			addExperience(cGame.var_7bc4);
			addCoins(cGame.var_7bcc);
			sub_2b022(cGame.var_7bb4);
			sub_41ff0();
			drawPopupToastWithSpr(Define.TEXT_MAILBOX_THANKBASE + cGame.var_7bb4, cGame.var_68bc[17][22][5], cGame.var_68bc[17][22][6]);
		}
	}

	private static void exitBarn() {
		playSndNoLoop(57);
		cGame.s_switcherState = 1;
		sub_2c69b();
	}

	private static void barnMoreButton() {
		switch (getState()) {
		case Define.GS_BARN: {
			playSndNoLoop(61);
			onMarketButton(3, 2, cGame.var_775c = true);
			break;
		}
		}
	}

	private static void switchToItemsTab() {
		switch (getState()) {
		case Define.GS_BARN: {
	...
	private static void switchToAnimalsTab() {
		switch (getState()) {
		case Define.GS_BARN: {
			sub_38251(new int[] { 3 });
			playSndNoLoop(61);
	...
	private static void switchToBuildingsTab() {
		switch (getState()) {
		case Define.GS_BARN: {
	...
	private static void sub_18b71() {
		loadMap();
		sub_29f90();
		final cActor[] array = new cActor[100];
		final int sub_5830 = cActor.sub_5830(0, 54, cGame.var_6d74, cGame.var_6d84, cGame.var_6d7c,
				cGame.var_6d8c, array, 100);
		int n = 0;
		for (int i = 0; i < sub_5830; ++i) {
			n += array[i].var_182d;
		}
		final int sub_5ad9 = cActor.sub_5ad9(0, 54);
		...
		sub_29f90();
		final int sub_5831 = cActor.sub_5830(0, 52, cGame.var_6d74, cGame.var_6d84, cGame.var_6d7c,
				cGame.var_6d8c, new cActor[100], 100);
		final int sub_4cf5 = cActor.sub_4cf5(0, 52);
		...
		if (!spendCoins((int) decryptLong(cGame.var_6d94))) {
			playSndNoLoop(56);
			cGame.var_6e1c = decryptLong(cGame.var_6d94);
			final String sub_4e1f;
			cGame.var_7ab4 = GLLib.Text_FindReplace(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCOIN)) == null) ? "" : sub_4e1f, "%d",
					GLLib.Text_FormatNumber(cGame.var_6e1c - getCoins(), cGame.s_currencySeprType, " "));
			cGame.var_7aac = 18;
			cGame.var_815c = true;
			cGame.var_7d24 = false;
			switchToState(Define.GS_BUYSCR);
		...
		array4[0] = array2[0] * cGame.s_zoomLevel / 100 - GLLibPlayer.Tileset_GetCameraX(0);
		array4[1] = array2[1] * cGame.s_zoomLevel / 100 - GLLibPlayer.Tileset_GetCameraY(0);
	...
	private static void sub_18e88() {
		if (!spendCash(decryptInt(cGame.var_6dc4))) {
			playSndNoLoop(56);
			cGame.var_6e1c = decryptInt(cGame.var_6dc4);
			final String sub_4e1f;
			cGame.var_7ab4 = GLLib.Text_FindReplace(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCASH)) == null) ? "" : sub_4e1f, "%d",
					GLLib.Text_FormatNumber(cGame.var_6e1c - getCash(), cGame.s_currencySeprType, " "));
			cGame.var_7aac = 19;
			cGame.var_815c = true;
			cGame.var_7d24 = true;
			switchToState(Define.GS_BUYSCR);
	...
	private static void sub_18f39() {
		if (!spendCash(decryptInt(cGame.var_6dcc))) {
			playSndNoLoop(56);
	...
	private static void sub_19074(int sub_3a3b8) {
		...
		for (char c = '\0'; c < cGame.var_7f74; ++c) {
			if (cGame.var_7e54[c] == sub_3a3b8) {
				...
				cGame.s_currentQuest = c;
				sub_48d55();
				cGame.s_popup_onCloseState = Define.GS_FARMDIARY;
				return;
			}
		}
	}
	...
	private static void sub_19104() {
		cGame.var_77ec = 0;
		if (cGame.s_manor_restoreLevel < 1) {
			if (sub_1903d(cGame.s_manor_restoreLevel)) {
				if (cGame.s_manor_restoreScrState == 3) {
					switchToState(Define.GS_MANOR_RESTORE);
				} else {
					switchToState(Define.GS_MANOR_RESTORE);
				...
				sub_19074(cGame.s_manor_restoreLevel);
			}
		} else {
			switchToState(Define.GS_KITCHEN);
		}
		playSndNoLoop(61);
	}
	...
	private static void sub_191a3() {
		cGame.var_77ec = 1;
		if (cGame.s_manor_restoreLevel < 2) {
			sub_193c3();
		} else {
			cGame.var_7a2c = 0;
			switchToState(Define.GS_MANOR_COLLECTIONS);
		}
		playSndNoLoop(61);
	}
	...
	private static void sub_191f1() {
		...
		if (cGame.s_manor_restoreLevel < 3) {
			...
			switchToState(Define.GS_MANOR_TROPHIES);
		}
		playSndNoLoop(61);
	}

	private static void sub_1924e() {
		if (cGame.s_manor_restoreLevel < 4) {
			cGame.var_77ec = 3;
			sub_193c3();
			return;
		}
	...
	private static void sub_1928b() {
		if (cGame.s_manor_restoreLevel < 5) {
			cGame.var_77ec = 4;
			sub_193c3();
			return;
		}
	...
	private static void sub_192c8() {
		if (cGame.s_manor_restoreLevel < 6) {
			cGame.var_77ec = 5;
			sub_193c3();
			return;
		}
	...
	private static void sub_19306() {
		if (cGame.s_manor_restoreLevel < 7) {
			cGame.var_77ec = 6;
			sub_193c3();
			return;
		}
	...
	private static void sub_19345() {
		if (cGame.s_manor_restoreLevel < 8) {
			cGame.var_77ec = 7;
			sub_193c3();
			return;
		}
	...
	private static void sub_1940b() {
		...
		cActor.newActor(47, 2, new int[] { 0, 0, 14 }).sub_8c4c(620, 365, 37, 1000, false, 1);
		playSndNoLoop(61);
	}

	private static void sub_19473() {
		if (sub_3a230(cGame.var_77ec)) {
			if (spendCoins(cGame.var_77e4)) {
				playSndNoLoop(49);
				sub_3a73b((short) 2);
				if (cGame.var_77bc == 0L) {
					final GameDatas class_h = GameDatas.s_allDatas[3];
					final int sub_df89 = sub_df89(cGame.s_manor_restoreLevel + 1);
					cGame.var_77fc = class_h.m_dataVars[sub_df89][21] * 60;
					cGame.var_7824 = class_h.m_dataVars[sub_df89][22];
			...
			if (cGame.var_77e4 > 0) {
				final String sub_4e1f;
				cGame.var_7ab4 = GLLib.Text_FindReplace(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCOIN)) == null) ? "" : sub_4e1f, "%d",
						GLLib.Text_FormatNumber(cGame.var_77e4 - getCoins(), cGame.s_currencySeprType, " "));
				cGame.var_7aac = 18;
				cGame.var_7d24 = false;
				cGame.var_815c = true;
				switchToState(Define.GS_BUYSCR);
	...
	private static void sub_195ec() {
		...
		if (cGame.var_780c > 0) {
			final String sub_4e1f;
			cGame.var_7ab4 = GLLib.Text_FindReplace(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCASH)) == null) ? "" : sub_4e1f, "%d",
					GLLib.Text_FormatNumber(cGame.var_780c - getCash(), cGame.s_currencySeprType, " "));
			cGame.var_7aac = 19;
			cGame.var_7d24 = true;
			cGame.var_815c = true;
			switchToState(Define.GS_BUYSCR);
	...
	private static void openSupportURL() {
		playClickSndAndWait();
		try {
			GLLib.OpenBrowser(GLLib.PaySMS_GetFullSupportUrl());
		} catch (final Exception ex) {
		}
	}
	...
	private static void drawPauseCreds() {
		...
		if (!cGame.s_displayPauseCreds) {
			...
			final short[] sub_4ac6 = cGame.var_7ffc[sanitizeTextSprIdx(n2)].WraptextB(cGame.var_79d4, n, false);
			final ASprite class_e = cGame.var_7ffc[sanitizeTextSprIdx(n2)];
			final short n3 = sub_4ac6[0];
			final ASprite class_e2 = class_e;
			cGame.var_79dc = (cGame.var_79b4 = n3 * class_e2.GetLineHeight() + (n3 - 1) * class_e2.GetLineSpacing()) / 2;
	...
	private static void openPrivacyNoticeURL() {
		...
		playClickSndAndWait();
		try {
			GLLib.OpenBrowser("http://www.gameloft.com/privacy-notice/");
		} catch (final Exception ex) {
		}
	}
	...
	private static void showPauseSndOpts() {
		...
		if (!cGame.s_displayPauseSndOpt) {
			sub_2000c(15, 46, cGame.s_displayPauseSndOpt = true);
	...
	private static void sub_1a62a() {
		if (sndPlayingOnChannel(0) && GLLibPlayer.Snd_GetCurrentSoundIndex() == 0) {
			sub_23d73();
		}
		playSndNoLoop(57);
		hidePauseOpts();
	...
	private static void debugAdd100000Coins() {
		playSndNoLoop(61);
		addCoins(100000);
	}

	private static void debugAdd1000000Coins() {
		playSndNoLoop(61);
		addCoins(1000000);
	}
	...
	private static void closeDebugMenu() {
		playSndNoLoop(57);
		hideDebugMenu();
		showPauseMenu();
	}

	private static void debugLevel50() {
		playSndNoLoop(61);
		setLevel(49);
		onLevelUp();
	}

	private static void debugLevelUp() {
		playSndNoLoop(61);
		onLevelUp();
	}
	...
	private static void sub_1ad8d() {
		...
		for (int i = cGame.var_7f74 - '\u0001'; i >= 0; --i) {
			if (cGame.var_7e4c[i] >= 0) {
				sub_4ab1c(cGame.s_currentQuest = i, true);
				sub_4a6a7(i);
			}
		}
	...
	private static String sub_1b386(final int n) {
		...
		if (n >= 0 && n < 297 && cGame.var_80fc[n] != -1) {
			final String sub_4e1f;
			s = (((sub_4e1f = GLLib.Text_GetString(cGame.var_80fc[n])) == null) ? "" : sub_4e1f);
		}
		return s;
	}
	...
	private static void showPauseMenu() {
		if (!cGame.s_displayBasePauseMnu) {
			...
			if ((supportUrl = GloftGF2M.s_instance.getAppProperty("URL-SUPPORT")) != null
					&& supportUrl.indexOf("http") != -1) {
				sub_2000c(15, 2, true);
				sub_2024d(15, 2, true);
				final String sub_4e1f;
				cGame.var_68cc[15][3] = (((sub_4e1f = GLLib.Text_GetString(Define.TEXT_PAUSE_CUSTOMERCARE)) == null) ? "" : sub_4e1f);
				sub_2000c(15, 3, true);
			}
			sub_2000c(15, 4, true);
			sub_2024d(15, 4, true);
			...
			if (IGP.IsAvailable()) {
				...
				final String sub_4e1f2;
				cGame.var_68cc[15][149] = (((sub_4e1f2 = GLLib.Text_GetString(Define.TEXT_PAUSE_IGP)) == null) ? "" : sub_4e1f2);
			}
			...
			sub_2c69b();
			sub_1fb8e(15);
			cGame.s_displayBasePauseMnu = true;
			if (sndPlayingOnChannel(0) && GLLibPlayer.Snd_GetCurrentSoundIndex() == 13) {
				sub_23d73();
			}
		}
	...
	private static void hidePauseMenu() {
		if (cGame.s_displayBasePauseMnu) {
			...
			cGame.s_displayBasePauseMnu = false;
		}
	}
	...
	private static void hidePauseCreds() {
		if (cGame.s_displayPauseCreds) {
			...
			cGame.s_displayPauseCreds = false;
		}
	}
	...
	private static void showPauseOpts() {
		if (!cGame.s_displayPauseOpts) {
			...
			sub_2c69b();
			sub_1fb8e(15);
			cGame.s_displayPauseOpts = true;
		}
	}

	private static void hidePauseOpts() {
		if (cGame.s_displayPauseOpts) {
			...
			cGame.s_displayPauseOpts = false;
		}
	}
	...
	private static void hideDebugMenu() {
		if (cGame.s_displayDebugInfo) {
			...
			cGame.s_displayDebugInfo = false;
		}
	}
	...
	private static void sub_1bccc() {
		playSndNoLoop(61);
		if (cGame.s_game_states[cGame.s_game_state] == Define.GS_POND) {
			sub_47802();
		}
	}
	...
	private static void sub_1c1d0() {
		if (spendCash(cGame.s_pond_highRodCashCost)) {
			playSndNoLoop(49);
			if (sub_479c7(2)) {
				sub_49db0(1, 1, 3, false);
			}
		...
		playSndNoLoop(56);
		if (cGame.s_pond_highRodCashCost > 0) {
			final String sub_4e1f;
			cGame.var_7ab4 = GLLib.Text_FindReplace(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCASH)) == null) ? "" : sub_4e1f, "%d",
					GLLib.Text_FormatNumber(cGame.s_pond_highRodCashCost - getCash(), cGame.s_currencySeprType, " "));
			cGame.var_7aac = 19;
			cGame.var_7d24 = true;
			switchToState(Define.GS_BUYSCR);
			cGame.var_815c = true;
	...
	private static void sub_1c288() {
		if (spendCash(cGame.s_pond_lowRodCashCost)) {
			playSndNoLoop(49);
			if (sub_479c7(1)) {
				sub_49db0(1, 1, 3, false);
			}
		...
		playSndNoLoop(56);
		if (cGame.s_pond_lowRodCashCost > 0) {
			final String sub_4e1f;
			cGame.var_7ab4 = GLLib.Text_FindReplace(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCASH)) == null) ? "" : sub_4e1f, "%d",
					GLLib.Text_FormatNumber(cGame.s_pond_lowRodCashCost - getCash(), cGame.s_currencySeprType, " "));
			cGame.var_7aac = 19;
			cGame.var_7d24 = true;
			switchToState(Define.GS_BUYSCR);
			cGame.var_815c = true;
	...
	private static void sub_1c7ce(int i) {
		...
		case Define.GS_POND: {
			cGame.s_pond_bubblePlayers = new GLLibPlayer[7];
			for (i = 0; i < 7; ++i) {
				cGame.s_pond_bubblePlayers[i] = new GLLibPlayer(cGame.var_68d4[32], 0, 0);
			}
			break;
		}
		}
	...
	private static void sub_1cd44(int i) {
		...
		case Define.GS_POND: {
			for (i = 0; i < 7; ++i) {
				cGame.s_pond_bubblePlayers[i] = null;
			}
			i = 65535;
			sub_d500(1, 7, i, 1, 0, 0, -1);
			i = 65535;
		...
		for (int i = 0; i < cGame.var_68bc[n].length; ++i) {
			...
			if (cGame.var_68bc[n][n2] != null) {
					...
					if ((array4 = array2)[11] != 0) {
						...
						if (n12 != 0) {
							if (n12 == 255) {
								...
								GLLib.AlphaRect_SetColor(color);
								GLLib.AlphaRect_Draw(GLLib.g, n8, n9, n10, n11);
							}
						}
					}
				}
				case 204: {
					...
					if (array2[17] == 1) {
						drawString(cGame.var_68cc[n][n3], n, n3, 0, 0);
						break;
					}
	...
	private static void sub_1df06(String s, int var_1de7, int n, int n2, int n3) {
		...
		n2 = array[14];
		if (array[15] == 1) {
			final short n4 = array[9];
			boolean b = false;
			final short n5;
			if ((n5 = array[16]) >= 0 && n5 < 10 && cGame.var_6914[n5] != null
	...
	static void drawStringWithPalette(final String s, int palette, final int x, final int y, int n3, int n4, int n5,
		...
		int strX = 0;
		int strY = 0;
		sub_237ff = sanitizeTextSprIdx(sub_237ff);
		switch (n4) {
		case 0: {
			anchor = 16;
			strY = x;
		...
		if (b) {
			...
			cGame.var_689c[2][sub_237ff].DrawPageB(GLLib.g, s, cGame.var_689c[2][sub_237ff].WraptextB(s, y, false), strX, strY, 0, -1, anchor, -1, false);
			return;
		}
		cGame.var_689c[2][sub_237ff].DrawString(GLLib.g, s, strX, strY, anchor);
		cGame.var_689c[2][sub_237ff].SetCurrentPalette(palette);
	}

	private static void drawString(String s, int var_1de7, int n, int n2, int n3) {
		final short[] array = cGame.var_68bc[var_1de7][n];
		n2 = n3;
		final short[] array2 = array;
		if (array[15] == 1) {
			...
			n = 0;
			short n4 = array[16];
			if (n4 >= 0 && n4 < 10 && cGame.var_6914[n4] != null
			...
			drawStringWithPalette(s, array2[2], array2[3] + n2, array2[5], array2[6], array2[10], n3, array2[7], array2[8], true,
					false);
			if (n != 0) {
				var_1de7 = GLLib.s_screenHeight;
				GLLib.SetClip(GLLib.g, 0, 0, GLLib.s_screenWidth, var_1de7, true);
	...
	private static void sub_1e477(int sub_3189, final short[] array, int n, int n2, int max) {
		...
		if (n < 0) {
			...
			if (n3 == 32) {
				if (n5 == 3) {
					cGame.s_pond_bubblePlayers[0].SetPos(array[2], array[3]);
				} else if (n5 == 4) {
					cGame.s_pond_bubblePlayers[1].SetPos(array[2], array[3]);
				} else if (n5 == 5) {
					cGame.s_pond_bubblePlayers[2].SetPos(array[2], array[3]);
				}
			} else {
				cGame.var_68ec[n].SetPos(array[2], array[3]);
				cGame.var_68ec[n].Render();
			}
		}
		if (b2) {
		...
		if (b) {
			...
			n = var_1de7;
			GLLib.SetClip(var_1daf2, 0, 0, n18, n, true);
		}
	}
	...
	private static int sub_1ed28(final int n, final int n2) {
		...
		final int sub_6494 = class_e.GetFrameModulesCount(n2);
	...
	private static void sub_1edd0(short[] array, final int n, final int n2, final int zoom) {
		...
		if (cGame.var_68dc[n5] == null) {
			...
			final int sub_6494 = class_e.GetFrameModulesCount(n7);
			...
			for (short n17 = 0; n17 < n16; ++n17) {
				...
				final int sub_332f = class_e.GetFrameModuleFlags(n7, n17);
			...
			for (short n21 = (short) n16; n21 < sub_6494; ++n21) {
				...
				final int sub_332f2 = class_e.GetFrameModuleFlags(n7, n21);
				int n24;
				if (n22 == 1) {
					if (sub_30ea3 < n8 >> 1) {
						n24 = n8 - (sub_30ea3 << 1);
			...
			cGame.var_68dc[n7] = ImageG.createRGBImage(array2, n14, n15, true);
		}
		if (cGame.var_68dc[n5] != null) {
	...
	private static void sub_1f7a3(int n, int n2, int sub_30ea, final int n3) {
		...
		final int sub_6494 = class_e.GetFrameModulesCount(sub_30ea);
		final short n6 = class_e._frames_fm_start[n2];
		final int sub_6495 = class_e.GetFrameModulesCount(n2);
		...
		if (sub_6495 >= 2) {
			class_e.SetFModuleOX(n6 + sub_6495 - 2, n4 * n3 / 100);
		}
				...
				if (cGame.var_6914[n5] == null) {
					...
					if (sub_20167(n, k)) {
						...
						if (cGame.var_68bc[n][k][0] == 205) {
							...
							sub_31e6 = class_e.GetFrameMinX(n7);
							sub_3238 = class_e.GetFrameMinY(n7);
	...
	// Groups
	private final static int ACTGROUP_INVALID = 0;
	private final static int ACTGROUP_FARM = 1;

	private final static int ACT_FARM_QUESTBAR = 65580;
	private final static int ACT_FARM_QUEST0 = 65575;
	private final static int ACT_FARM_QUEST1 = 65586;
	private final static int ACT_FARM_QUEST2 = 65587;
	private final static int ACT_FARM_QUEST3 = 65588;
	private final static int ACT_FARM_MARKET = 65595;
	private final static int ACT_FARM_ZOOM = 65594;
	private final static int ACT_FARM_PAUSE = 65573;
	private final static int ACT_FARM_MAILBOX = 65596;
	
	private static void dispatchAction(int actionId) {
		Label_7332: {
			switch (actionId >> 16 & 0xFFFF) {
			case ACTGROUP_INVALID: {
				return;
			}
			case ACTGROUP_FARM: {
				switch (actionId) {
				case ACT_FARM_QUESTBAR: {
					if (cGame.s_tutorialState != 13) {
						...
						if (cGame.s_tutorialState != 11 || !sub_20167(1, 38)) {
							...
							sub_26a6a(false, cGame.s_currentQuest, '\0');
						}
					}
					return;
				}
				case ACT_FARM_QUEST0: {
					...
					if (cGame.s_questStates[cGame.s_currentQuest] == 1) {
						...
						playSndNoLoop(60);
						switchToState(Define.GS_FARMDIARY);
					}
					sub_10947(false);
					return;
				}
				case ACT_FARM_QUEST1: {
				...
				case ACT_FARM_MARKET: {
					playSndNoLoop(60);
					onMarketButton(2, 0, true);
					...
					if (!sub_2cad2(cGame.var_6aac)) {
						if (cGame.var_6aa4 == 0) {
							...
							case 49: {
								...
								if (cGame.var_708c > 0) {
									final String sub_4e1f;
									cGame.var_7ab4 = GLLib.Text_FindReplace(
											((sub_4e1f = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCOIN)) == null) ? "" : sub_4e1f, "%d",
											GLLib.Text_FormatNumber(cGame.var_708c - getCoins(), cGame.s_currencySeprType, " "));
									cGame.var_7aac = 18;
									cGame.var_7d24 = false;
									cGame.var_815c = true;
									...
									final String sub_4e1f2;
									cGame.var_7ab4 = GLLib.Text_FindReplace(
											((sub_4e1f2 = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCASH)) == null) ? "" : sub_4e1f2, "%d",
											GLLib.Text_FormatNumber(cGame.var_7094 - getCash(), cGame.s_currencySeprType, " "));
									cGame.var_7aac = 19;
									cGame.var_7d24 = true;
									cGame.var_815c = true;
								}
							...
							case 20: {
								...
								if (cGame.var_708c > 0) {
									final String sub_4e1f3;
									cGame.var_7ab4 = GLLib.Text_FindReplace(
											((sub_4e1f3 = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCOIN)) == null) ? "" : sub_4e1f3, "%d",
											GLLib.Text_FormatNumber(cGame.var_708c - getCoins(), cGame.s_currencySeprType, " "));
									cGame.var_7aac = 18;
									cGame.var_7d24 = false;
									cGame.var_815c = true;
									...
									final String sub_4e1f4;
									cGame.var_7ab4 = GLLib.Text_FindReplace(
											((sub_4e1f4 = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCASH)) == null) ? "" : sub_4e1f4, "%d",
											GLLib.Text_FormatNumber(cGame.var_7094 - getCash(), cGame.s_currencySeprType, " "));
									cGame.var_7aac = 19;
									cGame.var_7d24 = true;
									cGame.var_815c = true;
				...
				case 65539: {
					if (cGame.var_8034 != null) {
						...
						case 52:
						case 54: {
							actionId = cGame.var_8034.prepareTime;
							break;
						}
						}
						if (!spendCash(actionId)) {
							playSndNoLoop(56);
							if (actionId > 0) {
								final String sub_4e1f5;
								cGame.var_7ab4 = GLLib.Text_FindReplace(
										((sub_4e1f5 = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCASH)) == null) ? "" : sub_4e1f5, "%d",
										GLLib.Text_FormatNumber(actionId - getCash(), cGame.s_currencySeprType, " "));
								cGame.var_7aac = 19;
								cGame.var_7d24 = true;
								cGame.var_815c = true;
								switchToState(Define.GS_BUYSCR);
				...
				case 65610: {
					...
					if (cGame.var_6aac.actorID == 0 && actionId <= cGame.var_8064[22]) {
						...
						cGame.s_popup_subtext = GLLib.Text_FormatNumber(cGame.var_7b14.getSellPrice(), cGame.s_currencySeprType, " ");
						sub_2000c(4, 13, true);
						sub_2000c(4, 15, true);
						sub_2000c(4, 16, true);
				...
				case 65611: {
					...
					actionId = cGame.var_6aac.var_18c5;
					sub_2ddd7(cGame.var_6aac);
					if (actionId < cGame.var_80a4[0] || actionId > cGame.var_80a4[63] || actionId % 2 == 1) {
						sub_2c0fa(true);
						sub_4ad3f(actionId);
					}
					sub_1179d(false);
	...
	// Better version of this method below:
	/*
		private static int sanitizeTextSprIdx(final int indexOld) {
			return indexOld <= 4 ? indexOld : 0;
		}
	*/
	private static int sanitizeTextSprIdx(final int indexOld) {
		if (indexOld == 1) {
	...
	static void playSndNoLoop(final int snd) {
		if (!cGame.var_69ec) {
			return;
		}
		playSound(cGame.var_6a3c[snd][0], snd, false);
	}

	private static void playSnd(final int snd, final boolean loop) {
		if (!cGame.var_69f4) {
			return;
		}
		...
		if (!cGame.var_6a9c && cGame.var_69fc) {
			...
			if (n4 > 10000L && n4 < 20000L) {
				...
				if (GLLib.Math_Rand(0, 100) < 80 && currentTimeMillis - cGame.var_6a8c > 5000L) {
					...
					playSndNoLoop(sub_2b98);
					cGame.var_6a8c = currentTimeMillis;
				}
				final int sub_2abc = GLLibPlayer.Snd_GetCurrentSoundIndex();
	...
	private static void playClickSndAndWait() {
		playSndNoLoop(61);
		try {
			Thread.sleep(1000);
	...
	private static boolean sub_240db() {
			...
			Label_0807: {
				if (GLLib.s_pointerX >= cGame.var_6acc - 20 && GLLib.s_pointerX <= cGame.var_6acc + 20
					...
					if (cGame.var_6abc && cGame.var_6aac != null && cGame.var_6aec) {
							...
							case 49: {
								...
								if (cGame.var_6aac.actorID == 0) {
									...
									if (cGame.var_6b24 > 0) {
										...
										cGame.var_7ab4 = GLLib.Text_FindReplace(
												((sub_4e1f3 = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCOIN)) == null) ? "" : sub_4e1f3, "%d",
												GLLib.Text_FormatNumber(cGame.var_6b24 - getCoins(), cGame.s_currencySeprType,
														" "));
										cGame.var_7aac = 18;
										cGame.var_7d24 = false;
										cGame.var_815c = true;
									...
									if (cGame.var_6b2c > 0) {
										...
										cGame.var_7ab4 = GLLib.Text_FindReplace(
												((sub_4e1f4 = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCASH)) == null) ? "" : sub_4e1f4, "%d",
												GLLib.Text_FormatNumber(cGame.var_6b2c - getCash(), cGame.s_currencySeprType,
														" "));
										cGame.var_7aac = 19;
										cGame.var_7d24 = true;
										cGame.var_815c = true;
						...
						final cActor sub_4f59;
						if ((sub_4f59 = cActor.sub_4f59()) != null) {
		...
		if (!b || cGame.s_tutorialState == 15 || cGame.s_tutorialState == 51) {
			return false;
		}
		final int[] array = new int[2];
		final int[] array2;
		...
		if (cGame.var_6aac != null) {
			sub_2c8b0(array2, array);
			cGame.var_6aac.cameraX = array[0];
			cGame.var_6aac.cameraY = array[1];
		}
		return true;
	}

	private static void sub_245ce(final cActor var_6aac, final boolean b) {
		cGame.var_6ab4 = null;
		if (var_6aac != null && cGame.var_807c == 0 && var_6aac.sub_a2a0(1)) {
			sub_251a0(-1);
			sub_11320(false, null);
			if (var_6aac.var_17c5 == 50 && var_6aac.actorID < 9) {
				sub_10cd1(true);
				cGame.var_6aa4 = -1;
				cGame.var_802c = null;
				return;
			...
			if (cGame.var_6aac != null) {
				...
				if (cGame.var_6b5c == null) {
					(cGame.var_6b5c = new GLLibPlayer(cGame.s_gameSprites[3], cGame.var_6aac.cameraX,
							cGame.var_6aac.cameraY)).SetAnim(2, -1);
				} else {
					cGame.var_6b5c.SetPos(cGame.var_6aac.cameraX, cGame.var_6aac.cameraY);
				}
			} else {
				cGame.var_6b5c = null;
			}
			cGame.var_8074 = true;
			cGame.var_6adc = cGame.var_6aac.cameraX;
			cGame.var_6ae4 = cGame.var_6aac.cameraY;
			if (cGame.var_6aac.var_17c5 == 54) {
				...
				if (cGame.var_6aac.sub_a2a0(32)) {
					if (cGame.var_6aa4 == 0) {
						...
						cGame.var_6aac.var_163d = GameDatas.s_allDatas[0].m_dataVars[cGame.var_6aac.actorID][13] * 60;
						cGame.var_6aac.var_16d5 = true;
						cGame.var_6aac.var_16dd = System.currentTimeMillis();
					}
				}
				cGame.s_animalAmountInSilo = cActor.sub_5ad9(0, 54);
			...
			cGame.var_6aac.posX = cGame.var_6aac.cameraX * cGame.s_zoomLevel / 100 - GLLibPlayer.Tileset_GetCameraX(0);
			cGame.var_6aac.posY = cGame.var_6aac.cameraY * cGame.s_zoomLevel / 100 - GLLibPlayer.Tileset_GetCameraY(0);
			...
			sub_2c69b();
			sub_1f8c5(1);
			if ((cGame.var_6aac.spriteId > -1 && cGame.var_6aac.spriteFrame > -1)
				...
				if (cGame.var_6aac.spriteId > -1) {
					...
					n2 = (class_e = (((var_1865 & 0x8000) != 0x0) ? cGame.var_68d4[n] : cGame.s_gameSprites[n]))
							.GetFrameWidth(cGame.var_6aac.spriteFrame) >> 1;
					n3 = class_e.GetFrameHeight(cGame.var_6aac.spriteFrame) >> 1;
				} else {
					final int var_187d;
				...
				if (cGame.var_6aac.cameraX - n2 > GLLibPlayer.Tileset_GetCameraX(0)
	...
	private static void sub_24a2c(final boolean b, final cActor class_f) {
		final boolean b2 = b;
	...
	private static void sub_24b52() {
		if (cGame.var_6aac != null) {
			...
			if (cGame.var_6aa4 == 1) {
				...
				sub_49db0(cGame.var_6aac.var_18c5, 1, 17, false);
				sub_49db0(cGame.var_6aac.var_18c5, 1, 9, false);
				if (cGame.var_6aac.var_17c5 == 49 && cGame.s_tutorialState == 42) {
					++cGame.var_6cbc;
				}
			} else if (cGame.var_6aa4 == 3 || cGame.var_6aa4 == 4) {
				if (cGame.var_6adc != cGame.var_6aac.cameraX && cGame.var_6ae4 != cGame.var_6aac.cameraY) {
			...
			if (cGame.var_708c > 0) {
				spendCoins(cGame.var_708c);
				cGame.var_708c = 0;
			}
			if (cGame.var_7094 > 0) {
				spendCash(cGame.var_7094);
				cGame.var_7094 = 0;
			}
			if (cGame.var_6aa4 == 1) {
			...
			if (cGame.var_6aac.var_17c5 == 54) {
				...
				if (cGame.var_6aa4 == 0) {
					...
					if (cGame.var_6aac.var_16cd > 0) {
						cActor.newActor(47, 2, new int[] { 0, 0, 14 }).sub_8c4c(cGame.var_6aac.cameraX,
								cGame.var_6aac.cameraY, 37, 1000, false, cGame.var_6aac.var_16cd);
					}
				...
				if (cGame.var_6aa4 == 0 || cGame.var_6aa4 == 1) {
					final int n;
					if ((n = GameDatas.s_allDatas[4].m_dataVars[cGame.var_6aac.actorID][19]) > 0) {
						cActor.newActor(47, 2, new int[] { 0, 0, 14 }).sub_8c4c(cGame.var_6aac.cameraX,
								cGame.var_6aac.cameraY, 37, 1000, false, n);
					}
				}
			...
			if (cGame.var_6aa4 == 1 && cGame.var_6aac.var_17c5 == 49) {
				if (cActor.sub_4cf5(0, 49) < getMaxPlots()) {
					final cActor sub_25a75;
					(sub_25a75 = sub_25a75(cGame.var_6aac.var_17c5, 0, cGame.var_6aac.cameraX,
							cGame.var_6aac.cameraY, true)).var_18c5 = cGame.var_8094[0];
				...
				final cActor sub_25b35;
				(sub_25b35 = sub_25b35(4, cGame.var_6aac.actorID)).var_18c5 = cGame.var_6aac.var_18c5;
	...
	private static void sub_25129() {
		if (cGame.var_6b5c != null && cGame.var_6aac != null) {
			...
			cGame.var_6b5c.SetScale(cGame.s_zoomLevel);
	...
	private static void sub_25213(int var_6b0c) {
		...
		final GameDatas class_h = GameDatas.s_allDatas[2];
		cGame.var_6b0c = var_6b0c;
		cGame.var_6b14 = class_h.m_dataVars[cGame.var_6b0c][14];
		cGame.var_6b1c = class_h.m_dataVars[cGame.var_6b0c][11];
		cGame.var_6b24 = class_h.m_dataVars[cGame.var_6b0c][6];
		cGame.var_6b2c = class_h.m_dataVars[cGame.var_6b0c][7];
		cGame.var_6b34 = class_h.m_dataVars[cGame.var_6b0c][1];
		cGame.var_6b3c = class_h.m_dataVars[cGame.var_6b0c][9];
		cGame.var_6b44 = class_h.m_dataVars[cGame.var_6b0c][8];
		cGame.var_6b4c = class_h.m_dataVars[cGame.var_6b0c][12];
		cGame.var_6b54 = (byte) class_h.m_dataVars[cGame.var_6b0c][15];
	}

	private static void sub_252cf() {
		if (cGame.var_6aac.sub_a2a0(2)) {
			final cActor[] array = new cActor[50];
			for (int sub_56ed = cActor.sub_56ed(0, 54, array, cGame.var_6aac), i = 0; i < sub_56ed; ++i) {
				final int[] array2 = new int[2];
				sub_2cfd6(array[i], array2, array[i].cameraX, array[i].cameraY);
	...
	private static void sub_253a8() {
		...
		if (cGame.var_6bec) {
			cGame.var_6c04 = GLLib.s_pointerX;
			cGame.var_6c0c = GLLib.s_pointerY;
		...
		if (cGame.var_8034 != null) {
			...
			final int[] array = new int[2];
			final int[] array2 = new int[2];
			array[0] = cGame.var_8034.cameraX;
			array[1] = cGame.var_8034.cameraY;
			array2[0] = array[0] * cGame.s_zoomLevel / 100 - cGame.var_800c.cameraX;
			array2[1] = array[1] * cGame.s_zoomLevel / 100 - cGame.var_800c.cameraY;
			for (int j = 0; j <= 7; ++j) {
		...
		if (cGame.var_6b5c != null) {
			...
			if (cGame.var_6aac != null) {
				final int[] array3 = new int[2];
				final int[] array4 = new int[2];
				array3[0] = cGame.var_6aac.cameraX;
				array3[1] = cGame.var_6aac.cameraY;
				array4[0] = array3[0] * cGame.s_zoomLevel / 100 - cGame.var_800c.cameraX;
				array4[1] = array3[1] * cGame.s_zoomLevel / 100 - cGame.var_800c.cameraY;
				...
				cGame.var_68bc[1][63][3] = (short) (array4[1] + 75 * cGame.s_zoomLevel / 100);
				sub_2340c(1, 62);
				sub_2340c(1, 63);
				if (!sub_2cad2(cGame.var_6aac)) {
		...
		sub_2df93();
		final cActor[] array5 = { null };
		cActor.sub_545c(0, 50, 14, array5, 1);
	...
	private static cActor sub_25a26(final int n, final int n2, final boolean b) {
		final int[] array = new int[2];
		final int[] array2;
	...
	private static cActor sub_25a75(final int n, final int n2, final int n3, final int n4, final boolean b) {
		final int[] array = { n3, n4, 11 };
		if (n == 50 || n == 54 || n == 48 || n == 22) {
			array[2] = 12;
		}
		final cActor sub_92ea = cActor.newActor(n, 0, array);
		final int[] array2 = new int[2];
		array2[0] = n3;
		array2[1] = n4;
		sub_2cfd6(sub_92ea, array2, array2[0], array2[1]);
		sub_92ea.cameraX = array2[0];
		sub_92ea.cameraY = array2[1];
	...
	private static cActor sub_25b35(int n, final int n2) {
		cActor class_f = null;
		final int[] array = new int[2];
		final int[] array2;
		(array2 = new int[2])[0] = GLLib.s_screenWidth >> 1;
		...
		sub_2c867(array, array2);
		sub_2c8b0(array2, array);
		final GameDatas class_h = GameDatas.s_allDatas[n];
		switch (n) {
		case 2: {
			(class_f = cActor.newActor(52, 0, new int[] { array[0], array[1], 12, class_h.m_dataVars[n2][9],
					class_h.m_dataVars[n2][19], class_h.m_dataVars[n2][20] })).actorID = n2;
			class_f.var_18c5 = class_h.m_dataVars[n2][1];
			class_f.var_188d = class_h.m_dataVars[n2][14];
			class_f.var_1605 = class_h.m_dataVars[n2][12];
			class_f.var_191d = class_h.m_dataVars[n2][11];
			class_f.prepareTime = (byte) class_h.m_dataVars[n2][15];
			class_f.var_187d = (byte) class_h.m_dataVars[n2][9];
			class_f.var_1885 = (byte) class_h.m_dataVars[n2][10];
			if (n2 >= 12) {
				break;
			}
			break;
		...
		case 0: {
			(class_f = cActor.newActor(54, 0,
					new int[] { array[0], array[1], 12, class_h.m_dataVars[n2][27], class_h.m_dataVars[n2][28],
							class_h.m_dataVars[n2][31], class_h.m_dataVars[n2][32], class_h.m_dataVars[n2][34],
							class_h.m_dataVars[n2][19], class_h.m_dataVars[n2][33], class_h.m_dataVars[n2][35],
							class_h.m_dataVars[n2][36] })).actorID = n2;
			class_f.sub_7ed6();
			if (class_h.m_dataVars[n2][34] == 1) {
				class_f.sub_7f11();
			} else {
			...
			class_f.var_1635 = 0;
			class_f.var_18c5 = class_h.m_dataVars[n2][1];
			final cActor class_f2 = class_f;
			n = class_h.m_dataVars[n2][31];
			short var_1685 = 0;
			if (n == 7) {
				var_1685 = 0;
			} else if (n == 8) {
			...
			class_f.var_182d = (short) class_h.m_dataVars[n2][12];
			...
			if (class_h.m_dataVars[n2][22] != 5 && class_h.m_dataVars[n2][22] != 110) {
				class_f.var_16ed = class_h.m_dataVars[n2][21];
			}
			break;
		}
		case 3: {
			(class_f = cActor.newActor(50, 0,
					new int[] { array[0], array[1], 12, n2, class_h.m_dataVars[n2][25], class_h.m_dataVars[n2][26],
							class_h.m_dataVars[n2][23], class_h.m_dataVars[n2][24], class_h.m_dataVars[n2][27],
							class_h.m_dataVars[n2][28], class_h.m_dataVars[n2][29] })).var_18c5 = class_h.m_dataVars[n2][1];
			if (class_f.actorID == Define.ACTOR_STABLES || class_f.actorID == Define.ACTOR_HENHOUSE) {
		...
		case 4: {
			(class_f = cActor.newActor(20, 0,
					new int[] { array[0], array[1], class_h.m_dataVars[n2][15], class_h.m_dataVars[n2][0],
							class_h.m_dataVars[n2][12], class_h.m_dataVars[n2][13], class_h.m_dataVars[n2][11],
							class_h.m_dataVars[n2][9], class_h.m_dataVars[n2][10], class_h.m_dataVars[n2][16],
							class_h.m_dataVars[n2][17] })).actorID = n2;
			class_f.var_18c5 = class_h.m_dataVars[n2][1];
			break;
		}
		case 9: {
			(class_f = cActor.newActor(51, 0,
					new int[] { array[0], array[1], class_h.m_dataVars[n2][4], class_h.m_dataVars[n2][0], class_h.m_dataVars[n2][1],
							class_h.m_dataVars[n2][2], class_h.m_dataVars[n2][3] })).actorID = n2;
			break;
		}
		case 8: {
			(class_f = cActor.newActor(42, 0,
					new int[] { array[0], array[1], 12, class_h.m_dataVars[n2][3] })).actorID = n2;
			break;
		}
		case 11: {
			if (n2 == -1) {
				(class_f = cActor.newActor(22, 0, new int[] { array[0], array[1], 12 })).actorID = n2;
				class_f.var_18c5 = -1;
				break;
			}
			if (n2 >= 4 && n2 <= 50) {
			...
			(class_f = cActor.newActor(48, 0, new int[] { array[0], array[1], 12, class_h.m_dataVars[n2][7],
					class_h.m_dataVars[n2][8], class_h.m_dataVars[n2][9] })).actorID = n2;
			class_f.var_18c5 = class_h.m_dataVars[n2][1];
			break;
		}
		case 15: {
			(class_f = cActor.newActor(32, 0,
					new int[] { array[0], array[1], class_h.m_dataVars[n2][7], class_h.m_dataVars[n2][1], class_h.m_dataVars[n2][2],
							class_h.m_dataVars[n2][4], class_h.m_dataVars[n2][5], class_h.m_dataVars[n2][3],
							class_h.m_dataVars[n2][6] })).actorID = n2;
			break;
		}
		case 28: {
			(class_f = cActor.newActor(34, 0, new int[] { 90, class_h.m_dataVars[n2][1], class_h.m_dataVars[n2][2],
					class_h.m_dataVars[n2][3], class_h.m_dataVars[n2][4] })).actorID = n2;
			break;
		}
		}
		return class_f;
	...
	static void sub_26427(final int[] array, final int[] array2) {
		if (cGame.s_zoomLevel == 100) {
			array2[0] = cGame.var_800c.cameraX + array[0];
			array2[1] = cGame.var_800c.cameraY + array[1];
			return;
		}
		if (cGame.s_zoomLevel == 50) {
			array2[0] = cGame.var_800c.cameraX + array[0] << 1;
			array2[1] = cGame.var_800c.cameraY + array[1] << 1;
			return;
		}
		array2[0] = (cGame.var_800c.cameraX + array[0]) * 100 / cGame.s_zoomLevel;
		array2[1] = (cGame.var_800c.cameraY + array[1]) * 100 / cGame.s_zoomLevel;
	}

	static void sub_264d4(final int[] array, final int[] array2) {
		array2[0] = array[0] - cGame.var_800c.cameraX;
		array2[1] = array[1] - cGame.var_800c.cameraY;
	}
	...
	private static void sub_2657c(final boolean b) {
		if (sub_20167(1, 12)) {
			sub_1df06(GLLib.Text_FormatNumber(getCoins(), cGame.s_currencySeprType, " "), 1, 13, 0, 0);
		}
		if (sub_20167(1, 21)) {
			if (!b || cGame.var_807c <= 10) {
				if (getLevel() < 50) {
					sub_1df06(GLLib.Text_FormatNumber(getExperience(), cGame.s_currencySeprType, " ") + " / "
							+ GLLib.Text_FormatNumber(sub_2e8f8(), cGame.s_currencySeprType, " "), 1, 22, 0, 0);
				}
		...
		if (sub_20167(1, 15)) {
			sub_1df06(GLLib.Text_FormatNumber(getCash(), cGame.s_currencySeprType, " "), 1, 16, 0, 0);
		}
		if (sub_20167(1, 87)) {
			final String sub_4e1f;
			drawString(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_NEWTROPHY)) == null) ? "" : sub_4e1f, 1, 88, 0, 0);
			return;
		}
		if (sub_20167(1, 78)) {
			for (int i = 0; i < 4; ++i) {
	...
	private static void sub_26716() {
		...
		if (cGame.var_6bd4) {
			if (sub_20167(1, 47)) {
				final String sub_4e1f;
				sub_1df06(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_QUEST_NEW)) == null) ? "" : sub_4e1f, 1, 51, 0, 0);
			}
			if (sub_20167(1, 48)) {
				final String sub_4e1f2;
				sub_1df06(((sub_4e1f2 = GLLib.Text_GetString(Define.TEXT_QUEST_NEW)) == null) ? "" : sub_4e1f2, 1, 52, 0, 0);
			}
			if (sub_20167(1, 49)) {
				final String sub_4e1f3;
				sub_1df06(((sub_4e1f3 = GLLib.Text_GetString(Define.TEXT_QUEST_NEW)) == null) ? "" : sub_4e1f3, 1, 53, 0, 0);
			}
			if (sub_20167(1, 50)) {
				final String sub_4e1f4;
				sub_1df06(((sub_4e1f4 = GLLib.Text_GetString(Define.TEXT_QUEST_NEW)) == null) ? "" : sub_4e1f4, 1, 54, 0, 0);
			}
		}
	}
	...
	private static void sub_26854() {
		if (cGame.var_6b9c && sub_20167(1, 45)) {
			...
			if (cGame.var_6bac < currentTimeMillis) {
				sub_26a6a(cGame.var_6b9c = false, cGame.s_currentQuest, '\0');
			}
	...
	private static void sub_26a6a(boolean var_6b9c, int i, final char c) {
		int state = getState();
		if (state != Define.GS_FARM && state != Define.GS_FARM_TUTORIAL && var_6b9c) {
			cGame.var_6bc4 = true;
			cGame.var_6bcc = c;
			cGame.s_currentQuest = i;
			return;
		}
		if (sub_20167(1, 44)) {
		...
		if (var_6b9c) {
			...
			if (c == '\u0001') {
				final String sub_4e1f;
				cGame.s_questText = (((sub_4e1f = GLLib.Text_GetString(Define.TEXT_QUEST_NEW)) == null) ? "" : sub_4e1f);
			} else if (c == '\u0002') {
				final String sub_4e1f2;
				cGame.s_questText = (((sub_4e1f2 = GLLib.Text_GetString(Define.TEXT_QUEST_PROGRESS)) == null) ? "" : sub_4e1f2);
			} else {
		...
		for (i = 0; i < cGame.var_7f74; ++i) {
			if (cGame.s_questStates[i] == 3) {
				n = i;
			}
		}
		final int var_7f6c;
		if ((var_7f6c = n) != -1) {
			cGame.s_currentQuest = var_7f6c;
			switchToState(Define.GS_FARMDIARY);
			cGame.var_6bc4 = false;
			cGame.var_6bcc = '\0';
			sub_2000c(1, 45, false);
	...
	private static void sub_26c8e() {
		...
		case 161: {
			if (!cGame.var_6c8c) {
				...
				if (getState() == Define.GS_FARM) {
					final cActor[] array = { null };
					cActor.sub_545c(0, 50, 18, array, 1);
					if (array[0] != null) {
						cGame.var_800c.sub_6b0c(array[0].cameraX, array[0].cameraY, 1000);
					}
				}
			}
		...
		case 163: {
			if (!cGame.var_6c8c) {
				...
				if (getState() == Define.GS_FARM) {
					final cActor[] array2 = { null };
					cActor.sub_545c(0, 50, 18, array2, 1);
					sub_28c2e(array2[0], 0, -50);
				}
			}
			if (getState() == Define.GS_FARM && sub_202b7(1, 44)) {
				sub_2024d(1, 44, false);
				sub_2c69b();
				sub_1f8c5(1);
				return;
		...
		case 167: {
			if (!cGame.var_6c8c) {
				...
				if (array3[0] != null) {
					cGame.var_800c.sub_6b0c(array3[0].cameraX, array3[0].cameraY, 1000);
				}
			}
			if (cGame.s_hasFinishedTut) {
				cGame.var_6c8c = (cGame.s_hasFinishedTut = false);
		...
		case 168: {
			if (!cGame.var_6c8c) {
				...
				cGame.s_hasFinishedTut = false;
				final cActor[] array4 = { null };
				cActor.sub_545c(0, 50, 15, array4, 1);
				if (array4[0] != null) {
	...
	private static void sub_27072() {
		if (cGame.var_6c9c != null) {
			cGame.var_68bc[1][9][2] = (short) ((cGame.var_6c9c.cameraX + cGame.var_6cac) * cGame.s_zoomLevel / 100
					- cGame.var_800c.cameraX);
			cGame.var_68bc[1][9][3] = (short) ((cGame.var_6c9c.cameraY + cGame.var_6cb4) * cGame.s_zoomLevel / 100
					- cGame.var_800c.cameraY);
			return;
		}
	...
	private static void sub_273b8() {
		...
		case 1: {
			if (!cGame.var_6c8c) {
				...
				sub_27132();
				final cActor[] array = new cActor[20];
				for (int sub_5439 = cActor.sub_5439(0, 49, array, 20), i = 0; i < sub_5439; ++i) {
					array[i].sub_7795(5);
				}
				cGame.var_6cec = 1944;
				cGame.var_6cf4 = 900;
		...
		case 4: {
			if (!cGame.var_6c8c) {
				cGame.s_hasFinishedTut = false;
				cGame.var_6c8c = true;
				final cActor[] array2 = new cActor[5];
				cActor.sub_5439(0, 49, array2, 5);
				if (array2[1] != null) {
					sub_28c2e(array2[1], 35, -100);
					cGame.var_800c.sub_6b0c(array2[1].cameraX, array2[1].cameraY, 1000);
				}
			}
			if (cGame.s_hasFinishedTut) {
				sub_2738d();
		...
		case 5: {
			if (!cGame.var_6c8c) {
				...
				cGame.var_6d34 = 0;
				cGame.var_6d2c = 0;
				cGame.var_6cec = cGame.var_68bc[1][71][2] + cGame.var_800c.cameraX;
				cGame.var_6cf4 = cGame.var_68bc[1][71][3] + cGame.var_800c.cameraY;
				cGame.var_6cec = 2088;
				cGame.var_6cf4 = 972;
				cGame.var_6cfc = 1944;
				cGame.var_6d04 = 900;
		...
		case 7: {
			if (!cGame.var_6c8c) {
				cGame.var_6c8c = true;
				cGame.s_hasFinishedTut = false;
				final cActor[] array4 = new cActor[3];
				cActor.sub_5439(0, 49, array4, 3);
				if (array4[1] != null) {
					sub_28c2e(array4[1], 0, -50);
					cGame.var_800c.sub_6b0c(array4[1].cameraX, array4[1].cameraY, 1000);
				}
				cGame.var_70e4 |= 0x1;
			}
			if (cGame.s_hasFinishedTut) {
		...
		case 14: {
			...
			if (cGame.var_6aac != null && cGame.var_6aac.var_17c5 == 54 && cGame.var_6aac.actorID == Define.ACTOR_UNK16) {
				cGame.s_hasFinishedTut = true;
			}
			if (cGame.s_hasFinishedTut) {
				sub_2738d();
		...
		case 15: {
			if (!cGame.var_6c8c) {
				...
				cGame.var_6aac.cameraX = array8[0];
				cGame.var_6aac.cameraY = array8[1];
				cGame.var_800c.sub_6b0c(cGame.var_6aac.cameraX, cGame.var_6aac.cameraY, 1000);
				sub_28ca1();
		...
		case 17: {
			if (!cGame.var_6c8c) {
				cGame.var_6c8c = true;
				final cActor[] array10 = { null };
				cActor.sub_545c(0, 54, 16, array10, 1);
		...
		case 18: {
			if (!cGame.var_6c8c) {
				cGame.var_6c8c = true;
				final cActor[] array11 = { null };
				cActor.sub_545c(0, 54, 16, array11, 1);
				if (array11[0] != null) {
		...
		case 23: {
			if (!cGame.var_6c8c) {
				...
				cGame.s_hasFinishedTut = false;
				final cActor[] array12 = { null };
				cActor.sub_545c(0, 50, 14, array12, 1);
				if (array12[0] != null) {
		...
		case 32: {
			if (!cGame.var_6c8c) {
				...
				cGame.s_hasFinishedTut = false;
				final cActor[] array13 = { null };
				cActor.sub_545c(0, 54, 17, array13, 1);
				if (array13[0] != null) {
		...
		case 34: {
			if (!cGame.var_6c8c) {
				...
				sub_2024d(1, 45, false);
				final cActor[] array14 = { null };
				cActor.sub_545c(0, 54, 17, array14, 1);
				if (array14[0] != null) {
					array14[0].sub_7ed6();
		...
		case 35: {
			if (!cGame.var_6c8c) {
				...
				sub_2024d(1, 44, false);
				sub_2024d(1, 45, false);
				final cActor[] array15 = { null };
				cActor.sub_545c(0, 54, 17, array15, 1);
		...
		case 37: {
			if (!cGame.var_6c8c) {
				cGame.var_6c8c = true;
				final cActor[] array16 = new cActor[40];
				final int sub_5440 = cActor.sub_5439(0, 49, array16, 40);
				cGame.var_70e4 |= 0x1;
		...
		case 38: {
			if (!cGame.var_6c8c) {
				...
				final cActor[] array17 = { null };
				cActor.sub_5439(0, 49, array17, 1);
				if (array17[0] != null) {
					sub_28c2e(array17[0], 0, -50);
					cGame.var_800c.sub_6b0c(array17[0].cameraX, array17[0].cameraY, 1000);
				}
			...
			if (cGame.var_6cbc >= 6) {
				final cActor[] array18 = { null };
				cActor.sub_5439(2, 47, array18, 1);
				if (array18[0] == null) {
					cGame.s_hasFinishedTut = true;
				}
			}
		...
		case 41: {
			if (!cGame.var_6c8c) {
				final int var_7fd4 = cGame.s_tutorialState;
		...
		case 42: {
			if (!cGame.var_6c8c) {
				...
				cGame.var_6cbc = 0;
				if (cGame.var_6aac != null) {
					cGame.var_6aac.cameraX = 2160;
					cGame.var_6aac.cameraY = 864;
					cGame.var_800c.sub_6b0c(cGame.var_6aac.cameraX, cGame.var_6aac.cameraY, 1000);
				}
			}
			if (cGame.var_6cbc >= 2) {
		...
		case 44: {
			if (!cGame.var_6c8c) {
				cGame.var_6c8c = true;
				cGame.s_hasFinishedTut = false;
				final cActor[] array19 = new cActor[5];
				cActor.sub_5439(0, 49, array19, 5);
		...
		case 47: {
			if (!cGame.var_6c8c) {
				...
				cGame.var_70e4 &= 0xFFFFFF00;
				sub_27132();
				final cActor[] array20 = { null };
				cActor.sub_545c(0, 50, 10, array20, 1);
				if (array20[0] != null) {
		...
		case 48: {
			...
			if (cGame.s_hasFinishedTut) {
				...
				cActor.sub_545c(0, 50, 10, array21, 1);
				if (array21[0] != null) {
					sub_28c2e(array21[0], 0, -100);
					cGame.var_800c.sub_6b0c(array21[0].cameraX, array21[0].cameraY, 1000);
				}
				sub_2738d();
			}
			cGame.s_hasFinishedTut = true;
		...
		case 49: {
			if (!cGame.var_6c8c) {
				...
				cGame.var_6c8c = true;
				sub_271e4(cGame.s_tutorialState);
				final cActor[] array22 = { null };
				cActor.sub_545c(0, 50, 10, array22, 1);
				if (array22[0] != null) {
		...
		case 52: {
			if (!cGame.var_6c8c) {
				...
				cGame.var_6aac.cameraX = array23[0];
				cGame.var_6aac.cameraY = array23[1];
		...
		case 54: {
			if (!cGame.var_6c8c) {
				final cActor[] array25 = { null };
				cActor.sub_545c(0, 50, 9, array25, 1);
				if (array25[0] != null) {
		...
		case 56: {
			if (!cGame.var_6c8c) {
				cGame.var_6c8c = true;
				final int var_7fd5 = cGame.s_tutorialState;
		...
		case 57: {
			...
			final cActor[] array26 = { null };
			cActor.sub_5439(2, 47, array26, 1);
			if (array26[0] != null) {
				cGame.var_6cc4 = true;
			}
	...
	private static void sub_28c2e(final cActor var_6c9c, final int var_6cac, final int var_6cb4) {
	...
	private static void sub_28cd9() {
		...
		cGame.var_7864 = false;
		cGame.var_6d64 = 0;
		final GameDatas class_h = GameDatas.s_allDatas[12];
		int n = 0;
		int i = 0;
		while (i == 0) {
			if (class_h.m_dataVars[n][1] == cGame.var_6d54) {
				i = 1;
		...
		final int n2 = class_h.m_dataVars[n][3];
		final int n3 = class_h.m_dataVars[n][4];
		final int n4 = class_h.m_dataVars[n][7];
		final int n5 = class_h.m_dataVars[n][8];
		cGame.var_6d94 = encryptLong(class_h.m_dataVars[n][2]);
		cGame.var_6da4 = encryptInt(class_h.m_dataVars[n][5]);
		cGame.var_6db4 = encryptInt(class_h.m_dataVars[n][9]);
		cGame.var_6dc4 = encryptInt(class_h.m_dataVars[n][6]);
		cGame.var_6dcc = encryptInt(class_h.m_dataVars[n][10]);
		if (decryptLong(cGame.var_6d9c = encryptLong(getCoins())) > decryptLong(cGame.var_6d94)) {
		...
		for (int j = 0; j < 2; ++j) {
			...
			switch (n6) {
			case 1: {
				final GameDatas class_h2 = GameDatas.s_allDatas[0];
				short n7 = 1008;
				short n8 = 0;
				short n9 = 0;
				...
				while (k < var_7a) {
					...
					if (n10 == class_h2.m_dataVars[k][1]) {
						n7 = (short) class_h2.m_dataVars[k][3];
						n8 = (short) class_h2.m_dataVars[k][4];
						n9 = (short) class_h2.m_dataVars[k][32];
						if (j == 0) {
							cGame.var_6ddc = (short) class_h2.m_dataVars[k][2];
							break;
						}
						cGame.var_6de4 = (short) class_h2.m_dataVars[k][2];
						break;
					} else {
						++k;
					}
				...
				if (j == 0) {
					cGame.var_6dac = encryptInt(
							cGame.var_6dac = (cGame.var_6dac = cActor.sub_4d73(0, n3)) + sub_2e024(3, n3 - 2000));
					break;
				}
				cGame.var_6dbc = encryptInt(
						cGame.var_6dbc = (cGame.var_6dbc = cActor.sub_4d73(0, n5)) + sub_2e024(3, n5 - 2000));
				break;
			}
			case 3: {
				final GameDatas class_h3 = GameDatas.s_allDatas[1];
				...
				while (l < var_7a2) {
					...
					if (n13 == class_h3.m_dataVars[l][1]) {
						n11 = (short) class_h3.m_dataVars[l][3];
						n12 = (short) class_h3.m_dataVars[l][4];
						if (j == 0) {
							cGame.var_6ddc = (short) class_h3.m_dataVars[l][2];
							break;
						}
						cGame.var_6de4 = (short) class_h3.m_dataVars[l][2];
						break;
					} else {
						++l;
					}
			...
			case 2: {
				final GameDatas class_h4 = GameDatas.s_allDatas[2];
				short n14 = 9;
				short n15 = 0;
				...
				while (n16 < var_7a3) {
					...
					if (n17 == class_h4.m_dataVars[n16][1]) {
						n14 = (short) class_h4.m_dataVars[n16][3];
						n15 = (short) class_h4.m_dataVars[n16][4];
						if (j == 0) {
							cGame.var_6ddc = (short) class_h4.m_dataVars[n16][2];
							break;
						}
						cGame.var_6de4 = (short) class_h4.m_dataVars[n16][2];
						break;
					} else {
						++n16;
					}
				...
				sub_d78c(1, cGame.var_68bc[11][j + 29][5]);
				if (j == 0) {
					cGame.var_6dac = encryptInt(cGame.var_6dac = (cGame.var_6dac = cActor.sub_4d73(0, n3))
							+ sub_2e024(4, n3 - 3000 - 12));
					break;
				}
				cGame.var_6dbc = encryptInt(
						cGame.var_6dbc = (cGame.var_6dbc = cActor.sub_4d73(0, n5)) + sub_2e024(4, n5 - 3000 - 12));
				break;
			}
			}
		}
		...
		if (cGame.var_6d54 > 0 && cGame.var_6d54 < 13) {
			for (int i = cGame.var_6d74; i < cGame.var_6d84; i += 2) {
				for (int j = cGame.var_6d7c; j <= cGame.var_6d8c; j += 2) {
					...
					sub_2c8b0(array2, array);
					if (cGame.s_zoomLevel < 100) {
						array[0] = array[0] * cGame.s_zoomLevel / 100;
						array[1] = array[1] * cGame.s_zoomLevel / 100;
					}
					int n5;
					int n6;
					if (cGame.s_zoomLevel == 100) {
			...
			for (int k = var_6d74; k < n9; ++k) {
				for (int l = n10; l < var_6d8c; ++l) {
					cGame.s_actor_physMap[l * 96 + k] = 0;
				}
			}
			cGame.var_6d5c[cGame.var_6d54] = true;
			if (cGame.var_6d54 < 12 && cGame.var_6dec[cGame.var_6d54 + 1] != null) {
				cGame.var_6dec[cGame.var_6d54 + 1].spriteFrame = 0;
			}
			if (cGame.var_807c == 0 && b) {
				sub_49db0(cGame.var_6d54, 1, 8, false);
				sub_2bae9(cGame.var_6d54, 1, 8);
			}
			final cActor[] array3 = new cActor[100];
			for (int sub_5830 = cActor.sub_5830(0, -1, cGame.var_6d74, cGame.var_6d84, cGame.var_6d7c,
	...
	private static void sub_29ee2() {
		if (cGame.var_6d6c != null && !cGame.var_6d6c.IsAnimOver()) {
			cGame.var_6d6c.SetScale(cGame.s_zoomLevel);
	...
	private static void sub_29fce() {
		...
		for (int i = 1; i < 13; ++i) {
			...
			if (!cGame.var_6d5c[i]) {
				...
				array[8] = 0;
				if (cGame.var_807c == 0) {
					(cGame.var_6dec[i] = cActor.newActor(32, 0, array)).sub_a21a(16777216);
				}
			}
		}
	}
	...
	private static void sub_2a274() {
		...
		final GameDatas class_h = GameDatas.s_allDatas[8];
		for (int i = 0; i < 10; ++i) {
			(cGame.var_6e24[i] = new int[6])[0] = class_h.m_dataVars[i][7];
			cGame.var_6e24[i][1] = class_h.m_dataVars[i][8];
		...
		cGame.var_6e3c = new int[(class_h2 = GameDatas.s_allDatas[24]).var_7a];
		for (int j = 0; j < class_h2.var_7a; ++j) {
			cGame.var_6e3c[j] = class_h2.m_dataVars[j][7];
		}
		for (int k = 0; k < 10; ++k) {
	...
	static boolean sub_2a397() {
		...
		final GameDatas class_h = GameDatas.s_allDatas[8];
		final GameDatas class_h2 = GameDatas.s_allDatas[18];
		final GameDatas class_h3 = GameDatas.s_allDatas[24];
		boolean b = false;
		for (int i = 0; i < 10; ++i) {
			if (cGame.var_6e34[i][3] > 0L) {
				...
				for (int n3 = cGame.var_6e24[i][1] / cGame.var_8064[25]; n2 >= cGame.var_6e3c[n3]; n2 = n
					...
					if ((cGame.var_6e24[cGame.var_7bb4][2] & 0x10) != 0x10) {
						sub_2b10b(i, -class_h3.m_dataVars[n3][8]);
					}
			...
			if (cGame.var_6e34[i][4] > 0L) {
				...
				while (true) {
					...
					if ((cGame.var_6e24[cGame.var_7bb4][2] & 0x1) != 0x1) {
						sub_2b10b(i, -class_h3.m_dataVars[n6][9]);
					}
					cGame.var_6e24[cGame.var_7bb4][2] = 0;
				}
			}
			if (cGame.var_6e34[i][2] > 0L && n - cGame.var_6e34[i][2] >= 86400L) {
				final int n8 = i;
				final GameDatas class_h4 = GameDatas.s_allDatas[18];
				cGame.var_6e34[n8][2] = 0L;
				if (class_h4.m_dataVars[getLevel() - 1][11] > -1) {
					for (int j = 0; j < 2; ++j) {
					...
					for (int n9 = 0, n10 = 0; n10 < 2 && n9 < class_h4.m_dataVars[getLevel() - 1][11]; ++n10) {
						if (sub_2b97 < class_h4.m_dataVars[getLevel() - 1][13]) {
							final int n11 = n9;
							final int n12 = n8;
							final int n13 = n10;
							final int n14 = class_h4.m_dataVars[getLevel() - 1][11] - n9;
							final int n15 = n13;
							final int n16 = n12;
							final GameDatas class_h5 = GameDatas.s_allDatas[1];
							int n17 = 0;
							final int[] array3 = new int[117];
							for (int k = 0; k < 117; ++k) {
								if (!sub_2afdd(n16, 1, k) && class_h5.m_dataVars[k][5] < n14
										&& class_h5.m_dataVars[k][11] <= getLevel() && class_h5.m_dataVars[k][14] >= 1) {
									array3[n17++] = k;
								}
							}
							int n18 = 0;
							if (n17 > 0) {
								...
								cGame.var_6e2c[n16][n15 * 3 + 2] = GLLib.Math_Rand(1,
										(n14 / class_h5.m_dataVars[cGame.var_6e2c[n16][n15 * 3 + 1]][5] < 5)
												? (n14 / class_h5.m_dataVars[cGame.var_6e2c[n16][n15 * 3 + 1]][5])
												: 5);
								n18 = cGame.var_6e2c[n16][n15 * 3 + 2]
										* class_h5.m_dataVars[cGame.var_6e2c[n16][n15 * 3 + 1]][5];
							}
							n9 = n11 + n18;
						} else if (sub_2b97 < class_h4.m_dataVars[getLevel() - 1][13]
								+ class_h4.m_dataVars[getLevel() - 1][14]) {
							final int n19 = n9;
							final int n20 = n8;
							final int n21 = n10;
							final int n22 = class_h4.m_dataVars[getLevel() - 1][11] - n9;
							final int n23 = n21;
							final int n24 = n20;
							final GameDatas class_h6 = GameDatas.s_allDatas[4];
							int n25 = 0;
							final int[] array4 = new int[63];
							for (int l = 0; l < 63; ++l) {
								if (!sub_2afdd(n24, 2, l) && class_h6.m_dataVars[l][8] <= getLevel()
										&& class_h6.m_dataVars[l][16] >= 1 && class_h6.m_dataVars[l][7] == 0
										&& sub_27009(class_h6.m_dataVars[l][6], class_h6.m_dataVars[l][7]) < n22) {
									array4[n25++] = l;
								}
							}
							int n26 = 0;
							if (n25 > 0) {
								...
								final int sub_27009 = sub_27009(class_h6.m_dataVars[cGame.var_6e2c[n24][n23 * 3 + 1]][6],
										class_h6.m_dataVars[cGame.var_6e2c[n24][n23 * 3 + 1]][7]);
							...
							final int n28 = n8;
							final int n29 = n10;
							final int n30 = class_h4.m_dataVars[getLevel() - 1][11] - n9;
							final int n31 = n29;
							final int n32 = n28;
							final GameDatas class_h7 = GameDatas.s_allDatas[16];
							int n33 = 0;
							final int[] array5 = new int[15];
							for (int n34 = 0; n34 < 15; ++n34) {
								if (!sub_2afdd(n32, 3, n34) && class_h7.m_dataVars[n34][4] <= getLevel()
										&& class_h7.m_dataVars[n34][5] < n30) {
									array5[n33] = n34;
									++n33;
								}
							}
							...
							if (n33 > 0) {
								...
								final int n37 = class_h7.m_dataVars[n36][5];
			...
			if (cGame.var_6e34[i][5] > 0L && n - cGame.var_6e34[i][5] >= 86400L) {
				if (class_h.m_dataVars[i][10] <= cGame.var_6e24[i][1]
						&& GLLib.Math_Rand(0, 100) < class_h.m_dataVars[i][9]) {
					int n38;
					for (n38 = class_h2.var_7a - 1; n38 > 0
							&& class_h2.m_dataVars[n38][12] > cGame.var_6e24[i][1]; --n38) {
					}
					final int n39 = i;
					...
					final int n41 = n39;
					final GameDatas class_h8 = GameDatas.s_allDatas[1];
					int n42 = 0;
					final int[] array6 = new int[117];
					for (int n43 = 0; n43 < 117; ++n43) {
						if (class_h8.m_dataVars[n43][11] <= n40 && class_h8.m_dataVars[n43][11] >= 0
								&& class_h8.m_dataVars[n43][12] >= 1) {
							if (class_h8.m_dataVars[n43][11] > 0) {
								n42 = 0;
							}
							array6[n42++] = n43;
						}
	...
	private static void sub_2b18e() {
		...
		final GameDatas class_h;
		cGame.var_6e54 = new int[(class_h = GameDatas.s_allDatas[23]).var_7a];
		for (int i = 0; i < class_h.var_7a; ++i) {
			cGame.var_6e54[i] = class_h.m_dataVars[i][6];
		}
		for (int j = 0; j < 20; ++j) {
	...
	private static void sub_2b23f(final int n, GameDatas class_h) {
		if (class_h == null) {
			class_h = GameDatas.s_allDatas[23];
		}
		...
		if (n < class_h.m_dataVars[getLevel() - 1][6]) {
			if (n == 0 && cGame.s_tutorialState != -1) {
			...
			final int sub_2b97 = GLLib.Math_Rand(class_h.m_dataVars[getLevel() - 1][1],
					class_h.m_dataVars[getLevel() - 1][2]);
			int n2 = 0;
			int n4;
			int n12;
			for (int n3 = 0; n3 < 3 && n2 < sub_2b97; n2 = n4 + n12, ++n3) {
				...
				final int n7 = class_h.m_dataVars[getLevel() - 1][4];
				final int n8 = n6;
				final int n9 = n5;
				final GameDatas class_h2 = GameDatas.s_allDatas[1];
				int n10 = 0;
				...
				for (int j = 0; j < 117; ++j) {
					final int n11 = j;
					if (cGame.var_6e44[n][0] != n11 && cGame.var_6e44[n][2] != n11 && class_h2.m_dataVars[j][5] < n8
							&& class_h2.m_dataVars[j][11] <= getLevel() && class_h2.m_dataVars[j][12] >= 1) {
						array[n10] = j;
						++n10;
					}
				}
				...
				if (n10 > 0) {
					...
					final int n13 = n8 / class_h2.m_dataVars[cGame.var_6e44[n][n9 << 1]][5];
					cGame.var_6e44[n][(n9 << 1) + 1] = GLLib.Math_Rand(1, (n13 < n7) ? n13 : n7);
					n12 = cGame.var_6e44[n][(n9 << 1) + 1] * class_h2.m_dataVars[cGame.var_6e44[n][n9 << 1]][5];
				}
			}
			cGame.var_6e4c[n][0] = encryptInt(n2);
			cGame.var_6e4c[n][1] = encryptInt(class_h.m_dataVars[getLevel() - 1][5]);
			cGame.var_6e4c[n][2] = GLLib.Math_Rand(409, 438);
		}
	}
	...
	private static void sub_2b850() {
		final GameDatas class_h = GameDatas.s_allDatas[25];
		for (int i = 0; i < cGame.s_trophy_numTrophies; ++i) {
			if (cGame.var_6e64[i] == -1) {
				cGame.var_6e64[i] = class_h.m_dataVars[i][1];
				final String sub_4e1f;
				cGame.var_6e6c[i] = (((sub_4e1f = GLLib.Text_GetString(class_h.m_dataVars[i][3])) == null) ? "" : sub_4e1f);
				final String sub_4e1f2;
				cGame.var_6e74[i] = (((sub_4e1f2 = GLLib.Text_GetString(class_h.m_dataVars[i][6])) == null) ? "" : sub_4e1f2);
				cGame.var_6e7c[i] = class_h.m_dataVars[i][4];
				cGame.var_6e84[i] = class_h.m_dataVars[i][5];
				cGame.var_6e8c[i] = class_h.m_dataVars[i][7];
				cGame.var_6e94[i] = encryptInt(0);
				cGame.var_6e9c[i] = encryptInt(class_h.m_dataVars[i][8]);
				cGame.var_6ea4[i] = class_h.m_dataVars[i][9];
				cGame.var_6eac[i] = false;
				cGame.var_6eb4[i] = class_h.m_dataVars[i][10];
				cGame.var_6ebc[i] = class_h.m_dataVars[i][11];
				cGame.var_6ec4[i] = class_h.m_dataVars[i][12];
				cGame.var_6ecc[i] = class_h.m_dataVars[i][13];
			} else if (cGame.var_6e64[i] == class_h.m_dataVars[i][1]) {
				final String sub_4e1f3;
				cGame.var_6e6c[i] = (((sub_4e1f3 = GLLib.Text_GetString(class_h.m_dataVars[i][3])) == null) ? "" : sub_4e1f3);
				final String sub_4e1f4;
				cGame.var_6e74[i] = (((sub_4e1f4 = GLLib.Text_GetString(class_h.m_dataVars[i][6])) == null) ? "" : sub_4e1f4);
				cGame.var_6e7c[i] = class_h.m_dataVars[i][4];
				cGame.var_6e84[i] = class_h.m_dataVars[i][5];
				cGame.var_6e8c[i] = class_h.m_dataVars[i][7];
				cGame.var_6e9c[i] = encryptInt(class_h.m_dataVars[i][8]);
	...
	private static int sub_2bf50() {
		...
		for (int j = 0; j < 64; ++j) {
			if (j % 2 != 0) {
				cGame.var_6efc[j] = (short) cActor.sub_4de1(0, 54, j, j);
			}
		}
		for (int k = 0; k < 64; ++k) {
		...
		for (int i = 0; i < cGame.s_trophy_numTrophies; ++i) {
			if (cGame.var_6ed4[i] == -1 && cGame.var_6edc[i] != 1 && !cGame.var_6eac[i]
				...
				if (cGame.var_6e8c[i] == cGame.var_80c4[29]) {
					cGame.var_6e94[i] = encryptInt(cActor.sub_4d73(0, cGame.var_6e8c[i]));
					if (decryptInt(cGame.var_6e94[i]) >= decryptInt(cGame.var_6e9c[i])) {
						cGame.var_6e94[i] = cGame.var_6e9c[i];
						n = i;
					}
				} else if (cGame.var_6e8c[i] == 3999) {
					cGame.var_6e94[i] = encryptInt(cActor.sub_4e6d(0, 52));
					if (decryptInt(cGame.var_6e94[i]) >= decryptInt(cGame.var_6e9c[i])) {
						cGame.var_6e94[i] = cGame.var_6e9c[i];
						n = i;
					}
				} else if (cGame.var_6e8c[i] == 2999) {
					cGame.var_6e94[i] = encryptInt(cActor.sub_4de1(0, 54, 0, 63));
					if (decryptInt(cGame.var_6e94[i]) >= decryptInt(cGame.var_6e9c[i])) {
						cGame.var_6e94[i] = cGame.var_6e9c[i];
						n = i;
					}
	...
	protected final void pointerReleased(final int x, final int y) {
		if (cGame.s_game_states[cGame.s_game_state] == Define.GS_IGP) {
	...
	protected final void pointerDragged(final int x, final int y) {
		...
		if (((GLLib.s_pointerX - cGame.var_6f3c < 0) ? (-(GLLib.s_pointerX - cGame.var_6f3c))
				: (GLLib.s_pointerX - cGame.var_6f3c)) < ((GLLib.s_pointerX - cGame.var_6f3c < 0)
						? (-(GLLib.s_pointerX - cGame.var_6f3c))
						: (GLLib.s_pointerX - cGame.var_6f3c))) {
			cGame.var_6f3c = GLLib.s_pointerX;
			cGame.var_6f4c = 0;
		}
		if (((GLLib.s_pointerY - cGame.var_6f44 < 0) ? (-(GLLib.s_pointerY - cGame.var_6f44))
				: (GLLib.s_pointerY - cGame.var_6f44)) < ((GLLib.s_pointerY - cGame.var_6f44 < 0)
						? (-(GLLib.s_pointerY - cGame.var_6f44))
						: (GLLib.s_pointerY - cGame.var_6f44))) {
			cGame.var_6f44 = GLLib.s_pointerY;
			cGame.var_6f4c = 0;
		}
	...
	static void sub_2c8b0(final int[] array, final int[] array2) {
		...
		array2[0] = n * 36 >> 8;
		array2[1] = (array[1] << 8) + n * 18 >> 8;
		array2[0] += 2088;
		array2[1] += 216;
	}

	static void sub_2c907(final cActor class_f) {
		final int[] array = new int[2];
		final int[] array2 = new int[2];
		array[0] = class_f.cameraX;
		array[1] = class_f.cameraY;
		sub_2c867(array, array2);
		...
		for (int i = 0; i < class_f.var_1815; ++i) {
			for (int j = 0; j < class_f.var_181d; ++j) {
				if (sub_2cdf8(array2[0] + i, array2[1] + j)) {
					...
					final byte[] var_6fc4 = cGame.s_actor_physMap;
					final int n4 = n3;
					var_6fc4[n4] |= 0x1;
				}
			}
	...
	static void sub_2c9ec(final cActor class_f) {
		final int[] array = new int[2];
		final int[] array2 = new int[2];
		array[0] = class_f.cameraX;
		array[1] = class_f.cameraY;
	...
	static boolean sub_2cad2(final cActor class_f) {
		final int[] array = new int[2];
		final int[] array2 = new int[2];
		array[0] = class_f.cameraX;
		array[1] = class_f.cameraY;
		...
		for (int n3 = 0; n3 < class_f.var_1815 && !b; ++n3) {
			for (int n4 = 0; n4 < class_f.var_181d && !b; b = (!sub_2cdf8(array2[0] + n3, array2[1] + n4)
					|| (cGame.s_actor_physMap[(array2[1] + n4) * 96 + array2[0] + n3] & 0x1) != 0x0), ++n4) {
			}
		}
		return b;
	}

	static boolean sub_2cc02(final cActor class_f, final cActor class_f2) {
		final int[] array = new int[2];
		final int[] array2 = new int[2];
		array[0] = class_f.cameraX;
		array[1] = class_f.cameraY;
		...
		final int[] array5 = new int[2];
		final int[] array6 = new int[2];
		array5[0] = class_f2.cameraX;
		array5[1] = class_f2.cameraY;
		...
		for (n = 0, n2 = 0; n2 < n3 && n == 0; ++n2) {
			for (n7 = 0; n7 < n4 && n == 0; ++n7) {
				if (sub_2cdf8(array[0] + n2, array[1] + n7)) {
					...
					n = (((cGame.s_actor_physMap[n] & 0x1) != 0x0) ? 1 : 0);
				} else {
					n = 1;
				}
			}
	...
	private static void sub_2ce3a(int i, final int n, final int n2, final int n3) {
		while (i < n2) {
			for (int j = n; j < n3; ++j) {
				cGame.s_actor_physMap[j * 96 + i] = 1;
			}
			++i;
		}
	}
	...
	static boolean sub_2ceb1(int n, final int n2) {
		if (sub_2cdf8(n, n2)) {
			n += n2 * 96;
			return (cGame.s_actor_physMap[n] & 0x1) == 0x0;
		}
		return false;
	}
	...
	private static boolean sub_2cf89(final cActor class_f, final int[] array) {
		final int[] array2 = new int[2];
		final int[] array3 = new int[2];
	...
	private static boolean sub_2cfd6(final cActor class_f, final int[] array, final int var_17cd, final int var_17d5) {
		final int[] array2;
		...
		boolean b2 = false;
		while (!b2 && n2 < 96) {
			class_f.cameraX = array2[0];
			class_f.cameraY = array2[1];
		...
		if (!b2) {
			class_f.cameraX = var_17cd;
			class_f.cameraY = var_17d5;
		}
		return b2;
	}
	...
	private static boolean sub_2da02(final int n, int sub_2da54, final cActor class_f) {
	...
	static boolean sub_2da54(int n, int n2, final int n3) {
		...
		if (n == 0) {
			...
			n4 = GameDatas.s_allDatas[4].m_dataVars[n2][1];
		} else if (n == 3) {
	...
	private static void sub_2ddd7(final cActor class_f) {
		if (class_f != null) {
			int n = 0;
			final int var_1835 = class_f.actorID;
	...
	private static void sub_2deb3(final cActor class_f, final boolean b) {
		if (class_f == null) {
			return;
		}
		if (b) {
	...
	static int sub_2df26() {
		int var_705c;
		if (cGame.var_807c == 0) {
			var_705c = cGame.var_76d4 * cActor.sub_4d73(0, 1002);
		} else {
	...
	static void sub_2df93() {
		if (cGame.var_6fd4 > 0 && cActor.sub_59d2(2) == 0 && cGame.var_70d4 == 0) {
			cGame.var_6fd4 = 0;
		}
		if (cGame.var_6fdc && cActor.sub_59d2(2) == 0 && cGame.var_70d4 == 0) {
	...
	private static int sub_2e024(int getIntValue, final int n) {
		...
		final int getIntValue3 = decryptInt(cGame.var_7174[getIntValue][n]);
		if (getIntValue2 != getIntValue3) {
			return getIntValue3;
		}
		return getIntValue2;
	}
	...
	private static void sub_2e27a(final boolean b) {
		...
		final GameDatas class_h = GameDatas.s_allDatas[5];
		for (int i = 0; i < 99; ++i) {
			cGame.var_7074[i] = class_h.m_dataVars[i][1];
			cGame.var_707c[i] = class_h.m_dataVars[i][2];
			cGame.var_7084[i] = (short) class_h.m_dataVars[i][3];
		}
		setMaxPlots(10);
		sub_2eaf0(10);
		setMaxSiloAmount(10);
	...
	static boolean spendCoins(final int amount) {
		if (amount <= getCoins()) {
			addCoins(-amount);
			return true;
		}
	...
	static boolean spendFeed(final int amount, final int index) {
		if (amount <= getFeed(index)) {
			addFeed(index, -amount);
			return true;
		}
		return false;
	}

	static boolean spendCash(final int amount) {
		if (amount <= getCash()) {
			addCash(-amount);
			return true;
		}
	...
	static void addCoins(int amount) {
		setCoins((getCoins() + amount < 0) ? 0
				: ((getCoins() + amount > cGame.s_maxCoins) ? cGame.s_maxCoins : (getCoins() + amount)));
		if (amount > 0) {
			amount = 0;
			sub_49db0(amount, amount, 11, false);
		}
	}

	static boolean sub_2e4fa(final int n, final int n2) {
		if (sub_2e954() + n > cGame.var_701c * cActor.sub_4d73(0, 1005)) {
			cGame.var_7aac = 1;
			sub_8370(Define.GS_FARM);
			return false;
		}
	...
	static void addDeluxifier(final int amount) {
		cGame.s_deluxifierAmount = ((cGame.s_deluxifierAmount + amount < 0) ? 0
				: ((cGame.s_deluxifierAmount + amount > cGame.s_maxDeluxifiers) ? cGame.s_maxDeluxifiers : (cGame.s_deluxifierAmount + amount)));
	}
	...
	private static void onLevelUp() {
		...
		if (nextLevel < 50) {
			final GameDatas class_h = GameDatas.s_allDatas[27];
			for (int i = 0; i < class_h.var_7a; ++i) {
				if (class_h.m_dataVars[i][1] == nextLevel) {
					setMaxPlots(class_h.m_dataVars[i][2]);
					// What the fuck Gameloft?
					cGame.var_795c = getMaxPlots() - getMaxPlots();
					sub_2eaf0(class_h.m_dataVars[i][3]);
					setMaxSiloAmount(class_h.m_dataVars[i][4]);
					break;
				}
			}
		} else {
		...
		if (nextLevel < 99) {
			...
			if (n2 > 0) {
				cActor.newActor(47, 2, array3).sub_8c4c(array[0], array[1], 36, 1000, false, n2);
			}
			if (n3 > 0) {
				cActor.newActor(47, 2, array3).sub_8c4c(array[0], array[1], 6, 1000, true, n3);
			}
		}
		cGame.var_6c84 = true;
		switchToState(Define.GS_LEVELUP);
		final GameDatas class_h2 = GameDatas.s_allDatas[23];
		for (int j = 0; j < class_h2.m_dataVars[getLevel() - 1][6]; ++j) {
	...
	static int getFeed(int index) {
		...
		final int getIntValue = decryptInt(cGame.var_714c[index]);
	...
	private static void addFeed(final int index, int amount) {
		amount = ((getFeed(index) + amount < 0) ? 0
				: ((getFeed(index) + amount > cGame.var_701c * cActor.sub_4d73(0, 1005))
						? (cGame.var_701c * cActor.sub_4d73(0, 1005))
						: (getFeed(index) + amount)));
		sub_2e99f(index, amount);
	}
	...
	static void sub_2ec47(final int n, final cActor class_f) {
		...
		if (cGame.var_70d4 > 0) {
			...
			case 0: {
				if (cGame.var_70b4[cGame.var_70cc] != 0 && cGame.var_70b4[cGame.var_70cc] != 1
					...
					cGame.var_8004.sub_66d8(cGame.var_70c4[cGame.var_70cc].cameraX - 36,
							cGame.var_70c4[cGame.var_70cc].cameraY - 18);
				...
				if (cGame.var_807c == 0 || cGame.var_6e24[cGame.var_807c - 1][5] > 0) {
					...
					case 1: {
						...
						if (cGame.var_70c4[cGame.var_70cc].var_17c5 == 49) {
							...
							if ((cGame.var_807c != 0 || sub_2dcf3(5) + cActor.sub_59d2(2) + n <= sub_2df26())
							...
							if ((cGame.var_807c != 0 || sub_2dcf3(5) + cActor.sub_59d2(2) + n2 <= sub_2df26())
					...
					case 4: {
						cGame.var_70c4[cGame.var_70cc].feedAnimal();
						break;
					}
					case 5: {
					...
					case 6: {
						...
						sub_2c9ec(class_f);
						cActor.newActor(47, 2, new int[] { 0, 0, 14 }).sub_8c4c(class_f.cameraX, class_f.cameraY, 37,
								1000, false, 1);
						class_f.var_185d = 9;
						class_f.spriteId = -1;
						class_f.spriteFrame = -1;
						break;
					}
					case 7: {
		...
		for (int i = 0; i < cGame.var_710c[cGame.var_70ec].length; ++i) {
			...
			case 108: {
				...
				(sub_25b35 = sub_25b35(cGame.var_7114[cGame.var_70ec][i * 6],
						cGame.var_7114[cGame.var_70ec][i * 6 + 1])).cameraX = cGame.var_7114[cGame.var_70ec][i
								* 6 + 2];
				sub_25b35.cameraY = cGame.var_7114[cGame.var_70ec][i * 6 + 3];
				sub_25b35.var_1845 = sub_25b35.cameraX;
				sub_25b35.var_184d = sub_25b35.cameraY;
				break;
			}
			case 103: {
				final cActor sub_25b36;
				(sub_25b36 = sub_25b35(cGame.var_7114[cGame.var_70ec][i * 6],
						cGame.var_7114[cGame.var_70ec][i * 6 + 1])).cameraX = cGame.var_800c.cameraX
								+ cGame.var_7114[cGame.var_70ec][i * 6 + 2];
				sub_25b36.cameraY = cGame.var_800c.cameraY + cGame.var_7114[cGame.var_70ec][i * 6 + 3];
				sub_25b36.var_1845 = sub_25b36.cameraX;
				sub_25b36.var_184d = sub_25b36.cameraY;
				break;
			}
			case 109: {
				final cActor[] array = new cActor[2];
				cActor.sub_545c(0, cGame.var_7114[cGame.var_70ec][i * 6],
			...
			case 104: {
				final cActor[] array2 = new cActor[2];
				cActor.sub_545c(0, cGame.var_7114[cGame.var_70ec][i * 6],
			...
			case 106: {
				final cActor[] array3 = new cActor[2];
				cActor.sub_545c(0, cGame.var_7114[cGame.var_70ec][i * 6],
			...
			case 105: {
				final cActor[] array4 = new cActor[2];
				cActor.sub_545c(0, cGame.var_7114[cGame.var_70ec][i * 6],
			...
			case 111: {
				sub_2fced(cActor.sub_53db(0, cGame.var_7114[cGame.var_70ec][i * 6]),
						cGame.var_7114[cGame.var_70ec][i * 6 + 1], cGame.var_7114[cGame.var_70ec][i * 6 + 2]);
				break;
			}
			case 112: {
				final cActor sub_53db = cActor.sub_53db(0, cGame.var_7114[cGame.var_70ec][i * 6]);
			...
			case 113: {
				cActor.sub_53db(0, cGame.var_7114[cGame.var_70ec][i * 6]).sub_4bf4();
				break;
			}
			case 21: {
				final cActor sub_53db2;
				(sub_53db2 = cActor.sub_53db(0,
						cGame.var_7114[cGame.var_70ec][i * 6])).cameraX = cGame.var_7114[cGame.var_70ec][i * 6
								+ 1];
				sub_53db2.cameraY = cGame.var_7114[cGame.var_70ec][i * 6 + 2];
				sub_53db2.var_1845 = sub_53db2.cameraX;
				sub_53db2.var_184d = sub_53db2.cameraY;
				break;
			}
			case 22: {
				final cActor sub_53db3;
				if ((sub_53db3 = cActor.sub_53db(0, cGame.var_7114[cGame.var_70ec][i * 6])).var_189d == null) {
			...
			case 11: {
				cGame.var_800c.cameraX = cGame.var_7114[cGame.var_70ec][i * 6];
				cGame.var_800c.cameraY = cGame.var_7114[cGame.var_70ec][i * 6 + 1];
				cGame.var_800c.var_1845 = cGame.var_800c.cameraX;
				cGame.var_800c.var_184d = cGame.var_800c.cameraY;
				break;
			}
			case 12: {
			...
			case 114: {
				final cActor sub_53db4;
				(sub_53db4 = cActor.sub_53db(0,
						cGame.var_7114[cGame.var_70ec][i * 6])).cameraX = cGame.var_800c.cameraX
								+ cGame.var_7114[cGame.var_70ec][i * 6 + 1];
				sub_53db4.cameraY = cGame.var_800c.cameraY + cGame.var_7114[cGame.var_70ec][i * 6 + 2];
				sub_53db4.var_1845 = sub_53db4.cameraX;
				sub_53db4.var_184d = sub_53db4.cameraY;
			...
			case 115: {
				final cActor sub_53db5 = cActor.sub_53db(0, cGame.var_7114[cGame.var_70ec][i * 6]);
				final int n = cGame.var_7114[cGame.var_70ec][i * 6 + 1];
				final int n2 = cGame.var_7114[cGame.var_70ec][i * 6 + 2];
				final int n3 = n;
				final cActor class_f = sub_53db5;
				switch (sub_53db5.var_17c5) {
				case 42: {
					class_f.sub_670e(cGame.var_800c.cameraX + n3, cGame.var_800c.cameraY + n2);
					continue;
				}
				case 32: {
					class_f.var_1845 = cGame.var_800c.cameraX + n3;
					class_f.var_184d = cGame.var_800c.cameraY + n2;
					continue;
				}
				case 51: {
					class_f.sub_924a(cGame.var_800c.cameraX + n3, cGame.var_800c.cameraY + n2);
					continue;
				}
				case 13: {
					class_f.sub_6b0c(cGame.var_800c.cameraX + n3, cGame.var_800c.cameraY + n2, 1500);
					continue;
				}
				}
				break;
	...
	private static void sub_2fced(final cActor class_f, final int var_1845, final int var_184d) {
		switch (class_f.var_17c5) {
		case 42: {
		...
		if (cGame.var_70ec < cGame.var_7124) {
			...
			if (cGame.var_70ec + 1 < cGame.var_7124
				...
				for (int i = 0; i < cGame.var_710c[cGame.var_70ec].length; ++i) {
					...
					case 116: {
						final cActor sub_53db;
						if ((sub_53db = cActor.sub_53db(0, cGame.var_7114[cGame.var_70ec][i * 6])).var_189d
								.IsAnimOver()) {
							sub_53db.sub_a25c(8);
							++n;
						}
					...
					case 22: {
						if (cActor.sub_53db(0, cGame.var_7114[cGame.var_70ec][i * 6]).var_189d.GetNumLoops() <= 0) {
							++n;
						}
						break;
					}
					case 105: {
						...
						cActor.sub_545c(0, cGame.var_7114[cGame.var_70ec][i * 6],
								cGame.var_7114[cGame.var_70ec][i * 6 + 1], array, 1);
						if (array[0].var_189d.GetNumLoops() <= 0) {
							++n;
						}
						break;
					}
					...
					case 115: {
						final cActor sub_53db2;
						if ((sub_53db2 = cActor.sub_53db(0,
								cGame.var_7114[cGame.var_70ec][i * 6])).cameraX == sub_53db2.var_1845
								&& sub_53db2.cameraY == sub_53db2.var_184d) {
							++n;
						}
						break;
					}
					case 12: {
						if (cGame.var_800c.cameraX + (GLLib.s_screenWidth >> 1) == cGame.var_800c.var_1845
								&& cGame.var_800c.cameraY + (GLLib.s_screenHeight >> 1) == cGame.var_800c.var_184d) {
							++n;
							break;
						}
						break;
					...
					case 109: {
						...
						case 13: {
							if (array2[0].cameraX + (GLLib.s_screenWidth >> 1) == array2[0].var_1845
									&& array2[0].cameraY + (GLLib.s_screenHeight >> 1) == array2[0].var_184d) {
								++n;
								continue;
							}
							continue;
						...
						default: {
							if (array2[0].cameraX == array2[0].var_1845 && array2[0].cameraY == array2[0].var_184d) {
								++n;
								continue;
							}
							continue;
	...
	// This might just be some stuff that the game does on load
	private static void Init(final boolean b) {
		GameDatas.s_allDatas = new GameDatas[34];
		GLLib.Pack_Open("/9");
		for (int i = 0; i < 34; ++i) {
			GameDatas.s_allDatas[i] = new GameDatas();
			final byte[] resourceBytes = GLLib.Pack_ReadData(i);
			GLLib.Dbg("Open File " + i);
			int offset = 0;
			GameDatas.s_allDatas[i].var_7a = GLLib.Mem_GetInt(resourceBytes, 0);
			offset += 4;
			GameDatas.s_allDatas[i].var_72 = GLLib.Mem_GetInt(resourceBytes, 4);
			offset += 4;
			if (GameDatas.s_allDatas[i].var_7a > 0 && GameDatas.s_allDatas[i].var_72 > 0) {
				final byte[] array = new byte[GameDatas.s_allDatas[i].var_72];
				for (int j = 0; j < GameDatas.s_allDatas[i].var_72; ++j) {
					array[j] = resourceBytes[offset];
					++offset;
				}
				GameDatas.s_allDatas[i].m_dataVars = new int[GameDatas.s_allDatas[i].var_7a][GameDatas.s_allDatas[i].var_72];
				for (int k = 0; k < GameDatas.s_allDatas[i].var_7a; ++k) {
					for (int l = 0; l < GameDatas.s_allDatas[i].var_72; ++l) {
						switch (array[l]) {
						case 1: {
							GameDatas.s_allDatas[i].m_dataVars[k][l] = resourceBytes[offset];
							break;
						}
						case 2: {
							GameDatas.s_allDatas[i].m_dataVars[k][l] = GLLib.Mem_GetShort(resourceBytes, offset);
							break;
						}
						case 4: {
							GameDatas.s_allDatas[i].m_dataVars[k][l] = GLLib.Mem_GetInt(resourceBytes, offset);
							break;
						}
						}
						offset += array[l];
					...
					if (!cGame.s_iapEnabled) {
						switch (i) {
						case 20: {
							GameDatas.s_allDatas[i].m_dataVars[k][1] = GameDatas.s_allDatas[i].m_dataVars[k][2];
						}
						case 3: {
							GameDatas.s_allDatas[i].m_dataVars[k][15] = GameDatas.s_allDatas[i].m_dataVars[k][16];
							GameDatas.s_allDatas[i].m_dataVars[k][31] = GameDatas.s_allDatas[i].m_dataVars[k][32];
							GameDatas.s_allDatas[i].m_dataVars[k][13] = GameDatas.s_allDatas[i].m_dataVars[k][14];
							break;
						}
						case 0: {
							GameDatas.s_allDatas[i].m_dataVars[k][15] = GameDatas.s_allDatas[i].m_dataVars[k][16];
						...
						case 2: {
							GameDatas.s_allDatas[i].m_dataVars[k][16] = GameDatas.s_allDatas[i].m_dataVars[k][17];
							GameDatas.s_allDatas[i].m_dataVars[k][12] = GameDatas.s_allDatas[i].m_dataVars[k][13];
							break;
						}
						case 7: {
							GameDatas.s_allDatas[i].m_dataVars[k][16] = GameDatas.s_allDatas[i].m_dataVars[k][17];
						...
						case 4: {
							GameDatas.s_allDatas[i].m_dataVars[k][19] = GameDatas.s_allDatas[i].m_dataVars[k][20];
							break;
						}
						case 1: {
							GameDatas.s_allDatas[i].m_dataVars[k][5] = GameDatas.s_allDatas[i].m_dataVars[k][6];
							GameDatas.s_allDatas[i].m_dataVars[k][7] = GameDatas.s_allDatas[i].m_dataVars[k][8];
							break;
						}
						case 6: {
							GameDatas.s_allDatas[i].m_dataVars[k][8] = GameDatas.s_allDatas[i].m_dataVars[k][9];
							GameDatas.s_allDatas[i].m_dataVars[k][10] = GameDatas.s_allDatas[i].m_dataVars[k][11];
							break;
						}
						}
					}
		...
		for (int n5 = 0; n5 < 30; ++n5) {
			cGame.var_8064[n5] = GameDatas.s_allDatas[20].m_dataVars[n5][1];
		}
		cGame.var_806c = new int[14];
		for (int n6 = 0; n6 < 14; ++n6) {
			cGame.var_806c[n6] = GameDatas.s_allDatas[31].m_dataVars[n6][2];
		}
		GLLib.text_encoding = "UTF-8";
		cGame.s_tutorialState = 0;
		cGame.s_zoomLevel = 100;
		cGame.var_8074 = true;
		...
		for (int n8 = 0; n8 < 117; ++n8) {
			cGame.var_80cc[n8] = (short) GameDatas.s_allDatas[1].m_dataVars[n8][1];
			cGame.var_80d4[n8] = (short) GameDatas.s_allDatas[1].m_dataVars[n8][3];
			cGame.var_80dc[n8] = (short) GameDatas.s_allDatas[1].m_dataVars[n8][4];
		}
		cGame.var_8094 = new short[22];
		cGame.var_809c = new int[22];
		for (int n9 = 0; n9 < 22; ++n9) {
			cGame.var_8094[n9] = (short) GameDatas.s_allDatas[2].m_dataVars[n9][1];
			cGame.var_809c[n9] = GameDatas.s_allDatas[2].m_dataVars[n9][2];
		}
		cGame.var_80a4 = new short[64];
		cGame.var_80ac = new int[64];
		for (int n10 = 0; n10 < 64; ++n10) {
			cGame.var_80a4[n10] = (short) GameDatas.s_allDatas[0].m_dataVars[n10][1];
			cGame.var_80ac[n10] = GameDatas.s_allDatas[0].m_dataVars[n10][2];
		}
		cGame.var_80bc = new int[10];
		for (int n11 = 0; n11 < 10; ++n11) {
			cGame.var_80bc[n11] = GameDatas.s_allDatas[8].m_dataVars[n11][1];
		}
		cGame.var_80c4 = new short[63];
		for (int n12 = 0; n12 < 63; ++n12) {
			cGame.var_80c4[n12] = (short) GameDatas.s_allDatas[4].m_dataVars[n12][1];
		}
		cGame.var_80fc = new short[297];
		cGame.var_80f4 = new short[297];
		for (int n13 = 0; n13 < 297; ++n13) {
			cGame.var_80fc[n13] = (short) GameDatas.s_allDatas[6].m_dataVars[n13][3];
			cGame.var_80f4[n13] = (short) GameDatas.s_allDatas[6].m_dataVars[n13][1];
		}
		cGame.var_80e4 = new short[83];
		for (int n14 = 0; n14 < 83; ++n14) {
			cGame.var_80e4[n14] = (short) GameDatas.s_allDatas[7].m_dataVars[n14][1];
		}
		cGame.var_80ec = new short[6];
		for (int n15 = 0; n15 < 6; ++n15) {
			cGame.var_80ec[n15] = (short) GameDatas.s_allDatas[22].m_dataVars[n15][1];
		}
		cGame.var_80b4 = new short[20];
		for (int n16 = 0; n16 < 20; ++n16) {
			cGame.var_80b4[n16] = (short) GameDatas.s_allDatas[3].m_dataVars[n16][1];
			if (GameDatas.s_allDatas[3].m_dataVars[n16][0] == 10) {
				cGame.var_76d4 = GameDatas.s_allDatas[3].m_dataVars[n16][30];
			} else if (GameDatas.s_allDatas[3].m_dataVars[n16][0] == 13) {
				cGame.var_701c = GameDatas.s_allDatas[3].m_dataVars[n16][30];
			}
		}
		cGame.var_8104 = new int[1440];
		cGame.var_810c = new short[1440];
		for (int n17 = 0; n17 < 1440; ++n17) {
			cGame.var_8104[n17] = GameDatas.s_allDatas[29].m_dataVars[n17][1];
			cGame.var_810c[n17] = (short) GameDatas.s_allDatas[29].m_dataVars[n17][2];
		}
		cGame.var_8114 = new int[281];
		cGame.var_811c = new short[281];
		for (int n18 = 0; n18 < 281; ++n18) {
			cGame.var_8114[n18] = GameDatas.s_allDatas[32].m_dataVars[n18][2];
			cGame.var_811c[n18] = (short) GameDatas.s_allDatas[32].m_dataVars[n18][1];
		}
		sub_2ebbe();
		cGame.s_actor_physMap = new byte[9216];
		sub_2d8bf();
		cActor.sub_9f59();
	...
	private static boolean drawMarket(int n) {
		if (n == 0) {
			...
			cGame.var_68cc[2][1] = ((GLLib.Text_GetString(Define.TEXT_MARKET) == null) ? "" : GLLib.Text_GetString(Define.TEXT_MARKET));
		}
		if (n == 1) {
			if (cGame.var_721c == 0) {
				if (cGame.var_722c == 4) {
			...
			cGame.var_720c = -1;
			cGame.s_market_currPage = 0;
			cGame.s_plotAmount = cActor.sub_4cf5(0, 49);
			if (cGame.s_tutorialState == -1 && cGame.var_6c5c == 160) {
				sub_2024d(2, 4, true);
		...
		if (n == 2) {
			...
			if ((sub_2b09 = GLLib.IsAnyKeyDown()) == 19 || sub_2b09 == 11) {
				if (cGame.s_tutorialState > 0) {
					final String sub_4e1f2;
					platformRequest("Show_Toast_" + (((sub_4e1f2 = GLLib.Text_GetString(Define.TEXT_CANNOTGOBACK)) == null) ? "" : sub_4e1f2));
				} else {
					onExitMarket();
				}
			}
			...
			if (cGame.var_6914[0] != null && !sub_2351a(0, 1)) {
				if (cGame.var_6914[0][8] < -cGame.var_7234 && cGame.s_market_currPage < cGame.var_719c - '\u0006') {
					sub_3275b(1);
				} else if (cGame.var_6914[0][8] > -10 && cGame.s_market_currPage > 0) {
					sub_3275b(-1);
				}
			}
		}
		if (n == 3) {
			sub_1dcc1(2);
			sub_1df06(GLLib.Text_FormatNumber(getCoins(), cGame.s_currencySeprType, " "), 2, 5, 0, 0);
			sub_1df06(GLLib.Text_FormatNumber(getCash(), cGame.s_currencySeprType, " "), 2, 9, 0, 0);
			final int[] array = new int[4];
			...
			for (int i = 0; i < n; ++i) {
				final String sub_4e1f3;
				drawString(((sub_4e1f3 = GLLib.Text_GetString(cGame.s_marketItemNames[i + cGame.s_market_currPage])) == null) ? ""
				...
				if (cGame.var_721c != 0 || cGame.var_7224 != -1
					...
					if (sub_20167(2, 33 + i * 14)) {
						...
						if (cGame.s_marketItemCosts[n8] > 0) {
							sub_1df06(GLLib.Text_FormatNumber(cGame.s_marketItemCosts[n8], cGame.s_currencySeprType, " "), 2, 32 + i * 14, 0,
									0);
						} else if (cGame.var_71d4[n8] > 0) {
							sub_1df06(GLLib.Text_FormatNumber(cGame.var_71d4[n8], cGame.s_currencySeprType, " "), 2, 32 + i * 14, 0,
									0);
						}
					}
					if (sub_20167(2, 40 + i * 14)) {
						final String sub_4e1f4;
						sub_1df06(
								(((sub_4e1f4 = GLLib.Text_GetString(Define.TEXT_PREFIX_LEVEL)) == null) ? "" : sub_4e1f4)
										+ Integer.toString(cGame.var_71fc[i + cGame.s_market_currPage]),
								2, 32 + i * 14, 0, 0);
					}
				}
			}
			if (cGame.var_720c >= 0 && cGame.var_720c < 6) {
				sub_1df06(
						GLLib.Text_FormatNumber(cGame.var_71c4[cGame.var_720c + cGame.s_market_currPage], cGame.s_currencySeprType, " "),
						2, 39 + 14 * cGame.var_720c, 0, 0);
				final int n9 = (n = cGame.var_71bc[cGame.var_720c + cGame.s_market_currPage]) / 86400;
				final int n10;
				...
				sub_1df06(
						GLLib.Text_FormatNumber(cGame.var_71b4[cGame.var_720c + cGame.s_market_currPage], cGame.s_currencySeprType, " "),
						2, 35 + 14 * cGame.var_720c, 0, 0);
			}
			if (cGame.var_720c != 0 && cGame.var_721c == 2 && cGame.s_market_currPage == 0) {
	...
	private static void sub_3151e(final int var_721c, int var_7224) {
		...
		var_7224 = 0;
		final GameDatas class_h;
		final int var_7a = (class_h = GameDatas.s_allDatas[var_721c]).var_7a;
		if (class_h != null) {
		...
		for (int i = 0; i < var_7a; ++i) {
			if (cGame.var_721c != 0 || cGame.var_7224 == class_h.m_dataVars[i][9]) {
				switch (cGame.var_721c) {
				case 0: {
					if ((n = class_h.m_dataVars[i][5]) > -1) {
						cGame.s_marketCropItemIDs[n] = class_h.m_dataVars[i][0];
						cGame.s_marketItemNames[n] = class_h.m_dataVars[i][2];
						cGame.s_marketItemCosts[n] = class_h.m_dataVars[i][6];
						cGame.var_71d4[n] = class_h.m_dataVars[i][7];
						cGame.var_71f4[n] = class_h.m_dataVars[i][1];
						cGame.var_71dc[n] = class_h.m_dataVars[i][3];
						cGame.var_71e4[n] = class_h.m_dataVars[i][4];
						cGame.var_71fc[n] = class_h.m_dataVars[i][8];
						cGame.s_marketItemIsLocked[n] = (class_h.m_dataVars[i][8] > getLevel());
						cGame.var_71ec[n] = class_h.m_dataVars[i][32];
						cGame.var_71b4[n] = class_h.m_dataVars[i][10];
						if (class_h.m_dataVars[i][34] == 1) {
							cGame.var_71bc[n] = class_h.m_dataVars[i][13] * 60;
						} else {
							cGame.var_71bc[n] = class_h.m_dataVars[i][25] * 60;
						}
						cGame.var_71c4[n] = class_h.m_dataVars[i][15];
						break;
					}
					break;
				}
				case 2: {
					if ((n = class_h.m_dataVars[i][5]) > -1) {
						...
						cGame.var_71fc[n] = class_h.m_dataVars[i][8];
						cGame.s_marketItemIsLocked[n] = (class_h.m_dataVars[i][8] > getLevel());
						cGame.var_71b4[n] = class_h.m_dataVars[i][16];
						cGame.var_71bc[n] = class_h.m_dataVars[i][11];
						cGame.var_71c4[n] = class_h.m_dataVars[i][12];
						break;
					}
					break;
				}
				case 3: {
					if ((n = class_h.m_dataVars[i][5]) > -1) {
						cGame.s_marketCropItemIDs[n] = class_h.m_dataVars[i][0];
						cGame.s_marketItemNames[n] = class_h.m_dataVars[i][2];
						if (class_h.m_dataVars[i][7] > 0) {
							final int sub_4d73 = cActor.sub_4d73(0, class_h.m_dataVars[i][1]);
							cGame.s_marketItemCosts[n] = class_h.m_dataVars[i][6
									+ ((sub_4d73 - 1 < 0) ? 0 : ((sub_4d73 - 1 > 3) ? 3 : (sub_4d73 - 1)))];
						} else {
							cGame.s_marketItemCosts[n] = class_h.m_dataVars[i][6];
						}
						cGame.var_71d4[n] = class_h.m_dataVars[i][10];
						cGame.var_71f4[n] = class_h.m_dataVars[i][1];
						cGame.var_71dc[n] = class_h.m_dataVars[i][3];
						cGame.var_71e4[n] = class_h.m_dataVars[i][4];
						cGame.var_71fc[n] = class_h.m_dataVars[i][11];
						cGame.s_marketItemIsLocked[n] = (class_h.m_dataVars[i][11] > getLevel());
						break;
					}
					break;
				}
		...
		if (cGame.s_tutorialState == 13 || cGame.s_tutorialState == 14) {
			sub_2024d(2, 113, false);
			sub_2000c(2, 113, false);
			if (var_721c != 0) {
	...
	private static void sub_31ca6(int n) {
		...
		n = 0;
		final GameDatas class_h;
		final int var_7a = (class_h = GameDatas.s_allDatas[13]).var_7a;
		if (class_h != null) {
			cGame.s_marketItemNames = new int[var_7a];
			cGame.s_marketCropItemIDs = null;
			cGame.var_71b4 = new int[var_7a];
		...
		for (int i = 0; i < var_7a; ++i) {
			cGame.var_71dc[i] = class_h.m_dataVars[i][2];
			cGame.var_71e4[i] = class_h.m_dataVars[i][3];
			cGame.s_marketItemNames[i] = class_h.m_dataVars[i][1];
			if (i < 6) {
	...
	private static void sub_31ee1(final int var_720c, final boolean b, final boolean b2) {
		...
		if (b) {
			...
			if (cGame.s_tutorialState == 14 && var_720c != 0) {
				sub_2024d(2, n2, false);
			} else {
				sub_2024d(2, n2, true);
			}
			if (cGame.var_721c == 0) {
				cGame.var_68bc[2][n4][8] = (short) cGame.var_71ec[cGame.s_market_currPage + var_720c];
	...
	private static void buyMarketItem(int n) {
		...
		if (!cGame.s_marketItemIsLocked[n]
				&& ((!b && cGame.s_marketItemCosts[n] <= getCoins()) || (b && cGame.var_71d4[n] <= getCash()))) {
			boolean b2 = false;
			...
			case 2: {
				if (cGame.s_marketCropItemIDs[n] == 0) {
					final cActor[] array = new cActor[50];
					final int sub_545c = cActor.sub_545c(0, 49, -1, array, 50);
					int n2 = -1;
					int n3 = Integer.MAX_VALUE;
					for (int i = 0; i < sub_545c; ++i) {
						final int n4 = array[i].cameraX - cGame.var_800c.cameraX;
						final int n5 = array[i].cameraY - cGame.var_800c.cameraY;
						final int n6;
					...
					cActor var_6ab4;
					if (n2 != -1) {
						var_6ab4 = sub_25a75(49, 0, array[n2].cameraX, array[n2].cameraY, true);
					} else {
			...
			if (cGame.var_6ab4 != null && b2) {
				...
				if (sub_2cf89(cGame.var_6ab4, array2)) {
					cGame.var_6ab4.cameraX = array2[0];
					cGame.var_6ab4.cameraY = array2[1];
				}
				cGame.var_800c.sub_6b0c(cGame.var_6ab4.cameraX, cGame.var_6ab4.cameraY, 1000);
			}
			sub_8370(Define.GS_FARM);
			...
			if (b) {
				if (cGame.var_71d4[n] > 0) {
					final String sub_4e1f;
					cGame.var_7ab4 = GLLib.Text_FindReplace(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCASH)) == null) ? "" : sub_4e1f,
							"%d", GLLib.Text_FormatNumber(cGame.var_71d4[n] - getCash(), cGame.s_currencySeprType, " "));
					cGame.var_7aac = 19;
					cGame.var_815c = true;
					cGame.var_7d24 = true;
					switchToState(Define.GS_BUYSCR);
				...
				final String sub_4e1f2;
				cGame.var_7ab4 = GLLib.Text_FindReplace(((sub_4e1f2 = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCOIN)) == null) ? "" : sub_4e1f2,
						"%d", GLLib.Text_FormatNumber(cGame.s_marketItemCosts[n] - getCoins(), cGame.s_currencySeprType, " "));
				cGame.var_7aac = 18;
				cGame.var_815c = true;
				cGame.var_7d24 = false;
				switchToState(Define.GS_BUYSCR);
	...
	private static void onMarketButton(final int n, final int var_722c, final boolean b) {
		sub_251a0(-1);
		sub_117fc();
		sub_3d6da(false, -1);
		sub_3e7c1();
		...
		cGame.var_722c = var_722c;
		if (b) {
			switchToState(Define.GS_MARKET);
			return;
		}
		sub_82a7(Define.GS_MARKET);
	}

	private static boolean drawSaledesk(final int n) {
		if (n == 1) {
			...
			final String sub_4e1f;
			cGame.var_68cc[3][197] = (((sub_4e1f = GLLib.Text_GetString(Define.TEXT_SALESDESK_NOITEM)) == null) ? "" : sub_4e1f);
		}
		if (n == 5) {
			if (cGame.var_7294 > 0) {
				final int var_7294 = cGame.var_7294;
				final cActor[] array = new cActor[2];
				cActor.sub_545c(0, 50, 9, array, 2);
				if (array[0] != null) {
					sub_e055(false, cGame.var_7294, array[0].cameraX, array[0].cameraY);
					if (cGame.var_729c > 0) {
						sub_e055(true, cGame.var_729c, array[0].cameraX, array[0].cameraY);
					}
				} else {
					sub_e055(false, cGame.var_7294, array[0].cameraX, array[0].cameraY);
					sub_e055(true, cGame.var_729c, array[0].cameraX, array[0].cameraY);
		...
		if (n == 3) {
			sub_1dcc1(3);
			final String sub_4e1f3;
			sub_1df06(((sub_4e1f3 = GLLib.Text_GetString(Define.TEXT_SALESDESK)) == null) ? "" : sub_4e1f3, 3, 8, 0, 0);
			if (cGame.var_72ec) {
				final String sub_4e1f4;
				sub_1df06(((sub_4e1f4 = GLLib.Text_GetString(Define.TEXT_DELIVER)) == null) ? "" : sub_4e1f4, 3, 200, 0, 0);
				final String sub_4e1f5;
				sub_1df06(((sub_4e1f5 = GLLib.Text_GetString(cGame.var_6e4c[cGame.var_72b4][2])) == null) ? ""
						: sub_4e1f5, 3, 176, 0, 0);
				for (int i = 0; i < 3; ++i) {
				...
				final String sub_4e1f6;
				sub_1df06(((sub_4e1f6 = GLLib.Text_GetString(cGame.var_723c[cGame.var_72b4])) == null) ? "" : sub_4e1f6,
						3, 189, 0, 0);
				sub_1df06(GLLib.Text_FormatNumber(cGame.var_7254[cGame.var_72b4], cGame.s_currencySeprType, " "), 3, 192, 0, 0);
				sub_1df06("" + cGame.var_7274[cGame.var_72b4], 3, 194, 0, 0);
				sub_1df06(GLLib.Text_FormatNumber(sub_336ae(), cGame.s_currencySeprType, " "), 3, 200, 0, 0);
			}
		}
		return false;
	}
	...
	private static void sub_32e1a(final int n, final boolean b) {
		...
		if (b) {
			...
			if (!cGame.var_72ec) {
				...
				final String sub_4fa1 = GLLib.Text_FormatNumber(decryptInt(cGame.var_72cc[cGame.var_72ac + n]),
						cGame.s_currencySeprType, " ");
				final int n4 = n2 + 13;
				cGame.var_68cc[3][n4] = sub_4fa1;
				final String sub_4fa2 = GLLib.Text_FormatNumber(decryptInt(cGame.var_72d4[cGame.var_72ac + n]),
						cGame.s_currencySeprType, " ");
				final int n5 = n2 + 11;
		...
		final String sub_4e1f;
		cGame.var_68cc[3][n2 + 16] = (((sub_4e1f = GLLib.Text_GetString(Define.TEXT_EMPTY)) == null) ? "" : sub_4e1f);
		sub_2000c(3, n2 + 18, false);
		sub_2000c(3, n2 + 13, false);
		sub_2000c(3, n2 + 11, false);
	}

	private static void openSDOrder(final int orderNum) {
		if (cGame.s_tutorialState == 56 && orderNum != 0) {
			return;
		}
		cGame.var_72b4 = cGame.var_72ac + orderNum;
		if (cGame.var_72ec) {
			final GameDatas class_h = GameDatas.s_allDatas[1];
			for (int i = 0; i < 3; ++i) {
				final int n3;
				...
				if (cGame.var_6e44[cGame.var_72b4] != null && cGame.var_6e44[cGame.var_72b4][i << 1] > -1) {
					cGame.var_68bc[3][n2][5] = (short) class_h.m_dataVars[cGame.var_6e44[cGame.var_72b4][i << 1]][3];
					cGame.var_68bc[3][n2][6] = (short) class_h.m_dataVars[cGame.var_6e44[cGame.var_72b4][i << 1]][4];
					...
					sub_2000c(3, n2, true);
					sub_2000c(3, n3 + 179, class_h.m_dataVars[cGame.var_6e44[cGame.var_72b4][i << 1]][9] == 1);
		...
		} else if (orderNum < cGame.var_72a4) {
	...
	private static void sub_336f2(final int n) {
		sub_33687((sub_336ae() + n < 0) ? 0
				: ((sub_336ae() + n > cGame.s_maxCoins) ? cGame.s_maxCoins : (sub_336ae() + n)));
	}
	...
	private static void sub_33c10() {
		...
		int n = 0;
		for (int i = 0; i < class_h.var_7a; ++i) {
			final int n2 = class_h.m_dataVars[i][3];
			final int n3;
			if ((n3 = class_h.m_dataVars[i][4]) >= 1 && n2 == cGame.var_736c && n3 - 1 == cGame.var_7304) {
				n = i;
				break;
			}
		}
		cGame.var_73bc = class_h.m_dataVars[n][1];
		if ((cGame.var_7374 = class_h.m_dataVars[n][18]) > 117) {
			return;
		}
		cGame.var_737c = class_h2.m_dataVars[cGame.var_7374][7];
		cGame.var_7384 = class_h.m_dataVars[n][16];
		cGame.s_kitchen_resultItemName = class_h.m_dataVars[n][2];
		cGame.var_73d4 = class_h.m_dataVars[n][6];
		cGame.s_kitchen_firstItemName = class_h2.m_dataVars[cGame.var_73d4][2];
		cGame.s_kitchen_firstItemNeedCnt = class_h.m_dataVars[n][7];
		cGame.var_73f4 = class_h.m_dataVars[n][8];
		cGame.var_73dc = class_h.m_dataVars[n][9];
		cGame.s_kitchen_secondItemName = class_h2.m_dataVars[cGame.var_73dc][2];
		cGame.s_kitchen_secondItemNeedCnt = class_h.m_dataVars[n][10];
		cGame.var_73fc = class_h.m_dataVars[n][11];
		cGame.var_7414 = class_h.m_dataVars[n][12];
		cGame.var_7394 = getPrepareTime(cGame.var_738c = class_h.m_dataVars[n][14] * 60);
		cGame.var_73a4 = class_h.m_dataVars[n][15];
		cGame.var_73ac = (short) class_h2.m_dataVars[cGame.var_7374][3];
		cGame.var_68bc[7][3][5] = (short) class_h2.m_dataVars[cGame.var_73d4][3];
		cGame.var_68bc[7][3][6] = (short) class_h2.m_dataVars[cGame.var_73d4][4];
		sub_d78c(1, cGame.var_68bc[7][3][5]);
		cGame.var_68bc[7][8][5] = (short) class_h2.m_dataVars[cGame.var_73dc][3];
		cGame.var_68bc[7][8][6] = (short) class_h2.m_dataVars[cGame.var_73dc][4];
		sub_d78c(1, cGame.var_68bc[7][8][5]);
		cGame.var_68bc[7][28][5] = (short) class_h2.m_dataVars[cGame.var_7374][3];
		cGame.var_68bc[7][28][6] = (short) class_h2.m_dataVars[cGame.var_7374][4];
		cGame.var_68bc[7][40][5] = (short) class_h2.m_dataVars[cGame.var_7374][3];
		cGame.var_68bc[7][40][6] = (short) class_h2.m_dataVars[cGame.var_7374][4];
		sub_d78c(1, class_h2.m_dataVars[cGame.var_7374][3]);
		sub_33e7d();
	}

	private static void sub_33e7d() {
		cGame.s_kitchen_firstItemCnt = sub_2e024(0, cGame.var_73d4);
		cGame.s_kitchen_secondItemCnt = sub_2e024(0, cGame.var_73dc);
		if (cGame.var_73d4 == cGame.var_73dc && cGame.s_kitchen_firstItemNeedCnt + cGame.s_kitchen_secondItemNeedCnt > cGame.s_kitchen_firstItemCnt) {
			if (cGame.s_kitchen_firstItemCnt <= cGame.s_kitchen_firstItemNeedCnt) {
				cGame.s_kitchen_secondItemCnt = 0;
			} else {
				cGame.s_kitchen_firstItemCnt = cGame.s_kitchen_firstItemNeedCnt;
				cGame.s_kitchen_secondItemCnt -= cGame.s_kitchen_firstItemNeedCnt;
			}
		}
		boolean b = false;
		boolean b2 = false;
		...
		boolean b3 = true;
		if (cGame.s_kitchen_firstItemNeedCnt <= cGame.s_kitchen_firstItemCnt) {
			sub_2000c(7, 5, true);
			sub_2000c(7, 7, false);
		...
		if (cGame.s_kitchen_secondItemNeedCnt <= cGame.s_kitchen_secondItemCnt) {
			sub_2000c(7, 10, true);
		...
		if (cGame.var_7414 > 0 && cGame.s_deluxifierAmount > 0 && !cGame.var_73b4) {
			sub_2000c(7, 17, true);
			sub_2024d(7, 17, true);
		} else {
			sub_2000c(7, 17, false);
	...
	private static void sub_34199(final boolean var_741c) {
		if (var_741c) {
			...
			sub_2386a(7, 43, 0, 1);
			if (cGame.var_73b4) {
				cGame.var_737c = GameDatas.s_allDatas[1].m_dataVars[cGame.var_7374 + 1][7];
			} else {
				cGame.var_737c = GameDatas.s_allDatas[1].m_dataVars[cGame.var_7374][7];
			}
		} else {
	...
	private static boolean drawKitchen(int n) {
		if (n == 0) {
		...
		if (n == 1) {
			...
			for (int j = 0; j < class_h.var_7a; ++j) {
				final int n2;
				final int n3;
				if ((n2 = class_h.m_dataVars[j][4]) > 0 && (n3 = class_h.m_dataVars[j][3]) > -1) {
					cGame.var_7314[n2 - 1][n3] = class_h.m_dataVars[j][2];
					cGame.var_731c[n2 - 1][n3] = class_h.m_dataVars[j][0];
					if (class_h.m_dataVars[j][18] != -1 && class_h.m_dataVars[j][18] < 117) {
						cGame.var_7324[n2 - 1][n3] = class_h2.m_dataVars[class_h.m_dataVars[j][18]][7];
					} else {
						cGame.var_7324[n2 - 1][n3] = 0;
					}
					cGame.var_732c[n2 - 1][n3] = class_h.m_dataVars[j][16];
					cGame.var_7334[n2 - 1][n3] = class_h.m_dataVars[j][14] * 60;
					final int n4;
					if ((n4 = class_h.m_dataVars[j][18]) != -1 && n4 < 117) {
						cGame.var_733c[n2 - 1][n3] = class_h2.m_dataVars[n4][3];
						cGame.var_7344[n2 - 1][n3] = class_h2.m_dataVars[n4][4];
					...
					cGame.var_734c[n2 - 1][n3] = class_h.m_dataVars[j][5];
			...
			for (int n7 = (cGame.var_747c - cGame.var_7484 >= 5) ? 5 : (cGame.var_747c - cGame.var_7484),
				...
				if (cGame.var_7484 + l < cGame.var_747c && l < 5) {
					...
					cGame.var_68cc[22][13
							+ l * 15] = (((sub_4e1f = GLLib.Text_GetString(cGame.var_7494[l + cGame.var_7484])) == null)
									? ""
									: sub_4e1f);
					if (!cGame.var_7354) {
						...
						cGame.var_68cc[22][12 + l * 15] = (((sub_4e1f2 = GLLib
								.Text_GetString(cGame.var_7494[l + cGame.var_7484])) == null) ? "" : sub_4e1f2);
					...
					cGame.var_68cc[22][12 + l
							* 15] = (((sub_4e1f3 = GLLib.Text_GetString(cGame.var_7494[l + cGame.var_7484])) == null)
									? ""
									: sub_4e1f3);
				}
				...
				if (n8 > cGame.var_74a4[n9] + cGame.var_749c[n9]) {
					...
					cGame.var_74d4[n9] = getPrepareTime(n12);
					cGame.var_74bc[n9] = 3;
					...
					sub_35a1e(true, l);
					final String sub_4e1f4;
					cGame.var_74d4[n9] = (((sub_4e1f4 = GLLib.Text_GetString(Define.TEXT_QUEUED)) == null) ? "" : sub_4e1f4);
		...
		if (n == 3) {
			sub_1dcc1(22);
			final String sub_4e1f5;
			sub_1df06(((sub_4e1f5 = GLLib.Text_GetString(Define.TEXT_KITCHEN_HOME)) == null) ? "" : sub_4e1f5, 22, 1, 0, 0);
			sub_1df06(GLLib.Text_FormatNumber(getCash(), cGame.s_currencySeprType, " "), 22, 9, 0, 0);
			...
			final String sub_4e1f6;
			sub_1df06(((sub_4e1f6 = GLLib.Text_GetString(Define.TEXT_RECIPES)) == null) ? "" : sub_4e1f6, 22, 94, 0, 0);
			...
			final int n19 = n15;
			n = n14;
			GLLib.SetClip(GLLib.g, n, n19, n18, n17, true);
			...
			for (int n20 = 0; n20 < n; ++n20) {
				...
				final String sub_4e1f7;
				drawString(((sub_4e1f7 = GLLib.Text_GetString(cGame.var_7314[cGame.var_7304][n21])) == null) ? ""
						: sub_4e1f7, 22, 97 + n20 * 9, 0, 0);
				if (getLevel() < cGame.var_734c[cGame.var_7304][n21]) {
					final String sub_4e1f8;
					sub_1df06(
							(((sub_4e1f8 = GLLib.Text_GetString(Define.TEXT_PREFIX_LEVEL)) == null) ? "" : sub_4e1f8)
									+ Integer.toString(cGame.var_734c[cGame.var_7304][n21]),
							22, 101 + n20 * 9, 0, 0);
				} else {
					sub_1df06(getPrepareTime(cGame.var_7334[cGame.var_7304][n21]), 22, 100 + n20 * 9, 0, 0);
				}
			}
			final int var_1ddf = GLLib.s_screenWidth;
			final int var_1de7 = GLLib.s_screenHeight;
	...
	private static void sub_353b5(final int n, final boolean b) {
		...
		if (cGame.var_7484 + n < cGame.var_747c) {
			...
			final String sub_4e1f;
			cGame.var_68cc[22][13
					+ n * 15] = (((sub_4e1f = GLLib.Text_GetString(cGame.var_7494[n + cGame.var_7484])) == null) ? ""
							: sub_4e1f);
			if (!cGame.var_7354) {
			...
			if (!cGame.var_7354 && n + cGame.var_7484 < cGame.var_7474
				...
				cGame.var_68cc[22][12
						+ n * 15] = (((sub_4e1f2 = GLLib.Text_GetString(cGame.var_7494[n + cGame.var_7484])) == null)
								? ""
								: sub_4e1f2);
			}
		}
	...
	private static void sub_35acd(final int n) {
		...
		final int n3 = class_h.m_dataVars[n2][6];
		final int n4 = class_h.m_dataVars[n2][7];
		final int n5 = class_h.m_dataVars[n2][9];
		final int n6 = class_h.m_dataVars[n2][10];
		if (sub_2dcf3(5) + cActor.sub_59d2(2) + n4 + n6 > sub_2df26()) {
			cGame.var_7aac = 2;
			sub_8370(Define.GS_FARM);
			return;
		}
	...
	private static boolean drawFeedmill(int n) {
		if (n == 0) {
		...
		if (n == 1) {
			...
			cGame.var_758c = 0;
			int n2 = 0;
			final GameDatas class_h = GameDatas.s_allDatas[22];
			final GameDatas class_h2 = GameDatas.s_allDatas[1];
			if (class_h != null) {
			...
			for (int i = 0; i < class_h.var_7a; ++i) {
				final int n3;
				if ((n3 = class_h.m_dataVars[i][3]) > -1) {
					cGame.var_7594[n3] = class_h.m_dataVars[i][2];
					cGame.var_759c[n3] = class_h.m_dataVars[i][0];
					if (class_h.m_dataVars[i][15] != -1 && class_h.m_dataVars[i][15] < 117) {
						cGame.var_75a4[n3] = class_h2.m_dataVars[class_h.m_dataVars[i][15]][7];
					} else {
						cGame.var_75a4[n3] = 0;
					}
					cGame.var_75ac[n3] = class_h.m_dataVars[i][13];
					cGame.var_75b4[n3] = class_h.m_dataVars[i][11] * 60;
					final int n4;
					if ((n4 = class_h.m_dataVars[i][15]) != -1 && n4 < 117) {
						cGame.var_75bc[n3] = class_h2.m_dataVars[n4][3];
						cGame.var_75c4[n3] = class_h2.m_dataVars[n4][4];
					...
					cGame.var_75cc[n3] = (byte) class_h.m_dataVars[i][4];
					if (n2 < 6) {
						++n2;
					}
					++cGame.var_7584;
		...
		if (n == 2) {
			final int sub_2b09;
			if ((sub_2b09 = GLLib.IsAnyKeyDown()) == 19 || sub_2b09 == 11) {
				if ((cGame.var_6c5c == 0 || cGame.var_6c5c == 160) && cGame.s_tutorialState == -1) {
					sub_14a74();
				} else {
					final String sub_4e1f;
					platformRequest("Show_Toast_" + (((sub_4e1f = GLLib.Text_GetString(Define.TEXT_CANNOTGOBACK)) == null) ? "" : sub_4e1f));
				}
			}
			if (cGame.s_tutorialState != -1) {
				sub_273b8();
		...
		if (n == 3) {
			sub_1dcc1(22);
			final String sub_4e1f2;
			sub_1df06(((sub_4e1f2 = GLLib.Text_GetString(Define.TEXT_FEEDMILL)) == null) ? "" : sub_4e1f2, 22, 1, 0, 0);
			sub_1df06(GLLib.Text_FormatNumber(getCash(), cGame.s_currencySeprType, " "), 22, 9, 0, 0);
			...
			GLLib.SetClip(GLLib.g, 0, 0, GLLib.s_screenWidth, GLLib.s_screenHeight, true);
			final String sub_4e1f3;
			sub_1df06(((sub_4e1f3 = GLLib.Text_GetString(Define.TEXT_FEEDTYPES)) == null) ? "" : sub_4e1f3, 22, 94, 0, 0);
			cGame.var_68d4[cGame.var_68bc[22][95][5]].GetFrameRect(cGame.var_68bc[22][95][6], 0, array, 0);
			...
			final int n12 = n8;
			n = n7;
			GLLib.SetClip(GLLib.g, n, n12, n11, n10, true);
			n = ((cGame.var_7584 - cGame.var_758c >= 6) ? 6 : (cGame.var_7584 - cGame.var_758c));
			for (int k = 0; k < n; ++k) {
				final String sub_4e1f4;
				drawString(((sub_4e1f4 = GLLib.Text_GetString(cGame.var_7594[k + cGame.var_758c])) == null) ? ""
						: sub_4e1f4, 22, 97 + k * 9, 0, 0);
				if (getLevel() < cGame.var_75cc[k + cGame.var_758c]) {
					final String sub_4e1f5;
					sub_1df06((((sub_4e1f5 = GLLib.Text_GetString(Define.TEXT_PREFIX_LEVEL)) == null) ? "" : sub_4e1f5)
							+ Integer.toString(cGame.var_75cc[k + cGame.var_758c]), 22, 101 + k * 9, 0, 0);
				} else {
					sub_1df06(getPrepareTime(cGame.var_75b4[k + cGame.var_758c]), 22, 100 + k * 9, 0, 0);
				}
			}
			final int var_1ddf = GLLib.s_screenWidth;
			final int var_1de7 = GLLib.s_screenHeight;
	...
	private static void sub_36661() {
		for (int n = (cGame.var_751c - cGame.var_7524 >= 5) ? 5 : (cGame.var_751c - cGame.var_7524),
			...
			if (cGame.var_7524 + i < cGame.var_751c && i < 5) {
				...
				final String sub_4e1f;
				cGame.var_68cc[22][12
						+ i * 15] = (((sub_4e1f = GLLib.Text_GetString(cGame.var_7534[i + cGame.var_7524])) == null)
								? ""
								: sub_4e1f);
			}
			final long n2 = System.currentTimeMillis() / 1000L;
			...
			if (n2 > cGame.var_7544[n3] + cGame.var_753c[n3]) {
				...
				cGame.var_7574[n3] = getPrepareTime(n6);
				cGame.var_7564[n3] = 3;
				...
				sub_37156(true, i);
				final String sub_4e1f2;
				cGame.var_7574[n3] = (((sub_4e1f2 = GLLib.Text_GetString(Define.TEXT_QUEUED)) == null) ? "" : sub_4e1f2);
	...
	private static void sub_36bc8(final int n, final boolean b) {
		...
		if (cGame.var_7524 + n < cGame.var_751c) {
			...
			final String sub_4e1f;
			cGame.var_68cc[22][13
					+ n * 15] = (((sub_4e1f = GLLib.Text_GetString(cGame.var_7534[n + cGame.var_7524])) == null) ? ""
							: sub_4e1f);
			if (!cGame.var_75d4) {
				sub_2000c(22, 22 + n * 15, b);
			...
			if (!cGame.var_75d4 && n + cGame.var_7524 < cGame.var_7474
				...
				final String sub_4e1f2;
				cGame.var_68cc[22][12
						+ n * 15] = (((sub_4e1f2 = GLLib.Text_GetString(cGame.var_7534[n + cGame.var_7524])) == null)
								? ""
								: sub_4e1f2);
			}
		}
	...
	private static void sub_37204(final int n) {
		...
		int n2 = 0;
		for (int i = 0; i < 6; ++i) {
			if (cGame.var_752c[n] == class_h.m_dataVars[i][1]) {
				n2 = i;
				break;
			}
		}
		final int n3 = class_h.m_dataVars[n2][5];
		final int n4 = class_h.m_dataVars[n2][6];
		final int n5 = class_h.m_dataVars[n2][8];
		final int n6 = class_h.m_dataVars[n2][9];
		if (sub_2dcf3(5) + cActor.sub_59d2(2) + n4 + n6 >= sub_2df26()) {
			cGame.var_7aac = 2;
			sub_8370(Define.GS_FARM);
			return;
	...
	private static void sub_37750() {
		...
		int n = 0;
		for (int i = 0; i < class_h.var_7a; ++i) {
			if (class_h.m_dataVars[i][3] == cGame.var_7604) {
				n = i;
				break;
			}
		}
		cGame.var_764c = class_h.m_dataVars[n][1];
		if ((cGame.var_760c = class_h.m_dataVars[n][15]) > 117) {
			return;
		}
		cGame.var_7614 = class_h.m_dataVars[n][13];
		cGame.var_762c = class_h.m_dataVars[n][2];
		cGame.var_7664 = class_h.m_dataVars[n][5];
		cGame.var_7654 = class_h2.m_dataVars[cGame.var_7664][2];
		cGame.var_7674 = class_h.m_dataVars[n][6];
		cGame.var_7684 = class_h.m_dataVars[n][7];
		cGame.var_766c = class_h.m_dataVars[n][8];
		cGame.var_765c = class_h2.m_dataVars[cGame.var_766c][2];
		cGame.var_767c = class_h.m_dataVars[n][9];
		cGame.var_768c = class_h.m_dataVars[n][10];
		cGame.var_7624 = getPrepareTime(cGame.var_761c = class_h.m_dataVars[n][11] * 60);
		cGame.var_7634 = class_h.m_dataVars[n][12];
		cGame.var_763c = (short) class_h2.m_dataVars[cGame.var_760c][3];
		cGame.var_7644 = (short) class_h2.m_dataVars[cGame.var_760c][4];
		cGame.var_68bc[6][3][5] = (short) class_h2.m_dataVars[cGame.var_7664][3];
		cGame.var_68bc[6][3][6] = (short) class_h2.m_dataVars[cGame.var_7664][4];
		sub_d78c(1, cGame.var_68bc[6][3][5]);
		cGame.var_68bc[6][8][5] = (short) class_h2.m_dataVars[cGame.var_766c][3];
		cGame.var_68bc[6][8][6] = (short) class_h2.m_dataVars[cGame.var_766c][4];
		sub_d78c(1, cGame.var_68bc[6][8][5]);
		cGame.var_68bc[6][21][5] = (short) class_h2.m_dataVars[cGame.var_760c][3];
		cGame.var_68bc[6][21][6] = (short) class_h2.m_dataVars[cGame.var_760c][4];
		cGame.var_68bc[6][32][5] = (short) class_h2.m_dataVars[cGame.var_760c][3];
		cGame.var_68bc[6][32][6] = (short) class_h2.m_dataVars[cGame.var_760c][4];
		sub_d78c(1, class_h2.m_dataVars[cGame.var_760c][3]);
		sub_37991();
	}
	...
	private static boolean drawBarn(int i) {
		if (i == 1) {
			...
			if (cGame.s_barnPage == 0) {
				sub_38251(new int[] { 0, 4 });
			} else if (cGame.s_barnPage == 1) {
				sub_38251(new int[] { 3 });
			} else if (cGame.s_barnPage == 2) {
				sub_38251(new int[] { 1, 2 });
			}
			sub_18af3(cGame.s_barnPage);
		...
		if (i == 5) {
			if (cGame.var_76ec != -1) {
				...
				final int n2 = cGame.s_barn_itemIDs[var_76ec];
			...
			cGame.var_76fc = null;
			cGame.var_7714 = null;
			cGame.s_barn_itemCounts = null;
			cGame.var_7724 = null;
			cGame.var_772c = null;
			cGame.var_7734 = null;
			cGame.var_773c = null;
			cGame.s_barn_itemNames = null;
			cGame.var_7744 = null;
			sub_d7d7(1);
			sub_239ef(10);
		}
		...
		if (i == 3 && !cGame.var_775c) {
			sub_1dcc1(10);
			final String sub_4e1f2;
			sub_1df06(((sub_4e1f2 = GLLib.Text_GetString(Define.TEXT_INVENTORY)) == null) ? "" : sub_4e1f2, 10, 1, 0, 0);
			final String sub_4e1f3;
			sub_1df06(((sub_4e1f3 = GLLib.Text_GetString(Define.TEXT_MAXIMUM)) == null) ? "" : sub_4e1f3, 10, 65, 0, 0);
			sub_1e44e(10, 60);
			if (sub_202b7(10, 63)) {
				final String sub_4e1f4;
				sub_1df06(((sub_4e1f4 = GLLib.Text_GetString(Define.TEXT_MORE)) == null) ? "" : sub_4e1f4, 10, 64, 0, 0);
			}
			...
			for (n13 = ((cGame.s_barnItemCount - cGame.s_barnScrollLvl >= 6) ? 6
				...
				final String sub_4e1f5;
				drawString(((sub_4e1f5 = GLLib.Text_GetString(cGame.s_barn_itemNames[cGame.s_barnScrollLvl + n14])) == null) ? ""
						: sub_4e1f5, 10, 14 + n14 * 7, 0, 0);
				sub_1df06("x" + cGame.s_barn_itemCounts[cGame.s_barnScrollLvl + n14], 10, 16 + n14 * 7, 0, 0);
			}
			String sub_4e1f6;
			for (i = n14; i < 6; ++i) {
				sub_1df06(((sub_4e1f6 = GLLib.Text_GetString(Define.TEXT_EMPTY)) == null) ? "" : sub_4e1f6, 10, 15 + i * 7, 0, 0);
			}
			final int var_1ddf = GLLib.s_screenWidth;
			final int var_1de7 = GLLib.s_screenHeight;
			i = var_1ddf;
			GLLib.SetClip(GLLib.g, 0, 0, i, var_1de7, true);
		}
		return false;
	}
	...
	private static void sub_38251(final int[] array) {
		...
		if (cGame.s_barnItemCount > 0) {
			...
			cGame.s_barn_itemIDs = new int[cGame.s_barnItemCount];
			cGame.var_7714 = new int[cGame.s_barnItemCount];
			cGame.s_barn_itemCounts = new short[cGame.s_barnItemCount];
			...
			cGame.s_barn_itemNames = new short[cGame.s_barnItemCount];
			...
			for (int j = 0; j < array.length; ++j) {
				...
				final GameDatas class_h = GameDatas.s_allDatas[n3];
				for (int k = 0; k < n4; ++k) {
					if (sub_2e024(array[j], k) > 0) {
						cGame.var_76fc[n2] = k;
						cGame.var_7704[n2] = array[j];
						cGame.s_barn_itemIDs[n2] = (short) class_h.m_dataVars[k + n5][0];
						cGame.var_7714[n2] = n3;
						cGame.s_barn_itemCounts[n2] = (short) sub_2e024(array[j], k);
						cGame.var_7724[n2] = (short) class_h.m_dataVars[k + n5][3];
						cGame.var_772c[n2] = (short) class_h.m_dataVars[k + n5][4];
						cGame.var_7734[n2] = 0;
						if (array[j] == 3 && class_h.m_dataVars[k][32] > 0) {
							cGame.var_7734[n2] = (short) class_h.m_dataVars[k][32];
						}
						cGame.var_773c[n2] = (short) class_h.m_dataVars[k + n5][1];
						cGame.s_barn_itemNames[n2] = (short) class_h.m_dataVars[k + n5][2];
						if (array[j] == 0) {
							cGame.var_7744[n2] = (byte) class_h.m_dataVars[k][9];
						}
						++n2;
						if (n < 6) {
							sub_385a9(n, true);
	...
	private static void sub_385a9(final int n, final boolean b) {
		...
		if (b) {
			while (true) {
				...
				boolean b2 = false;
				Label_0233: {
					switch (cGame.var_7704[cGame.s_barnScrollLvl + n]) {
					case 3: {
						cGame.var_68bc[10][n5][8] = cGame.var_7734[cGame.s_barnScrollLvl + n];
					...
					case 0: {
						...
						n7 = 10;
						n8 = n4 + 19;
						if (cGame.var_7744[cGame.s_barnScrollLvl + n] > 0) {
							b2 = true;
							break Label_0233;
						}
						break;
					...
					default: {
						cGame.var_68bc[10][n5][5] = cGame.var_7724[cGame.s_barnScrollLvl + n];
						cGame.var_68bc[10][n5][6] = cGame.var_772c[cGame.s_barnScrollLvl + n];
	...
	private static boolean drawManor(final int n) {
		if (n == 0) {
			cGame.var_7fcc = cGame.s_zoomLevel;
			cGame.s_zoomLevel = 100;
		...
		if (n == 1) {
			...
			for (int j = 0; j < ((cGame.s_manor_restoreLevel - 3 < 6) ? (cGame.s_manor_restoreLevel - 3) : 6); ++j) {
				if (cGame.var_7774[j] < System.currentTimeMillis()) {
					...
					cGame.var_68fc[j].RandomizeAnim();
					cGame.var_68fc[j].Render();
			...
			for (int k = 0; k < 3; ++k) {
				...
				cGame.var_690c[k].RandomizeAnim();
			...
			for (int n9 = 0; n9 <= ((cGame.s_manor_restoreLevel < 3) ? cGame.s_manor_restoreLevel : 2); ++n9) {
			...
			if (cGame.s_manor_restoreLevel < 9) {
				...
				switch (cGame.s_manor_restoreScrState) {
				case 0: {
					if (sub_4ac19(sub_3a3b8(cGame.s_manor_restoreLevel))) {
						n11 = 1;
						final boolean sub_3a230 = sub_3a230(cGame.s_manor_restoreLevel);
						final boolean sub_3a231 = sub_3a383();
						if (cGame.var_77dc = (sub_3a230 && sub_3a231)) {
							sub_3a73b((short) 1);
							n11 = 5;
							final short n12 = cGame.var_68bc[13][2 + cGame.s_manor_restoreLevel][2];
							final short n13 = cGame.var_68bc[13][2 + cGame.s_manor_restoreLevel][3];
				...
				case 1: {
					n11 = 1;
					final boolean sub_3a232 = sub_3a230(cGame.s_manor_restoreLevel);
					final boolean sub_3a233 = sub_3a383();
					if (cGame.var_77dc = (sub_3a232 && sub_3a233)) {
						n11 = 5;
						final short n14 = cGame.var_68bc[13][2 + cGame.s_manor_restoreLevel][2];
						final short n15 = cGame.var_68bc[13][2 + cGame.s_manor_restoreLevel][3];
						cGame.var_6904.SetSprite(cGame.var_68d4[36]);
						cGame.var_6904.SetAnim(1, -1, true);
				...
				case 3: {
					n11 = 12;
					final short n16 = cGame.var_68bc[13][2 + cGame.s_manor_restoreLevel][2];
					final short n17 = cGame.var_68bc[13][2 + cGame.s_manor_restoreLevel][3];
					cGame.var_6904.SetSprite(cGame.var_68d4[36]);
				...
				cGame.var_68bc[13][2 + cGame.s_manor_restoreLevel][5] = 36;
				cGame.var_68bc[13][2 + cGame.s_manor_restoreLevel][6] = (short) n11;
				sub_2000c(13, 2 + cGame.s_manor_restoreLevel, true);
				sub_2024d(13, 2 + cGame.s_manor_restoreLevel, true);
			}
			for (int n18 = 3; n18 < ((cGame.s_manor_restoreLevel < 9) ? cGame.s_manor_restoreLevel : 9); ++n18) {
				...
				if (cGame.var_68fc[n19] != null && cGame.var_68fc[n19].IsAnimOver()
					...
					cGame.var_68fc[n19].RandomizeAnim();
					cGame.var_778c[n19] = false;
				}
			}
			cGame.var_777c = new cActor[6];
		...
		if (n == 5) {
			cGame.var_777c = null;
			cGame.s_zoomLevel = cGame.var_7fcc;
			if (cGame.var_7844) {
				cGame.s_manor_restoreScrState = 0;
				++cGame.s_manor_restoreLevel;
				final cActor[] array = new cActor[2];
				cActor.sub_545c(0, 50, 18, array, 2);
				cActor.sub_6bd7();
				cGame.var_800c.sub_6b0c(array[0].cameraX, array[0].cameraY, 1000);
				final ASprite class_e;
				final short n24 = (class_e = cGame.s_gameSprites[128])._frames_fm_start[5];
				if (cGame.var_8004 != null) {
					cGame.var_8004.cameraX = array[0].cameraX + class_e.GetFModuleOX(n24);
					cGame.var_8004.cameraY = array[0].cameraY + class_e.GetFModuleOY(n24);
				}
				cGame.var_6c54 = true;
				if (cGame.var_781c > 0) {
					final cActor[] array2 = new cActor[2];
					cActor.sub_545c(0, 50, 18, array2, 2);
					sub_e055(true, cGame.var_781c, array2[0].cameraX, array2[0].cameraY);
				}
				cGame.var_7844 = false;
			}
			sub_239ef(13);
		...
		if (n == 2) {
			...
			if (cGame.s_manor_restoreScrState == 3) {
				cGame.var_68bc[13][2 + cGame.s_manor_restoreLevel][5] = 36;
				cGame.var_68bc[13][2 + cGame.s_manor_restoreLevel][6] = 12;
				final int n25 = cGame.var_6f7c & 0xFFFF;
				if ((cGame.var_6f7c >> 16 & 0xFFFF) == 0xD && n25 == 2 + cGame.s_manor_restoreLevel
				...
				if (cGame.var_7784) {
					...
					sub_2000c(13, 2 + cGame.s_manor_restoreLevel, false);
				}
				if (cGame.var_6904 != null) {
					cGame.var_6904.Update(GLLib.s_game_frameDT);
				}
			} else if (cGame.s_manor_restoreScrState == 2) {
				cGame.var_68bc[13][2 + cGame.s_manor_restoreLevel][6] = 8;
				cGame.var_7784 = true;
				if (cGame.var_77bc + cGame.var_77fc - System.currentTimeMillis() / 1000L < 0L) {
					cGame.s_manor_restoreScrState = 3;
					final short n26 = cGame.var_68bc[13][2 + cGame.s_manor_restoreLevel][2];
					final short n27 = cGame.var_68bc[13][2 + cGame.s_manor_restoreLevel][3];
					cGame.var_6904.SetSprite(cGame.var_68d4[36]);
					cGame.var_6904.SetAnim(5, -1, true);
			...
			} else if (cGame.s_manor_restoreScrState == 1 && cGame.var_77dc) {
				if (cGame.var_6904.IsAnimOver()) {
					final short n28 = cGame.var_68bc[13][2 + cGame.s_manor_restoreLevel][2];
					final short n29 = cGame.var_68bc[13][2 + cGame.s_manor_restoreLevel][3];
					cGame.var_6904.SetSprite(cGame.var_68d4[36]);
					cGame.var_6904.SetAnim(1, -1, true);
					cGame.var_6904.SetPos(n28, n29);
				}
				final int n30 = cGame.var_6f7c & 0xFFFF;
				if ((cGame.var_6f7c >> 16 & 0xFFFF) == 0xD && n30 == 2 + cGame.s_manor_restoreLevel
						&& !cGame.var_6904.IsAnimOver()) {
					cGame.var_7784 = true;
				} else if (!GLLib.Pointer_IsHeldDown() && cGame.var_7784) {
					cGame.var_7784 = false;
			...
			for (int n31 = 0; n31 < ((cGame.s_manor_restoreLevel - 3 < 6) ? (cGame.s_manor_restoreLevel - 3) : 6); ++n31) {
				if (cGame.var_68fc[n31].IsAnimOver()) {
					if (cGame.var_7774[n31] < System.currentTimeMillis()) {
						...
						cGame.var_68fc[n31].RandomizeAnim();
			...
			for (int n35 = 0; n35 < 3; ++n35) {
				...
				if ((cGame.var_6f7c >> 16 & 0xFFFF) == 0xD && n36 == n35 + 2) {
					...
					if (n35 == 0 && cGame.s_manor_restoreLevel >= 1) {
						if (cGame.var_779c) {
							cGame.var_68bc[13][2][6] = 6;
						} else {
							cGame.var_68bc[13][2][6] = 2;
						}
					} else if (n35 == 1 && cGame.s_manor_restoreLevel >= 2) {
						if (cGame.var_77a4) {
							cGame.var_68bc[13][3][6] = 7;
						} else {
							cGame.var_68bc[13][3][6] = 3;
						}
					} else if (n35 == 2 && cGame.s_manor_restoreLevel >= 3) {
						if (cGame.var_77ac) {
							cGame.var_68bc[13][4][6] = 4;
						} else {
							cGame.var_68bc[13][4][6] = 0;
					...
					if (n35 == 0 && cGame.s_manor_restoreLevel >= 1 && cGame.var_779c && cGame.var_7794[n35]) {
						cGame.var_7794[n35] = false;
					} else if (n35 == 1 && cGame.s_manor_restoreLevel >= 2 && cGame.var_77a4 && cGame.var_7794[n35]) {
						cGame.var_7794[n35] = false;
					} else if (n35 == 2 && cGame.s_manor_restoreLevel >= 3 && cGame.var_77ac && cGame.var_7794[n35]) {
						cGame.var_7794[n35] = false;
					}
				}
		...
		if (n == 3) {
			...
			if (cGame.var_6904 != null && !cGame.var_6904.IsAnimOver() && !cGame.var_7784) {
				cGame.var_6904.Render();
			}
			for (int n41 = 0; n41 < ((cGame.s_manor_restoreLevel - 3 < 6) ? (cGame.s_manor_restoreLevel - 3) : 6); ++n41) {
				if (cGame.var_68fc[n41] != null && !cGame.var_68fc[n41].IsAnimOver() && !cGame.var_778c[n41]) {
					cGame.var_68fc[n41].Render();
				}
			}
			...
			for (int n42 = 0; n42 < 3; ++n42) {
				if (cGame.var_690c[n42] != null && !cGame.var_690c[n42].IsAnimOver() && !cGame.var_7794[n42]) {
					cGame.var_690c[n42].Render();
				}
			}
			final String sub_4e1f;
			sub_1df06(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_MANOR)) == null) ? "" : sub_4e1f, 13, 1, 0, 0);
			final String sub_4e1f2;
			sub_1df06(((sub_4e1f2 = GLLib.Text_GetString(Define.TEXT_MANOR_KITCHEN)) == null) ? "" : sub_4e1f2, 13, 21, 0, 0);
			final String sub_4e1f3;
			sub_1df06(((sub_4e1f3 = GLLib.Text_GetString(Define.TEXT_MANOR_COLLROOM)) == null) ? "" : sub_4e1f3, 13, 23, 0, 0);
			final String sub_4e1f4;
			sub_1df06(((sub_4e1f4 = GLLib.Text_GetString(Define.TEXT_MANOR_TROPHYROOM)) == null) ? "" : sub_4e1f4, 13, 25, 0, 0);
			final String sub_4e1f5;
			sub_1df06(((sub_4e1f5 = GLLib.Text_GetString(Define.TEXT_MANOR_GALLERY)) == null) ? "" : sub_4e1f5, 13, 27, 0, 0);
			final String sub_4e1f6;
			sub_1df06(((sub_4e1f6 = GLLib.Text_GetString(Define.TEXT_MANOR_LIBRARY)) == null) ? "" : sub_4e1f6, 13, 29, 0, 0);
			final String sub_4e1f7;
			sub_1df06(((sub_4e1f7 = GLLib.Text_GetString(Define.TEXT_MANOR_GREENHOUSE)) == null) ? "" : sub_4e1f7, 13, 31, 0, 0);
			final String sub_4e1f8;
			sub_1df06(((sub_4e1f8 = GLLib.Text_GetString(Define.TEXT_MANOR_PANTRY)) == null) ? "" : sub_4e1f8, 13, 33, 0, 0);
			final String sub_4e1f9;
			sub_1df06(((sub_4e1f9 = GLLib.Text_GetString(Define.TEXT_MANOR_STORAGE)) == null) ? "" : sub_4e1f9, 13, 35, 0, 0);
			final String sub_4e1f10;
			sub_1df06(((sub_4e1f10 = GLLib.Text_GetString(Define.TEXT_MANOR_ATTIC)) == null) ? "" : sub_4e1f10, 13, 37, 0, 0);
			for (int n43 = 0; n43 < 6; ++n43) {
				if (cGame.var_68bc[13][n43 + 45][10] == 1) {
					sub_1df06(getRawPrepareTime((int) ((cGame.var_7774[n43] - System.currentTimeMillis()) / 1000L)), 13,
							n43 + 52, 0, 0);
				}
			}
			for (int n44 = 0; n44 < 6; ++n44) {
				if (cGame.var_777c[n44] != null) {
					cGame.var_777c[n44].PaintFrame();
	...
	private static boolean sub_39c33(final int n) {
		...
		if (cGame.var_68fc[n].IsAnimOver() && cGame.var_7774[n] >= System.currentTimeMillis()) {
			...
			case 4: {
				if (sub_2e954() >= cGame.var_701c * cActor.sub_4d73(0, 1005)) {
					playSndNoLoop(56);
					cGame.var_7aac = 1;
					sub_8370(Define.GS_FARM);
					return false;
			...
			case 5: {
				...
				int n7;
				int n8;
				for (class_h = GameDatas.s_allDatas[3], j = 0; j < class_h.var_7a; ++j) {
					n7 = class_h.m_dataVars[j][0];
					n8 = 36;
					switch (n) {
					case 0: {
						n8 = 1;
				...
				final int n9 = class_h.m_dataVars[j][13];
				if (n == 1) {
					n5 = (0x5 | n9 << 16);
					break;
				}
			...
			case 4: {
				...
				for (int k = 0; k < class_h2.var_7a; ++k) {
					if (class_h2.m_dataVars[k][16] != 0) {
						...
						if (n11 == class_h2.m_dataVars[k][16]) {
							array2[n10] = k;
							++n10;
						}
					}
				...
				final int n12 = class_h2.m_dataVars[array2[sub_2b97]][3];
				n5 = (class_h2.m_dataVars[array2[sub_2b97]][1] - 4000 | class_h2.m_dataVars[array2[sub_2b97]][17] << 16);
			...
			(cGame.var_777c[n] = cActor.newActor(47, 2, array)).sub_8c4c(cGame.var_800c.cameraX + n2,
					cGame.var_800c.cameraY + n3, n4, 1000, true, n5);
			b = true;
			if (n == 1) {
	...
	private static boolean sub_3a230(int n) {
		...
		cGame.var_77e4 = class_h.m_dataVars[n2][6];
		cGame.var_77d4 = class_h.m_dataVars[n2][2];
		n = class_h.m_dataVars[n2][34];
		final String sub_4e1f;
		cGame.var_784c = (((sub_4e1f = GLLib.Text_GetString(Define.TEXT_ACRE_BASEREQ + cGame.s_manor_restoreLevel)) == null) ? "" : sub_4e1f);
		return cGame.var_6d5c[n];
	}

	private static boolean sub_3a383() {
		return cGame.var_77e4 <= getCoins();
	}
	...
	private static void sub_3a485() {
		for (cActor var_17ad = cActor.var_157d[0]; var_17ad != null; var_17ad = var_17ad.var_17ad) {
			if (var_17ad.var_17c5 == 50) {
				final int n = cGame.s_manor_restoreLevel + 1;
	...
	private static void sub_3a73b(final short var_77f4) {
		cGame.s_manor_restoreScrState = var_77f4;
		if (var_77f4 == 1) {
			sub_2000c(14, 3, true);
			sub_2000c(14, 6, true);
	...
	private static boolean drawSendItem(int n) {
		if (n == 0) {
			cGame.var_774c = sub_237d7(10, 0, 1, 7, 20, 54) + 10;
			sub_1daf4(10);
			sub_2000c(10, 63, false);
			...
			sub_2000c(10, 63, false);
			final String sub_4e1f;
			cGame.var_68cc[10][66] = (((sub_4e1f = GLLib.Text_GetString(Define.TEXT_SEND_DESC)) == null) ? "" : sub_4e1f);
			sub_2c69b();
			sub_1fb8e(10);
		...
		if (n == 5) {
			...
			sub_d7d7(1);
			if (cGame.var_78bc) {
				drawPopupToastWithSpr(Define.TEXT_MAILBOX_THANKBASE + cGame.var_7bb4, cGame.s_mailbox_neighborSprs[cGame.var_7bb4],
		...
		if (n == 3) {
			sub_1dcc1(10);
			final String sub_4e1f2;
			sub_1df06(((sub_4e1f2 = GLLib.Text_GetString(Define.TEXT_SEND_ITEM)) == null) ? "" : sub_4e1f2, 10, 1, 0, 0);
			final int[] array = new int[4];
			...
			for (int i = 0; i < n; ++i) {
				final String sub_4e1f3;
				drawString(((sub_4e1f3 = GLLib.Text_GetString(cGame.var_7874[cGame.var_786c + i])) == null) ? ""
	...
	private static void sub_3ae52(final int n) {
		...
		for (int i = 0; i < 5; ++i) {
			if ((n >> i & 0x1) != 0x0) {
				...
				switch (n3) {
				case 0: {
					class_h = GameDatas.s_allDatas[1];
					break;
				}
				case 1: {
					class_h = GameDatas.s_allDatas[3];
					break;
				}
				}
				for (int j = 0; j < class_h.var_7a; ++j) {
					if (sub_2e024(n3, j) > 0) {
						...
						cGame.var_7874[cGame.var_78c4] = class_h.m_dataVars[j][2];
						cGame.var_788c[cGame.var_78c4] = (short) class_h.m_dataVars[j][3];
						cGame.var_7894[cGame.var_78c4] = (short) class_h.m_dataVars[j][4];
						cGame.var_789c[cGame.var_78c4] = (short) class_h.m_dataVars[j][11];
						cGame.var_78ac[cGame.var_78c4] = (short) class_h.m_dataVars[j][1];
						cGame.var_78a4[cGame.var_78c4] = (short) sub_2e024(n3, j);
						cGame.var_78b4[cGame.var_78c4] = (byte) class_h.m_dataVars[j][9];
						++cGame.var_78c4;
						if (n2 < 6) {
							sub_3b009(n2, true);
							++n2;
	...
	private static void sub_3b1e6(final int n) {
		...
		sub_2b10b(cGame.var_7bb4,
				cGame.var_789c[n + cGame.var_786c]
						* GameDatas.s_allDatas[24].m_dataVars[cGame.var_6e24[cGame.var_7bb4][1] / cGame.var_8064[25]][3]
						/ getLevel());
		final int n3;
		sub_49db0(n3 = cGame.var_80bc[0] + cGame.var_7bb4, 1, 28, false);
		sub_49db0(cGame.var_78ac[n + cGame.var_786c], 1, 26, false);
		sub_2bae9(n3, 1, 28);
		drawPopupToastWithSpr(Define.TEXT_MAILBOX_THANKBASE + cGame.var_7bb4, cGame.s_mailbox_neighborSprs[cGame.var_7bb4], cGame.s_mailbox_neighborSprIdxs[cGame.var_7bb4]);
		cGame.var_78bc = true;
		cGame.s_switcherState = 1;
		sub_2c69b();
	}

	private static boolean drawRequestItem(int n) {
		if (n == 0) {
			cGame.var_774c = sub_237d7(10, 0, 1, 7, 20, 54) + 10;
			sub_1daf4(10);
			sub_2000c(10, 63, false);
			...
			sub_2c69b();
			sub_1fb8e(10);
			cGame.s_reqItem_itemStrs = new int[117];
			cGame.s_reqItem_itemIds = new int[117];
		...
		if (n == 5) {
			cGame.s_reqItem_itemStrs = null;
			cGame.s_reqItem_itemIds = null;
			cGame.var_78e4 = null;
			cGame.var_78ec = null;
			cGame.var_78f4 = null;
			cGame.var_78fc = null;
			...
			sub_d7d7(1);
			if (cGame.var_7914) {
				drawPopupToastWithSpr(Define.TEXT_POPUP_SENTREQUEST, 7, 0);
			}
			sub_239ef(10);
		}
		if (n == 2) {
			...
			if (cGame.var_6914[0] != null && !sub_2351a(0, 1)) {
				if (cGame.var_6914[0][8] < -cGame.var_774c && cGame.var_78cc < cGame.s_reqItem_itemIndex - 6) {
					sub_3b90d(1);
		...
		if (n == 3) {
			sub_1dcc1(10);
			final String sub_4e1f;
			sub_1df06(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_REQUEST)) == null) ? "" : sub_4e1f, 10, 1, 0, 0);
			final int[] array = new int[4];
			cGame.var_68d4[cGame.var_68bc[10][12][5]].GetFrameRect(cGame.var_68bc[10][12][6], 0, array, 0);
			final int n2 = cGame.var_68bc[10][12][2] + array[0];
			final int n3 = cGame.var_68bc[10][12][3] + array[1];
			...
			n = n2;
			GLLib.SetClip(GLLib.g, n, n7, n6, n5, true);
			n = ((cGame.s_reqItem_itemIndex - cGame.var_78cc >= 6) ? 6 : (cGame.s_reqItem_itemIndex - cGame.var_78cc));
			for (int i = 0; i < n; ++i) {
				final String sub_4e1f2;
				drawString(((sub_4e1f2 = GLLib.Text_GetString(cGame.s_reqItem_itemStrs[cGame.var_78cc + i])) == null) ? ""
	...
	private static void sub_3b70c(int i) {
		int n = 0;
		cGame.var_78cc = 0;
		cGame.s_reqItem_itemIndex = 0;
		if ((i & 0x1) != 0x0) {
			final GameDatas class_h = GameDatas.s_allDatas[1];
			for (int j = 0; j < 117; ++j) {
				if (class_h.m_dataVars[j][14] > 0 && class_h.m_dataVars[j][11] <= getLevel()) {
					cGame.s_reqItem_itemIds[cGame.s_reqItem_itemIndex] = j;
					cGame.var_78e4[cGame.s_reqItem_itemIndex] = 0;
					cGame.s_reqItem_itemStrs[cGame.s_reqItem_itemIndex] = class_h.m_dataVars[j][2];
					cGame.var_78ec[cGame.s_reqItem_itemIndex] = (short) class_h.m_dataVars[j][3];
					cGame.var_78f4[cGame.s_reqItem_itemIndex] = (short) class_h.m_dataVars[j][4];
					cGame.var_78fc[cGame.s_reqItem_itemIndex] = (short) class_h.m_dataVars[j][11];
					cGame.var_7904[cGame.s_reqItem_itemIndex] = (short) class_h.m_dataVars[j][1];
					++cGame.s_reqItem_itemIndex;
					if (n < 6) {
						sub_3b82d(n, true);
						++n;
					}
	...
	private static void sub_3b90d(final int n) {
		...
		int n3;
		int i;
		for (n3 = ((cGame.s_reqItem_itemIndex - cGame.var_78cc >= 6) ? 6
				: (cGame.s_reqItem_itemIndex - cGame.var_78cc)), i = 0; i < n3; ++i) {
			sub_3b82d(i, true);
		}
		while (i < 6) {
			sub_3b82d(i, false);
	...
	private static void sub_3b9d3(final int n) {
		...
		if (cGame.var_7b6c[cGame.var_7bb4] * cGame.var_6e24[cGame.var_7bb4][1] / cGame.var_8064[24] >= GLLib
			...
			case 0: {
				cGame.var_6e24[cGame.var_7bb4][4] = cGame.s_reqItem_itemIds[n + cGame.var_78cc];
				break;
			}
			}
		} else {
	...
	private static boolean drawLevelupScreen(int n) {
		if (n == 0) {
			sub_23d73();
			cGame.var_6a6c = 0L;
			try {
		...
		if (n == 1) {
			...
			cGame.var_7924 = 0;
			final GameDatas class_h;
			final int var_7a = (class_h = GameDatas.s_allDatas[10]).var_7a;
			int var_7954 = 0;
			if (cGame.var_795c > 0) {
			...
			for (int i = 0; i < var_7a; ++i) {
				final int n2 = class_h.m_dataVars[i][1];
				final int n3 = class_h.m_dataVars[i][2];
				final short n4 = (short) class_h.m_dataVars[i][3];
				final short n5 = (short) class_h.m_dataVars[i][4];
				final short n6 = (short) class_h.m_dataVars[i][5];
			...
			sub_2c69b();
			sub_1fb8e(12);
			cGame.var_791c = cActor.sub_904a(4);
			sub_3de31();
		}
		if (n == 5) {
			sub_d7d7(1);
		...
		if (n == 3) {
			...
			final String sub_4e1f2;
			final String sub_4e1f3;
			String s = (((sub_4e1f2 = GLLib.Text_GetString(Define.TEXT_LEVEL)) == null) ? "" : sub_4e1f2) + " " + getLevel()
					+ (((sub_4e1f3 = GLLib.Text_GetString(Define.TEXT_EXCLAM)) == null) ? "" : sub_4e1f3);
			if (cGame.s_currencySeprType == 11) {
				final String sub_4e1f4;
				final String sub_4e1f5;
				s = getLevel() + (((sub_4e1f4 = GLLib.Text_GetString(Define.TEXT_LEVEL)) == null) ? "" : sub_4e1f4)
						+ (((sub_4e1f5 = GLLib.Text_GetString(Define.TEXT_EXCLAM)) == null) ? "" : sub_4e1f5);
			}
			sub_1df06(s, 12, 23, 0, 0);
			final String sub_4e1f6;
			drawString(((sub_4e1f6 = GLLib.Text_GetString(Define.TEXT_UNLOCKED)) == null) ? "" : sub_4e1f6, 12, 24, 0, 0);
			final String sub_4e1f7;
			drawString(((sub_4e1f7 = GLLib.Text_GetString(Define.TEXT_LEVELDESC)) == null) ? "" : sub_4e1f7, 12, 26, 0, 0);
			final String sub_4e1f8;
			drawString(((sub_4e1f8 = GLLib.Text_GetString(Define.TEXT_REACHED)) == null) ? "" : sub_4e1f8, 12, 25, 0, 0);
			final String sub_4e1f9;
			drawString(((sub_4e1f9 = GLLib.Text_GetString(Define.TEXT_LEVELFLAVORBASE + (getLevel() - 2))) == null) ? "" : sub_4e1f9, 12, 27, 0, 0);
	...
	private static boolean drawPauseMenu(int substate) {
		if (substate == 0) {
			sub_23d73();
			playSndNoLoop(60);
			final String hasPush;
			cGame.s_hasPushNotifications = ((hasPush = GloftGF2M.s_instance.getAppProperty("Has-Push-Notification")) != null
					&& hasPush.indexOf("0") == -1);
		...
		if (substate == 8 && !cGame.s_displayPauseSndOpt && cGame.s_displayPauseHelp) {
			if (GLLib.Pointer_IsDown() || GLLib.Pointer_IsDragged() || cGame.var_799c) {
				...
				if (sub_2c577(GLLib.s_pointerX, GLLib.s_pointerY, n2, n3, n4, n5)) {
					if (!cGame.var_799c) {
						cGame.var_79a4 = GLLib.s_pointerY;
					}
					cGame.var_799c = true;
					if (cGame.var_79cc >= n5) {
						final boolean b = (cGame.var_79c4 += GLLib.s_pointerY - cGame.var_79a4) > cGame.var_79cc / 2
								- n5 / 2;
		...
		if (substate == 2) {
			...
			if (cGame.s_displayPauseCreds && cGame.var_797c) {
		...
		if (substate == 3) {
			...
			if (cGame.s_displayBasePauseMnu) {
				final String sub_4e1f;
				sub_1df06(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_PAUSE_TITLE)) == null) ? "" : sub_4e1f, 15, 1, 0, 0);
				final String sub_4e1f2;
				drawString(((sub_4e1f2 = GLLib.Text_GetString(Define.TEXT_PAUSE_OPTIONS)) == null) ? "" : sub_4e1f2, 15, 5, 0, 0);
				final String sub_4e1f3;
				drawString(((sub_4e1f3 = GLLib.Text_GetString(Define.TEXT_PAUSE_ABOUT)) == null) ? "" : sub_4e1f3, 15, 8, 0, 0);
				final String sub_4e1f4;
				drawString(((sub_4e1f4 = GLLib.Text_GetString(Define.TEXT_PAUSE_PRIV)) == null) ? "" : sub_4e1f4, 15, 10, 0, 0);
				final String sub_4e1f5;
				drawString(((sub_4e1f5 = GLLib.Text_GetString(Define.TEXT_PAUSE_EXIT)) == null) ? "" : sub_4e1f5, 15, 14, 0, 0);
			}
			if (cGame.s_displayPauseHelp) {
				int n6;
				...
				final String sub_4e1f6;
				drawString(((sub_4e1f6 = GLLib.Text_GetString(Define.TEXT_PAUSE_HELP)) == null) ? "" : sub_4e1f6, 15, 50, 0, 0);
				final String sub_4e1f7;
				drawString(((sub_4e1f7 = GLLib.Text_GetString(Define.TEXT_BACK)) == null) ? "" : sub_4e1f7, 15, 49, 0, 0);
				final String sub_4e1f8;
				drawString(((sub_4e1f8 = GLLib.Text_GetString(n6)) == null) ? "" : sub_4e1f8, 15, 56, 0, 0);
				final String sub_4e1f9;
				drawString(((sub_4e1f9 = GLLib.Text_GetString(Define.TEXT_PREVIOUS)) == null) ? "" : sub_4e1f9, 15, 57, 0, 0);
				final String sub_4e1f10;
				drawString(((sub_4e1f10 = GLLib.Text_GetString(Define.TEXT_NEXT)) == null) ? "" : sub_4e1f10, 15, 58, 0, 0);
				...
				final short n13 = n9;
				substate = n8;
				GLLib.SetClip(GLLib.g, substate, n13, n12, n11, true);
				final String sub_4e1f11;
				drawString(((sub_4e1f11 = GLLib.Text_GetString(n7)) == null) ? "" : sub_4e1f11, 15, 59, 0, cGame.var_79c4);
				final int var_1ddf = GLLib.s_screenWidth;
				final int var_1de7 = GLLib.s_screenHeight;
				substate = var_1ddf;
				GLLib.SetClip(GLLib.g, 0, 0, substate, var_1de7, true);
			}
			if (cGame.s_displayPauseCreds) {
				final String sub_4e1f12;
				drawString(((sub_4e1f12 = GLLib.Text_GetString(Define.TEXT_PAUSE_BACK)) == null) ? "" : sub_4e1f12, 15, 19, 0, 0);
				...
				final short n19 = n15;
				substate = n14;
				GLLib.SetClip(GLLib.g, substate, n19, n18, n17, true);
				drawString(cGame.var_79d4, 15, 21, 0, cGame.var_79ac);
				final int var_1ddf2 = GLLib.s_screenWidth;
				final int var_1de8 = GLLib.s_screenHeight;
				substate = var_1ddf2;
				GLLib.SetClip(GLLib.g, 0, 0, substate, var_1de8, true);
			}
			if (cGame.s_displayPauseOpts) {
				final String sub_4e1f13;
				drawString(((sub_4e1f13 = GLLib.Text_GetString(Define.TEXT_PAUSE_OPTIONS)) == null) ? "" : sub_4e1f13, 15, 23, 0, 0);
				final String sub_4e1f14;
				drawString(((sub_4e1f14 = GLLib.Text_GetString(Define.TEXT_PAUSE_BACK)) == null) ? "" : sub_4e1f14, 15, 35, 0, 0);
				final String sub_4e1f15;
				drawString(((sub_4e1f15 = GLLib.Text_GetString(Define.TEXT_PAUSE_SNDOPTIONS)) == null) ? "" : sub_4e1f15, 15, 25, 0, 0);
				final String sub_4e1f16;
				drawString(((sub_4e1f16 = GLLib.Text_GetString(Define.TEXT_PAUSE_HELP)) == null) ? "" : sub_4e1f16, 15, 27, 0, 0);
				final String sub_4e1f17;
				drawString(((sub_4e1f17 = GLLib.Text_GetString(Define.TEXT_PAUSE_LANGUAGE)) == null) ? "" : sub_4e1f17, 15, 29, 0, 0);
			}
			if (cGame.s_displayPauseSndOpt) {
				final String sub_4e1f18;
				drawString(((sub_4e1f18 = GLLib.Text_GetString(Define.TEXT_PAUSE_SNDOPTIONS)) == null) ? "" : sub_4e1f18, 15, 39, 0, 0);
				final String sub_4e1f19;
				drawString(((sub_4e1f19 = GLLib.Text_GetString(Define.TEXT_PAUSE_BACK)) == null) ? "" : sub_4e1f19, 15, 47, 0, 0);
				final String sub_4e1f20;
				sub_1df06(((sub_4e1f20 = GLLib.Text_GetString(Define.TEXT_PAUSE_MUSIC)) == null) ? "" : sub_4e1f20, 15, 41, 0, 0);
				final String sub_4e1f21;
				sub_1df06(((sub_4e1f21 = GLLib.Text_GetString(Define.TEXT_PAUSE_SFX)) == null) ? "" : sub_4e1f21, 15, 44, 0, 0);
				String sub_4e1f22;
				String sub_4e1f23;
				sub_1df06(cGame.var_69f4 ? (((sub_4e1f22 = GLLib.Text_GetString(Define.TEXT_PAUSE_ON)) == null) ? "" : sub_4e1f22)
						: (((sub_4e1f23 = GLLib.Text_GetString(Define.TEXT_PAUSE_OFF)) == null) ? "" : sub_4e1f23), 15, 42, 0, 0);
				String sub_4e1f24;
				String sub_4e1f25;
				sub_1df06(cGame.var_69ec ? (((sub_4e1f24 = GLLib.Text_GetString(Define.TEXT_PAUSE_ON)) == null) ? "" : sub_4e1f24)
						: (((sub_4e1f25 = GLLib.Text_GetString(Define.TEXT_PAUSE_OFF)) == null) ? "" : sub_4e1f25), 15, 45, 0, 0);
			}
			if (cGame.s_displayDebugInfo) {
				drawString("BACK", 15, 61, 0, 0);
				drawString("L.50", 15, 89, 0, 0);
				drawString("= 0", 15, 81, 0, 0);
				drawString("= 0", 15, 75, 0, 0);
				drawString("= 0", 15, 69, 0, 0);
				drawString("= 0", 15, 87, 0, 0);
				drawString(Integer.toString(getExperience()), 15, 77, 0, 0);
				drawString(Integer.toString(getCash()), 15, 71, 0, 0);
				drawString(Integer.toString(getCoins()), 15, 64, 0, 0);
				drawString(Integer.toString(cGame.s_deluxifierAmount), 15, 83, 0, 0);
				drawString(Integer.toString(cGame.var_7984), 15, 96, 0, 0);
				drawString(cGame.var_798c, 15, 97, 0, 0);
				drawString("start quest", 15, 98, 0, 0);
				drawString("PARTY", 15, 106, 0, 0);
				drawString("EXPAN", 15, 108, 0, 0);
				drawString("MANOR", 15, 110, 0, 0);
				drawString(Integer.toString(getFeed(0)), 15, 122, 0, 0);
				drawString(Integer.toString(getFeed(1)), 15, 125, 0, 0);
				drawString(Integer.toString(getFeed(2)), 15, 128, 0, 0);
				drawString(Integer.toString(getFeed(3)), 15, 131, 0, 0);
				drawString(Integer.toString(getFeed(4)), 15, 134, 0, 0);
				drawString(Integer.toString(getFeed(5)), 15, 137, 0, 0);
			}
		}
		return false;
	}
	...
	private static void sub_3cdc4() {
		...
		final String sub_4e1f;
		final String s = ((sub_4e1f = GLLib.Text_GetString(n)) == null) ? "" : sub_4e1f;
		final short n2 = cGame.var_68bc[15][59][5];
		final short n3 = cGame.var_68bc[15][59][7];
		final short[] sub_4ac6 = cGame.var_7ffc[sanitizeTextSprIdx(n3)].WraptextB(s, n2, false);
		final ASprite class_e = cGame.var_7ffc[sanitizeTextSprIdx(n3)];
		final short n4 = sub_4ac6[0];
		final ASprite class_e2 = class_e;
		cGame.var_79c4 = (cGame.var_79cc = n4 * class_e2.GetLineHeight() + (n4 - 1) * class_e2.GetLineSpacing()) / 2
	...
	private static boolean drawCollectionRoom(int n) {
		if (n == 0) {
		...
		if (n == 5) {
			...
			if (cGame.var_7a3c > 0) {
				...
				if (array[0] != null) {
					cGame.var_800c.sub_6b0c(array[0].cameraX, array[0].cameraY, 1000);
					cActor.newActor(47, 2, array2).sub_8c4c(array[0].cameraX, array[0].cameraY, 37, 1000, false,
							cGame.var_7a3c);
					cActor.newActor(47, 2, array2).sub_8c4c(array[0].cameraX, array[0].cameraY, 36, 1000, true,
							cGame.var_7a34);
				}
			}
			sub_239ef(16);
		...
		if (n == 3) {
			sub_1dcc1(16);
			final String sub_4e1f;
			sub_1df06(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_COLLECTIONS)) == null) ? "" : sub_4e1f, 16, 90, 0, 0);
			final int[] array3 = new int[4];
			...
			for (int j = 0; j < 5; ++j) {
				...
				final String sub_4e1f2;
				sub_1df06(((sub_4e1f2 = GLLib.Text_GetString(n)) == null) ? "" : sub_4e1f2, 16, 58 + j * 6, 0, 0);
				sub_1df06(GLLib.Text_FormatNumber(cGame.var_7a0c[cGame.var_7a2c + j], cGame.s_currencySeprType, " "), 16,
						59 + j * 6, 0, 0);
				sub_1df06(GLLib.Text_FormatNumber(cGame.var_7a14[cGame.var_7a2c + j], cGame.s_currencySeprType, " "), 16,
						61 + j * 6, 0, 0);
				final String sub_4e1f3;
				sub_1df06(((sub_4e1f3 = GLLib.Text_GetString(Define.TEXT_ITEM_COLLBASE + cGame.var_7a2c + j)) == null) ? "" : sub_4e1f3, 16,
						3 + j * 3, 0, 0);
			}
			for (int k = 0; k < 20; ++k) {
	...
	private static void sub_3dac2() {
		...
		final GameDatas class_h = GameDatas.s_allDatas[16];
		for (int k = 0; k < 15; ++k) {
			cGame.var_79fc[k] = (short) class_h.m_dataVars[k][1];
			cGame.var_7a04[k] = (byte) class_h.m_dataVars[k][4];
			cGame.var_7a0c[k] = class_h.m_dataVars[k][5];
			cGame.var_7a14[k] = class_h.m_dataVars[k][6];
		}
		final GameDatas class_h2 = GameDatas.s_allDatas[17];
		for (int l = 0; l < 60; ++l) {
			cGame.var_7a1c[l] = (byte) class_h2.m_dataVars[l][3];
		}
	}
	...
	private static boolean drawTrophyRoom(int n) {
		if (n == 0) {
		...
		if (n == 2) {
			...
			cGame.var_68cc[19][75] = (GLLib.Text_GetString(Define.TEXT_TROPHIES) == null ? "" : GLLib.Text_GetString(Define.TEXT_TROPHIES));
			for (int l = 0; l < 5; ++l) {
				...
				if (cGame.var_6ecc[cGame.s_trophy_scrollLevel + l] > 0) {
					cGame.var_68cc[19][5 + l * 14] = GLLib.Text_FormatNumber(cGame.var_6ecc[cGame.s_trophy_scrollLevel + l],
							cGame.s_currencySeprType, " ");
				}
				if (cGame.var_6ec4[cGame.s_trophy_scrollLevel + l] > 0) {
					cGame.var_68cc[19][6 + l * 14] = GLLib.Text_FormatNumber(cGame.var_6ec4[cGame.s_trophy_scrollLevel + l],
							cGame.s_currencySeprType, " ");
				}
				if (cGame.var_6ebc[cGame.s_trophy_scrollLevel + l] > 0) {
					cGame.var_68cc[19][7 + l * 14] = GLLib.Text_FormatNumber(cGame.var_6ebc[cGame.s_trophy_scrollLevel + l],
							cGame.s_currencySeprType, " ");
				}
			}
		}
	...
	private static boolean drawSilo(final int n) {
		if (n == 1) {
			cGame.s_siloMaxStorage = encryptInt(cGame.var_701c * cActor.sub_4d73(0, 1005));
			sub_2c69b();
			sub_1fb8e(23);
			cGame.s_animalAmountInSilo = cActor.sub_5ad9(0, 54);
		...
		if (n == 3) {
			sub_1dcc1(23);
			final String title;
			sub_1df06(((title = GLLib.Text_GetString(Define.TEXT_SILOTITLE)) == null) ? "" : title, 23, 1, 0, 0);
			final String maxText;
			sub_1df06(((maxText = GLLib.Text_GetString(Define.TEXT_MAXIMUM)) == null) ? "" : maxText, 23, 39, 0, 0);
			sub_1e44e(23, 32);
			final String moreText;
			sub_1df06(((moreText = GLLib.Text_GetString(Define.TEXT_MORE)) == null) ? "" : moreText, 23, 38, 0, 0);
			sub_1df06(Integer.toString(sub_2e954()) + "/" + decryptInt(cGame.s_siloMaxStorage), 23, 35, 0, 0);
			final String sub_4e1f4;
			sub_1df06(((sub_4e1f4 = GLLib.Text_GetString(Define.TEXT_SILO_ANIMALS)) == null) ? "" : sub_4e1f4, 23, 36, 0, 0);
			sub_1df06(Integer.toString(cGame.s_animalAmountInSilo) + "/" + getMaxSiloAmount(), 23, 37, 0, 0);
			final String sub_4e1f5;
			drawString(((sub_4e1f5 = GLLib.Text_GetString(Define.TEXT_ITEM_COWFEED)) == null) ? "" : sub_4e1f5, 23, 4, 0, 0);
			sub_1df06(Integer.toString(getFeed(0)), 23, 5, 0, 0);
			final String sub_4e1f6;
			drawString(((sub_4e1f6 = GLLib.Text_GetString(Define.TEXT_ITEM_CHICKENFEED)) == null) ? "" : sub_4e1f6, 23, 8, 0, 0);
			sub_1df06(Integer.toString(getFeed(1)), 23, 9, 0, 0);
			final String sub_4e1f7;
			drawString(((sub_4e1f7 = GLLib.Text_GetString(Define.TEXT_ITEM_PIGFEED)) == null) ? "" : sub_4e1f7, 23, 12, 0, 0);
			sub_1df06(Integer.toString(getFeed(2)), 23, 13, 0, 0);
			final String sub_4e1f8;
			drawString(((sub_4e1f8 = GLLib.Text_GetString(Define.TEXT_ITEM_GOATFEED)) == null) ? "" : sub_4e1f8, 23, 16, 0, 0);
			sub_1df06(Integer.toString(getFeed(3)), 23, 17, 0, 0);
			final String sub_4e1f9;
			drawString(((sub_4e1f9 = GLLib.Text_GetString(Define.TEXT_ITEM_SHEEPFEED)) == null) ? "" : sub_4e1f9, 23, 20, 0, 0);
			sub_1df06(Integer.toString(getFeed(4)), 23, 21, 0, 0);
			final String sub_4e1f10;
			drawString(((sub_4e1f10 = GLLib.Text_GetString(Define.TEXT_ITEM_SUPERFEED)) == null) ? "" : sub_4e1f10, 23, 24, 0, 0);
			sub_1df06(Integer.toString(getFeed(5)), 23, 25, 0, 0);
		}
		return false;
	}

	private static boolean drawFarm(final int n) {
		if (n == 0) {
			...
			if (cGame.s_tutorialState == -1 && cGame.var_7a9c) {
		...
		if (n == 1) {
			if (cGame.s_game_states[cGame.s_game_state] == Define.GS_FARM && cGame.s_isPaused && !cGame.var_69dc) {
				loadMap();
				cGame.var_800c.sub_692a();
				cGame.s_isPaused = false;
			}
			...
			sub_2c69b();
			sub_1fb8e(1);
			if (cGame.s_tutorialState == -1 && (cGame.var_7fa4 == -1 & sub_49794())) {
				sub_26a6a(true, cGame.s_currentQuest, '\u0001');
			}
			sub_11737();
			if (cGame.var_7fdc) {
			...
			int var_17d5 = 0;
			if (array[0] != null) {
				var_17cd = array[0].cameraX;
				var_17d5 = array[0].cameraY;
			}
			final int[] array2 = { 0, 0, 14 };
			if (cGame.var_709c > 0) {
				cActor.newActor(47, 2, array2).sub_8c4c(var_17cd - 50, var_17d5, 37, 1000, false, cGame.var_709c);
				cGame.var_709c = 0;
			}
			if (cGame.var_70a4 > 0) {
				cActor.newActor(47, 2, array2).sub_8c4c(var_17cd, var_17d5, 36, 1000, true, cGame.var_70a4);
				cGame.var_70a4 = 0;
			}
			if (cGame.var_70ac > 0) {
				cActor.newActor(47, 2, array2).sub_8c4c(var_17cd + 50, var_17d5, 6, 1000, true, cGame.var_70ac);
				cGame.var_70ac = 0;
			}
			cActor.sub_4ba6(0);
		}
		if (n == 8) {
			if (GLLib.Pointer_IsReleased()) {
				...
				if (cGame.var_6aa4 == 0 || cGame.var_6aa4 == 1) {
					final int[] array3 = new int[2];
					final int[] array4;
					(array4 = new int[2])[0] = GLLib.s_pointerX;
					...
					if (cGame.var_6aac != null && sub_2d213(array4[0], array4[1]) > -1) {
						...
						cGame.var_6aac.cameraX = array3[0];
						cGame.var_6aac.cameraY = array3[1];
					}
				}
			} else if (cGame.var_803c > 15 && cGame.var_6aac != cGame.var_802c && cGame.s_tutorialState != 15
					&& cGame.s_tutorialState != 52 && cGame.s_tutorialState != 51 && cGame.s_tutorialState != 42) {
				if (cGame.var_6aa4 == 0 || cGame.var_6aa4 == 1 || cGame.var_6aa4 == 4) {
					sub_117fc();
			...
			if (cGame.var_6aa4 != -1) {
				...
				case 50: {
					...
					if (cGame.s_tutorialState == 23 && cGame.var_8024.actorID != Define.ACTOR_MILL) {
						return false;
					}
					if (cGame.var_6c64 == 1) {
						return false;
					}
					if (cGame.var_8024.actorID == Define.ACTOR_SALEDESK) {
						switchToState(Define.GS_SALEDESK);
						return true;
					}
					if (cGame.var_8024.actorID == Define.ACTOR_MANOR) {
						if (cGame.var_6c64 != 1 && cGame.var_6c64 != 2) {
					...
					if (cGame.var_8024.actorID == Define.ACTOR_MILL) {
						playSndNoLoop(37);
						switchToState(Define.GS_MILL);
						return true;
					}
					if (cGame.var_8024.actorID == Define.ACTOR_BARN) {
						cGame.s_barnPage = 0;
						switchToState(Define.GS_BARN);
						return true;
					}
					if (cGame.var_8024.actorID == Define.ACTOR_MAIL) {
						if (sub_4ac19(2) || sub_4abbb(cGame.var_80f4[2])) {
							playSndNoLoop(61);
							switchToState(Define.GS_MAIL);
							sub_10cd1(false);
						...
						playSndNoLoop(56);
						break;
					} else if (cGame.var_8024.actorID == Define.ACTOR_STABLES || cGame.var_8024.actorID == Define.ACTOR_HENHOUSE) {
						...
						int n2 = 0;
						int n3 = 0;
						if (cGame.var_8024.actorID == Define.ACTOR_HENHOUSE) {
							playSndNoLoop(16);
							n3 = 1;
							n2 = 0 + cActor.sub_4de1(0, 54, 5, 15);
						} else if (cGame.var_8024.actorID == Define.ACTOR_STABLES) {
							playSndNoLoop(17);
							n3 = 2;
							n2 = 0 + cActor.sub_4de1(0, 54, 17, 27) + cActor.sub_4de1(0, 54, 41, 51)
									+ cActor.sub_4de1(0, 54, 53, 63);
						}
						final int j = 1 + n2 / 3;
						if (sub_2dcf3(5) + cActor.sub_59d2(2) + j > sub_2df26()) {
							if (sub_2dcf3(5) < sub_2df26()) {
								final String sub_4e1f3;
								final String sub_4e1f4;
								drawCustomPopupNoOpts(((sub_4e1f3 = GLLib.Text_GetString(Define.TEXT_POPUP_BARNALMOSTFULL)) == null) ? "" : sub_4e1f3,
						...
						cActor.newActor(47, 2, array5);
						final cActor sub_92ea = cActor.newActor(47, 2, array5);
						sub_49db0(cGame.var_80b4[cGame.var_8024.actorID], 1, 7, false);
						sub_92ea.sub_8c4c(cGame.var_8024.cameraX, cGame.var_8024.cameraY, 59, 1000, true,
						...
						break;
					} else if (cGame.var_8024.actorID == Define.ACTOR_SILO) {
						if (sub_4abbb(cGame.var_80f4[1])) {
							playSndNoLoop(60);
							switchToState(Define.GS_SILO);
							return true;
						}
						break;
					} else {
						if (cGame.var_8024.actorID == Define.ACTOR_POND && cGame.var_8024.sub_a2a0(512)) {
							cGame.var_8024.sub_aa8a();
							final String sub_4e1f5;
							final String s2 = ((sub_4e1f5 = GLLib.Text_GetString(Define.TEXT_POPUP_POND)) == null) ? "" : sub_4e1f5;
							final String sub_4e1f6;
							final String var_7acc = ((sub_4e1f6 = GLLib.Text_GetString(Define.TEXT_POPUP_PONDDESC)) == null) ? "" : sub_4e1f6;
		...
		if (n == 2) {
			...
			if ((sub_2b09 = GLLib.IsAnyKeyDown()) == 19 || sub_2b09 == 24 || sub_2b09 == 11) {
				if (sub_202b7(1, 37) && sub_20167(1, 37)) {
					...
					final String sub_4e1f7;
					platformRequest("Show_Toast_" + (((sub_4e1f7 = GLLib.Text_GetString(Define.TEXT_CANNOTGOBACK)) == null) ? "" : sub_4e1f7));
				} else if (sub_2b09 == 24) {
					final String sub_4e1f8;
					platformRequest("Show_Toast_" + (((sub_4e1f8 = GLLib.Text_GetString(Define.TEXT_CANNOTPAUSE)) == null) ? "" : sub_4e1f8));
				}
			}
			sub_253a8();
			if (cGame.var_6c54) {
	...
	private static boolean drawPopup(final int n) {
		...
		if (n == 5) {
			...
			if (cGame.s_popup_onCloseAct == Define.GS_BUYSCR) {
				switchToState(Define.GS_BUYSCR);
			} else if (cGame.s_popup_onCloseState != Define.GS_EXIT) {
				switchToState(cGame.s_popup_onCloseState);
				cGame.s_popup_onCloseState = Define.GS_EXIT;
		...
		if (n == 3) {
			...
			if (cGame.s_popup_title == "" || cGame.s_popup_title == null) {
				drawString(cGame.s_popup_desc, 4, 2, 0, 0);
			} else {
				sub_1df06(cGame.s_popup_title, 4, 8, 0, 0);
				drawString(cGame.s_popup_desc, 4, 9, 0, 0);
			}
			...
			if (cGame.var_68bc[4][15][10] == 1) {
				...
				case 2: {
					final String sub_4e1f2;
					sub_1df06(((sub_4e1f2 = GLLib.Text_GetString(Define.TEXT_OK)) == null) ? "" : sub_4e1f2, 4, 17, 0, 0);
					final String sub_4e1f3;
					sub_1df06(((sub_4e1f3 = GLLib.Text_GetString(Define.TEXT_CANCEL)) == null) ? "" : sub_4e1f3, 4, 18, 0, 0);
					break;
				}
				case 3: {
					final String sub_4e1f4;
					sub_1df06(((sub_4e1f4 = GLLib.Text_GetString(Define.TEXT_SURE)) == null) ? "" : sub_4e1f4, 4, 17, 0, 0);
					final String sub_4e1f5;
					sub_1df06(((sub_4e1f5 = GLLib.Text_GetString(Define.TEXT_LATER)) == null) ? "" : sub_4e1f5, 4, 18, 0, 0);
					break;
				}
				}
			}
			if (cGame.var_68bc[4][30][10] == 1) {
				final String sub_4e1f6;
				sub_1df06(((sub_4e1f6 = GLLib.Text_GetString(Define.TEXT_MARKETTITLE)) == null) ? "" : sub_4e1f6, 4, 31, 0, 0);
			}
		}
		return false;
	}
	...
	private static boolean drawFarmNeighbor(final int n) {
		if (n == 0) {
			loadMap();
			playSnd(14, false);
			...
			cGame.var_70e4 &= 0xFFFFFFFE;
			final cActor[] array = new cActor[50];
			for (int sub_550f = cActor.sub_550f(0, 54, 0, 63, array, 50), i = 0; i < sub_550f; ++i) {
				if (array[i] != null) {
					array[i].sub_85b3(16);
				}
			}
		...
		if (n == 2) {
			...
			if ((sub_2b09 = GLLib.IsAnyKeyDown()) == 19 || sub_2b09 == 24 || sub_2b09 == 11) {
				if (sub_202b7(1, 37) && sub_20167(1, 37)) {
					...
					final String sub_4e1f2;
					platformRequest("Show_Toast_" + (((sub_4e1f2 = GLLib.Text_GetString(Define.TEXT_CANNOTPAUSE)) == null) ? "" : sub_4e1f2));
				}
			}
			sub_253a8();
			sub_2edea();
		...
		if (cGame.var_807c <= 10) {
			...
			if (cGame.var_6e24[cGame.var_807c - 1][5] == 0) {
				...
				sub_2b10b(cGame.var_807c - 1,
						GameDatas.s_allDatas[24].m_dataVars[cGame.var_6e24[cGame.var_807c - 1][1] / cGame.var_8064[25]][4]);
				if (sub_4ac19(2)) {
					cGame.var_6c54 = true;
					cGame.var_6c5c = 169;
					cGame.var_6c8c = (cGame.s_hasFinishedTut = false);
	...
	private static boolean drawMailbox(int n) {
		if (n == 0) {
			cGame.var_7b94 = sub_237d7(9, 0, 1, 11, 23, 66) + 10;
			sub_237d7(9, 0, 1, 15, 84, 137);
			sub_1daf4(9);
			if (cGame.var_7b9c != 4 && cGame.var_7b9c != 3) {
				cGame.s_mailbox_scrollLevel = 0;
				cGame.var_7b44 = null;
				cGame.s_mailbox_neighborNames = null;
				cGame.var_7b54 = null;
				cGame.s_mailbox_neighborSprs = null;
				cGame.s_mailbox_neighborSprIdxs = null;
				cGame.var_7b6c = null;
				cGame.s_mailbox_neighborCnt = 0;
				final GameDatas class_h = GameDatas.s_allDatas[8];
				cGame.s_mailbox_neighborCnt = 10;
				if (class_h != null) {
					cGame.var_7b44 = new int[cGame.s_mailbox_neighborCnt];
					cGame.s_mailbox_neighborNames = new int[cGame.s_mailbox_neighborCnt];
					cGame.var_7b54 = new int[cGame.s_mailbox_neighborCnt];
					cGame.s_mailbox_neighborSprs = new int[cGame.s_mailbox_neighborCnt];
					cGame.s_mailbox_neighborSprIdxs = new int[cGame.s_mailbox_neighborCnt];
					cGame.var_7b6c = new int[cGame.s_mailbox_neighborCnt];
					for (int i = 0; i < cGame.s_mailbox_neighborCnt; ++i) {
						cGame.var_7b44[i] = class_h.m_dataVars[i][0];
						cGame.s_mailbox_neighborNames[i] = class_h.m_dataVars[i][2];
						cGame.var_7b54[i] = class_h.m_dataVars[i][6];
						cGame.s_mailbox_neighborSprs[i] = class_h.m_dataVars[i][4];
						cGame.s_mailbox_neighborSprIdxs[i] = class_h.m_dataVars[i][5];
						cGame.var_7b6c[i] = class_h.m_dataVars[i][9];
					}
				}
			} else {
				sub_2000c(9, 7, false);
		...
		if (n == 1) {
			...
			if (cGame.var_7b9c != 4 && cGame.var_7b9c != 3) {
				...
				int n2 = 0;
				for (int j = 0; j < cGame.s_mailbox_neighborCnt; ++j) {
					if (n2 < 5) {
		...
		if (n == 2) {
			...
			if (cGame.var_698c) {
				if (cGame.var_6914[0] != null && !sub_2351a(0, 1)) {
					if (cGame.var_6914[0][8] < -cGame.var_7b94 && cGame.s_mailbox_scrollLevel < cGame.s_mailbox_neighborCnt - 5) {
						sub_418b1(1);
					} else if (cGame.var_6914[0][8] > -10 && cGame.s_mailbox_scrollLevel > 0) {
						sub_418b1(-1);
					}
				}
				if (cGame.var_7b7c) {
		...
		if (n == 3) {
			...
			if (cGame.var_698c) {
				final String sub_4e1f;
				sub_1df06(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_MAILBOX_NEIGHBORS)) == null) ? "" : sub_4e1f, 9, 1, 0, 0);
				final int[] array = new int[4];
				...
				final int n8 = n4;
				n = n3;
				GLLib.SetClip(GLLib.g, n, n8, n7, n6, true);
				int n9;
				String sub_4e1f2;
				String sub_4e1f3;
				for (n = 0; n < cGame.s_mailbox_neighborCnt && n < 5; ++n) {
					n9 = n * 11;
					sub_1df06(((sub_4e1f2 = GLLib.Text_GetString(cGame.s_mailbox_neighborNames[n + cGame.s_mailbox_scrollLevel])) == null) ? ""
							: sub_4e1f2, 9, n9 + 13, 0, 0);
					if (getLevel() < cGame.var_7b54[n + cGame.s_mailbox_scrollLevel]) {
						sub_1df06((((sub_4e1f3 = GLLib.Text_GetString(Define.TEXT_PREFIX_LEVEL)) == null) ? "" : sub_4e1f3)
								+ Integer.toString(cGame.var_7b54[n + cGame.s_mailbox_scrollLevel]), 9, n9 + 22, 0, 0);
					}
				}
				final int var_1ddf = GLLib.s_screenWidth;
				final int var_1de7 = GLLib.s_screenHeight;
	...
	private static void sub_41599(final int n, final boolean b) {
		...
		final int n4 = n3 + 16;
		if (b) {
			cGame.var_68bc[9][n4][5] = (short) cGame.s_mailbox_neighborSprs[cGame.s_mailbox_scrollLevel + n];
			cGame.var_68bc[9][n4][6] = (short) cGame.s_mailbox_neighborSprIdxs[cGame.s_mailbox_scrollLevel + n];
			final boolean b2 = getLevel() < cGame.var_7b54[cGame.s_mailbox_scrollLevel + n];
			final int n5 = n3 + 17;
			...
			sub_2000c(9, n3 + 15, cGame.var_6e24[n + cGame.s_mailbox_scrollLevel][3] != -1);
			cGame.var_68bc[9][n3 + 15][5] = 28;
			cGame.var_68bc[9][n3 + 15][6] = 1;
			sub_2000c(9, n3 + 14, cGame.var_6e24[n + cGame.s_mailbox_scrollLevel][4] != -1);
			if (sub_20167(9, n3 + 14)) {
				final GameDatas class_h = GameDatas.s_allDatas[1];
				cGame.var_68bc[9][n3 + 14][5] = (short) class_h.m_dataVars[cGame.var_6e24[n + cGame.s_mailbox_scrollLevel][4]][3];
				cGame.var_68bc[9][n3 + 14][6] = (short) class_h.m_dataVars[cGame.var_6e24[n + cGame.s_mailbox_scrollLevel][4]][4];
			}
			final int n7 = cGame.s_mailbox_scrollLevel + n;
			...
			sub_2b081(9, n5, cGame.var_6e24[cGame.s_mailbox_scrollLevel + n][1]);
			return;
		}
		sub_2000c(9, n2, false);
		sub_2000c(9, n3 + 22, false);
	...
	private static void sub_41938(final int n) {
		...
		if (sub_2da54(0, cGame.var_6e24[n + cGame.s_mailbox_scrollLevel][3], 1)) {
			sub_41ad0(15 + n * 11, cGame.var_6e24[n + cGame.s_mailbox_scrollLevel][3], true);
			playSndNoLoop(48);
			cGame.var_6e24[n + cGame.s_mailbox_scrollLevel][3] = -1;
			cGame.var_6e34[n + cGame.s_mailbox_scrollLevel][5] = System.currentTimeMillis() / 1000L;
			sub_49db0(cGame.var_80bc[0] + n + cGame.s_mailbox_scrollLevel, 1, 37, false);
			sub_2b10b(n + cGame.s_mailbox_scrollLevel,
					GameDatas.s_allDatas[24].m_dataVars[cGame.var_6e24[n + cGame.s_mailbox_scrollLevel][1] / cGame.var_8064[25]][5]);
		}
	}
	...
	private static void sub_41a13(int n) {
		...
		if (sub_2da54(0, cGame.var_6e24[n + cGame.s_mailbox_scrollLevel][4], 1)) {
			sub_41ad0(14 + n * 11, cGame.var_6e24[n + cGame.s_mailbox_scrollLevel][4], false);
			sub_41ad0(14 + n * 11, cGame.var_6e24[n + cGame.s_mailbox_scrollLevel][4], false);
			playSndNoLoop(48);
			cGame.var_6e24[n + cGame.s_mailbox_scrollLevel][4] = -1;
	...
	private static void sub_41ad0(final int var_7b8c, final int n, final boolean b) {
		...
		cGame.var_68bc[9][67][5] = (short) class_h.m_dataVars[n][3];
		cGame.var_68bc[9][67][6] = (short) class_h.m_dataVars[n][4];
		sub_2000c(9, 67, true);
	...
	private static void sub_41ba8(final int n) {
		if (getLevel() < cGame.var_7b54[cGame.s_mailbox_scrollLevel + n]) {
			playSndNoLoop(56);
			return;
		}
		playSndNoLoop(61);
		switchToState(Define.GS_MAIL_NEIGHBOR);
		cGame.var_7bb4 = n + cGame.s_mailbox_scrollLevel;
	}

	private static boolean drawNeighborScreen(int var_7bb4) {
		if (var_7bb4 == 0) {
			sub_1daf4(17);
			sub_41ff0();
		...
		if (var_7bb4 == 3) {
			sub_1dcc1(17);
			final String sub_4e1f;
			sub_1df06(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_MAILBOX_NEIGHBORS)) == null) ? "" : sub_4e1f, 17, 2, 0, 0);
			final String sub_4e1f2;
			sub_1df06(((sub_4e1f2 = GLLib.Text_GetString(cGame.s_mailbox_neighborNames[cGame.var_7bb4])) == null) ? "" : sub_4e1f2, 17,
					11, 0, 0);
			var_7bb4 = cGame.var_7bb4;
			if (cGame.var_6e2c[var_7bb4][0] != 0) {
				final String sub_4e1f3;
				drawString(((sub_4e1f3 = GLLib.Text_GetString(Define.TEXT_MAILBOX_HELPBASE + cGame.var_7bb4)) == null) ? "" : sub_4e1f3, 17, 17, 0,
						0);
				...
				if (cGame.var_6e2c[cGame.var_7bb4][0] != 0) {
					final String sub_4e1f4;
					sub_1df06((((sub_4e1f4 = GLLib.Text_GetString(cGame.var_7bd4)) == null) ? "" : sub_4e1f4) + " x"
				...
				if (cGame.var_6e2c[cGame.var_7bb4][3] != 0) {
					final String sub_4e1f5;
					sub_1df06((((sub_4e1f5 = GLLib.Text_GetString(cGame.var_7bec)) == null) ? "" : sub_4e1f5) + " x"
				...
				final String sub_4e1f6;
				sub_1df06(((sub_4e1f6 = GLLib.Text_GetString(Define.TEXT_MAILBOX_DECLINE)) == null) ? "" : sub_4e1f6, 17, 46, 0, 0);
				final String sub_4e1f7;
				sub_1df06(((sub_4e1f7 = GLLib.Text_GetString(Define.TEXT_MAILBOX_DELIVER)) == null) ? "" : sub_4e1f7, 17, 47, 0, 0);
			} else {
				final String sub_4e1f8;
				drawString(((sub_4e1f8 = GLLib.Text_GetString(cGame.var_7bbc)) == null) ? "" : sub_4e1f8, 17, 17, 0, 0);
				final String sub_4e1f9;
				drawString(((sub_4e1f9 = GLLib.Text_GetString(Define.TEXT_MAILBOX_NONEED)) == null) ? "" : sub_4e1f9, 17, 42, 0, 0);
			}
		}
		return false;
	}
	...
	private static void sub_41ff0() {
		...
		if (cGame.var_6e2c[cGame.var_7bb4][0] != 0) {
			final GameDatas class_h;
			cGame.var_7bc4 = (class_h = GameDatas.s_allDatas[18]).m_dataVars[getLevel() - 1][17];
			cGame.var_7bcc = class_h.m_dataVars[getLevel() - 1][16];
		...
		cGame.var_68bc[17][22][5] = (short) cGame.s_mailbox_neighborSprs[cGame.var_7bb4];
		cGame.var_68bc[17][22][6] = (short) cGame.s_mailbox_neighborSprIdxs[cGame.var_7bb4];
		sub_423b1();
		sub_2c69b();
		sub_1fb8e(17);
	}
	...
	private static int sub_4244f(final int n, final int n2) {
		...
		switch (n) {
		case 1: {
			n3 = GameDatas.s_allDatas[1].m_dataVars[n2][2];
			break;
		}
		case 2: {
			n3 = GameDatas.s_allDatas[4].m_dataVars[n2][2];
			break;
		}
		case 3: {
			n3 = GameDatas.s_allDatas[17].m_dataVars[n2][2];
			break;
		}
		}
		return n3;
	...
	private static int sub_42560(final int n, final int n2) {
		...
		switch (n) {
		case 1: {
			n3 = GameDatas.s_allDatas[1].m_dataVars[n2][15];
			break;
		}
		}
		return n3;
	...
	private static void sub_426c2() {
		...
		if ((n2 = cGame.var_6e34[cGame.var_7bb4][4] + 86400L - n) <= 0L) {
			...
			cGame.var_68cc[17][4] = getRawPrepareTime((int) ((n2 < 0L) ? 0L : ((n2 > 2147483647L) ? 2147483647L : n2)));
			sub_2000c(17, 4, true);
			sub_23a3d(17, 3, 0);
		}
		...
		if (cGame.var_6e24[cGame.var_7bb4][5] > 0) {
			...
			cGame.var_68cc[17][7] = getRawPrepareTime((int) ((n3 < 0L) ? 0L : ((n3 > 2147483647L) ? 2147483647L : n3)));
			sub_2000c(17, 7, true);
			if (n3 <= 0L) {
		...
		cGame.var_68cc[17][9] = getRawPrepareTime((int) ((n4 < 0L) ? 0L : ((n4 > 2147483647L) ? 2147483647L : n4)));
		sub_2000c(17, 9, true);
		sub_23a3d(17, 8, 0);
	}

	private static boolean drawHUD(int n) {
		if (n == 0) {
		...
		if (n == 8 && GLLib.Pointer_IsReleased() && cGame.var_711c != 17) {
			while (cGame.var_70ec < cGame.var_7124) {
				for (int n12 = 0; n12 < cGame.var_710c[cGame.var_70ec].length; ++n12) {
					...
					case 11: {
						cGame.var_800c.cameraX = cGame.var_7114[cGame.var_70ec][n12 * 6];
						cGame.var_800c.cameraY = cGame.var_7114[cGame.var_70ec][n12 * 6 + 1];
						break;
					}
					case 114: {
						final cActor sub_53db;
						(sub_53db = cActor.sub_53db(0,
								cGame.var_7114[cGame.var_70ec][n12 * 6])).cameraX = cGame.var_800c.cameraX
										+ cGame.var_7114[cGame.var_70ec][n12 * 6 + 1];
						sub_53db.cameraY = cGame.var_800c.cameraY + cGame.var_7114[cGame.var_70ec][n12 * 6 + 2];
						break;
					}
					case 12: {
						cGame.var_800c.cameraX = cGame.var_800c.var_1845 - (GLLib.s_screenWidth >> 1);
						cGame.var_800c.cameraY = cGame.var_800c.var_184d - (GLLib.s_screenHeight >> 1);
						break;
					}
					case 111:
					case 115: {
						final cActor sub_53db2;
						final cActor class_f = sub_53db2 = cActor.sub_53db(0,
								cGame.var_7114[cGame.var_70ec][n12 * 6]);
						class_f.cameraX = class_f.var_1845;
						sub_53db2.cameraY = sub_53db2.var_184d;
						break;
					}
					case 104:
					case 109: {
						final cActor[] array3 = new cActor[2];
						cActor.sub_545c(0, cGame.var_7114[cGame.var_70ec][n12 * 6],
						...
						default: {
							array3[0].cameraX = array3[0].var_1845;
							array3[0].cameraY = array3[0].var_184d;
							continue;
						}
						}
	...
	private static int getPoolIndex(final int idx) {
	...
	private static boolean sub_4378f(ASprite spr, int idx) {
	      byte var2 = 0;
	      boolean var3 = false;
	...
	private static String sub_43907(final int n) {
		final String sub_4e1f;
		String s = ((sub_4e1f = GLLib.Text_GetString((cGame.var_7cdc == 3) ? 797
										...
										: ((cGame.var_7cdc == 2) ? 798
												: ((cGame.var_7cdc == 6) ? 856
														: ((cGame.var_7cdc != 0) ? 799 : 796)))))))) == null) ? ""
																: sub_4e1f;
		if (cGame.var_7cdc == 3) {
			s = GLLib.Text_FindReplace(s, "%num", cGame.s_iapPriceTexts[n]);
		} else {
			if (cGame.var_7cdc != 10) {
				if (cGame.var_7cdc == 11) {
					s = GLLib.Text_FindReplace(s, "%amount", GLLib.Text_FormatNumber(cGame.var_7cec[n], cGame.s_currencySeprType, " "));
				} else if (cGame.var_7cdc == 6) {
					int sub_7965;
					if (cGame.var_7d04[n] == -1) {
						sub_7965 = GLLib.PaySMS_FindPrice(n, "Cash");
					...
					if (sub_7965 == 1) {
						final String sub_4e1f2;
						s = GLLib.Text_FindReplace(s, "%price", sub_45928(cGame.s_iapPriceTexts[n])) + " "
								+ (((sub_4e1f2 = GLLib.Text_GetString(Define.TEXT_IAP_PRICEOF2SMS)) == null) ? "" : sub_4e1f2);
						return s;
					}
					final String sub_4e1f3;
					s = GLLib.Text_FindReplace(s, "%price", sub_45928(cGame.s_iapPriceTexts[n])) + " "
							+ (((sub_4e1f3 = GLLib.Text_GetString(Define.TEXT_IAP_PRICEOF1SMS)) == null) ? "" : sub_4e1f3);
					return s;
				} else {
					if (cGame.var_7cdc == 0) {
						return s;
					...
					if (cGame.var_7cdc == 2) {
						s = GLLib.Text_FindReplace(s, "%num", "1");
					}
				}
			}
			s = GLLib.Text_FindReplace(s, "%price", sub_45928(cGame.s_iapPriceTexts[n]));
	...
	private static boolean drawToast(final int n) {
		if (n == 0) {
			cGame.var_7c3c = false;
			boolean b = true;
			boolean b2 = false;
			boolean b3 = false;
			if (getPreviousState() == Define.GS_TOAST) {
				cGame.s_switcherState = 1;
				sub_2c69b();
			} else {
				switch (cGame.s_toastType) {
				...
				case 10: {
					final String sub_4e1f4;
					cGame.var_7c2c = (((sub_4e1f4 = GLLib.Text_GetString(Define.TEXT_IAP_REDEEMALL)) == null) ? "" : sub_4e1f4);
					b = false;
					b2 = true;
					b3 = true;
					break;
				...
				case 9: {
					final String sub_4e1f5;
					cGame.var_7c2c = (((sub_4e1f5 = GLLib.Text_GetString(Define.TEXT_IAP_REDEEMNODIGITS)) == null) ? "" : sub_4e1f5);
					b = false;
					b2 = true;
					b3 = true;
					break;
				...
				case 12: {
					final String sub_4e1f6;
					cGame.var_7c2c = (((sub_4e1f6 = GLLib.Text_GetString(Define.TEXT_POPUP_RESETDESC)) == null) ? "" : sub_4e1f6);
					b3 = true;
					break;
				}
				case 13: {
					if (getPreviousState() == Define.GS_LOADING) {
						final String sub_4e1f7;
						cGame.var_7c2c = (((sub_4e1f7 = GLLib.Text_GetString(Define.TEXT_POPUP_NEIGHBORFARMERROR)) == null) ? "" : sub_4e1f7);
						break;
					}
					b = false;
					b2 = true;
				...
				case 14: {
					final String sub_4e1f8;
					cGame.var_7c2c = (((sub_4e1f8 = GLLib.Text_GetString(Define.TEXT_POPUP_CUSTOMERCAREBACKUPDESC)) == null) ? "" : sub_4e1f8);
					b3 = true;
					break;
				}
				case 15: {
					final String sub_4e1f9;
					cGame.var_7c2c = GLLib.Text_FindReplace(((sub_4e1f9 = GLLib.Text_GetString(Define.TEXT_POPUP_CUSTOMERCARECOINSDESC)) == null) ? "" : sub_4e1f9,
							"%d", "" + 0);
					b = false;
					b2 = true;
					b3 = true;
				...
				case 16: {
					...
					cGame.var_7c2c = GLLib
							.Text_FindReplace(((sub_4e1f10 = GLLib.Text_GetString(Define.TEXT_POPUP_CUSTOMERCARECASHDESC)) == null) ? "" : sub_4e1f10, "%d", "" + 0);
					b = false;
					b2 = true;
					b3 = true;
					break;
				...
				case 17: {
					final String sub_4e1f11;
					cGame.var_7c2c = (((sub_4e1f11 = GLLib.Text_GetString(Define.TEXT_POPUP_CUSTOMERCARECOINSRESETDESC)) == null) ? "" : sub_4e1f11);
					b = false;
					b2 = true;
					b3 = true;
					break;
				...
				case 18: {
					final String sub_4e1f12;
					cGame.var_7c2c = (((sub_4e1f12 = GLLib.Text_GetString(Define.TEXT_POPUP_CUSTOMERCARECASHRESETDESC)) == null) ? "" : sub_4e1f12);
					b = false;
					b2 = true;
					b3 = true;
					break;
				...
				case 20: {
					final String sub_4e1f13;
					cGame.var_7c2c = (((sub_4e1f13 = GLLib.Text_GetString(Define.TEXT_IAP_RESETCYCLEDESC)) == null) ? "" : sub_4e1f13);
					b = true;
					b2 = false;
					b3 = true;
					break;
				...
				default: {
					final String sub_4e1f14;
					cGame.var_7c2c = (((sub_4e1f14 = GLLib.Text_GetString(Define.TEXT_POPUP_AREYOUSURE)) == null) ? "" : sub_4e1f14);
					break;
				}
				}
				sub_1daf4(27);
				...
				if (cGame.var_7c3c) {
					...
					if (cGame.var_7cdc != 11) {
						...
						final String sub_4e1f15;
						cGame.var_68cc[27][17] = (((sub_4e1f15 = GLLib.Text_GetString(Define.TEXT_IAP_CONFIRM)) == null) ? "" : sub_4e1f15);
					}
					if (cGame.var_7cdc == 4) {
						...
						final String sub_4e1f16;
						cGame.var_68cc[27][13] = (((sub_4e1f16 = GLLib.Text_GetString(Define.TEXT_IAP_DANISHBUY)) == null) ? "" : sub_4e1f16);
						b = false;
						b2 = false;
						...
						sub_2000c(27, 13, true);
						final String sub_4e1f17;
						cGame.var_68cc[27][13] = (((sub_4e1f17 = GLLib.Text_GetString(Define.TEXT_MARKET_BUY)) == null) ? "" : sub_4e1f17);
						sub_2000c(27, 14, true);
						sub_2024d(27, 14, true);
						sub_2000c(27, 15, true);
						final String sub_4e1f18;
						cGame.var_68cc[27][15] = (((sub_4e1f18 = GLLib.Text_GetString(Define.TEXT_IAP_TERMSCONDS)) == null) ? "" : sub_4e1f18);
						b = false;
						b2 = false;
					}
				} else {
				...
				if (b) {
					...
					case 8: {
						if (cGame.var_7cdc == 11) {
							final String sub_4e1f19;
							cGame.var_68cc[27][7] = (((sub_4e1f19 = GLLib.Text_GetString(Define.TEXT_IAP_INDOCANCEL)) == null) ? ""
									: sub_4e1f19);
							final String sub_4e1f20;
							cGame.var_68cc[27][9] = (((sub_4e1f20 = GLLib.Text_GetString(Define.TEXT_IAP_INDOBUY)) == null) ? ""
									: sub_4e1f20);
							break;
						}
						if (cGame.var_7cdc == 10) {
							final String sub_4e1f21;
							cGame.var_68cc[27][7] = (((sub_4e1f21 = GLLib.Text_GetString(Define.TEXT_IAP_CANCEL)) == null) ? ""
									: sub_4e1f21);
							final String sub_4e1f22;
							cGame.var_68cc[27][9] = (((sub_4e1f22 = GLLib.Text_GetString(Define.TEXT_IAP_BUY)) == null) ? ""
									: sub_4e1f22);
							break;
						}
						if (cGame.var_7cdc == 6) {
							final String sub_4e1f23;
							cGame.var_68cc[27][7] = (((sub_4e1f23 = GLLib.Text_GetString(Define.TEXT_IAP_LATER)) == null) ? ""
									: sub_4e1f23);
							final String sub_4e1f24;
							cGame.var_68cc[27][9] = (((sub_4e1f24 = GLLib.Text_GetString(Define.TEXT_IAP_OK)) == null) ? ""
									: sub_4e1f24);
							break;
						}
						final String sub_4e1f25;
						cGame.var_68cc[27][7] = (((sub_4e1f25 = GLLib.Text_GetString(Define.TEXT_IAP_ENCANCEL)) == null) ? "" : sub_4e1f25);
						final String sub_4e1f26;
						cGame.var_68cc[27][9] = (((sub_4e1f26 = GLLib.Text_GetString(Define.TEXT_IAP_ENBUY)) == null) ? "" : sub_4e1f26);
						break;
					}
					default: {
						final String sub_4e1f27;
						cGame.var_68cc[27][7] = (((sub_4e1f27 = GLLib.Text_GetString(Define.TEXT_NO)) == null) ? "" : sub_4e1f27);
						final String sub_4e1f28;
						cGame.var_68cc[27][9] = (((sub_4e1f28 = GLLib.Text_GetString(Define.TEXT_YES)) == null) ? "" : sub_4e1f28);
						break;
					}
					}
					sub_2000c(27, 6, true);
					...
					final String sub_4e1f29;
					cGame.var_68cc[27][11] = (((sub_4e1f29 = GLLib.Text_GetString(Define.TEXT_OK)) == null) ? "" : sub_4e1f29);
	...
	private static void sub_44d11() {
		cGame.s_iapTermsConditions = GLLib.PaySMS_GetTermsAndConditions();
		final short n2 = cGame.var_68bc[8][156][6];
		final short n3 = cGame.var_68bc[8][156][7];
		final short[] sub_4ac6 = cGame.var_7ffc[sanitizeTextSprIdx(n3)].WraptextB(cGame.s_iapTermsConditions, cGame.var_68bc[8][156][5], false);
		final ASprite class_e = cGame.var_7ffc[sanitizeTextSprIdx(n3)];
		final short n4 = sub_4ac6[0];
		if ((cGame.var_7d34 = n4 * class_e.GetLineHeight() + (n4 - 1) * class_e.GetLineSpacing() - n2 + 24) < 0) {
			cGame.var_7d34 = 0;
		}
		cGame.var_7d2c = 0;
	}

	private static boolean drawBuyScreen(final int n) {
		if (n == 0) {
			if (!cGame.s_iapEnabled && cGame.var_7aac == 19) {
				final String sub_4e1f;
				final String s = ((sub_4e1f = GLLib.Text_GetString(Define.TEXT_NOTIAP_NOTENOUGHCASHDESC)) == null) ? "" : sub_4e1f;
				...
				final String sub_4e1f2;
				sub_405b1(((sub_4e1f2 = GLLib.Text_GetString(Define.TEXT_NOTIAP_NOTENOUGHCASH)) == null) ? "" : sub_4e1f2,
						GLLib.Text_FindReplace(s, "%d", GLLib.Text_FormatNumber(n2, cGame.s_currencySeprType, " ")), 7);
				cGame.var_7aac = -1;
				cGame.var_7d24 = false;
			}
			cGame.var_7ccc = false;
			...
			if (getLevel() < 3) {
				...
				sub_82a7(Define.GS_POPUP);
			}
			final GameDatas class_h = GameDatas.s_allDatas[30];
			for (int k = 0; k < 6; ++k) {
				cGame.var_7cf4[k] = class_h.m_dataVars[k][1];
				cGame.var_7c6c[k] = class_h.m_dataVars[k][2];
			}
			sub_45e60(false);
			sub_17ace();
			final String sub_4e1f3;
			cGame.var_68cc[8][1] = (((sub_4e1f3 = GLLib.Text_GetString(Define.TEXT_IAP_MORE)) == null) ? "" : sub_4e1f3);
			cGame.var_68cc[8][7] = GLLib.Text_FormatNumber(getCash(), cGame.s_currencySeprType, " ");
			cGame.var_68cc[8][4] = GLLib.Text_FormatNumber(getCoins(), cGame.s_currencySeprType, " ");
			...
			final String sub_4e1f4;
			cGame.var_68cc[8][191] = (((sub_4e1f4 = GLLib.Text_GetString(Define.TEXT_IAP_VALIDATE)) == null) ? "" : sub_4e1f4);
			final String sub_4e1f5;
			cGame.var_68cc[8][193] = (((sub_4e1f5 = GLLib.Text_GetString(Define.TEXT_IAP_RESEND)) == null) ? "" : sub_4e1f5);
			final String sub_4e1f6;
			cGame.var_68cc[8][195] = (((sub_4e1f6 = GLLib.Text_GetString(Define.TEXT_RESET)) == null) ? "" : sub_4e1f6);
			final String sub_4e1f7;
			cGame.var_68cc[8][197] = (((sub_4e1f7 = GLLib.Text_GetString(Define.TEXT_IAP_ENTERCODE)) == null) ? "" : sub_4e1f7);
			final String sub_4e1f8;
			cGame.var_68cc[8][163] = (((sub_4e1f8 = GLLib.Text_GetString(Define.TEXT_IAP_REDEEMENTER)) == null) ? "" : sub_4e1f8);
			final String sub_4e1f9;
			cGame.var_68cc[8][165] = (((sub_4e1f9 = GLLib.Text_GetString(Define.TEXT_IAP_REDEEMMINI)) == null) ? "" : sub_4e1f9);
			final String sub_4e1f10;
			cGame.var_68cc[8][161] = (((sub_4e1f10 = GLLib.Text_GetString(Define.TEXT_IAP_SMSPIN)) == null) ? "" : sub_4e1f10);
			final String sub_4e1f11;
			cGame.var_68cc[8][200] = (((sub_4e1f11 = GLLib.Text_GetString(Define.TEXT_OK)) == null) ? "" : sub_4e1f11);
			final String sub_4e1f12;
			cGame.var_68cc[8][198] = (((sub_4e1f12 = GLLib.Text_GetString(Define.TEXT_IAP_THANKYOU)) == null) ? "" : sub_4e1f12);
			final String sub_4e1f13;
			cGame.var_68cc[8][207] = (((sub_4e1f13 = GLLib.Text_GetString(Define.TEXT_IAP_RETRY)) == null) ? "" : sub_4e1f13);
			final String sub_4e1f14;
			cGame.var_68cc[8][16] = (((sub_4e1f14 = GLLib.Text_GetString(Define.TEXT_IAP_PACKNOTFOUND)) == null) ? "" : sub_4e1f14);
			sub_2000c(8, 16, false);
			cGame.s_iapCashIndex = -1;
		}
		if (n == 1) {
			if (!cGame.var_7d24) {
				...
				cGame.var_6984 = false;
				sub_171dc();
			} else if (GLLib.PaySMS_CanRedeemCode()) {
				sub_1715b();
				sub_16bcb();
				sub_174e9();
				sub_17536();
			...
			if (cGame.s_iapEnabled && cGame.var_7aac == 19) {
				final String sub_4e1f15;
				sub_405b1(((sub_4e1f15 = GLLib.Text_GetString(Define.TEXT_NOTIAP_NOTENOUGHCASH)) == null) ? "" : sub_4e1f15, cGame.var_7ab4, 7);
				cGame.var_7aac = -1;
				cGame.var_7d24 = true;
			} else if (cGame.var_7aac == 18) {
				final String sub_4e1f16;
				sub_405b1(((sub_4e1f16 = GLLib.Text_GetString(Define.TEXT_NOTENOUGHCOINTITLE)) == null) ? "" : sub_4e1f16, cGame.var_7ab4, 7);
				cGame.var_7aac = -1;
				cGame.var_7d24 = false;
			}
			if (cGame.var_7d5c) {
		...
		if (n == 2) {
			if (GLLib.IsAnyKeyDown() == 19) {
				if (cGame.var_6924) {
					...
					final String sub_4e1f17;
					platformRequest("Show_Toast_" + (((sub_4e1f17 = GLLib.Text_GetString(Define.TEXT_CANNOTGOBACK)) == null) ? "" : sub_4e1f17));
				}
			}
			for (int l = 0; l < 6; ++l) {
				...
				if (cGame.var_6964) {
					...
					case 10: {
						if (!cGame.var_6954 && !cGame.var_7c4c) {
							...
							sub_45e60(false);
							cGame.var_7c4c = true;
							cGame.var_7cdc = GLLib.PaySMS_GetSpecialFlow();
							cGame.var_7cd4 = true;
							cGame.var_692c = false;
							sub_16d6a();
							GLLib.PaySMS_GetVirtualCurrency(200L);
							break;
						}
						if (cGame.var_7c4c) {
							break;
		...
		if (n == 8 && cGame.var_6924) {
			if (GLLib.Pointer_IsDown() || GLLib.Pointer_IsDragged() || cGame.var_799c) {
				...
				if (sub_2c577(GLLib.s_pointerX, GLLib.s_pointerY, cGame.var_68bc[8][156][2], cGame.var_68bc[8][156][3],
					...
					if (!cGame.var_7d44) {
						cGame.var_7d3c = GLLib.s_pointerY;
					}
					cGame.var_7d44 = true;
					if ((cGame.var_7d2c += GLLib.s_pointerY - cGame.var_7d3c) > 0) {
						cGame.var_7d2c = 0;
			...
			if (GLLib.s_pointerY < cGame.var_68bc[8][156][3]
	...
	private static String sub_45928(String sub_4e1f) {
		...
		if (sub_4e1f.toLowerCase().startsWith("bs ")
			...
			return sub_4e1f.substring(0, 3) + trim.substring(0, index2) + " "
					+ (((sub_4e1f = GLLib.Text_GetString(Define.TEXT_IAP_VATINCLUDED)) == null) ? "" : sub_4e1f);
		}
	...
	private static String sub_45a01(int n) {
		...
		if (s.toLowerCase().indexOf(s2.toLowerCase()) >= 0) {
			final String sub_4e1f;
			s3 = GLLib.Text_FindReplace(s, s2, ((sub_4e1f = GLLib.Text_GetString(Define.TEXT_IAP_SMS)) == null) ? "" : sub_4e1f);
		} else {
			...
			if (cGame.var_7cdc == 2 || cGame.var_7cdc == 5 || cGame.var_7cdc == 4) {
				String sub_4e1f2;
				String sub_4e1f3;
				str = ((cGame.s_currencySeprType == 1 || cGame.var_7cdc == 4)
						? (" " + (((sub_4e1f2 = GLLib.Text_GetString(Define.TEXT_IAP_SMSPRICE)) == null) ? "" : sub_4e1f2))
						: (" " + (((sub_4e1f3 = GLLib.Text_GetString(Define.TEXT_IAP_PRICEOF1SMS)) == null) ? "" : sub_4e1f3)));
			} else if (cGame.var_7cdc == 6) {
				int sub_7965;
				if (cGame.var_7d04[n] == -1) {
					sub_7965 = GLLib.PaySMS_FindPrice(n, s4);
					cGame.var_7d04[n] = sub_7965;
				} else {
					sub_7965 = cGame.var_7d04[n];
				}
				String sub_4e1f4;
				String sub_4e1f5;
				str = ((sub_7965 == 1) ? (" + 2 " + (((sub_4e1f4 = GLLib.Text_GetString(Define.TEXT_IAP_SMS)) == null) ? "" : sub_4e1f4))
						: (" + 1 " + (((sub_4e1f5 = GLLib.Text_GetString(Define.TEXT_IAP_SMS)) == null) ? "" : sub_4e1f5)));
			} else {
				String sub_4e1f6;
				str = ((cGame.var_7cdc == 9 || cGame.var_7cdc == 1)
						? (" " + (((sub_4e1f6 = GLLib.Text_GetString(Define.TEXT_IAP_VATNOTINCLUDED)) == null) ? "" : sub_4e1f6))
						: "");
			}
		...
		if (s3.trim().equals("")) {
			final String sub_4e1f7;
			s3 = (((sub_4e1f7 = GLLib.Text_GetString(Define.TEXT_MARKET_BUY)) == null) ? "" : sub_4e1f7);
		}
		return s3;
	}
	...
	private static void sub_45da5() {
		cGame.var_7cbc = 0;
		cGame.var_7cdc = GLLib.PaySMS_GetSpecialFlow();
		for (int i = 0; i < GLLib.PaySMS_GetCurrencyAmount("Cash"); ++i) {
			cGame.s_iapPrices[i] = GLLib.PaySMS_GetItemPrice(i, "Cash");
			final String sub_45a01 = sub_45a01(i);
			final long sub_7921 = GLLib.PaySMS_GetVirtualCurrency(200L, i, "Cash");
	...
	private static void sub_45f32() {
		...
		if (cGame.var_6964) {
			...
			case 10: {
				sub_174e9();
				if (cGame.var_6924) {
					if (cGame.s_iapTermsConditions != null) {
						GLLib.SetClip(GLLib.g, cGame.var_68bc[8][156][2], cGame.var_68bc[8][156][3],
								cGame.var_68bc[8][156][5], cGame.var_68bc[8][156][6], true);
						drawString(cGame.s_iapTermsConditions, 8, 156, 0, cGame.var_7d2c);
						GLLib.SetClip(GLLib.g, 0, 0, GLLib.s_screenWidth, GLLib.s_screenHeight, true);
					}
					...
					if (cGame.var_6964) {
						if (cGame.var_7cbc > 0 && cGame.var_692c) {
							if (cGame.var_7cbc > 0) {
								sub_1df06(GLLib.Text_FormatNumber(cGame.var_7cec[0], cGame.s_currencySeprType, " "), 8, 22, 0, 0);
							...
							if (1 < cGame.var_7cbc) {
								sub_1df06(GLLib.Text_FormatNumber(cGame.var_7cec[1], cGame.s_currencySeprType, " "), 8, 37, 0, 0);
							...
							if (2 < cGame.var_7cbc) {
								if (cGame.s_iapPriceTexts[2] != null) {
									sub_1df06(GLLib.Text_FormatNumber(cGame.var_7cec[2], cGame.s_currencySeprType, " "), 8, 52, 0,
											0);
								...
								if (3 < cGame.var_7cbc) {
									sub_1df06(GLLib.Text_FormatNumber(cGame.var_7cec[3], cGame.s_currencySeprType, " "), 8, 67, 0,
											0);
							...
							if (4 < cGame.var_7cbc) {
								if (cGame.s_iapPriceTexts[4] != null) {
									sub_1df06(GLLib.Text_FormatNumber(cGame.var_7cec[4], cGame.s_currencySeprType, " "), 8, 82, 0,
											0);
								...
								if (5 < cGame.var_7cbc) {
									sub_1df06(GLLib.Text_FormatNumber(cGame.var_7cec[5], cGame.s_currencySeprType, " "), 8, 97, 0,
											0);
							...
							final String sub_4e1f;
							drawString(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_IAP_NOPROFILE)) == null) ? "" : sub_4e1f, 8, 201, 0, 0);
						}
					}
				}
				return;
			...
			case 8: {
				cGame.var_7d1c = GLLib.PaySMS_GetErrorCode();
				sub_174e9();
				sub_177a2();
				sub_1715b();
				cGame.var_697c = 0;
			...
			case 2: {
				...
				if (cGame.var_697c == 4) {
					...
					final String sub_4e1f2;
					cGame.var_68cc[8][161] = (((sub_4e1f2 = GLLib.Text_GetString(Define.TEXT_IAP_SMSPIN)) == null) ? "" : sub_4e1f2);
			...
			case 3:
			case 11: {
				final int n = cGame.var_7d1c = GLLib.PaySMS_GetErrorCode();
				sub_174e9();
				sub_177a2();
				sub_1715b();
				cGame.var_6974 = 8;
		...
		if (cGame.var_6984) {
			sub_171dc();
			if (cGame.var_6984) {
				sub_1df06(GLLib.Text_FormatNumber(cGame.var_7cf4[0], cGame.s_currencySeprType, " "), 8, 116, 0, 0);
				GLLib.SetClip(GLLib.g, cGame.var_68bc[8][119][2], cGame.var_68bc[8][119][3],
						cGame.var_68bc[8][119][5], cGame.var_68bc[8][119][6], true);
				final String sub_4e1f3;
				sub_1df06(
						GLLib.Text_FormatNumber(cGame.var_7c6c[0], cGame.s_currencySeprType, " ") + " "
								+ (((sub_4e1f3 = GLLib.Text_GetString(Define.TEXT_IAP_CASH)) == null) ? "" : sub_4e1f3),
						8, 119, -cGame.var_7c7c[0], 0);
				GLLib.SetClip(GLLib.g, 0, 0, GLLib.s_screenWidth, GLLib.s_screenHeight, true);
				sub_1df06(GLLib.Text_FormatNumber(cGame.var_7cf4[1], cGame.s_currencySeprType, " "), 8, 122, 0, 0);
				GLLib.SetClip(GLLib.g, cGame.var_68bc[8][125][2], cGame.var_68bc[8][125][3],
						cGame.var_68bc[8][125][5], cGame.var_68bc[8][125][6], true);
				final String sub_4e1f4;
				sub_1df06(
						GLLib.Text_FormatNumber(cGame.var_7c6c[1], cGame.s_currencySeprType, " ") + " "
								+ (((sub_4e1f4 = GLLib.Text_GetString(Define.TEXT_IAP_CASH)) == null) ? "" : sub_4e1f4),
						8, 125, -cGame.var_7c7c[1], 0);
				GLLib.SetClip(GLLib.g, 0, 0, GLLib.s_screenWidth, GLLib.s_screenHeight, true);
				if (cGame.var_7cc4 > 2) {
					sub_1df06(GLLib.Text_FormatNumber(cGame.var_7cf4[2], cGame.s_currencySeprType, " "), 8, 128, 0, 0);
					GLLib.SetClip(GLLib.g, cGame.var_68bc[8][131][2], cGame.var_68bc[8][131][3],
							cGame.var_68bc[8][131][5], cGame.var_68bc[8][131][6], true);
					final String sub_4e1f5;
					sub_1df06(
							GLLib.Text_FormatNumber(cGame.var_7c6c[2], cGame.s_currencySeprType, " ") + " "
									+ (((sub_4e1f5 = GLLib.Text_GetString(Define.TEXT_IAP_CASH)) == null) ? "" : sub_4e1f5),
							8, 131, -cGame.var_7c7c[2], 0);
					GLLib.SetClip(GLLib.g, 0, 0, GLLib.s_screenWidth, GLLib.s_screenHeight, true);
					sub_1df06(GLLib.Text_FormatNumber(cGame.var_7cf4[3], cGame.s_currencySeprType, " "), 8, 134, 0, 0);
					GLLib.SetClip(GLLib.g, cGame.var_68bc[8][137][2], cGame.var_68bc[8][137][3],
							cGame.var_68bc[8][137][5], cGame.var_68bc[8][137][6], true);
					final String sub_4e1f6;
					sub_1df06(
							GLLib.Text_FormatNumber(cGame.var_7c6c[3], cGame.s_currencySeprType, " ") + " "
									+ (((sub_4e1f6 = GLLib.Text_GetString(Define.TEXT_IAP_CASH)) == null) ? "" : sub_4e1f6),
							8, 137, -cGame.var_7c7c[3], 0);
					GLLib.SetClip(GLLib.g, 0, 0, GLLib.s_screenWidth, GLLib.s_screenHeight, true);
				}
				if (cGame.var_7cc4 > 4) {
					sub_1df06(GLLib.Text_FormatNumber(cGame.var_7cf4[4], cGame.s_currencySeprType, " "), 8, 140, 0, 0);
					GLLib.SetClip(GLLib.g, cGame.var_68bc[8][143][2], cGame.var_68bc[8][143][3],
							cGame.var_68bc[8][143][5], cGame.var_68bc[8][143][6], true);
					final String sub_4e1f7;
					sub_1df06(
							GLLib.Text_FormatNumber(cGame.var_7c6c[4], cGame.s_currencySeprType, " ") + " "
									+ (((sub_4e1f7 = GLLib.Text_GetString(Define.TEXT_IAP_CASH)) == null) ? "" : sub_4e1f7),
							8, 143, -cGame.var_7c7c[4], 0);
					GLLib.SetClip(GLLib.g, 0, 0, GLLib.s_screenWidth, GLLib.s_screenHeight, true);
					sub_1df06(GLLib.Text_FormatNumber(cGame.var_7cf4[5], cGame.s_currencySeprType, " "), 8, 146, 0, 0);
					GLLib.SetClip(GLLib.g, cGame.var_68bc[8][149][2], cGame.var_68bc[8][149][3],
							cGame.var_68bc[8][149][5], cGame.var_68bc[8][149][6], true);
					final String sub_4e1f8;
					sub_1df06(
							GLLib.Text_FormatNumber(cGame.var_7c6c[5], cGame.s_currencySeprType, " ") + " "
									+ (((sub_4e1f8 = GLLib.Text_GetString(Define.TEXT_IAP_CASH)) == null) ? "" : sub_4e1f8),
	...
	private static void sub_46afe() {
		if ((System.currentTimeMillis() & 0x200L) != 0x0L) {
			final String sub_4e1f;
			drawString(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_IAP_WAITING)) == null) ? "" : sub_4e1f, 8, 159, 0, 0);
		}
	}

	private static void sub_46b63() {
		final String sub_4e1f;
		drawString(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_IAP_INPROG)) == null) ? "" : sub_4e1f, 8, 160, 0, 0);
	}
	...
	private static void sub_46bb6(final int var_7d1c) {
		...
		if (var_7d1c < 0 && var_7d1c >= -10) {
			final String sub_4e1f;
			drawString(((sub_4e1f = GLLib.Text_GetString(cGame.var_7d14[-var_7d1c])) == null) ? "" : sub_4e1f, 8, 201, 0,
					0);
			return;
		}
		if (var_7d1c > 10 && var_7d1c < 12) {
			final String sub_4e1f2;
			drawString(((sub_4e1f2 = GLLib.Text_GetString(cGame.var_7d14[var_7d1c])) == null) ? "" : sub_4e1f2, 8, 201, 0,
					0);
			return;
		}
		final String sub_4e1f3;
		drawString(((sub_4e1f3 = GLLib.Text_GetString(cGame.var_7d14[12])) == null) ? "" : sub_4e1f3, 8, 201, 0, 0);
	}
	...
	private static void sub_46c9b(final boolean b) {
		...
		final int sub_237ff = sanitizeTextSprIdx(cGame.var_68bc[8][n][7]);
		for (int i = 0; i < 6; ++i) {
			String s;
			if (b) {
				if (i < cGame.var_7cbc) {
				...
				final String sub_4e1f;
				s = cGame.var_7c6c[i] + " " + (((sub_4e1f = GLLib.Text_GetString(Define.TEXT_IAP_CASH)) == null) ? "" : sub_4e1f);
			}
	...
	private static boolean drawPond(final int n) {
		if (n == 0) {
			cGame.var_69dc = false;
			sub_23d73();
			playSnd(10, true);
			final GameDatas class_h;
			if ((class_h = GameDatas.s_allDatas[33]) != null) {
				cGame.s_pond_lowRodCashCost = class_h.m_dataVars[1][2];
				cGame.s_pond_highRodCashCost = class_h.m_dataVars[1][3];
			}
			if (cGame.s_pond_lowRodCashCost < 0) {
				cGame.s_pond_lowRodCashCost = 30;
			}
			if (cGame.s_pond_highRodCashCost < 0) {
				cGame.s_pond_highRodCashCost = 50;
			}
		}
		if (n == 1) {
			playSnd(10, true);
			if (cGame.s_pond_pondState == 1) {
				sub_2c69b();
				sub_1fb8e(24);
				cGame.s_pond_bubbleIndex = 0;
				while (cGame.s_pond_bubbleIndex < 7) {
					cGame.s_pond_bubblePlayers[cGame.s_pond_bubbleIndex].SetAnim(0, -1, true);
					cGame.s_pond_bubblePlayers[cGame.s_pond_bubbleIndex].SetPos(cGame.s_pond_bubbleXs[cGame.s_pond_bubbleIndex],
							cGame.s_pond_bubbleYs[cGame.s_pond_bubbleIndex]);
					cGame.s_pond_bubblePlayers[cGame.s_pond_bubbleIndex].RandomizeAnim();
					++cGame.s_pond_bubbleIndex;
				}
				for (int i = 0; i < cGame.var_7d74; ++i) {
					cGame.s_pond_bubblePlayers[cGame.var_7de4[i]].SetAnim(-1, 1);
				}
			} else if (cGame.s_pond_pondState == 2) {
				sub_4875f();
			} else {
				sub_47802();
			}
		...
		if (n == 8 && cGame.s_pond_pondState == 1 && GLLib.Pointer_IsReleased()) {
			...
			for (int j = 0; j < cGame.s_pond_bubbleIndex; ++j) {
				if (cGame.s_pond_bubblePlayers[j].GetAnim() == 0 && cGame.var_7d74 < 5 && GLLib.s_pointerX > cGame.s_pond_bubbleXs[j] - 65
						&& GLLib.s_pointerX < cGame.s_pond_bubbleXs[j] + 65 && GLLib.s_pointerY > cGame.s_pond_bubbleYs[j] - 30
						&& GLLib.s_pointerY < cGame.s_pond_bubbleYs[j] + 30 && !cGame.var_7e44 && cGame.var_7e3c == -1) {
					cGame.var_7e44 = true;
					cGame.var_7e3c = j;
					break;
				}
		...
		if (n == 5) {
			...
			cGame.var_7d74 = 0;
			cGame.var_7d94 = 0;
			cGame.s_pond_bubbleXs = null;
			cGame.s_pond_bubbleYs = null;
			cGame.var_7dac = null;
			cGame.var_7db4 = null;
			cGame.var_7dbc = null;
			cGame.var_7dc4 = null;
		...
		if (n == 2) {
			...
			if (cGame.s_pond_pondState == 0) {
				if (sub_2b09 == 19) {
					sub_1c12f();
				}
				for (int l = 0; l < 3; ++l) {
					cGame.s_pond_bubblePlayers[l].Update(GLLib.s_game_frameDT);
				}
			...
			} else if (cGame.s_pond_pondState == 1) {
				if (sub_2b09 == 19) {
					final String sub_4e1f;
					platformRequest("Show_Toast_" + (((sub_4e1f = GLLib.Text_GetString(Define.TEXT_CANNOTGOBACK)) == null) ? "" : sub_4e1f));
				}
				if (cGame.s_pond_bubbleIndex < 7 && --cGame.var_7d64 < 0) {
					animatePondBubbles();
				}
				if (cGame.var_7e44) {
				...
				for (int n12 = 0; n12 < 7; ++n12) {
					if (cGame.s_pond_bubblePlayers[n12].GetAnim() == 0 || cGame.s_pond_bubblePlayers[n12].GetAnim() == 2) {
						cGame.s_pond_bubblePlayers[n12].Update(GLLib.s_game_frameDT);
					}
					if (cGame.s_pond_bubblePlayers[n12].GetAnim() == 2 || cGame.s_pond_bubblePlayers[n12].GetAnim() == 1) {
						if (cGame.var_7d74 >= 5 && n2 == cGame.var_7d94 && cGame.s_pond_bubblePlayers[n12].IsAnimOver()) {
							playSndNoLoop(38);
							sub_4875f();
						} else {
							cGame.s_pond_bubblePlayers[n12].Update(GLLib.s_game_frameDT);
			...
			} else if (cGame.s_pond_pondState == 2 && (sub_2b09 == 11 || sub_2b09 == 19)) {
				sub_47802();
			}
			if (!sndPlayingOnChannel(0)) {
				playSnd(10, true);
		...
		if (n == 3) {
			...
			if (cGame.s_pond_pondState == 0) {
				for (int n13 = 0; n13 < 3; ++n13) {
					cGame.s_pond_bubblePlayers[n13].Render();
				}
				final String sub_4e1f2;
				sub_1df06(((sub_4e1f2 = GLLib.Text_GetString(Define.TEXT_POND_FREEROD)) == null) ? "" : sub_4e1f2, 24, 20, 0, 0);
				sub_1df06(Integer.toString(cGame.s_pond_highRodCashCost), 24, 22, 0, 0);
				sub_1df06(Integer.toString(cGame.s_pond_lowRodCashCost), 24, 24, 0, 0);
				if (sub_20167(24, 28)) {
					final int n14;
				...
				for (int n16 = 0; n16 < 7; ++n16) {
					cGame.s_pond_bubblePlayers[n16].Render();
				}
	...
	private static void sub_47802() {
		...
		cGame.s_pond_bubblePlayers[0].SetAnim(3, -1);
		cGame.s_pond_bubblePlayers[1].SetAnim(4, -1);
		cGame.s_pond_bubblePlayers[2].SetAnim(5, -1);
		...
		cGame.var_7d74 = 0;
		cGame.var_7d94 = 0;
		cGame.s_pond_bubbleXs = new int[7];
		cGame.s_pond_bubbleYs = new int[7];
		cGame.var_7d64 = 30;
		cGame.var_7e3c = -1;
		cGame.var_7e44 = false;
	}
	...
	private static boolean sub_479c7(int i) {
		if (sub_2dcf3(5) + cActor.sub_59d2(2) > sub_2df26() - 15) {
			if (i == 1) {
				addCash(cGame.s_pond_lowRodCashCost);
			} else if (i == 2) {
			...
			sub_4019a(7, 0, 10);
			final String sub_4e1f;
			cGame.s_popup_title = (((sub_4e1f = GLLib.Text_GetString(Define.TEXT_POPUP_NOSPACE)) == null) ? "" : sub_4e1f);
			final String sub_4e1f2;
			cGame.s_popup_desc = (((sub_4e1f2 = GLLib.Text_GetString(Define.TEXT_POPUP_NOSPACEDESC)) == null) ? "" : sub_4e1f2);
			sub_82a7(Define.GS_POPUP);
			return false;
		}
		...
		case 0: {
			...
			if ((class_h = GameDatas.s_allDatas[33]) != null) {
				long n;
				if ((n = class_h.m_dataVars[0][1] * 1000) == 0L) {
					n = 86400000L;
				}
		...
		for (i = 0; i < 7; ++i) {
			cGame.s_pond_bubblePlayers[i].SetAnim(-1, 1);
		}
		...
		i = 0;
		int var_7dd4 = 0;
		final GameDatas class_h2 = GameDatas.s_allDatas[19];
		for (int j = 0; j < class_h2.var_7a; ++j) {
			switch (cGame.var_7d7c) {
			case 0: {
				if (class_h2.m_dataVars[j][6] > 0) {
					cGame.var_7db4[i] = class_h2.m_dataVars[j][4];
					cGame.var_7dbc[i] = class_h2.m_dataVars[j][3];
					cGame.var_7dc4[i] = class_h2.m_dataVars[j][5];
					cGame.var_7dac[i] = class_h2.m_dataVars[j][6];
			...
			case 1: {
				if (class_h2.m_dataVars[j][7] > 0) {
					cGame.var_7db4[i] = class_h2.m_dataVars[j][4];
					cGame.var_7dbc[i] = class_h2.m_dataVars[j][3];
					cGame.var_7dc4[i] = class_h2.m_dataVars[j][5];
					cGame.var_7dac[i] = class_h2.m_dataVars[j][7];
					var_7dd4 += cGame.var_7dac[i];
					++i;
					break;
				}
			...
			case 2: {
				if (class_h2.m_dataVars[j][8] > 0) {
					cGame.var_7db4[i] = class_h2.m_dataVars[j][4];
					cGame.var_7dbc[i] = class_h2.m_dataVars[j][3];
					cGame.var_7dc4[i] = class_h2.m_dataVars[j][5];
					cGame.var_7dac[i] = class_h2.m_dataVars[j][8];
					var_7dd4 += cGame.var_7dac[i];
					++i;
					break;
				}
	...
	private static void animatePondBubbles() {
		cGame.s_pond_bubbleIndex = 0;
		while (cGame.s_pond_bubbleIndex < 7) {
			cGame.s_pond_bubbleXs[cGame.s_pond_bubbleIndex] = GLLib.Math_Rand(240, 600);
			cGame.s_pond_bubbleYs[cGame.s_pond_bubbleIndex] = GLLib.Math_Rand(160, 300);
			cGame.s_pond_bubblePlayers[cGame.s_pond_bubbleIndex].SetAnim(0, -1, true);
			cGame.s_pond_bubblePlayers[cGame.s_pond_bubbleIndex].SetPos(cGame.s_pond_bubbleXs[cGame.s_pond_bubbleIndex],
					cGame.s_pond_bubbleYs[cGame.s_pond_bubbleIndex]);
			cGame.s_pond_bubblePlayers[cGame.s_pond_bubbleIndex].RandomizeAnim();
			cGame.s_pond_bubblePlayers[cGame.s_pond_bubbleIndex].Render();
			++cGame.s_pond_bubbleIndex;
		}
	}
	...
	private static void sub_47eb6(final int n) {
		...
		if (cGame.var_7d94 < 3 && cGame.var_7db4[i] != 0) {
			playSndNoLoop(46);
			cGame.s_pond_bubblePlayers[n].SetAnim(1, 1);
			int n3 = 0;
			int n4 = 0;
			if (cGame.var_7d7c == 0) {
			...
			cGame.var_68bc[24][25 + cGame.var_7d94][2] = (short) cGame.s_pond_bubbleXs[n];
			cGame.var_68bc[24][25 + cGame.var_7d94][3] = (short) (cGame.s_pond_bubbleYs[n] - 50);
			final int n5 = 0x180000 | (25 + cGame.var_7d94 & 0xFFFF);
			sub_23556(n5, n5, cGame.s_pond_bubbleXs[n], cGame.s_pond_bubbleYs[n] - 50, n3 - 50, n4 + 50, 500);
			...
			case 1: {
				final GameDatas class_h = GameDatas.s_allDatas[1];
				for (int j = 0; j < class_h.var_7a; ++j) {
					if (class_h.m_dataVars[j][1] == cGame.var_7dbc[i]) {
						n6 = class_h.m_dataVars[j][3];
						n7 = class_h.m_dataVars[j][4];
						final String sub_4e1f;
						s = (((sub_4e1f = GLLib.Text_GetString(class_h.m_dataVars[j][2])) == null) ? "" : sub_4e1f);
						if (j == 110) {
							addDeluxifier(cGame.var_7dc4[i]);
			...
			case 2: {
				...
				n7 = 36;
				final String sub_4e1f2;
				s = (((sub_4e1f2 = GLLib.Text_GetString(Define.TEXT_COINS)) == null) ? "" : sub_4e1f2);
				addCoins(cGame.var_7dc4[i]);
			...
			case 3: {
				...
				n7 = 37;
				final String sub_4e1f3;
				s = (((sub_4e1f3 = GLLib.Text_GetString(Define.TEXT_EXP)) == null) ? "" : sub_4e1f3);
			...
			case 4: {
				...
				n7 = 6;
				final String sub_4e1f4;
				s = (((sub_4e1f4 = GLLib.Text_GetString(Define.TEXT_MANOR_FARMCASH)) == null) ? "" : sub_4e1f4);
				addCash(cGame.var_7dc4[i]);
				cGame.var_7e14 += cGame.var_7dc4[i];
				break;
			}
			case 5: {
				final GameDatas class_h2 = GameDatas.s_allDatas[4];
				for (int k = 0; k < class_h2.var_7a; ++k) {
					if (class_h2.m_dataVars[k][1] == cGame.var_7dbc[i]) {
						n6 = class_h2.m_dataVars[k][3];
						n7 = class_h2.m_dataVars[k][4];
						final String sub_4e1f5;
						s = (((sub_4e1f5 = GLLib.Text_GetString(class_h2.m_dataVars[k][2])) == null) ? "" : sub_4e1f5);
			...
			case 6: {
				final GameDatas class_h3 = GameDatas.s_allDatas[0];
				for (int l = 0; l < class_h3.var_7a; ++l) {
					if (class_h3.m_dataVars[l][1] == cGame.var_7dbc[i]) {
						n6 = class_h3.m_dataVars[l][3];
						n7 = class_h3.m_dataVars[l][4];
						n8 = class_h3.m_dataVars[l][32];
						final String sub_4e1f6;
						s = (((sub_4e1f6 = GLLib.Text_GetString(class_h3.m_dataVars[l][2])) == null) ? "" : sub_4e1f6);
			...
			case 7: {
				...
				for (int n9 = 0; n9 < class_h4.var_7a; ++n9) {
					if (class_h4.m_dataVars[n9][1] == cGame.var_7dbc[i]) {
						n6 = class_h4.m_dataVars[n9][3];
						n7 = class_h4.m_dataVars[n9][4];
						final String sub_4e1f7;
						s = (((sub_4e1f7 = GLLib.Text_GetString(class_h4.m_dataVars[n9][2])) == null) ? "" : sub_4e1f7);
			...
			playSndNoLoop(46);
			cGame.s_pond_bubblePlayers[n].SetAnim(2, 1);
		}
		cGame.var_7de4[cGame.var_7d74] = n;
		++cGame.var_7d74;
	}

	private static void drawPondFinishPopup() {
		final String popDescr = (GLLib.Text_GetString(Define.TEXT_POPUP_PONDWINDESC) == null ? "" : GLLib.Text_GetString(Define.TEXT_POPUP_PONDWINDESC));
		sub_1dcc1(20);
		sub_1df06((GLLib.Text_GetString(Define.TEXT_POPUP_PONDWIN)) == null ? "" : GLLib.Text_GetString(Define.TEXT_POPUP_PONDWIN), 20, 5, 0, 0);
		drawString(popDescr, 20, 7, 0, 0);
		if (sub_20167(20, 4)) {
			sub_1df06((GLLib.Text_GetString(Define.TEXT_PONDOK)) == null ? "" : GLLib.Text_GetString(Define.TEXT_PONDOK), 20, 6, 0, 0);
		}
		for (int i = 0; i < cGame.var_7d94; ++i) {
			if (cGame.var_7e04[i] > 0) {
				sub_1df06(GLLib.Text_FormatNumber(cGame.var_7e04[i], cGame.s_currencySeprType, " "), 20, i + 13, 0, 0);
			}
		}
	}
	...
	private static void sub_4875f() {
		...
		sub_2c69b();
		sub_1fb8e(20);
		cGame.s_pond_pondState = 2;
	}

	private static boolean drawFarmDiary(final int n) {
		if (n == 0) {
			sub_1daf4(5);
			sub_2c69b();
			sub_1fb8e(5);
		...
		if (n == 3) {
			...
			switch (cGame.s_questStates[cGame.s_currentQuest]) {
			case 2: {
				sub_1dcc1(5);
				if (!sub_20167(5, 0)) {
					break;
				...
				final String sub_4e1f;
				sub_1df06(((sub_4e1f = GLLib.Text_GetString(Define.TEXT_DIARY)) == null) ? "" : sub_4e1f, 5, 1, 0, 0);
				sub_1df06(cGame.s_questNames[cGame.s_currentQuest], 5, 3, 0, 0);
				drawString(cGame.s_questDescriptions[cGame.s_currentQuest], 5, 4, 0, 0);
				if (cGame.s_questQuests[cGame.s_currentQuest] != "") {
					drawString(cGame.s_questQuests[cGame.s_currentQuest], 5, 7, 0, 0);
					sub_1df06(""
							+ GLLib.Text_FormatNumber(decryptInt(cGame.s_questValue[cGame.s_currentQuest]), cGame.s_currencySeprType, " ")
							+ "/"
							+ GLLib.Text_FormatNumber(decryptInt(cGame.s_questNeededVals[cGame.s_currentQuest]), cGame.s_currencySeprType, " "), 5,
							8, 0, 0);
					if (cGame.var_68bc[5][10][10] == 1) {
						sub_1df06("" + cGame.var_7eb4[cGame.s_currentQuest], 5, 12, 0, 0);
					}
				}
				if (cGame.s_questQuests2[cGame.s_currentQuest] != "") {
					drawString(cGame.s_questQuests2[cGame.s_currentQuest], 5, 15, 0, 0);
					sub_1df06(""
							+ GLLib.Text_FormatNumber(decryptInt(cGame.var_7ecc[cGame.s_currentQuest]), cGame.s_currencySeprType, " ")
							+ "/"
							+ GLLib.Text_FormatNumber(decryptInt(cGame.var_7ed4[cGame.s_currentQuest]), cGame.s_currencySeprType, " "), 5,
							16, 0, 0);
					if (sub_20167(5, 18)) {
						sub_1df06("" + cGame.var_7eec[cGame.s_currentQuest], 5, 20, 0, 0);
					}
				}
				if (cGame.s_loadedTexts[cGame.s_currentQuest] == "") {
					break;
				}
				drawString(cGame.s_loadedTexts[cGame.s_currentQuest], 5, 23, 0, 0);
				sub_1df06("" + GLLib.Text_FormatNumber(decryptInt(cGame.var_7f04[cGame.s_currentQuest]), cGame.s_currencySeprType, " ")
						+ "/" + GLLib.Text_FormatNumber(decryptInt(cGame.var_7f0c[cGame.s_currentQuest]), cGame.s_currencySeprType, " "),
						5, 24, 0, 0);
				if (sub_20167(5, 26)) {
					sub_1df06("" + cGame.var_7f24[cGame.s_currentQuest], 5, 28, 0, 0);
					break;
				}
				break;
			}
			case 3: {
				sub_1dcc1(5);
				final String sub_4e1f2;
				sub_1df06(((sub_4e1f2 = GLLib.Text_GetString(Define.TEXT_QUEST_TASKCOMPLETE)) == null) ? "" : sub_4e1f2, 5, 30, 0, 0);
				sub_1df06(cGame.s_questNames[cGame.s_currentQuest], 5, 33, 0, 0);
				drawString(cGame.s_questOutros[cGame.s_currentQuest], 5, 34, 0, 0);
				final String sub_4e1f3;
				sub_1df06(((sub_4e1f3 = GLLib.Text_GetString(Define.TEXT_QUEST_REWARDS)) == null) ? "" : sub_4e1f3, 5, 35, 0, 0);
				sub_1df06(GLLib.Text_FormatNumber(decryptInt(cGame.var_7f44[cGame.s_currentQuest]), cGame.s_currencySeprType, " "), 5, 46,
						0, 0);
				if (decryptInt(cGame.var_7f4c[cGame.s_currentQuest]) > 0) {
					sub_1df06(GLLib.Text_FormatNumber(decryptInt(cGame.var_7f4c[cGame.s_currentQuest]), cGame.s_currencySeprType, " "), 5,
							50, 0, 0);
				}
				if (decryptInt(cGame.var_7f54[cGame.s_currentQuest]) > 0 && !cGame.s_iapEnabled) {
					sub_1df06(GLLib.Text_FormatNumber(decryptInt(cGame.var_7f54[cGame.s_currentQuest]), cGame.s_currencySeprType, " "), 5,
							48, 0, 0);
				}
				final String sub_4e1f4;
				sub_1df06(((sub_4e1f4 = GLLib.Text_GetString(Define.TEXT_OK)) == null) ? "" : sub_4e1f4, 5, 54, 0, 0);
				break;
			}
			}
		}
		if (n == 1) {
			if (cGame.s_questStates[cGame.s_currentQuest] == 1) {
				cGame.s_questStates[cGame.s_currentQuest] = 2;
			}
			sub_2c69b();
			sub_1fb8e(5);
			sub_48d55();
	...
	private static void sub_48d55() {
		...
		int n = 0;
		Label_0115: {
			if (cGame.var_7e7c[cGame.s_currentQuest] != 1) {
				if (cGame.var_7e7c[cGame.s_currentQuest] == 6) {
					n = 8;
					break Label_0115;
				}
				if (cGame.var_7e7c[cGame.s_currentQuest] == 2) {
					n = 15;
					break Label_0115;
				}
				if (cGame.var_7e7c[cGame.s_currentQuest] == 5) {
					n = 24;
					break Label_0115;
				}
				if (cGame.var_7e7c[cGame.s_currentQuest] == 3) {
					n = 25;
					break Label_0115;
				}
				if (cGame.var_7e7c[cGame.s_currentQuest] == 4) {
					n = 26;
					break Label_0115;
				}
			}
		...
		if (cGame.s_questStates[cGame.s_currentQuest] == 1) {
			sub_405b1(cGame.s_questNames[cGame.s_currentQuest], cGame.s_questIntros[cGame.s_currentQuest], n2);
		} else if (cGame.s_questStates[cGame.s_currentQuest] == 2) {
			if (cGame.var_7e4c[cGame.s_currentQuest] == cGame.var_80f4[0]
					|| cGame.var_7e4c[cGame.s_currentQuest] == cGame.var_80f4[1]) {
				if (!cGame.var_7ebc[cGame.s_currentQuest]) {
					if (cGame.var_7e4c[cGame.s_currentQuest] == cGame.var_80f4[0]) {
						if (cGame.var_7fac) {
							sub_2000c(5, 58, true);
					...
					} else if (cGame.var_7e4c[cGame.s_currentQuest] == cGame.var_80f4[1]) {
						if (cGame.var_7fb4) {
							sub_2000c(5, 58, true);
			...
			sub_2000c(5, 13, true);
			sub_2000c(5, 21, true);
			if (decryptInt(cGame.s_questNeededVals[cGame.s_currentQuest]) > 0 && cGame.var_7ebc[cGame.s_currentQuest]) {
				sub_2000c(5, 9, true);
			} else {
				sub_2000c(5, 9, false);
			}
			if (decryptInt(cGame.var_7ed4[cGame.s_currentQuest]) > 0 && cGame.var_7ef4[cGame.s_currentQuest]) {
				sub_2000c(5, 17, true);
			} else {
				sub_2000c(5, 17, false);
			}
			if (decryptInt(cGame.var_7f0c[cGame.s_currentQuest]) > 0 && cGame.var_7f2c[cGame.s_currentQuest]) {
				sub_2000c(5, 25, true);
			} else {
				sub_2000c(5, 25, false);
			}
			if (decryptInt(cGame.s_questValue[cGame.s_currentQuest]) < decryptInt(cGame.s_questNeededVals[cGame.s_currentQuest])) {
				if (cGame.var_7eb4[cGame.s_currentQuest] > 0) {
					sub_2000c(5, 10, true);
					sub_2024d(5, 10, true);
					sub_2000c(5, 11, true);
			...
			if (decryptInt(cGame.var_7ecc[cGame.s_currentQuest]) < decryptInt(cGame.var_7ed4[cGame.s_currentQuest])) {
				if (cGame.var_7eec[cGame.s_currentQuest] > 0) {
					sub_2000c(5, 18, true);
					sub_2024d(5, 18, true);
					sub_2000c(5, 19, true);
			...
			if (decryptInt(cGame.var_7f04[cGame.s_currentQuest]) < decryptInt(cGame.var_7f0c[cGame.s_currentQuest])) {
				if (cGame.var_7f24[cGame.s_currentQuest] > 0) {
					sub_2000c(5, 26, true);
					sub_2024d(5, 26, true);
					sub_2000c(5, 27, true);
		...
		} else if (cGame.s_questStates[cGame.s_currentQuest] == 3) {
			sub_2000c(5, 58, false);
			sub_2000c(5, 31, true);
			sub_2000c(5, 32, true);
			sub_2000c(5, 56, true);
	...
	private static void sub_4934e() {
		...
		cGame.s_questDescriptions = new String[cGame.var_7f74];
		...
		cGame.s_questValue = new int[cGame.var_7f74];
		cGame.s_questNeededVals = new int[cGame.var_7f74];
		...
		cGame.s_questStates = new int[cGame.var_7f74];
		for (char c = '\0'; c < cGame.var_7f74; ++c) {
			cGame.var_7e4c[c] = -1;
			cGame.var_7e54[c] = -1;
			cGame.var_7e5c[c] = 0;
			...
			cGame.s_questDescriptions[c] = "";
			cGame.var_7e84[c] = 0;
			cGame.var_7e7c[c] = 0;
			cGame.s_questQuests[c] = "";
			cGame.s_questQuests2[c] = "";
			cGame.s_loadedTexts[c] = "";
			cGame.s_questValue[c] = encryptInt(0);
			cGame.s_questNeededVals[c] = encryptInt(0);
		...
		final GameDatas class_h = GameDatas.s_allDatas[6];
		(cGame.var_7f84 = new short[22])[0] = (short) class_h.m_dataVars[18][1];
		cGame.var_7f84[1] = (short) class_h.m_dataVars[44][1];
		cGame.var_7f84[2] = (short) class_h.m_dataVars[49][1];
		cGame.var_7f84[3] = (short) class_h.m_dataVars[62][1];
		cGame.var_7f84[4] = (short) class_h.m_dataVars[68][1];
		cGame.var_7f84[5] = (short) class_h.m_dataVars[85][1];
		cGame.var_7f84[6] = (short) class_h.m_dataVars[112][1];
		cGame.var_7f84[7] = (short) class_h.m_dataVars[124][1];
		cGame.var_7f84[8] = (short) class_h.m_dataVars[131][1];
		cGame.var_7f84[9] = (short) class_h.m_dataVars[164][1];
		cGame.var_7f84[10] = (short) class_h.m_dataVars[165][1];
		cGame.var_7f84[11] = (short) class_h.m_dataVars[170][1];
		cGame.var_7f84[12] = (short) class_h.m_dataVars[180][1];
		cGame.var_7f84[13] = (short) class_h.m_dataVars[181][1];
		cGame.var_7f84[14] = (short) class_h.m_dataVars[205][1];
		cGame.var_7f84[15] = (short) class_h.m_dataVars[229][1];
		cGame.var_7f84[16] = (short) class_h.m_dataVars[233][1];
		cGame.var_7f84[17] = (short) class_h.m_dataVars[239][1];
		cGame.var_7f84[18] = (short) class_h.m_dataVars[267][1];
		cGame.var_7f84[19] = (short) class_h.m_dataVars[270][1];
		cGame.var_7f84[20] = (short) class_h.m_dataVars[291][1];
		cGame.var_7f84[21] = (short) class_h.m_dataVars[292][1];
	}
	...
	private static boolean sub_49794() {
		boolean b = false;
		if (cGame.s_tutorialState != -1 && cGame.s_tutorialState != 10) {
			return false;
		}
		final GameDatas class_h = GameDatas.s_allDatas[6];
		int n = 0;
		for (char var_7f6c = '\0'; var_7f6c < cGame.var_7f74; ++var_7f6c) {
			if (!sub_4aad0(var_7f6c)) {
				for (int i = n; i < cGame.var_7f7c; ++i) {
					...
					if (!b2 && !sub_4abbb(n2) && getLevel() >= class_h.m_dataVars[i][14]) {
						final int n3 = class_h.m_dataVars[i][15];
						final int n4 = class_h.m_dataVars[i][16];
						final int n5 = class_h.m_dataVars[i][17];
						boolean b3 = true;
						if (n3 != -1 && !sub_4abbb(class_h.m_dataVars[n3][1])) {
							b3 = false;
						}
						if (n4 != -1 && !sub_4abbb(class_h.m_dataVars[n4][1])) {
							b3 = false;
						}
						if (n5 != -1 && !sub_4abbb(class_h.m_dataVars[n5][1])) {
							b3 = false;
						}
						if (b3) {
	...
	private static void sub_4998f(final int n, final int n2) {
		if (cGame.var_7e4c[n] != -1 && cGame.s_questStates[n] != 3) {
			if (n2 == 0) {
				cGame.s_questValue[n] = cGame.s_questNeededVals[n];
			...
			if ((decryptInt(cGame.s_questNeededVals[n]) == 0 || cGame.var_7ebc[n])
	...
	static int sub_49db0(final int n, final int n2, final int n3, final boolean b) {
		int n4 = 0;
		for (char c = '\0'; c < cGame.var_7f74; ++c) {
			if (cGame.s_questStates[c] == 2) {
				int var_7fa4 = -1;
				final int sub_49a81;
				if ((sub_49a81 = sub_49a81(cGame.var_7ebc[c], cGame.var_7ea4[c], n, cGame.var_7eac[c], n3,
						b)) == 3 || sub_49a81 == 1) {
					cGame.s_questValue[c] = encryptInt(decryptInt(cGame.s_questValue[c]) + n2);
					if (decryptInt(cGame.s_questValue[c]) >= decryptInt(cGame.s_questNeededVals[c])) {
						cGame.s_questValue[c] = cGame.s_questNeededVals[c];
						cGame.var_7ebc[c] = true;
						var_7fa4 = c;
					}
					if (decryptInt(cGame.s_questValue[c]) < 0) {
						cGame.s_questValue[c] = 0;
					}
				} else if (sub_49a81 == 2) {
					if (n2 >= decryptInt(cGame.s_questNeededVals[c])) {
						cGame.s_questValue[c] = cGame.s_questNeededVals[c];
						cGame.var_7ebc[c] = true;
						var_7fa4 = c;
					} else {
						cGame.s_questValue[c] = encryptInt(n2);
					}
				}
				final int sub_49a82;
				...
				if (var_7fa4 != -1) {
					...
					playSndNoLoop(39);
					if ((decryptInt(cGame.s_questNeededVals[var_7fa4]) == 0 || cGame.var_7ebc[var_7fa4])
	...
	private static void sub_4a22d(final int n, final int n2, final boolean b) {
		final GameDatas class_h = GameDatas.s_allDatas[6];
		cGame.var_7e4c[n2] = class_h.m_dataVars[n][1];
		cGame.var_7e54[n2] = n;
		sub_2024d(1, 44, true);
		cGame.var_7e5c[n2] = class_h.m_dataVars[n][14];
		final int n3;
		String[] array;
		int n4;
		String s;
		if ((n3 = class_h.m_dataVars[n][3]) < 0) {
			...
			n4 = n2;
			final String sub_4e1f;
			s = (((sub_4e1f = GLLib.Text_GetString(n3)) == null) ? "" : sub_4e1f);
		}
		array[n4] = s;
		final int n5;
		String[] array2;
		int n6;
		String s2;
		if ((n5 = class_h.m_dataVars[n][5]) < 0) {
			...
			n6 = n2;
			final String sub_4e1f2;
			s2 = (((sub_4e1f2 = GLLib.Text_GetString(n5)) == null) ? "" : sub_4e1f2);
		}
		array2[n6] = s2;
		final int n7;
		String[] array3;
		int n8;
		String s3;
		if ((n7 = class_h.m_dataVars[n][6]) < 0) {
			array3 = cGame.s_questDescriptions;
			n8 = n2;
			s3 = "%DESC TEXT ERROR%";
		} else {
			array3 = cGame.s_questDescriptions;
			n8 = n2;
			final String sub_4e1f3;
			s3 = (((sub_4e1f3 = GLLib.Text_GetString(n7)) == null) ? "" : sub_4e1f3);
		}
		array3[n8] = s3;
		cGame.var_7e84[n2] = class_h.m_dataVars[n][7];
		cGame.var_7e7c[n2] = class_h.m_dataVars[n][4];
		final int n9;
		String[] array4;
		int n10;
		String s4;
		if ((n9 = class_h.m_dataVars[n][18]) < 0) {
			...
			n10 = n2;
			final String sub_4e1f4;
			s4 = (((sub_4e1f4 = GLLib.Text_GetString(n9)) == null) ? "" : sub_4e1f4);
		}
		array4[n10] = s4;
		final int n11;
		String[] array5;
		int n12;
		String s5;
		if ((n11 = class_h.m_dataVars[n][23]) < 0) {
			...
			n12 = n2;
			final String sub_4e1f5;
			s5 = (((sub_4e1f5 = GLLib.Text_GetString(n11)) == null) ? "" : sub_4e1f5);
		}
		array5[n12] = s5;
		final int n13;
		String[] array6;
		int n14;
		String s6;
		if ((n13 = class_h.m_dataVars[n][28]) < 0) {
			...
			n14 = n2;
			final String sub_4e1f6;
			s6 = (((sub_4e1f6 = GLLib.Text_GetString(n13)) == null) ? "" : sub_4e1f6);
		}
		array6[n14] = s6;
		cGame.s_questNeededVals[n2] = encryptInt(class_h.m_dataVars[n][20]);
		cGame.var_7ea4[n2] = class_h.m_dataVars[n][19];
		cGame.var_7eac[n2] = class_h.m_dataVars[n][21];
		cGame.var_7eb4[n2] = class_h.m_dataVars[n][22];
		cGame.var_7ed4[n2] = encryptInt(class_h.m_dataVars[n][25]);
		cGame.var_7edc[n2] = class_h.m_dataVars[n][24];
		cGame.var_7ee4[n2] = class_h.m_dataVars[n][26];
		cGame.var_7eec[n2] = class_h.m_dataVars[n][27];
		cGame.var_7f0c[n2] = encryptInt(class_h.m_dataVars[n][30]);
		cGame.var_7f14[n2] = class_h.m_dataVars[n][29];
		cGame.var_7f1c[n2] = class_h.m_dataVars[n][31];
		cGame.var_7f24[n2] = class_h.m_dataVars[n][32];
		final int n15;
		String[] array7;
		int n16;
		String s7;
		if ((n15 = class_h.m_dataVars[n][13]) < 0) {
			...
			n16 = n2;
			final String sub_4e1f7;
			s7 = (((sub_4e1f7 = GLLib.Text_GetString(n15)) == null) ? "" : sub_4e1f7);
		}
		array7[n16] = s7;
		cGame.var_7f44[n2] = encryptInt(class_h.m_dataVars[n][8]);
		cGame.var_7f4c[n2] = encryptInt(class_h.m_dataVars[n][10]);
		cGame.var_7f54[n2] = encryptInt(class_h.m_dataVars[n][12]);
		if (b) {
			cGame.s_questStates[n2] = 1;
			cGame.s_questValue[n2] = encryptInt(0);
	...
	private static void sub_4a6a7(final int var_7f6c) {
		if (cGame.s_questStates[var_7f6c] != 3) {
			return;
		}
		...
		cGame.s_questDescriptions[var_7f6c] = "";
		...
		cGame.s_questValue[var_7f6c] = encryptInt(0);
		cGame.s_questNeededVals[var_7f6c] = encryptInt(0);
		...
		cGame.s_questStates[var_7f6c] = 0;
		int n = var_7f6c + 1;
		for (int n2 = var_7f6c; n2 < cGame.var_7f74 - '\u0001' && cGame.var_7e4c[n2 + 1] != -1; ++n2) {
			...
			cGame.s_questDescriptions[n2] = cGame.s_questDescriptions[n2 + 1];
			...
			cGame.s_questValue[n2] = cGame.s_questValue[n2 + 1];
			cGame.s_questNeededVals[n2] = cGame.s_questNeededVals[n2 + 1];
			...
			cGame.s_questStates[n2] = cGame.s_questStates[n2 + 1];
		}
		if (n < cGame.var_7f74) {
			cGame.var_7e4c[n] = -1;
			cGame.var_7e54[n] = -1;
			...
			cGame.s_questDescriptions[n] = "";
			cGame.var_7e84[n] = 0;
			cGame.var_7e7c[n] = 0;
			cGame.s_questQuests[n] = "";
			cGame.s_questQuests2[n] = "";
			cGame.s_loadedTexts[n] = "";
			cGame.s_questValue[n] = encryptInt(0);
			cGame.s_questNeededVals[n] = encryptInt(0);
			...
			cGame.s_questStates[n] = 0;
		}
		cGame.s_currentQuest = var_7f6c;
		if (var_7f6c >= 1 && cGame.var_7e4c[var_7f6c] == -1) {
			--cGame.s_currentQuest;
		}
	}
	...
	private static void sub_4ab1c(final int var_7f6c, final boolean b) {
		cGame.s_questStates[var_7f6c] = 3;
		cGame.s_currentQuest = var_7f6c;
		...
		if (cGame.var_7eac[var_7f6c] == 1) {
			final cActor[] array = new cActor[30];
			for (int sub_5439 = cActor.sub_5439(0, 22, array, 30), i = 0; i < sub_5439; ++i) {
				array[i].sub_9274();
			}
		}
	}
	...
	static boolean sub_4ac19(final int n) {
		boolean b = false;
		for (char c = '\0'; c < cGame.var_7f74 && cGame.var_7e4c[c] != -1; ++c) {
			if (cGame.s_questStates[c] >= 2 && cGame.var_7e4c[c] == cGame.var_80f4[n]) {
				b = true;
				break;
			}
		}
			...
			if (cGame.s_questStates[c] == 2) {
				if (!cGame.var_7ebc[c] && cGame.var_7eac[c] == 38) {
					...
					if (cGame.var_7ea4[c] == 2998) {
						cGame.s_questValue[c] = encryptInt(cActor.sub_4de1(0, 54, 4, 15));
						if (decryptInt(cGame.s_questValue[c]) >= decryptInt(cGame.s_questNeededVals[c])) {
							cGame.s_questValue[c] = cGame.s_questNeededVals[c];
							n2 = c;
						}
					} else if (cGame.var_7ea4[c] == 2997) {
						cGame.s_questValue[c] = encryptInt(cActor.sub_4de1(0, 54, 16, 27));
						if (decryptInt(cGame.s_questValue[c]) >= decryptInt(cGame.s_questNeededVals[c])) {
							cGame.s_questValue[c] = cGame.s_questNeededVals[c];
							n2 = c;
						}
					} else if (cGame.var_7ea4[c] == 2996) {
						cGame.s_questValue[c] = encryptInt(cActor.sub_4de1(0, 54, 28, 39));
						if (decryptInt(cGame.s_questValue[c]) >= decryptInt(cGame.s_questNeededVals[c])) {
							cGame.s_questValue[c] = cGame.s_questNeededVals[c];
							n2 = c;
						}
					} else if (cGame.var_7ea4[c] == 2995) {
						cGame.s_questValue[c] = encryptInt(cActor.sub_4de1(0, 54, 40, 51));
						if (decryptInt(cGame.s_questValue[c]) >= decryptInt(cGame.s_questNeededVals[c])) {
							cGame.s_questValue[c] = cGame.s_questNeededVals[c];
							n2 = c;
						}
					} else if (cGame.var_7ea4[c] == 2994) {
						cGame.s_questValue[c] = encryptInt(cActor.sub_4de1(0, 54, 52, 63));
						if (decryptInt(cGame.s_questValue[c]) >= decryptInt(cGame.s_questNeededVals[c])) {
							cGame.s_questValue[c] = cGame.s_questNeededVals[c];
							n2 = c;
						}
					} else if (cGame.var_7ea4[c] == 2999) {
						cGame.s_questValue[c] = encryptInt(cActor.sub_4de1(0, 54, 0, 63));
						if (decryptInt(cGame.s_questValue[c]) >= decryptInt(cGame.s_questNeededVals[c])) {
							cGame.s_questValue[c] = cGame.s_questNeededVals[c];
							n2 = c;
						}
					} else if (n == cGame.var_7ea4[c]) {
						cGame.s_questValue[c] = encryptInt(cActor.sub_4d73(0, n));
						if (decryptInt(cGame.s_questValue[c]) >= decryptInt(cGame.s_questNeededVals[c])) {
							cGame.s_questValue[c] = cGame.s_questNeededVals[c];
							n2 = c;
						}
					...
					if (n2 != -1) {
						...
						if ((decryptInt(cGame.s_questNeededVals[n2]) == 0 || cGame.var_7ebc[n2])
					...
					cGame.s_questValue[c] = encryptInt(cActor.sub_4ed9(0, 54));
					if (decryptInt(cGame.s_questValue[c]) >= decryptInt(cGame.s_questNeededVals[c])) {
						cGame.s_questValue[c] = cGame.s_questNeededVals[c];
						cGame.var_7ebc[c] = true;
						if ((decryptInt(cGame.s_questNeededVals[c]) == 0 || cGame.var_7ebc[c])
	...
	cGame(final Object application, final Object display) {
	...
	final void Game_update() {
		...
		if (cGame.s_switcherState == -1 && cGame.s_game_states[cGame.s_game_state] != Define.GS_IGP) {
			...
			if (cGame.s_game_currentActionID < 0) {
				cGame.var_6f7c = -1;
				cGame.var_6f8c = -1;
				cGame.s_game_currentActionID = -1;
				int n = 0;
				Label_0207: {
					if (cGame.var_6f74 != null) {
						for (int i = cGame.var_6f74.length - 1; i >= 0; --i) {
							if (cGame.var_6f74[i] != null && cGame.var_6f74[i][5] != -1
									&& sub_2c577(GLLib.s_pointerX, GLLib.s_pointerY, cGame.var_6f74[i][0],
				...
				if (GLLib.s_pointerState == 1 && n > -1) {
					...
					if (cGame.var_6f84 == n && getRealAddedPointerCoords() < 50) {
						cGame.s_game_currentActionID = n;
					}
					cGame.var_6f84 = -1;
					cGame.var_6f9c = -1;
				}
					...
					if (cGame.var_6f84 == n && getRealAddedPointerCoords() < 50) {
						...
						if (b) {
							if ((cGame.var_6fac += GLLib.s_game_frameDT) > 600 && cGame.var_6fac > 900) {
								cGame.s_game_currentActionID = cGame.var_6f84;
								cGame.var_6fac -= 300;
							}
							break Label_0429;
						}
			...
			if (cGame.s_game_currentActionID > -1 && cGame.s_gamePlayer != null && cGame.s_gamePlayer.GetAnim() < 0) {
				for (int k = 0; k < cGame.var_6fb4.length; ++k) {
					final short n4;
					if (cGame.var_6fb4[k] > -1
							&& cGame.s_game_currentActionID == (cGame.var_6fa4 << 16 | (cGame.var_6fb4[k] & 0xFFFF))
							&& cGame.var_6fa4 > -1
			...
			if (var_6f9c > -1 && cGame.var_6f9c == -1) {
				...
				if ((n6 = cGame.var_68bc[var_6f9c >> 16 & 0xFFFF][n5][19]) >= 0 && n6 < 10
					...
					if (cGame.s_game_currentActionID > -1) {
						sub_23297(n6, n5);
					} else {
						final short n7 = n6;
						...
						sub_23297(n7, n14);
						cGame.s_game_currentActionID = (n8 << 16 | (n14 & 0xFFFF));
					}
				}
				cGame.var_6bec = false;
			}
			...
			if (cGame.s_game_currentActionID > -1) {
				if (cGame.s_gamePlayer == null) {
					action = cGame.s_game_currentActionID;
					cGame.s_game_currentActionID = -1;
					...
					Label_1980: {
						if (n34 < 2) {
							...
							for (int n35 = n34 - 1; n35 >= 0; --n35) {
								...
								if ((b3 && sub_2dcf3 + cActor.sub_59d2(2) >= sub_2df26)
										|| (b4 && sub_2dcf3 + cActor.sub_59d2(2) >= sub_2df26)
		...
		GLLib.Dbg("G_DT : " + GLLib.s_game_frameDT + " ms");
		GLLib.Dbg("G_Update : " + (System.currentTimeMillis() - update) + " ms");
		sub_b693();
		GLLib.Dbg("G_Paint : " + (System.currentTimeMillis() - paint) + " ms");
	}

	public final void hideNotify() {
		super.hideNotify();
		if (cGame.s_game_state != Define.GS_EXIT) {
			dispatchState(7, cGame.s_game_state);
			final int sub_8396;
	...
	public final void showNotify() {
		...
		if (cGame.s_game_state != Define.GS_EXIT) {
			...
			dispatchState(6, cGame.s_game_state);
		}
	}
	...
	protected final void UnInit() {
		...
		cGame.s_questDescriptions = null;
		cGame.var_7e84 = null;
		cGame.var_7e7c = null;
		cGame.s_questQuests = null;
		cGame.s_questQuests2 = null;
		cGame.s_loadedTexts = null;
		cGame.s_questValue = null;
		cGame.s_questNeededVals = null;
		cGame.var_7ebc = null;
		cGame.var_7ea4 = null;
		cGame.var_7eac = null;
		cGame.var_7eb4 = null;
	...
	private static void sub_4c5ea() {
		if (cGame.var_7ffc[0] != null) {
			cGame.var_7ffc[0].FreeCachePoolData();
		}
		if (cGame.var_7ffc[1] != null) {
			cGame.var_7ffc[1].FreeCachePoolData();
		}
		if (cGame.var_7ffc[2] != null) {
			cGame.var_7ffc[2].FreeCachePoolData();
		}
		if (cGame.var_7ffc[3] != null) {
			cGame.var_7ffc[3].FreeCachePoolData();
		}
		if (cGame.var_7ffc[4] != null) {
			cGame.var_7ffc[4].FreeCachePoolData();
		}
	}
	...
	private static void platformRequest(String url) {
		...
		if (b) {
			try {
				url = GLLib.Text_FindReplace(url, "|", "");
				GloftGF2M.s_instance.platformRequest(url);
			} catch (final Exception ex) {
				ex.printStackTrace();
			}
	...
	public static void sub_4c768() {
		...
		for (int sub_5439 = cActor.sub_5439(2, 47, array, 10), i = 0; i < sub_5439; ++i) {
	...
	static {
		...
		cGame.s_displayPauseCreds = false;
		cGame.s_displayPauseHelp = false;
		cGame.s_displayPauseSndOpt = false;
		cGame.s_displayPauseOpts = false;
		cGame.s_displayDebugInfo = true;
		cGame.s_isPaused = false;
		cGame.var_69dc = false;
		...
		cGame.var_795c = 0;
		cGame.var_7964 = true;
		cGame.s_hasPushNotifications = false;
		...
		cGame.s_iapTermsConditions = null;
		cGame.var_7ca4 = 0;
		cGame.var_7cac = -1;
		cGame.var_7cb4 = 0;
		cGame.var_7cbc = 0;
		...
		cGame.var_7e1c = 0;
		cGame.var_7e24 = 0;
		cGame.s_pond_lowRodCashCost = 0;
		cGame.s_pond_highRodCashCost = 0;
		cGame.var_7e3c = -1;
		cGame.var_7e44 = false;
		cGame.s_currentQuest = 0;
		cGame.var_7f74 = '\u0004';
